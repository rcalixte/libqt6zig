...
pub const QBoxPlotLegendMarker = extern struct {
    ...
    /// Allocate a new QBoxPlotLegendMarker object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    ...
    /// ` legend: QLegend `
    ///
    pub fn new(_series: anytype, legend: anytype) QBoxPlotLegendMarker {
        comptime _ = @TypeOf(_series)._is_QBoxPlotSeries;
        comptime _ = @TypeOf(legend)._is_QLegend;
        return .{ .ptr = qtc.QBoxPlotLegendMarker_new(@ptrCast(_series.ptr), @ptrCast(legend.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_series: anytype, legend: anytype, _parent: anytype) QBoxPlotLegendMarker {
        comptime _ = @TypeOf(_series)._is_QBoxPlotSeries;
        comptime _ = @TypeOf(legend)._is_QLegend;
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QBoxPlotLegendMarker_new2(@ptrCast(_series.ptr), @ptrCast(legend.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    ///
    pub fn type0(self: QBoxPlotLegendMarker) i32 {
    ...
    /// ` _label: []const u8 `
    ///
    pub fn setLabel(self: QBoxPlotLegendMarker, _label: []const u8) void {
    ...
    /// ` _brush: QBrush `
    ///
    pub fn setLabelBrush(self: QBoxPlotLegendMarker, _brush: anytype) void {
    ...
    /// ` _font: QFont `
    ///
    pub fn setFont(self: QBoxPlotLegendMarker, _font: anytype) void {
    ...
    /// ` _pen: QPen `
    ///
    pub fn setPen(self: QBoxPlotLegendMarker, _pen: anytype) void {
    ...
    /// ` _brush: QBrush `
    ///
    pub fn setBrush(self: QBoxPlotLegendMarker, _brush: anytype) void {
        comptime _ = @TypeOf(_brush)._is_QBrush;
    ...
    ///
    pub fn setShape(self: QBoxPlotLegendMarker, _shape: i32) void {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QBoxPlotLegendMarker, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QBoxPlotLegendMarker, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QBoxPlotLegendMarker, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QBoxPlotLegendMarker, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QBoxPlotLegendMarker.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QBoxPlotLegendMarker, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QBoxPlotLegendMarker, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QBoxPlotLegendMarker_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QBoxPlotLegendMarker, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QBoxPlotLegendMarker_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QBoxPlotLegendMarker, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QBoxPlotLegendMarker_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QBoxPlotLegendMarker, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QBoxPlotLegendMarker_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QBoxPlotLegendMarker, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QBoxPlotLegendMarker_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QBoxPlotLegendMarker, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QBoxPlotLegendMarker_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QBoxPlotLegendMarker, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QBoxPlotLegendMarker_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QBoxPlotLegendMarker, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QBoxPlotLegendMarker_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QBoxPlotLegendMarker, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QBoxPlotLegendMarker_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QBoxPlotLegendMarker, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QBoxPlotLegendMarker_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
