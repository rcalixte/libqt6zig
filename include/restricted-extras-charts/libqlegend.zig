...
pub const QLegend = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QLegend_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QLegend_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QLegend_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _rect: QRectF `
    ///
    pub fn mapToItem2(self: QLegend, item: anytype, _rect: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        comptime _ = @TypeOf(_rect)._is_QRectF;
    ...
    /// ` _rect: QRectF `
    ///
    pub fn mapToParent2(self: QLegend, _rect: anytype) QPolygonF {
        comptime _ = @TypeOf(_rect)._is_QRectF;
    ...
    /// ` _rect: QRectF `
    ///
    pub fn mapToScene2(self: QLegend, _rect: anytype) QPolygonF {
        comptime _ = @TypeOf(_rect)._is_QRectF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapToItem3(self: QLegend, item: anytype, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapToParent3(self: QLegend, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapToScene3(self: QLegend, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` _rect: QRectF `
    ///
    pub fn mapFromItem2(self: QLegend, item: anytype, _rect: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        comptime _ = @TypeOf(_rect)._is_QRectF;
    ...
    /// ` _rect: QRectF `
    ///
    pub fn mapFromParent2(self: QLegend, _rect: anytype) QPolygonF {
        comptime _ = @TypeOf(_rect)._is_QRectF;
    ...
    /// ` _rect: QRectF `
    ///
    pub fn mapFromScene2(self: QLegend, _rect: anytype) QPolygonF {
        comptime _ = @TypeOf(_rect)._is_QRectF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapFromItem3(self: QLegend, item: anytype, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapFromParent3(self: QLegend, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapFromScene3(self: QLegend, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` h: f64 `
    ///
    pub fn mapToItem6(self: QLegend, item: anytype, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` h: f64 `
    ///
    pub fn mapToParent6(self: QLegend, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
    ...
    /// ` h: f64 `
    ///
    pub fn mapToScene6(self: QLegend, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
    ...
    /// ` h: f64 `
    ///
    pub fn mapFromItem6(self: QLegend, item: anytype, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` h: f64 `
    ///
    pub fn mapFromParent6(self: QLegend, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
    ...
    /// ` h: f64 `
    ///
    pub fn mapFromScene6(self: QLegend, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
