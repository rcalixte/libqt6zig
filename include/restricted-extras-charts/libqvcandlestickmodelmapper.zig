...
pub const qvcandlestickmodelmapper = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QVCandlestickModelMapper_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QVCandlestickModelMapper_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QVCandlestickModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QVCandlestickModelMapperparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QVCandlestickModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QVCandlestickModelMapperobjectName: [*:0]const u8) callconv(.c) void `
    ///
