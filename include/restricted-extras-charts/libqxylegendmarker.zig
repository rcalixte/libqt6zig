...
pub const qxylegendmarker = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QXYLegendMarker_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QXYLegendMarker_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QXYLegendMarker `
    ///
    /// ` callback: *const fn (self: QtC.QXYLegendMarkerstatus: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QXYLegendMarker `
    ///
    /// ` callback: *const fn (self: QtC.QXYLegendMarkerparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QXYLegendMarker `
    ///
    /// ` callback: *const fn (self: QtC.QXYLegendMarkerobjectName: [*:0]const u8) callconv(.c) void `
    ///
