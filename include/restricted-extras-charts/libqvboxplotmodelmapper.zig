...
pub const qvboxplotmodelmapper = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QVBoxPlotModelMapper_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseSetFirst(self: ?*anyopaque, first: i32) void {
        qtc.QVBoxPlotModelMapper_QBaseSetFirst(@ptrCast(self), @bitCast(first));
    }
    ...
    pub fn QBaseSetCount(self: ?*anyopaque, count: i32) void {
        qtc.QVBoxPlotModelMapper_QBaseSetCount(@ptrCast(self), @bitCast(count));
    }
    ...
    pub fn QBaseSetFirstBoxSetSection(self: ?*anyopaque, firstBoxSetSection: i32) void {
        qtc.QVBoxPlotModelMapper_QBaseSetFirstBoxSetSection(@ptrCast(self), @bitCast(firstBoxSetSection));
    }
    ...
    pub fn QBaseSetLastBoxSetSection(self: ?*anyopaque, lastBoxSetSection: i32) void {
        qtc.QVBoxPlotModelMapper_QBaseSetLastBoxSetSection(@ptrCast(self), @bitCast(lastBoxSetSection));
    }
    ...
    pub fn QBaseSetOrientation(self: ?*anyopaque, orientation: i32) void {
        qtc.QVBoxPlotModelMapper_QBaseSetOrientation(@ptrCast(self), @bitCast(orientation));
    }
