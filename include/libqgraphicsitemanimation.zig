...
pub const qgraphicsitemanimation = struct {
    ...
    /// ` self: QtC.QGraphicsItemAnimation `
    ///
    /// ` callback: *const fn (self: QtC.QGraphicsItemAnimationparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QGraphicsItemAnimation `
    ///
    /// ` callback: *const fn (self: QtC.QGraphicsItemAnimationobjectName: [*:0]const u8) callconv(.c) void `
    ///
