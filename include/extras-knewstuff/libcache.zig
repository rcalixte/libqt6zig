...
pub const knscore__cache = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KNSCore__Cache_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn RegistryForProvider(self: ?*anyopaque, providerId: []const u8, allocator: std.mem.Allocator) []QtC.KNSCore__Entry {
        ...
        const _ret = allocator.alloc(QtC.KNSCore__Entry, _arr.len) catch @panic("knscore__cache.RegistryForProvider: Memory allocation failed");
    ...
    pub fn Registry(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.KNSCore__Entry {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.KNSCore__Entry, _arr.len) catch @panic("knscore__cache.Registry: Memory allocation failed");
        const _data: [*]QtC.KNSCore__Entry = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
        return _ret;
    }
    ...
    pub fn RequestFromCache(self: ?*anyopaque, param1: ?*anyopaque, allocator: std.mem.Allocator) []QtC.KNSCore__Entry {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.KNSCore__Entry, _arr.len) catch @panic("knscore__cache.RequestFromCache: Memory allocation failed");
        const _data: [*]QtC.KNSCore__Entry = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
        return _ret;
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("knscore__cache.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KNSCore__Cache `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__Cache) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNSCore__Cache `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__Cache, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNSCore__Cache `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__Cache, objectName: [*:0]const u8) callconv(.c) void `
    ///
