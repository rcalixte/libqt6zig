...
pub const knscore__itemsmodel = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KNSCore__ItemsModel_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KNSCore__ItemsModel_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    /// ` self: QtC.KNSCore__ItemsModel `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__ItemsModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNSCore__ItemsModel `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__ItemsModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNSCore__ItemsModel `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__ItemsModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("knscore__itemsmodel.DynamicPropertyNames: Memory allocation failed");
    ...
    pub fn MimeTypes(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("knscore__itemsmodel.MimeTypes: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn RoleNames(self: ?*anyopaque, allocator: std.mem.Allocator) map_i32_u8 {
        ...
        while (i < _map.len) : (i += 1) {
            ...
            _ret.put(allocator, _key, _value_slice) catch @panic("knscore__itemsmodel.RoleNames: Memory allocation failed");
        }
        return _ret;
    }
