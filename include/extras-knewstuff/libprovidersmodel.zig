...
pub const KNSCore__ProvidersModel = extern struct {
    ...
    pub fn RoleNames(self: KNSCore__ProvidersModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("knscore__providersmodel.RoleNames: Total capacity allocation failed");
        defer {
    ...
    pub fn ItemData(self: KNSCore__ProvidersModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("knscore__providersmodel.ItemData: Total capacity allocation failed");
        defer {
            qtc.libqt_free(_map.keys);
            qtc.libqt_free(_map.values);
        }
