...
pub const qpluginloader = struct {
    ...
    /// ` self: QtC.QPluginLoader `
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoaderparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader `
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoaderobjectName: [*:0]const u8) callconv(.c) void `
    ///
