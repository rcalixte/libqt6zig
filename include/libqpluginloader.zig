...
pub const qpluginloader = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QPluginLoader_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QPluginLoader `
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, param1: qobjectdefs_enums.Call, param2: i32, param3: *?*anyopaque) callconv(.c) i32 `
    ///
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QPluginLoader_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn FileName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QPluginLoader_FileName(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn ErrorString(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QPluginLoader_ErrorString(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: QtC.QPluginLoader `
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader `
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, event: QtC.QEvent) callconv(.c) bool `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, event: QtC.QTimerEvent) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, event: QtC.QChildEvent) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, event: QtC.QEvent) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, signal: QtC.QMetaMethod) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, signal: [*:0]const u8) callconv(.c) i32 `
    ///
    ...
    /// ` self: QtC.QPluginLoader`
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, signal: QtC.QMetaMethod) callconv(.c) bool `
    ///
    ...
    /// ` self: QtC.QPluginLoader `
    ///
    /// ` callback: *const fn (self: QtC.QPluginLoader, objectName: [*:0]const u8) callconv(.c) void `
    ///
