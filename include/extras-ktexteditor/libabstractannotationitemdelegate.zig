...
pub const ktexteditor__styleoptionannotationitem = struct {
    ...
    pub fn SetWrappedLine(self: ?*anyopaque, wrappedLine: i32) void {
        qtc.KTextEditor__StyleOptionAnnotationItem_SetWrappedLine(@ptrCast(self), @bitCast(wrappedLine));
    }
    ...
    pub fn SetWrappedLineCount(self: ?*anyopaque, wrappedLineCount: i32) void {
        qtc.KTextEditor__StyleOptionAnnotationItem_SetWrappedLineCount(@ptrCast(self), @bitCast(wrappedLineCount));
    }
    ...
    pub fn SetVisibleWrappedLineInGroup(self: ?*anyopaque, visibleWrappedLineInGroup: i32) void {
        qtc.KTextEditor__StyleOptionAnnotationItem_SetVisibleWrappedLineInGroup(@ptrCast(self), @bitCast(visibleWrappedLineInGroup));
    }
    ...
    pub fn SetAnnotationItemGroupingPosition(self: ?*anyopaque, annotationItemGroupingPosition: i32) void {
        qtc.KTextEditor__StyleOptionAnnotationItem_SetAnnotationItemGroupingPosition(@ptrCast(self), @bitCast(annotationItemGroupingPosition));
    }
...
pub const ktexteditor__abstractannotationitemdelegate = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KTextEditor__AbstractAnnotationItemDelegate_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Paint(self: ?*anyopaque, painter: ?*anyopaque, option: ?*anyopaque, model: ?*anyopaque, line: i32) void {
        qtc.KTextEditor__AbstractAnnotationItemDelegate_Paint(@ptrCast(self), @ptrCast(painter), @ptrCast(option), @ptrCast(model), @bitCast(line));
    }
    ...
    pub fn SizeHint(self: ?*anyopaque, option: ?*anyopaque, model: ?*anyopaque, line: i32) QtC.QSize {
        return qtc.KTextEditor__AbstractAnnotationItemDelegate_SizeHint(@ptrCast(self), @ptrCast(option), @ptrCast(model), @bitCast(line));
    }
    ...
    pub fn HelpEvent(self: ?*anyopaque, event: ?*anyopaque, view: ?*anyopaque, option: ?*anyopaque, model: ?*anyopaque, line: i32) bool {
        return qtc.KTextEditor__AbstractAnnotationItemDelegate_HelpEvent(@ptrCast(self), @ptrCast(event), @ptrCast(view), @ptrCast(option), @ptrCast(model), @bitCast(line));
    }
    ...
    pub fn SizeHintChanged(self: ?*anyopaque, model: ?*anyopaque, line: i32) void {
        qtc.KTextEditor__AbstractAnnotationItemDelegate_SizeHintChanged(@ptrCast(self), @ptrCast(model), @bitCast(line));
    }
    ...
    pub fn OnSizeHintChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, i32) callconv(.c) void) void {
        qtc.KTextEditor__AbstractAnnotationItemDelegate_Connect_SizeHintChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("ktexteditor__abstractannotationitemdelegate.Children: Memory allocation failed");
