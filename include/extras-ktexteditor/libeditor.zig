...
pub const ktexteditor__editor = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KTextEditor__Editor_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn OnDocumentCreated(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KTextEditor__Editor_Connect_DocumentCreated(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn ConfigPage(self: ?*anyopaque, number: i32, parent: ?*anyopaque) QtC.KTextEditor__ConfigPage {
        return qtc.KTextEditor__Editor_ConfigPage(@ptrCast(self), @bitCast(number), @ptrCast(parent));
    }
    ...
    pub fn OnConfigChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KTextEditor__Editor_Connect_ConfigChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnRepositoryReloaded(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KTextEditor__Editor_Connect_RepositoryReloaded(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
