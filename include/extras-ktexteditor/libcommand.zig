...
pub const ktexteditor__command = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KTextEditor__Command_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KTextEditor__Command_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KTextEditor__Command `
    ///
    /// ` callback: *const fn (self: QtC.KTextEditor__Commandparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KTextEditor__Command `
    ///
    /// ` callback: *const fn (self: QtC.KTextEditor__CommandobjectName: [*:0]const u8) callconv(.c) void `
    ///
