...
pub const QWebEngineHistoryModel = extern struct {
    ...
    pub fn RoleNames(self: QWebEngineHistoryModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qwebenginehistorymodel.RoleNames: Total capacity allocation failed");
        defer {
    ...
    pub fn ItemData(self: QWebEngineHistoryModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qwebenginehistorymodel.ItemData: Total capacity allocation failed");
        defer {
            qtc.libqt_free(_map.keys);
            qtc.libqt_free(_map.values);
        }
