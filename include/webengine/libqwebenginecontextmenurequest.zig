...
pub const qwebenginecontextmenurequest = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineContextMenuRequest_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn SelectedText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QWebEngineContextMenuRequest_SelectedText(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn LinkText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QWebEngineContextMenuRequest_LinkText(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn MisspelledWord(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QWebEngineContextMenuRequest_MisspelledWord(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn SpellCheckerSuggestions(self: ?*anyopaque, allocator: std.mem.Allocator) []const []const u8 {
    ...
    /// ` self: QtC.QWebEngineContextMenuRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineContextMenuRequest, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineContextMenuRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineContextMenuRequest, objectName: [*:0]const u8) callconv(.c) void `
    ///
