...
pub const qwebenginenewwindowrequest = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.QWebEngineNewWindowRequest_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QWebEngineNewWindowRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineNewWindowRequestparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineNewWindowRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineNewWindowRequestobjectName: [*:0]const u8) callconv(.c) void `
    ///
