...
pub const qwebenginenotification = struct {
    ...
    /// ` self: QtC.QWebEngineNotification `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineNotificationparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineNotification `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineNotificationobjectName: [*:0]const u8) callconv(.c) void `
    ///
