...
pub const qambientsound = struct {
    ...
    /// ` self: QtC.QAmbientSound `
    ///
    /// ` callback: *const fn (self: QtC.QAmbientSoundparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAmbientSound `
    ///
    /// ` callback: *const fn (self: QtC.QAmbientSoundobjectName: [*:0]const u8) callconv(.c) void `
    ///
