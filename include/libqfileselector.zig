...
pub const qfileselector = struct {
    ...
    /// ` self: QtC.QFileSelector `
    ///
    /// ` callback: *const fn (self: QtC.QFileSelectorparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSelector `
    ///
    /// ` callback: *const fn (self: QtC.QFileSelectorobjectName: [*:0]const u8) callconv(.c) void `
    ///
