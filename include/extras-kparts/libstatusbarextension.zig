...
pub const kparts__statusbarextension = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KParts__StatusBarExtension_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KParts__StatusBarExtension_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KParts__StatusBarExtension `
    ///
    /// ` callback: *const fn (self: QtC.KParts__StatusBarExtensionparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KParts__StatusBarExtension `
    ///
    /// ` callback: *const fn (self: QtC.KParts__StatusBarExtensionobjectName: [*:0]const u8) callconv(.c) void `
    ///
