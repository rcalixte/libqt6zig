...
pub const kparts__fileinfoextension = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KParts__FileInfoExtension_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KParts__FileInfoExtension_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KParts__FileInfoExtension `
    ///
    /// ` callback: *const fn (self: QtC.KParts__FileInfoExtensionparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KParts__FileInfoExtension `
    ///
    /// ` callback: *const fn (self: QtC.KParts__FileInfoExtensionobjectName: [*:0]const u8) callconv(.c) void `
    ///
