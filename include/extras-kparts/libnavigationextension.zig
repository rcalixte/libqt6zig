...
pub const KParts__NavigationExtension = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KParts__NavigationExtension_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KParts__NavigationExtension_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KParts__NavigationExtension_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn popupMenu5(self: KParts__NavigationExtension, allocator: std.mem.Allocator, global: anytype, items: anytype, arguments: anytype, flags: i32, actionGroups: ArrayMap_constu8_SliceQAction) void {
        ...
        var actionGroups_i: usize = 0;
        var actionGroups_it = actionGroups.iterator();
        while (actionGroups_it.next()) |it_entry| : (actionGroups_i += 1) {
            const actionGroups_key = it_entry.key_ptr.*;
            actionGroups_keys[actionGroups_i] = qtc.libqt_string{
                .len = actionGroups_key.len,
                .data = actionGroups_key.ptr,
            };
            const value = it_entry.value_ptr.*;
            actionGroups_values[actionGroups_i] = qtc.libqt_list{
                .len = value.len,
