...
pub const KLanguageButton = extern struct {
    /// ### [Upstream resources](https://api.kde.org/klanguagebutton.html)
    ///
    /// The pointer to the underlying Qt C++ object
    ///
    ptr: QtC.KLanguageButton,

    pub const _is_KLanguageButton = {};
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KLanguageButton_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KLanguageButton_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KLanguageButton_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: KLanguageButton `
    ///
    pub fn asQPaintDevice(self: KLanguageButton) QPaintDevice {
    ...
    ///
    pub fn fromQPaintDevice(_qpaintdevice: anytype) KLanguageButton {
