...
pub const kcombobox = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KComboBox_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KComboBox_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxtext: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxparam1: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxparam1: kcompletionbase_enums.KeyBindingType) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxparam1: kcompletion_enums.CompletionMode) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxcontextMenu: QtC.QMenu) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBox, items: [*][*:0]const u8, autoSuggest: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxindex: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxtitle: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxicon: QtC.QIcon) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxiconText: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxpos: QtC.QPoint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    pub fn QBaseNativeEvent(self: ?*anyopaque, eventType: []u8, message: ?*anyopaque, result: *isize) bool {
        ...
        return qtc.KComboBox_QBaseNativeEvent(@ptrCast(self), eventType_str, @ptrCast(message), @ptrCast(result));
    }
    ...
    /// ` self: QtC.KComboBox`
    ///
    /// ` callback: *const fn (self: QtC.KComboBox, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
    ...
    pub fn VirtualHook(self: ?*anyopaque, id: i32, data: ?*anyopaque) void {
        qtc.KComboBox_VirtualHook(@ptrCast(self), @intCast(id), @ptrCast(data));
    }
    ...
    pub fn QBaseVirtualHook(self: ?*anyopaque, id: i32, data: ?*anyopaque) void {
        qtc.KComboBox_QBaseVirtualHook(@ptrCast(self), @intCast(id), @ptrCast(data));
    }
    ...
    /// ` self: QtC.KComboBox `
    ///
    /// ` callback: *const fn (self: QtC.KComboBoxobjectName: [*:0]const u8) callconv(.c) void `
    ///
