...
pub const KComboBox = extern struct {
    ...
    /// ` self: KComboBox `
    ///
    pub fn asKCompletionBase(self: KComboBox) KCompletionBase {
    ...
    ///
    pub fn fromKCompletionBase(_kcompletionbase: anytype) KComboBox {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KComboBox_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KComboBox_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KComboBox_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: KComboBox `
    ///
    pub fn asQPaintDevice(self: KComboBox) QPaintDevice {
    ...
    ///
    pub fn fromQPaintDevice(_qpaintdevice: anytype) KComboBox {
    ...
    pub fn setDelegate(self: KComboBox, _delegate: anytype) void {
        ...
        qtc.KComboBox_SetDelegate(@ptrCast(self.ptr), @ptrCast(_delegate_.ptr));
    }
    ...
    pub fn superSetDelegate(self: KComboBox, _delegate: anytype) void {
        comptime _ = @TypeOf(_delegate)._is_KCompletionBase;
        const _delegate_ = if (@hasDecl(@TypeOf(_delegate), "asKCompletionBase")) _delegate.asKCompletionBase() else _delegate;
        qtc.KComboBox_SuperSetDelegate(@ptrCast(self.ptr), @ptrCast(_delegate_.ptr));
    }
