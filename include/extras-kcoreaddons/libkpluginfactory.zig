...
pub const KPluginFactory = extern struct {
    ...
    /// Allocate a new KPluginFactory object in C++ memory
    ///
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KPluginFactory_Tr(s_Cstring);
    ...
    /// ` self: KPluginFactory `
    ///
    /// ` _metaData: KPluginMetaData `
    ///
    pub fn setMetaData(self: KPluginFactory, _metaData: anytype) void {
        comptime _ = @TypeOf(_metaData)._is_KPluginMetaData;
        qtc.KPluginFactory_SetMetaData(@ptrCast(self.ptr), @ptrCast(_metaData.ptr));
    }
    ...
    /// ` args: []QVariant `
    ///
    pub fn create(self: KPluginFactory, iface: [:0]const u8, parentWidget: anytype, _parent: anytype, args: []QVariant) QObject {
        ...
        return .{ .ptr = qtc.KPluginFactory_Create(@ptrCast(self.ptr), iface_Cstring, @ptrCast(parentWidget.ptr), @ptrCast(_parent.ptr), args_list) };
    }
    ...
    /// ` args: []QVariant `
    ///
    pub fn superCreate(self: KPluginFactory, iface: [:0]const u8, parentWidget: anytype, _parent: anytype, args: []QVariant) QObject {
        const iface_Cstring = iface.ptr;
        comptime _ = @TypeOf(parentWidget)._is_QWidget;
        comptime _ = @TypeOf(_parent)._is_QObject;
        const args_list = qtc.libqt_list{
        ...
        return .{ .ptr = qtc.KPluginFactory_SuperCreate(@ptrCast(self.ptr), iface_Cstring, @ptrCast(parentWidget.ptr), @ptrCast(_parent.ptr), args_list) };
    }
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KPluginFactory_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KPluginFactory_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KPluginFactory, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KPluginFactory, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KPluginFactory, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KPluginFactory, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KPluginFactory.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KPluginFactory, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KPluginFactory, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KPluginFactory_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: KPluginFactory, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KPluginFactory_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KPluginFactory, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KPluginFactory_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: KPluginFactory, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KPluginFactory_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: KPluginFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KPluginFactory_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: KPluginFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KPluginFactory_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: KPluginFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KPluginFactory_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: KPluginFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KPluginFactory_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: KPluginFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KPluginFactory_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: KPluginFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KPluginFactory_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
