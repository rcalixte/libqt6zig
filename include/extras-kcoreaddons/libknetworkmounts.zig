...
pub const knetworkmounts = struct {
    ...
    /// ` self: QtC.KNetworkMounts `
    ///
    /// ` callback: *const fn (self: QtC.KNetworkMountsparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNetworkMounts `
    ///
    /// ` callback: *const fn (self: QtC.KNetworkMountsobjectName: [*:0]const u8) callconv(.c) void `
    ///
