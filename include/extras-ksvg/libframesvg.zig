...
pub const ksvg__framesvg = struct {
    ...
    pub fn SuperMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KSvg__FrameSvg_SuperMetaObject(@ptrCast(self));
    }
    ...
    pub fn SuperMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KSvg__FrameSvg_SuperMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn SuperMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KSvg__FrameSvg_SuperMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` path: []const u8 `
    ///
    pub fn SuperSetImagePath(self: ?*anyopaque, path: []const u8) void {
        const path_str = qtc.libqt_string{
            .len = path.len,
            .data = path.ptr,
        };
        qtc.KSvg__FrameSvg_SuperSetImagePath(@ptrCast(self), path_str);
    }
    ...
    pub fn SuperEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KSvg__FrameSvg_SuperEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSvg__FrameSvg_SuperTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSvg__FrameSvg_SuperChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KSvg__FrameSvg_SuperCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KSvg__FrameSvg_SuperConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn SuperDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KSvg__FrameSvg_SuperDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn SuperSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KSvg__FrameSvg_SuperSender(@ptrCast(self));
    }
    ...
    pub fn SuperSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KSvg__FrameSvg_SuperSenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn SuperReceivers(self: ?*anyopaque, signal: [:0]const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KSvg__FrameSvg_SuperReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn SuperIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KSvg__FrameSvg_SuperIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
