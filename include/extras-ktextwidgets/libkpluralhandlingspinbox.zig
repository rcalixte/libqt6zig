...
pub const kpluralhandlingspinbox = struct {
    ...
    pub fn OnMetaObject(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QMetaObject) void {
        qtc.KPluralHandlingSpinBox_OnMetaObject(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnMetacast(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) ?*anyopaque) void {
        qtc.KPluralHandlingSpinBox_OnMetacast(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KPluralHandlingSpinBox_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KPluralHandlingSpinBox_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn TextFromValue(self: ?*anyopaque, val: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KPluralHandlingSpinBox_TextFromValue(@ptrCast(self), @intCast(val));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn QBaseTextFromValue(self: ?*anyopaque, val: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KPluralHandlingSpinBox_QBaseTextFromValue(@ptrCast(self), @intCast(val));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kpluralhandlingspinbox.TextFromValue: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    ...
    /// ` self: QtC.KPluralHandlingSpinBox`
    ///
    /// ` callback: *const fn (self: QtC.KPluralHandlingSpinBox, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
