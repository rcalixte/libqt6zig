...
pub const KModelIndexProxyMapper = extern struct {
    ...
    /// Allocate a new KModelIndexProxyMapper object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(leftModel: anytype, rightModel: anytype, _parent: anytype) KModelIndexProxyMapper {
        comptime _ = @TypeOf(leftModel)._is_QAbstractItemModel;
        comptime _ = @TypeOf(rightModel)._is_QAbstractItemModel;
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.KModelIndexProxyMapper_new2(@ptrCast(leftModel.ptr), @ptrCast(rightModel.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KModelIndexProxyMapper_Tr(s_Cstring);
    ...
    /// ### DEPRECATED: Use `mapLeftToRight` instead
    ///
    pub const MapLeftToRight = mapLeftToRight;
    ...
    /// ### DEPRECATED: Use `mapRightToLeft` instead
    ///
    pub const MapRightToLeft = mapRightToLeft;
    ...
    /// ### DEPRECATED: Use `mapSelectionLeftToRight` instead
    ///
    pub const MapSelectionLeftToRight = mapSelectionLeftToRight;
    ...
    /// ### DEPRECATED: Use `mapSelectionRightToLeft` instead
    ///
    pub const MapSelectionRightToLeft = mapSelectionRightToLeft;
    ...
    /// ### DEPRECATED: Use `isConnectedChanged` instead
    ///
    pub const IsConnectedChanged = isConnectedChanged;
    ...
    /// ### DEPRECATED: Use `onIsConnectedChanged` instead
    ///
    pub const OnIsConnectedChanged = onIsConnectedChanged;
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KModelIndexProxyMapper_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KModelIndexProxyMapper_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KModelIndexProxyMapper, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KModelIndexProxyMapper, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KModelIndexProxyMapper, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KModelIndexProxyMapper, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KModelIndexProxyMapper.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KModelIndexProxyMapper, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KModelIndexProxyMapper, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KModelIndexProxyMapper_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: KModelIndexProxyMapper, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KModelIndexProxyMapper_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KModelIndexProxyMapper, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KModelIndexProxyMapper_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: KModelIndexProxyMapper, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KModelIndexProxyMapper_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: KModelIndexProxyMapper, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KModelIndexProxyMapper_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: KModelIndexProxyMapper, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KModelIndexProxyMapper_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: KModelIndexProxyMapper, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KModelIndexProxyMapper_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: KModelIndexProxyMapper, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KModelIndexProxyMapper_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: KModelIndexProxyMapper, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KModelIndexProxyMapper_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: KModelIndexProxyMapper, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KModelIndexProxyMapper_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
