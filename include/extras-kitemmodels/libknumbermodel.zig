...
pub const knumbermodel = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KNumberModel_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KNumberModel_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel`
    ///
    /// ` callback: *const fn (self: QtC.KNumberModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.KNumberModel`
    ///
    /// ` callback: *const fn (self: QtC.KNumberModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.KNumberModel`
    ///
    /// ` callback: *const fn (self: QtC.KNumberModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNumberModel `
    ///
    /// ` callback: *const fn (self: QtC.KNumberModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
