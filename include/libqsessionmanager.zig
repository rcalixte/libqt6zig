...
pub const qsessionmanager = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QSessionManager_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn SetRestartHint(self: ?*anyopaque, restartHint: i32) void {
        qtc.QSessionManager_SetRestartHint(@ptrCast(self), @bitCast(restartHint));
    }
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn RestartCommand(self: ?*anyopaque, allocator: std.mem.Allocator) []const []const u8 {
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn DiscardCommand(self: ?*anyopaque, allocator: std.mem.Allocator) []const []const u8 {
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn SetManagerProperty2(self: ?*anyopaque, name: []const u8, value: []const []const u8, allocator: std.mem.Allocator) void {
        const name_str = qtc.libqt_string{
            .len = name.len,
            .data = name.ptr,
        };
