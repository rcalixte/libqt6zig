...
pub const kwidgetjobtracker = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KWidgetJobTracker_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTracker, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTracker) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTracker, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTracker, objectName: [*:0]const u8) callconv(.c) void `
    ///
