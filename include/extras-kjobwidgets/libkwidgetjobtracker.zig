...
pub const kwidgetjobtracker = struct {
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTrackerjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTrackerparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KWidgetJobTracker `
    ///
    /// ` callback: *const fn (self: QtC.KWidgetJobTrackerobjectName: [*:0]const u8) callconv(.c) void `
    ///
