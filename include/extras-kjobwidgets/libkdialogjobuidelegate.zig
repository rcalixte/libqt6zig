...
pub const kdialogjobuidelegate = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KDialogJobUiDelegate_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KDialogJobUiDelegate `
    ///
    /// ` callback: *const fn (self: QtC.KDialogJobUiDelegateparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDialogJobUiDelegate `
    ///
    /// ` callback: *const fn (self: QtC.KDialogJobUiDelegateobjectName: [*:0]const u8) callconv(.c) void `
    ///
