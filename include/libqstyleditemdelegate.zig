...
pub const qstyleditemdelegate = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QStyledItemDelegate_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QStyledItemDelegate_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseDisplayText(self: ?*anyopaque, value: ?*anyopaque, locale: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QStyledItemDelegate_QBaseDisplayText(@ptrCast(self), @ptrCast(value), @ptrCast(locale));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("qstyleditemdelegate.DisplayText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    ...
    /// ` self: QtC.QStyledItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QStyledItemDelegateeditor: QtC.QWidget) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QStyledItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QStyledItemDelegateparam1: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QStyledItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QStyledItemDelegateeditor: QtC.QWidget, hint: qabstractitemdelegate_enums.EndEditHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QStyledItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QStyledItemDelegateparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QStyledItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QStyledItemDelegateobjectName: [*:0]const u8) callconv(.c) void `
    ///
