...
pub const qsqltablemodel = struct {
    ...
    pub fn OnMetaObject(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QMetaObject) void {
        qtc.QSqlTableModel_OnMetaObject(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnMetacast(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) ?*anyopaque) void {
        qtc.QSqlTableModel_OnMetacast(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.QSqlTableModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlTableModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlTableModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlTableModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlTableModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlTableModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlTableModel`
    ///
    /// ` callback: *const fn (self: QtC.QSqlTableModel, index: QtC.QModelIndex, roles: qtc.libqt_map (map_i32_qtcqvariant)) callconv(.c) bool `
    ///
