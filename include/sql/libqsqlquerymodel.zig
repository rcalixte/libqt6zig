...
pub const qsqlquerymodel = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QSqlQueryModel_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QSqlQueryModel_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
