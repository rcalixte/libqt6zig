...
pub const qsqlquerymodel = struct {
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel`
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel`
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel`
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSqlQueryModel `
    ///
    /// ` callback: *const fn (self: QtC.QSqlQueryModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
