...
pub const qtimer = struct {
    ...
    pub fn SuperMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QTimer_SuperMetaObject(@ptrCast(self));
    }
    ...
    pub fn SuperMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QTimer_SuperMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn SuperMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QTimer_SuperMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn SuperTimerEvent(self: ?*anyopaque, param1: ?*anyopaque) void {
        qtc.QTimer_SuperTimerEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn SuperEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QTimer_SuperEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QTimer_SuperEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn SuperChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QTimer_SuperChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QTimer_SuperCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QTimer_SuperConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn SuperDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QTimer_SuperDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn SuperSender(self: ?*anyopaque) QtC.QObject {
        return qtc.QTimer_SuperSender(@ptrCast(self));
    }
    ...
    pub fn SuperSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.QTimer_SuperSenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn SuperReceivers(self: ?*anyopaque, signal: [:0]const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.QTimer_SuperReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn SuperIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.QTimer_SuperIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
