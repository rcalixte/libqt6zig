...
pub const qtimer = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QTimer_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.QTimer, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QTimer_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.QTimer, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QTimer_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QTimer_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.QTimer_Tr(s_Cstring);
    ...
    ///
    /// ``` self: QtC.QTimer, atype: qnamespace_enums.TimerType ```
    ...
    ///
    /// ``` self: QtC.QTimer, singleShot: bool ```
    ...
    ///
    /// ``` self: QtC.QTimer, param1: QtC.QTimerEvent ```
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, param1: QtC.QTimerEvent) callconv(.c) void ```
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.QTimer_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.QTimer_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.QTimer, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.QTimer, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.QTimer, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.QTimer, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QTimer, name: []const u8, value: QtC.QVariant ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTimer, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.QTimer, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.QTimer, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QTimer, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.QTimer, event: QtC.QEvent ```
    pub fn Event(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QTimer_Event(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QTimer_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.QTimer, watched: QtC.QObject, event: QtC.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QTimer_EventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QTimer_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.QTimer, event: QtC.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QTimer_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QTimer_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QTimer_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QTimer_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.QTimer, signal: QtC.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QTimer_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QTimer_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QTimer_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QTimer_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn Sender(self: ?*anyopaque) QtC.QObject {
        return qtc.QTimer_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.QTimer_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.QTimer_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.QTimer_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn () callconv(.c) i32 ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.QTimer, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.QTimer_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.QTimer_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.QTimer_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.QTimer_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QTimer, callback: *const fn (self: QtC.QTimer, objectName: [*:0]const u8) callconv(.c) void ```
