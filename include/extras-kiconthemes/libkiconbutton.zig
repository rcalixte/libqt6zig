...
pub const kiconbutton = struct {
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtonicon: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtonchecked: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtontitle: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtonicon: QtC.QIcon) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtoniconText: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtonpos: QtC.QPoint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtonparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIconButton `
    ///
    /// ` callback: *const fn (self: QtC.KIconButtonobjectName: [*:0]const u8) callconv(.c) void `
    ///
