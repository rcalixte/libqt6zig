...
pub const KWindowStateSaver = extern struct {
    ...
    /// Allocate a new KWindowStateSaver object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    /// ` window: QWindow `
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KWindowStateSaver, watched: anytype, _event: anytype) bool {
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: KWindowStateSaver, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KWindowStateSaver, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KWindowStateSaver, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KWindowStateSaver, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KWindowStateSaver, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KWindowStateSaver.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KWindowStateSaver, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KWindowStateSaver, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KWindowStateSaver_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: KWindowStateSaver, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KWindowStateSaver_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: KWindowStateSaver, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KWindowStateSaver_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: KWindowStateSaver, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KWindowStateSaver_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: KWindowStateSaver, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KWindowStateSaver_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: KWindowStateSaver, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KWindowStateSaver_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
