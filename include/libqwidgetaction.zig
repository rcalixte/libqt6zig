...
pub const qwidgetaction = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QWidgetAction_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QWidgetAction_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QWidgetAction `
    ///
    /// ` callback: *const fn (self: QtC.QWidgetActionenabled: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWidgetAction `
    ///
    /// ` callback: *const fn (self: QtC.QWidgetActioncheckable: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWidgetAction `
    ///
    /// ` callback: *const fn (self: QtC.QWidgetActionparam1: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWidgetAction `
    ///
    /// ` callback: *const fn (self: QtC.QWidgetActionchecked: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWidgetAction `
    ///
    /// ` callback: *const fn (self: QtC.QWidgetActionparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWidgetAction `
    ///
    /// ` callback: *const fn (self: QtC.QWidgetActionobjectName: [*:0]const u8) callconv(.c) void `
    ///
