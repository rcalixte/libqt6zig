...
pub const qnmeapositioninfosource = struct {
    ...
    ///
    pub fn SupportedPositioningMethods(self: ?*anyopaque) i64 {
    ...
    ///
    pub fn OnSupportedPositioningMethods(self: ?*anyopaque, callback: *const fn () callconv(.c) i64) void {
    ...
    /// ` flag of qgeopositioninfosource_enums.PositioningMethod `
    ///
    pub fn QBaseSupportedPositioningMethods(self: ?*anyopaque) i64 {
    ...
    /// ` hasFix: *bool `
    ///
    pub fn ParsePosInfoFromNmeaData(self: ?*anyopaque, data: []const u8, size: i32, posInfo: ?*anyopaque, hasFix: *bool) bool {
    ...
    /// ` hasFix: *bool `
    ///
    pub fn QBaseParsePosInfoFromNmeaData(self: ?*anyopaque, data: []const u8, size: i32, posInfo: ?*anyopaque, hasFix: *bool) bool {
        const data_Cstring = data.ptr;
    ...
    /// ` flag of qgeopositioninfosource_enums.PositioningMethod `
    ///
    pub fn PreferredPositioningMethods(self: ?*anyopaque) i64 {
    ...
    pub fn CreateDefaultSource2(parameters: map_constu8_qtcqvariant, parent: ?*anyopaque, allocator: std.mem.Allocator) QtC.QGeoPositionInfoSource {
        const parameters_keys = allocator.alloc(qtc.libqt_string, parameters.count()) catch @panic("qnmeapositioninfosource.CreateDefaultSource2: Memory allocation failed");
        defer allocator.free(parameters_keys);
        const parameters_values = allocator.alloc(QtC.QVariant, parameters.count()) catch @panic("qnmeapositioninfosource.CreateDefaultSource2: Memory allocation failed");
    ...
    pub fn CreateSource2(sourceName: []const u8, parameters: map_constu8_qtcqvariant, parent: ?*anyopaque, allocator: std.mem.Allocator) QtC.QGeoPositionInfoSource {
        ...
        const parameters_keys = allocator.alloc(qtc.libqt_string, parameters.count()) catch @panic("qnmeapositioninfosource.CreateSource2: Memory allocation failed");
        defer allocator.free(parameters_keys);
        const parameters_values = allocator.alloc(QtC.QVariant, parameters.count()) catch @panic("qnmeapositioninfosource.CreateSource2: Memory allocation failed");
        defer allocator.free(parameters_values);
        var i: usize = 0;
        var parameters_it = parameters.iterator();
        while (parameters_it.next()) |entry| : (i += 1) {
    ...
    ///
    pub fn SetPreferredPositioningMethods(self: ?*anyopaque, methods: i64) void {
    ...
    /// ` methods: flag of qgeopositioninfosource_enums.PositioningMethod `
    ///
    pub fn QBaseSetPreferredPositioningMethods(self: ?*anyopaque, methods: i64) void {
    ...
    ///
    pub fn OnSetPreferredPositioningMethods(self: ?*anyopaque, callback: *const fn (?*anyopaque, i64) callconv(.c) void) void {
