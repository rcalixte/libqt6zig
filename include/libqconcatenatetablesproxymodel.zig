...
pub const qconcatenatetablesproxymodel = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QConcatenateTablesProxyModel_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QConcatenateTablesProxyModel_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    /// ` self: QtC.QConcatenateTablesProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QConcatenateTablesProxyModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QConcatenateTablesProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QConcatenateTablesProxyModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QConcatenateTablesProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QConcatenateTablesProxyModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
