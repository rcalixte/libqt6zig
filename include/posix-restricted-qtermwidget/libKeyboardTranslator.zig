...
pub const konsole__keyboardtranslator = struct {
    ...
    /// ` self: QtC.Konsole__KeyboardTranslator `
    ///
    /// ` entry: QtC.Konsole__KeyboardTranslator__Entry `
    ///
    ...
    /// ` self: QtC.Konsole__KeyboardTranslator `
    ///
    /// ` existing: QtC.Konsole__KeyboardTranslator__Entry `
    ///
    /// ` replacement: QtC.Konsole__KeyboardTranslator__Entry `
    ///
...
pub const konsole__keyboardtranslatormanager = struct {
    ...
    ///
    /// ` translator: QtC.Konsole__KeyboardTranslator `
    ///
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn AllTranslators(self: ?*anyopaque, allocator: std.mem.Allocator) []const []const u8 {
...
pub const konsole__keyboardtranslator__entry = struct {
    ...
    /// ` self: QtC.Konsole__KeyboardTranslator__Entry `
    ///
    /// ` rhs: QtC.Konsole__KeyboardTranslator__Entry `
    ///
