...
pub const qgraphicsproxywidget = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QGraphicsProxyWidget_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QGraphicsProxyWidget `
    ///
    /// ` callback: *const fn (self: QtC.QGraphicsProxyWidgetparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QGraphicsProxyWidget `
    ///
    /// ` callback: *const fn (self: QtC.QGraphicsProxyWidgetobjectName: [*:0]const u8) callconv(.c) void `
    ///
