...
pub const packagekit__daemon = struct {
    ...
    /// ``` self: QtC.PackageKit__Daemon, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.PackageKit__Daemon_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.PackageKit__Daemon, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.PackageKit__Daemon_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), param3);
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.PackageKit__Daemon_Tr(s_Cstring);
    ...
    ///
    ///
    /// Returns: ``` flag of transaction_enums.Filter ```
    pub fn Filters() i32 {
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.PackageKit__Daemon_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.PackageKit__Daemon_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.PackageKit__Daemon, callback: *const fn (self: QtC.PackageKit__Daemon, objectName: [*:0]const u8) callconv(.c) void ```
