...
pub const packagekit__bitfield = struct {
    ...
    ///
    /// ``` self: QtC.PackageKit__Bitfield, mask: u64 ```
    ...
    /// [Upstream resources](https://github.com/PackageKit/PackageKit-Qt)
    ///
    /// ``` self: QtC.PackageKit__Bitfield, mask: QtC.PackageKit__Bitfield ```
    ...
    /// [Upstream resources](https://github.com/PackageKit/PackageKit-Qt)
    ///
    /// ``` self: QtC.PackageKit__Bitfield, other: QtC.PackageKit__Bitfield ```
