...
pub const ktoolbarspaceraction = struct {
    ...
    ///
    /// ``` parent: QtC.QObject ```
    pub fn New(parent: ?*anyopaque) QtC.KToolBarSpacerAction {
        return qtc.KToolBarSpacerAction_new(@ptrCast(parent));
    }
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KToolBarSpacerAction_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KToolBarSpacerAction, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KToolBarSpacerAction_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KToolBarSpacerAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KToolBarSpacerAction_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KToolBarSpacerAction_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KToolBarSpacerAction_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KToolBarSpacerAction_Tr(s_Cstring);
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, parent: QtC.QWidget) callconv(.c) QtC.QWidget ```
    pub fn OnCreateWidget(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) QtC.QWidget) void {
        qtc.KToolBarSpacerAction_OnCreateWidget(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseCreateWidget(self: ?*anyopaque, parent: ?*anyopaque) QtC.QWidget {
        return qtc.KToolBarSpacerAction_QBaseCreateWidget(@ptrCast(self), @ptrCast(parent));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KToolBarSpacerAction_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KToolBarSpacerAction_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, w: QtC.QWidget ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, widget: QtC.QWidget ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, allocator: std.mem.Allocator ```
    pub fn AssociatedObjects(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("ktoolbarspaceraction.AssociatedObjects: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, group: QtC.QActionGroup ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, icon: QtC.QIcon ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, text: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, tip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, what: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, priority: qaction_enums.Priority ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, b: bool ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, shortcut: QtC.QKeySequence ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, shortcuts: []QtC.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#setShortcuts)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, shortcuts: qkeysequence_enums.StandardKey ```
    ...
    pub fn Shortcuts(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QKeySequence {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QKeySequence, _arr.len) catch @panic("ktoolbarspaceraction.Shortcuts: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, context: qnamespace_enums.ShortcutContext ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, autoRepeat: bool ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, font: QtC.QFont ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, checkable: bool ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, varVal: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, event: qaction_enums.ActionEvent ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, menuRole: qaction_enums.MenuRole ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, visible: bool ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, show: bool ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, checked: bool ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, enabled: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#changed)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#enabledChanged)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, enabled: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#checkableChanged)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, checkable: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, param1: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#toggled)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, param1: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#showStatusText)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, object: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#triggered)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, checked: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("ktoolbarspaceraction.Children: Memory allocation failed");
        const _data: [*]QtC.QObject = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, name: []const u8, value: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, param1: QtC.QEvent ```
    pub fn Event(self: ?*anyopaque, param1: ?*anyopaque) bool {
        return qtc.KToolBarSpacerAction_Event(@ptrCast(self), @ptrCast(param1));
    }
    ...
    pub fn QBaseEvent(self: ?*anyopaque, param1: ?*anyopaque) bool {
        return qtc.KToolBarSpacerAction_QBaseEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, param1: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KToolBarSpacerAction_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, param1: QtC.QObject, param2: QtC.QEvent ```
    pub fn EventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return qtc.KToolBarSpacerAction_EventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, param1: ?*anyopaque, param2: ?*anyopaque) bool {
        return qtc.KToolBarSpacerAction_QBaseEventFilter(@ptrCast(self), @ptrCast(param1), @ptrCast(param2));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, param1: QtC.QObject, param2: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KToolBarSpacerAction_OnEventFilter(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn DeleteWidget(self: ?*anyopaque, widget: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_DeleteWidget(@ptrCast(self), @ptrCast(widget));
    }
    ...
    pub fn QBaseDeleteWidget(self: ?*anyopaque, widget: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_QBaseDeleteWidget(@ptrCast(self), @ptrCast(widget));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, widget: QtC.QWidget) callconv(.c) void ```
    pub fn OnDeleteWidget(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToolBarSpacerAction_OnDeleteWidget(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, event: QtC.QTimerEvent ```
    pub fn TimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_TimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToolBarSpacerAction_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, event: QtC.QChildEvent ```
    pub fn ChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_ChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToolBarSpacerAction_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, event: QtC.QEvent ```
    pub fn CustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_CustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToolBarSpacerAction_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, signal: QtC.QMetaMethod ```
    pub fn ConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_ConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToolBarSpacerAction_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn DisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_DisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToolBarSpacerAction_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn CreatedWidgets(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QWidget {
        const _arr: qtc.libqt_list = qtc.KToolBarSpacerAction_CreatedWidgets(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QWidget, _arr.len) catch @panic("ktoolbarspaceraction.CreatedWidgets: Memory allocation failed");
    ...
    pub fn QBaseCreatedWidgets(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QWidget {
        const _arr: qtc.libqt_list = qtc.KToolBarSpacerAction_QBaseCreatedWidgets(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QWidget, _arr.len) catch @panic("ktoolbarspaceraction.CreatedWidgets: Memory allocation failed");
        const _data: [*]QtC.QWidget = @ptrCast(@alignCast(_arr.data));
        @memcpy(_ret, _data[0.._arr.len]);
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn () callconv(.c) [*:null]QtC.QWidget ```
    pub fn OnCreatedWidgets(self: ?*anyopaque, callback: *const fn () callconv(.c) [*:null]QtC.QWidget) void {
        qtc.KToolBarSpacerAction_OnCreatedWidgets(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Sender(self: ?*anyopaque) QtC.QObject {
        return qtc.KToolBarSpacerAction_Sender(@ptrCast(self));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KToolBarSpacerAction_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KToolBarSpacerAction_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn SenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KToolBarSpacerAction_SenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KToolBarSpacerAction_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KToolBarSpacerAction_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, signal: []const u8 ```
    pub fn Receivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KToolBarSpacerAction_Receivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KToolBarSpacerAction_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KToolBarSpacerAction_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn IsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KToolBarSpacerAction_IsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KToolBarSpacerAction_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KToolBarSpacerAction_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.KToolBarSpacerAction, callback: *const fn (self: QtC.KToolBarSpacerAction, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KToolBarSpacerAction_Delete(@ptrCast(self));
    }
};
