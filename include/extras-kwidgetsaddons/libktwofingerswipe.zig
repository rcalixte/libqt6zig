...
pub const ktwofingerswipe = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KTwoFingerSwipe_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KTwoFingerSwipe `
    ///
    /// ` callback: *const fn (self: QtC.KTwoFingerSwipeparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KTwoFingerSwipe `
    ///
    /// ` callback: *const fn (self: QtC.KTwoFingerSwipeobjectName: [*:0]const u8) callconv(.c) void `
    ///
