...
pub const kdatepicker = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KDatePicker_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KDatePicker_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    /// ` self: QtC.KDatePicker`
    ///
    /// ` callback: *const fn (self: QtC.KDatePicker, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
