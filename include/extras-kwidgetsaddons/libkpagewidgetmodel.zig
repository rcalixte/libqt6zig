...
pub const KPageWidgetModel = extern struct {
    ...
    pub fn ItemData(self: KPageWidgetModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kpagewidgetmodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: KPageWidgetModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kpagewidgetmodel.RoleNames: Total capacity allocation failed");
        defer {
