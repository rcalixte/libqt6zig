...
pub const kpagemodel = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KPageModel_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KPageModel_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
