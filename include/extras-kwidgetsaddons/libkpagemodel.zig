...
pub const kpagemodel = struct {
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel `
    ///
    /// ` callback: *const fn (self: QtC.KPageModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPageModel`
    ///
    /// ` callback: *const fn (self: QtC.KPageModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.KPageModel`
    ///
    /// ` callback: *const fn (self: QtC.KPageModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.KPageModel`
    ///
    /// ` callback: *const fn (self: QtC.KPageModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
