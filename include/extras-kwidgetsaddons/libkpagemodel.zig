...
pub const KPageModel = extern struct {
    ...
    pub fn ItemData(self: KPageModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kpagemodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: KPageModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kpagemodel.RoleNames: Total capacity allocation failed");
        defer {
