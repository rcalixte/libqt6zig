...
pub const kviewstatemaintainerbase = struct {
    ...
    /// ` self: QtC.KViewStateMaintainerBase `
    ///
    /// ` callback: *const fn (self: QtC.KViewStateMaintainerBaseparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KViewStateMaintainerBase `
    ///
    /// ` callback: *const fn (self: QtC.KViewStateMaintainerBaseobjectName: [*:0]const u8) callconv(.c) void `
    ///
