...
pub const kdatepickerpopup = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KDatePickerPopup_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KDatePickerPopup_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn DateMap(self: ?*anyopaque, allocator: std.mem.Allocator) map_qtcqdate_constu8 {
        ...
        while (i < _map.len) : (i += 1) {
            ...
            _ret.put(allocator, @ptrCast(_key), _value) catch @panic("kdatepickerpopup.DateMap: Memory allocation failed");
        }
        return _ret;
    }
    ...
    /// ` self: QtC.KDatePickerPopup`
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopup, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
