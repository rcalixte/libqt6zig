...
pub const solid__opticaldrive = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.Solid__OpticalDrive_MetaObject(@ptrCast(self));
    }
    ...
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        ...
        return qtc.Solid__OpticalDrive_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.Solid__OpticalDrive_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::opticaldrive.Tr: Memory allocation failed");
    ...
    ///
    pub fn SupportedMedia(self: ?*anyopaque) i32 {
        return qtc.Solid__OpticalDrive_SupportedMedia(@ptrCast(self));
    }
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    pub fn ReadSpeed(self: ?*anyopaque) i32 {
        return qtc.Solid__OpticalDrive_ReadSpeed(@ptrCast(self));
    }
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    pub fn WriteSpeed(self: ?*anyopaque) i32 {
        return qtc.Solid__OpticalDrive_WriteSpeed(@ptrCast(self));
    }
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn WriteSpeeds(self: ?*anyopaque, allocator: std.mem.Allocator) []i32 {
        const _arr: qtc.libqt_list = qtc.Solid__OpticalDrive_WriteSpeeds(@ptrCast(self));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(i32, _arr.len) catch @panic("solid::opticaldrive.WriteSpeeds: Memory allocation failed");
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    pub fn Eject(self: ?*anyopaque) bool {
        return qtc.Solid__OpticalDrive_Eject(@ptrCast(self));
    }
    ...
    /// ` udi: []const u8 `
    ///
    pub fn EjectPressed(self: ?*anyopaque, udi: []const u8) void {
        const udi_str = qtc.libqt_string{
            .len = udi.len,
            .data = udi.ptr,
        };
        qtc.Solid__OpticalDrive_EjectPressed(@ptrCast(self), udi_str);
    }
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDriveudi: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` udi: []const u8 `
    ///
    pub fn EjectDone(self: ?*anyopaque, errorVal: i32, errorData: QtC.QVariant, udi: []const u8) void {
        const udi_str = qtc.libqt_string{
            .len = udi.len,
            .data = udi.ptr,
        };
        qtc.Solid__OpticalDrive_EjectDone(@ptrCast(self), @intCast(errorVal), @ptrCast(errorData), udi_str);
    }
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDriveerrorVal: solidnamespace_enums.ErrorType, errorData: QtC.QVariant, udi: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` udi: []const u8 `
    ///
    pub fn EjectRequested(self: ?*anyopaque, udi: []const u8) void {
        const udi_str = qtc.libqt_string{
            .len = udi.len,
            .data = udi.ptr,
        };
        qtc.Solid__OpticalDrive_EjectRequested(@ptrCast(self), udi_str);
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::opticaldrive.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::opticaldrive.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn TypeToString(typeVal: i32, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::opticaldrive.TypeToString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn TypeDescription(typeVal: i32, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::opticaldrive.TypeDescription: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("solid::opticaldrive.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("solid::opticaldrive.Children: Memory allocation failed");
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("solid::opticaldrive.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("solid::opticaldrive.DynamicPropertyNames: Memory allocation failed");
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDrive) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDriveparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__OpticalDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDriveobjectName: [*:0]const u8) callconv(.c) void `
    ///
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.Solid__OpticalDrive_Delete(@ptrCast(self));
    }
};
