...
pub const solid__opticaldisc = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.Solid__OpticalDisc_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.Solid__OpticalDisc `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDiscparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__OpticalDisc `
    ///
    /// ` callback: *const fn (self: QtC.Solid__OpticalDiscobjectName: [*:0]const u8) callconv(.c) void `
    ///
