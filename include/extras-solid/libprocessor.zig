...
pub const solid__processor = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.Solid__Processor_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("solid__processor.Children: Memory allocation failed");
    ...
    /// ` self: QtC.Solid__Processor `
    ///
    /// ` callback: *const fn (self: QtC.Solid__Processor) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__Processor `
    ///
    /// ` callback: *const fn (self: QtC.Solid__Processor, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__Processor `
    ///
    /// ` callback: *const fn (self: QtC.Solid__Processor, objectName: [*:0]const u8) callconv(.c) void `
    ///
