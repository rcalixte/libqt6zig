...
pub const solid__processor = struct {
    ...
    /// ` self: QtC.Solid__Processor `
    ///
    /// ` callback: *const fn (self: QtC.Solid__Processorparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__Processor `
    ///
    /// ` callback: *const fn (self: QtC.Solid__ProcessorobjectName: [*:0]const u8) callconv(.c) void `
    ///
