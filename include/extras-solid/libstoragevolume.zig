...
pub const solid__storagevolume = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.Solid__StorageVolume_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.Solid__StorageVolume, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.Solid__StorageVolume_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.Solid__StorageVolume, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    ...
    /// ``` self: QtC.Solid__StorageVolume ```
    ///
    /// Returns: ``` storagevolume_enums.UsageType ```
    ...
    pub fn FsType(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.Solid__StorageVolume_FsType(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Label(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.Solid__StorageVolume_Label(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Uuid(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.Solid__StorageVolume_Uuid(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.Solid__StorageVolume, callback: *const fn (self: QtC.Solid__StorageVolume, objectName: [*:0]const u8) callconv(.c) void ```
