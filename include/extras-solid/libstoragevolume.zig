...
pub const solid__storagevolume = struct {
    ...
    /// ` self: QtC.Solid__StorageVolume `
    ///
    /// ` callback: *const fn (self: QtC.Solid__StorageVolumeparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__StorageVolume `
    ///
    /// ` callback: *const fn (self: QtC.Solid__StorageVolumeobjectName: [*:0]const u8) callconv(.c) void `
    ///
