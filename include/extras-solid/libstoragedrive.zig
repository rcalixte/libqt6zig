...
pub const solid__storagedrive = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.Solid__StorageDrive_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.Solid__StorageDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__StorageDriveparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__StorageDrive `
    ///
    /// ` callback: *const fn (self: QtC.Solid__StorageDriveobjectName: [*:0]const u8) callconv(.c) void `
    ///
