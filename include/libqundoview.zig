...
pub const qundoview = struct {
    ...
    /// ` self: QtC.QUndoView`
    ///
    /// ` callback: *const fn (self: QtC.QUndoView, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QUndoView`
    ///
    /// ` callback: *const fn (self: QtC.QUndoView, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
