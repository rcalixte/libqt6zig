...
pub const QExtensionFactory = extern struct {
    ...
    /// Allocate a new QExtensionFactory object in C++ memory
    ///
    ...
    /// ## Parameter(s):
    ///
    /// ` _parent: QExtensionManager `
    ///
    pub fn new2(_parent: anytype) QExtensionFactory {
        comptime _ = @TypeOf(_parent)._is_QExtensionManager;
    ...
    /// ### DEPRECATED: Use `createExtension` instead
    ///
    pub const CreateExtension = createExtension;
    ...
    /// ` _parent: QObject `
    ///
    pub fn createExtension(self: QExtensionFactory, object: anytype, iid: []const u8, _parent: anytype) QObject {
        comptime _ = @TypeOf(object)._is_QObject;
        const iid_str = qtc.libqt_string{
            .len = iid.len,
            .data = iid.ptr,
        ...
        return .{ .ptr = qtc.QExtensionFactory_CreateExtension(@ptrCast(self.ptr), @ptrCast(object.ptr), iid_str, @ptrCast(_parent.ptr)) };
    }

    /// ### DEPRECATED: Use `onCreateExtension` instead
    ///
    pub const OnCreateExtension = onCreateExtension;
    ...
    ///
    pub const SuperCreateExtension = superCreateExtension;
    ...
    /// ` _parent: QObject `
    ///
    pub fn superCreateExtension(self: QExtensionFactory, object: anytype, iid: []const u8, _parent: anytype) QObject {
        comptime _ = @TypeOf(object)._is_QObject;
        const iid_str = qtc.libqt_string{
            .len = iid.len,
            .data = iid.ptr,
        ...
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QExtensionFactory_SuperCreateExtension(@ptrCast(self.ptr), @ptrCast(object.ptr), iid_str, @ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QExtensionFactory, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QExtensionFactory, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QExtensionFactory, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QExtensionFactory, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QExtensionFactory.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QExtensionFactory, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QExtensionFactory, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QExtensionFactory_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QExtensionFactory, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QExtensionFactory_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QExtensionFactory, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QExtensionFactory_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QExtensionFactory, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QExtensionFactory_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QExtensionFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QExtensionFactory_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QExtensionFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QExtensionFactory_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QExtensionFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QExtensionFactory_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QExtensionFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QExtensionFactory_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QExtensionFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QExtensionFactory_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QExtensionFactory, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QExtensionFactory_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
