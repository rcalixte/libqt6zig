...
pub const qdesignerformwindowmanagerinterface = struct {
    ...
    ///
    pub fn CreateFormWindow(self: ?*anyopaque, parentWidget: ?*anyopaque, flags: i64) QtC.QDesignerFormWindowInterface {
    ...
    ///
    pub fn OnCreateFormWindow(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, i64) callconv(.c) QtC.QDesignerFormWindowInterface) void {
    ...
    /// ` flags: flag of qnamespace_enums.WindowType `
    ///
    pub fn QBaseCreateFormWindow(self: ?*anyopaque, parentWidget: ?*anyopaque, flags: i64) QtC.QDesignerFormWindowInterface {
