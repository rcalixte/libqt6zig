...
pub const QStandardItemModel = extern struct {
    ...
    pub fn RoleNames(self: QStandardItemModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qstandarditemmodel.RoleNames: Total capacity allocation failed");
        defer {
    ...
    pub fn ItemData(self: QStandardItemModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qstandarditemmodel.ItemData: Total capacity allocation failed");
        defer {
            qtc.libqt_free(_map.keys);
            qtc.libqt_free(_map.values);
        }
