...
pub const TextGrammarCheck__GrammalecteResultJob = extern struct {
    ...
    /// New constructs a new TextGrammarCheck::GrammalecteResultJob object.
    ///
    pub fn New() TextGrammarCheck__GrammalecteResultJob {
        return .{ .ptr = qtc.TextGrammarCheck__GrammalecteResultJob_new() };
    }

    /// New2 constructs a new TextGrammarCheck::GrammalecteResultJob object.
    ///
    /// ## Parameter(s):
    ///
    /// ` parent: QObject `
    ///
    pub fn New2(parent: anytype) TextGrammarCheck__GrammalecteResultJob {
        comptime _ = @TypeOf(parent)._is_QObject;
        return .{ .ptr = qtc.TextGrammarCheck__GrammalecteResultJob_new2(@ptrCast(parent.ptr)) };
    }
    ...
    /// ` text: []const u8 `
    ///
    pub fn SetText(self: TextGrammarCheck__GrammalecteResultJob, text: []const u8) void {
    ...
    /// ` pythonPath: []const u8 `
    ///
    pub fn SetPythonPath(self: TextGrammarCheck__GrammalecteResultJob, pythonPath: []const u8) void {
    ...
    ///
    pub fn SetGrammarlecteCliPath(self: TextGrammarCheck__GrammalecteResultJob, grammarlecteCliPath: []const u8) void {
    ...
    pub fn Arguments(self: TextGrammarCheck__GrammalecteResultJob, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("textgrammarcheck__grammalecteresultjob.Arguments: Memory allocation failed");
    ...
    ///
    pub fn SetArguments(self: TextGrammarCheck__GrammalecteResultJob, allocator: std.mem.Allocator, arguments: []const []const u8) void {
        const arguments_arr = allocator.alloc(qtc.libqt_string, arguments.len) catch @panic("textgrammarcheck__grammalecteresultjob.SetArguments: Memory allocation failed");
    ...
    ///
    pub fn Error(self: TextGrammarCheck__GrammalecteResultJob, typeVal: i32) void {
    ...
    /// ` thread: QThread `
    ///
    pub fn MoveToThread(self: TextGrammarCheck__GrammalecteResultJob, thread: anytype) bool {
    ...
    /// ` parent: QObject `
    ///
    pub fn SetParent(self: TextGrammarCheck__GrammalecteResultJob, parent: anytype) void {
        comptime _ = @TypeOf(parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn Connect3(self: TextGrammarCheck__GrammalecteResultJob, sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn DynamicPropertyNames(self: TextGrammarCheck__GrammalecteResultJob, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("textgrammarcheck__grammalecteresultjob.DynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn Connect4(self: TextGrammarCheck__GrammalecteResultJob, sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` event: QEvent `
    ///
    pub fn Event(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) bool {
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteResultJob_Event(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) bool {
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteResultJob_SuperEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn EventFilter(self: TextGrammarCheck__GrammalecteResultJob, watched: anytype, event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteResultJob_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperEventFilter(self: TextGrammarCheck__GrammalecteResultJob, watched: anytype, event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteResultJob_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QTimerEvent `
    ///
    pub fn TimerEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QTimerEvent;
        qtc.TextGrammarCheck__GrammalecteResultJob_TimerEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QTimerEvent `
    ///
    pub fn SuperTimerEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QTimerEvent;
        qtc.TextGrammarCheck__GrammalecteResultJob_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QChildEvent `
    ///
    pub fn ChildEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QChildEvent;
        qtc.TextGrammarCheck__GrammalecteResultJob_ChildEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QChildEvent `
    ///
    pub fn SuperChildEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QChildEvent;
        qtc.TextGrammarCheck__GrammalecteResultJob_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn CustomEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QEvent;
        qtc.TextGrammarCheck__GrammalecteResultJob_CustomEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperCustomEvent(self: TextGrammarCheck__GrammalecteResultJob, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QEvent;
        qtc.TextGrammarCheck__GrammalecteResultJob_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
