...
pub const TextAutoCorrectionWidgets__AutoCorrectionWidget = extern struct {
    /// ### [Upstream resources](https://api.kde.org/legacy/ktextaddons/html/classTextAutoCorrectionWidgets_1_1AutoCorrectionWidget.html)
    ///
    /// The pointer to the underlying Qt C++ object
    ///
    ptr: QtC.TextAutoCorrectionWidgets__AutoCorrectionWidget,

    pub const _is_TextAutoCorrectionWidgets__AutoCorrectionWidget = {};
...
pub const enums = struct {
    pub const ImportFileType = enum(i32) {
        pub const LibreOffice: i32 = 0;
        pub const KMail: i32 = 1;
    };
};
