...
pub const qbuffer = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QBuffer_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseOpen(self: ?*anyopaque, openMode: i32) bool {
        return qtc.QBuffer_QBaseOpen(@ptrCast(self), @bitCast(openMode));
    }
    ...
    pub fn QBaseSeek(self: ?*anyopaque, off: i64) bool {
        return qtc.QBuffer_QBaseSeek(@ptrCast(self), @bitCast(off));
    }
    ...
    pub fn QBaseReadData(self: ?*anyopaque, data: [:0]u8, maxlen: i64) i64 {
        const data_Cstring = data.ptr;
        return qtc.QBuffer_QBaseReadData(@ptrCast(self), data_Cstring, @bitCast(maxlen));
    }
    ...
    pub fn QBaseWriteData(self: ?*anyopaque, data: [:0]const u8, lenVal: i64) i64 {
        const data_Cstring = data.ptr;
        return qtc.QBuffer_QBaseWriteData(@ptrCast(self), data_Cstring, @bitCast(lenVal));
    }
    ...
    pub fn QBaseWaitForReadyRead(self: ?*anyopaque, msecs: i32) bool {
        return qtc.QBuffer_QBaseWaitForReadyRead(@ptrCast(self), @bitCast(msecs));
    }
    ...
    pub fn QBaseWaitForBytesWritten(self: ?*anyopaque, msecs: i32) bool {
        return qtc.QBuffer_QBaseWaitForBytesWritten(@ptrCast(self), @bitCast(msecs));
    }
    ...
    pub fn QBaseReadLineData(self: ?*anyopaque, data: [:0]u8, maxlen: i64) i64 {
        const data_Cstring = data.ptr;
        return qtc.QBuffer_QBaseReadLineData(@ptrCast(self), data_Cstring, @bitCast(maxlen));
    }
    ...
    pub fn QBaseSkipData(self: ?*anyopaque, maxSize: i64) i64 {
        return qtc.QBuffer_QBaseSkipData(@ptrCast(self), @bitCast(maxSize));
    }
    ...
    pub fn QBaseSetOpenMode(self: ?*anyopaque, openMode: i32) void {
        qtc.QBuffer_QBaseSetOpenMode(@ptrCast(self), @bitCast(openMode));
    }
