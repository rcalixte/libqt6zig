...
pub const qscilexercpp = struct {
    ...
    /// ` self: QtC.QsciLexerCPP `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerCPPc: QtC.QColor, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerCPP `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerCPPeolfilled: bool, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerCPP `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerCPPf: QtC.QFont, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerCPP `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerCPPprop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerCPP `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerCPPparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerCPP `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerCPPobjectName: [*:0]const u8) callconv(.c) void `
    ///
