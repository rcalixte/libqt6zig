...
pub const qscilexerproperties = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QsciLexerProperties_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QsciLexerProperties_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QsciLexerProperties_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseColor(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerProperties_QBaseColor(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseEolFill(self: ?*anyopaque, style: i32) bool {
        return qtc.QsciLexerProperties_QBaseEolFill(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseFont(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerProperties_QBaseFont(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseKeywords(self: ?*anyopaque, set: i32) [:0]const u8 {
        const _ret = qtc.QsciLexerProperties_QBaseKeywords(@ptrCast(self), @bitCast(set));
        return std.mem.span(_ret);
    }
    ...
    pub fn QBasePaper(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerProperties_QBasePaper(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultColor2(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerProperties_QBaseDefaultColor2(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultFont2(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerProperties_QBaseDefaultFont2(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultPaper2(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerProperties_QBaseDefaultPaper2(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseSetAutoIndentStyle(self: ?*anyopaque, autoindentstyle: i32) void {
        qtc.QsciLexerProperties_QBaseSetAutoIndentStyle(@ptrCast(self), @bitCast(autoindentstyle));
    }
    ...
    pub fn QBaseSetColor(self: ?*anyopaque, c: ?*anyopaque, style: i32) void {
        qtc.QsciLexerProperties_QBaseSetColor(@ptrCast(self), @ptrCast(c), @bitCast(style));
    }
    ...
    pub fn QBaseSetEolFill(self: ?*anyopaque, eoffill: bool, style: i32) void {
        qtc.QsciLexerProperties_QBaseSetEolFill(@ptrCast(self), eoffill, @bitCast(style));
    }
    ...
    pub fn QBaseSetFont(self: ?*anyopaque, f: ?*anyopaque, style: i32) void {
        qtc.QsciLexerProperties_QBaseSetFont(@ptrCast(self), @ptrCast(f), @bitCast(style));
    }
    ...
    pub fn QBaseSetPaper(self: ?*anyopaque, c: ?*anyopaque, style: i32) void {
        qtc.QsciLexerProperties_QBaseSetPaper(@ptrCast(self), @ptrCast(c), @bitCast(style));
    }
    ...
    pub fn QBaseTextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        var _bytearray: qtc.libqt_string = qtc.QsciLexerProperties_QBaseTextAsBytes(@ptrCast(self), text_str);
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qscilexerproperties.TextAsBytes: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    pub fn QBaseBytesAsText(self: ?*anyopaque, bytes: [:0]const u8, size: i32, allocator: std.mem.Allocator) []const u8 {
        const bytes_Cstring = bytes.ptr;
        var _str = qtc.QsciLexerProperties_QBaseBytesAsText(@ptrCast(self), bytes_Cstring, @bitCast(size));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("qscilexerproperties.BytesAsText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
