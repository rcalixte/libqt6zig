...
pub const qsciapis = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QsciAPIs_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QsciAPIs_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QsciAPIs `
    ///
    /// ` callback: *const fn (self: QtC.QsciAPIs, context: [*][*:0]const u8, commas: i32, style: qsciscintilla_enums.CallTipsStyle, shifts: [*:-1]i32) callconv(.c) [*][*:0]const u8 `
    ///
    ...
    /// ` self: QtC.QsciAPIs `
    ///
    /// ` callback: *const fn (self: QtC.QsciAPIsparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciAPIs `
    ///
    /// ` callback: *const fn (self: QtC.QsciAPIsobjectName: [*:0]const u8) callconv(.c) void `
    ///
