...
pub const qsciscintillabase = struct {
    ...
    pub fn QBaseFromMimeData(self: ?*anyopaque, source: ?*anyopaque, rectangular: *bool, allocator: std.mem.Allocator) []u8 {
        var _bytearray: qtc.libqt_string = qtc.QsciScintillaBase_QBaseFromMimeData(@ptrCast(self), @ptrCast(source), @ptrCast(rectangular));
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qsciscintillabase.FromMimeData: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBase, text: [*:0]u8, rectangular: bool) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBasetitle: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBaseicon: QtC.QIcon) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBaseiconText: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBasepos: QtC.QPoint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBaseparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase`
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBase, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
    ...
    /// ` self: QtC.QsciScintillaBase `
    ///
    /// ` callback: *const fn (self: QtC.QsciScintillaBaseobjectName: [*:0]const u8) callconv(.c) void `
    ///
