...
pub const QsciLexerPostScript = extern struct {
    ...
    /// Allocate a new QsciLexerPostScript object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_parent: anytype) QsciLexerPostScript {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QsciLexerPostScript_new2(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ### DEPRECATED: Use `setTokenize` instead
    ///
    pub const SetTokenize = setTokenize;
    ...
    /// ` _tokenize: bool `
    ///
    pub fn setTokenize(self: QsciLexerPostScript, _tokenize: bool) void {
        qtc.QsciLexerPostScript_SetTokenize(@ptrCast(self.ptr), _tokenize);
    }

    /// ### DEPRECATED: Use `onSetTokenize` instead
    ///
    pub const OnSetTokenize = onSetTokenize;
    ...
    ///
    pub const SuperSetTokenize = superSetTokenize;
    ...
    /// ` _tokenize: bool `
    ///
    pub fn superSetTokenize(self: QsciLexerPostScript, _tokenize: bool) void {
        qtc.QsciLexerPostScript_SuperSetTokenize(@ptrCast(self.ptr), _tokenize);
    }
    ...
    /// ` _level: i32 `
    ///
    pub fn setLevel(self: QsciLexerPostScript, _level: i32) void {
        qtc.QsciLexerPostScript_SetLevel(@ptrCast(self.ptr), @bitCast(_level));
    }

    /// ### DEPRECATED: Use `onSetLevel` instead
    ///
    pub const OnSetLevel = onSetLevel;
    ...
    ///
    pub const SuperSetLevel = superSetLevel;
    ...
    /// ` _level: i32 `
    ///
    pub fn superSetLevel(self: QsciLexerPostScript, _level: i32) void {
        qtc.QsciLexerPostScript_SuperSetLevel(@ptrCast(self.ptr), @bitCast(_level));
    }
    ...
    ///
    pub fn setAPIs(self: QsciLexerPostScript, _apis: anytype) void {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QsciLexerPostScript, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QsciLexerPostScript, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QsciLexerPostScript, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QsciLexerPostScript, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QsciLexerPostScript.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QsciLexerPostScript, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn autoCompletionWordSeparators(self: QsciLexerPostScript, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QsciLexerPostScript.autoCompletionWordSeparators: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    ///
    pub fn setEditor(self: QsciLexerPostScript, _editor: anytype) void {
        comptime _ = @TypeOf(_editor)._is_QsciScintilla;
        qtc.QsciLexerPostScript_SetEditor(@ptrCast(self.ptr), @ptrCast(_editor.ptr));
    }
    ...
    /// ` _editor: QsciScintilla `
    ///
    pub fn superSetEditor(self: QsciLexerPostScript, _editor: anytype) void {
        comptime _ = @TypeOf(_editor)._is_QsciScintilla;
        qtc.QsciLexerPostScript_SuperSetEditor(@ptrCast(self.ptr), @ptrCast(_editor.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QsciLexerPostScript, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerPostScript_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QsciLexerPostScript, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerPostScript_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QsciLexerPostScript, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerPostScript_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QsciLexerPostScript, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerPostScript_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QsciLexerPostScript, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QsciLexerPostScript_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QsciLexerPostScript, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QsciLexerPostScript_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QsciLexerPostScript, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QsciLexerPostScript_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QsciLexerPostScript, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QsciLexerPostScript_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QsciLexerPostScript, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QsciLexerPostScript_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QsciLexerPostScript, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QsciLexerPostScript_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
