...
pub const qscilexer = struct {
    ...
    /// ` self: QtC.QsciLexer `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerc: QtC.QColor, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexer `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexereolfilled: bool, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexer `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerf: QtC.QFont, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexer `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerprop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void `
    ///
    ...
    pub fn QBaseTextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        var _bytearray: qtc.libqt_string = qtc.QsciLexer_QBaseTextAsBytes(@ptrCast(self), text_str);
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qscilexer.TextAsBytes: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    /// ` self: QtC.QsciLexer `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexer `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerobjectName: [*:0]const u8) callconv(.c) void `
    ///
