...
pub const kio__transferjob = struct {
    ...
    /// ` self: QtC.KIO__TransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__TransferJob, job: QtC.KIO__Job, offset: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__TransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__TransferJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__TransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__TransferJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__TransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__TransferJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__TransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__TransferJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
