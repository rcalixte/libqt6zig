...
pub const kdirmodel = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KDirModel_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KDirModel_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelindex: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelindex: QtC.QModelIndex, sequenceIndex: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel`
    ///
    /// ` callback: *const fn (self: QtC.KDirModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.KDirModel`
    ///
    /// ` callback: *const fn (self: QtC.KDirModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDirModel `
    ///
    /// ` callback: *const fn (self: QtC.KDirModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
