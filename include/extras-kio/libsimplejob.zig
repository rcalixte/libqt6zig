...
pub const kio__simplejob = struct {
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: QtC.KIO__SimpleJob ```
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KIO__SimpleJob_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KIO__SimpleJob, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KIO__SimpleJob_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KIO__SimpleJob, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__SimpleJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__SimpleJob_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.Tr: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, handle: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, param1: i32, param2: []const u8 ```
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__SimpleJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KIO__SimpleJob_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, extension: QtC.KIO__JobUiDelegateExtension ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, allocator: std.mem.Allocator ```
    pub fn ErrorString(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KIO__Job_ErrorString(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.ErrorString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn DetailedErrorStrings(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::simplejob.DetailedErrorStrings: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::simplejob.DetailedErrorStrings: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, parentJob: QtC.KIO__Job ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, metaData: QtC.KIO__MetaData ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, key: []const u8, value: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#addMetaData)
    ///
    /// ``` self: QtC.KIO__SimpleJob, values: map_constu8_constu8, allocator: std.mem.Allocator ```
    pub fn AddMetaData2(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::simplejob.AddMetaData2: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::simplejob.AddMetaData2: Memory allocation failed");
    ...
    pub fn MergeMetaData(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::simplejob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::simplejob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_values);
        var i: usize = 0;
        var values_it = values.iterator();
        while (values_it.next()) |entry| {
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, key: []const u8, allocator: std.mem.Allocator ```
    pub fn QueryMetaData(self: ?*anyopaque, key: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.QueryMetaData: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, job: QtC.KIO__Job ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__SimpleJob, reqUrl: QtC.QUrl, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings1(self: ?*anyopaque, reqUrl: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::simplejob.DetailedErrorStrings1: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::simplejob.DetailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__SimpleJob, reqUrl: QtC.QUrl, method: i32, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings2(self: ?*anyopaque, reqUrl: ?*anyopaque, method: i32, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::simplejob.DetailedErrorStrings2: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::simplejob.DetailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, delegate: QtC.KJobUiDelegate ```
    ...
    pub fn ErrorText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.ErrorText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, unit: kjob_enums.Unit ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, autodelete: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, job: QtC.KJob, message: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, job: QtC.KJob, size: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, job: QtC.KJob, speed: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#kill)
    ///
    /// ``` self: QtC.KIO__SimpleJob, verbosity: kjob_enums.KillVerbosity ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#setFinishedNotificationHidden)
    ///
    /// ``` self: QtC.KIO__SimpleJob, hide: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::simplejob.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, b: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KIO__SimpleJob, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio::simplejob.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__SimpleJob, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("kio::simplejob.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::simplejob.DynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KIO__SimpleJob, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KIO__SimpleJob, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__SimpleJob, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__SimpleJob, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__SimpleJob, callback: *const fn (self: QtC.KIO__SimpleJob, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KIO__SimpleJob_Delete(@ptrCast(self));
    }
};
...
pub const kio = struct {
    ...
    ///
    /// ``` param1: QtC.QUrl ```
    pub fn Rmdir(param1: ?*anyopaque) QtC.KIO__SimpleJob {
        return qtc.KIO_Rmdir(@ptrCast(param1));
    }

    /// [Qt documentation](https://api.kde.org/kio.html#chown)
    ///
    /// ``` param1: QtC.QUrl, param2: []const u8, param3: []const u8 ```
    pub fn Chown(param1: ?*anyopaque, param2: []const u8, param3: []const u8) QtC.KIO__SimpleJob {
        const param2_str = qtc.libqt_string{
            .len = param2.len,
            .data = param2.ptr,
        };
        ...
        return qtc.KIO_Chown(@ptrCast(param1), param2_str, param3_str);
    }

    /// [Qt documentation](https://api.kde.org/kio.html#setModificationTime)
    ///
    /// ``` param1: QtC.QUrl, param2: QtC.QDateTime ```
    pub fn SetModificationTime(param1: ?*anyopaque, param2: ?*anyopaque) QtC.KIO__SimpleJob {
        return qtc.KIO_SetModificationTime(@ptrCast(param1), @ptrCast(param2));
    }
    ...
    pub fn Symlink(param1: []const u8, param2: ?*anyopaque, param3: i32) QtC.KIO__SimpleJob {
        ...
        return qtc.KIO_Symlink(param1_str, @ptrCast(param2), @intCast(param3));
    }
    ...
    pub fn Special(param1: ?*anyopaque, param2: []u8, param3: i32) QtC.KIO__SimpleJob {
        ...
        return qtc.KIO_Special(@ptrCast(param1), param2_str, @intCast(param3));
    }
    ...
    pub fn Mount(param1: bool, param2: []u8, param3: []const u8, param4: []const u8, param5: i32) QtC.KIO__SimpleJob {
        ...
        return qtc.KIO_Mount(param1, param2_str, param3_str, param4_str, @intCast(param5));
    }
    ...
    pub fn Unmount(param1: []const u8, param2: i32) QtC.KIO__SimpleJob {
        ...
        return qtc.KIO_Unmount(param1_str, @intCast(param2));
    }

    /// [Qt documentation](https://api.kde.org/kio.html#http_update_cache)
    ///
    /// ``` param1: QtC.QUrl, param2: bool, param3: QtC.QDateTime ```
    pub fn HttpUpdateCache(param1: ?*anyopaque, param2: bool, param3: ?*anyopaque) QtC.KIO__SimpleJob {
        return qtc.KIO_HttpUpdateCache(@ptrCast(param1), param2, @ptrCast(param3));
    }
