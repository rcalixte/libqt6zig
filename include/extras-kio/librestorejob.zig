...
pub const kio__restorejob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__RestoreJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn TrashUrls(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QUrl {
        ...
        const _ret = allocator.alloc(QtC.QUrl, _arr.len) catch @panic("kio__restorejob.TrashUrls: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__RestoreJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__RestoreJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__RestoreJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__RestoreJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__restorejob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__RestoreJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__RestoreJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__RestoreJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__RestoreJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__RestoreJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__RestoreJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn RestoreFromTrash(param1: []QtC.QUrl, param2: i32) QtC.KIO__RestoreJob {
        ...
        return qtc.KIO_RestoreFromTrash(param1_list, @bitCast(param2));
    }
};
