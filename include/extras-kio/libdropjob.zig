...
pub const kio__dropjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__DropJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJoburl: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KIO__CopyJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobitemProps: QtC.KFileItemListProperties) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
