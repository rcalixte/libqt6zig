...
pub const kio__dropjob = struct {
    /// ### [Upstream resources](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ## Parameter(s):
    ///
    /// ` self: QtC.KIO__DropJob `
    ///
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KIO__DropJob_MetaObject(@ptrCast(self));
    }
    ...
    pub fn Metacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        ...
        return qtc.KIO__DropJob_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__DropJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` actions: []QtC.QAction `
    ///
    pub fn SetApplicationActions(self: ?*anyopaque, actions: []?*anyopaque) void {
        const actions_list = qtc.libqt_list{
            .len = actions.len,
            .data = @ptrCast(actions.ptr),
        };
        qtc.KIO__DropJob_SetApplicationActions(@ptrCast(self), actions_list);
    }
    ...
    /// ` p: QtC.QPoint `
    ///
    pub fn ShowMenu(self: ?*anyopaque, p: ?*anyopaque) void {
        qtc.KIO__DropJob_ShowMenu(@ptrCast(self), @ptrCast(p));
    }
    ...
    /// ` url: QtC.QUrl `
    ///
    pub fn ItemCreated(self: ?*anyopaque, url: ?*anyopaque) void {
        qtc.KIO__DropJob_ItemCreated(@ptrCast(self), @ptrCast(url));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, url: QtC.QUrl) callconv(.c) void `
    ///
    pub fn OnItemCreated(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__DropJob_Connect_ItemCreated(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` job: QtC.KIO__CopyJob `
    ///
    pub fn CopyJobStarted(self: ?*anyopaque, job: ?*anyopaque) void {
        qtc.KIO__DropJob_CopyJobStarted(@ptrCast(self), @ptrCast(job));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KIO__CopyJob) callconv(.c) void `
    ///
    pub fn OnCopyJobStarted(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__DropJob_Connect_CopyJobStarted(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` itemProps: QtC.KFileItemListProperties `
    ///
    pub fn PopupMenuAboutToShow(self: ?*anyopaque, itemProps: ?*anyopaque) void {
        qtc.KIO__DropJob_PopupMenuAboutToShow(@ptrCast(self), @ptrCast(itemProps));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, itemProps: QtC.KFileItemListProperties) callconv(.c) void `
    ///
    pub fn OnPopupMenuAboutToShow(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__DropJob_Connect_PopupMenuAboutToShow(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` p: QtC.QPoint `
    ///
    /// ` atAction: QtC.QAction `
    ///
    pub fn ShowMenu2(self: ?*anyopaque, p: ?*anyopaque, atAction: ?*anyopaque) void {
        qtc.KIO__DropJob_ShowMenu2(@ptrCast(self), @ptrCast(p), @ptrCast(atAction));
    }
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__dropjob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, objectName: [*:0]const u8) callconv(.c) void `
    ///
    ...
    pub fn Delete(self: ?*anyopaque) void {
        qtc.KIO__DropJob_Delete(@ptrCast(self));
    }
};
...
pub const kio = struct {
    ...
    pub fn Drop(param1: ?*anyopaque, param2: ?*anyopaque, param3: i32) QtC.KIO__DropJob {
        return qtc.KIO_Drop(@ptrCast(param1), @ptrCast(param2), @bitCast(param3));
    }
    ...
    pub fn Drop2(param1: ?*anyopaque, param2: ?*anyopaque, param3: i32, param4: i32) QtC.KIO__DropJob {
        return qtc.KIO_Drop2(@ptrCast(param1), @ptrCast(param2), @bitCast(param3), @bitCast(param4));
    }
};
