...
pub const kio__dropjob = struct {
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DropJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DropJob, job: QtC.KJob, percent: u64) callconv(.c) void `
    ///
