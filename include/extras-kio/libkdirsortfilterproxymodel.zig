...
pub const KDirSortFilterProxyModel = extern struct {
    ...
    pub fn ItemData(self: KDirSortFilterProxyModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kdirsortfilterproxymodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: KDirSortFilterProxyModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kdirsortfilterproxymodel.RoleNames: Total capacity allocation failed");
        defer {
