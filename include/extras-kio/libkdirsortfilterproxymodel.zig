...
pub const kdirsortfilterproxymodel = struct {
    ...
    pub fn OnMetaObject(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QMetaObject) void {
        qtc.KDirSortFilterProxyModel_OnMetaObject(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnMetacast(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) ?*anyopaque) void {
        qtc.KDirSortFilterProxyModel_OnMetacast(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KDirSortFilterProxyModel_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KDirSortFilterProxyModel_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KDirSortFilterProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.KDirSortFilterProxyModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.KDirSortFilterProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.KDirSortFilterProxyModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    pub fn CreateSourceIndex(self: ?*anyopaque, row: i32, col: i32, internalPtr: ?*anyopaque) QtC.QModelIndex {
        return qtc.KDirSortFilterProxyModel_CreateSourceIndex(@ptrCast(self), @intCast(row), @intCast(col), @ptrCast(internalPtr));
    }
    ...
    pub fn QBaseCreateSourceIndex(self: ?*anyopaque, row: i32, col: i32, internalPtr: ?*anyopaque) QtC.QModelIndex {
        return qtc.KDirSortFilterProxyModel_QBaseCreateSourceIndex(@ptrCast(self), @intCast(row), @intCast(col), @ptrCast(internalPtr));
    }
    ...
    /// ` self: QtC.KDirSortFilterProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.KDirSortFilterProxyModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
