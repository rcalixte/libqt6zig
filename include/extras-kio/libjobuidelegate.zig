...
pub const kio__jobuidelegate = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__JobUiDelegate_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn AskDeleteConfirmation(self: ?*anyopaque, urls: []QtC.QUrl, deletionType: i32, confirmationType: i32) bool {
        ...
        return qtc.KIO__JobUiDelegate_AskDeleteConfirmation(@ptrCast(self), urls_list, @bitCast(deletionType), @bitCast(confirmationType));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__jobuidelegate.Children: Memory allocation failed");
