...
pub const qfilesystemmodel = struct {
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelnewPath: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelpath: [*:0]const u8, oldName: [*:0]const u8, newName: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelpath: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileSystemModel `
    ///
    /// ` callback: *const fn (self: QtC.QFileSystemModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
