...
pub const Poppler__OptContentModel = extern struct {
    ...
    pub fn ItemData(self: Poppler__OptContentModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("poppler__optcontentmodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: Poppler__OptContentModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("poppler__optcontentmodel.RoleNames: Total capacity allocation failed");
        defer {
