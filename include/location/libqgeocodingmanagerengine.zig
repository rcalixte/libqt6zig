...
pub const QGeoCodingManagerEngine = extern struct {
    ...
    /// Allocate a new QGeoCodingManagerEngine object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(allocator: std.mem.Allocator, parameters: ArrayMap_constu8_QVariant, _parent: anytype) QGeoCodingManagerEngine {
        const parameters_count = parameters.count();
        ...
        return .{ .ptr = qtc.QGeoCodingManagerEngine_new2(parameters_map, @ptrCast(_parent.ptr)) };
    }
    ...
    /// ### DEPRECATED: Use `onGeocode` instead
    ///
    pub const OnGeocode = onGeocode;
    ...
    ///
    pub const SuperGeocode = superGeocode;
    ...
    /// ### DEPRECATED: Use `onGeocode2` instead
    ///
    pub const OnGeocode2 = onGeocode2;
    ...
    ///
    pub const SuperGeocode2 = superGeocode2;
    ...
    /// ### DEPRECATED: Use `onReverseGeocode` instead
    ///
    pub const OnReverseGeocode = onReverseGeocode;
    ...
    ///
    pub const SuperReverseGeocode = superReverseGeocode;
    ...
    /// ` _locale: QLocale `
    ///
    pub fn setLocale(self: QGeoCodingManagerEngine, _locale: anytype) void {
        comptime _ = @TypeOf(_locale)._is_QLocale;
        qtc.QGeoCodingManagerEngine_SetLocale(@ptrCast(self.ptr), @ptrCast(_locale.ptr));
    }
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QGeoCodingManagerEngine, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QGeoCodingManagerEngine, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QGeoCodingManagerEngine, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QGeoCodingManagerEngine, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QGeoCodingManagerEngine.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QGeoCodingManagerEngine, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QGeoCodingManagerEngine, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QGeoCodingManagerEngine_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QGeoCodingManagerEngine, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QGeoCodingManagerEngine_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QGeoCodingManagerEngine, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QGeoCodingManagerEngine_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QGeoCodingManagerEngine, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QGeoCodingManagerEngine_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QGeoCodingManagerEngine, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QGeoCodingManagerEngine_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QGeoCodingManagerEngine, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QGeoCodingManagerEngine_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QGeoCodingManagerEngine, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QGeoCodingManagerEngine_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QGeoCodingManagerEngine, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QGeoCodingManagerEngine_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QGeoCodingManagerEngine, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QGeoCodingManagerEngine_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QGeoCodingManagerEngine, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QGeoCodingManagerEngine_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
