...
pub const qgeocodingmanager = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QGeoCodingManager_MetaObject(@ptrCast(self));
    }
    ...
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        ...
        return qtc.QGeoCodingManager_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn ManagerName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QGeoCodingManager_ManagerName(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn ManagerVersion(self: ?*anyopaque) i32 {
        return qtc.QGeoCodingManager_ManagerVersion(@ptrCast(self));
    }
    ...
    ///
    pub fn Geocode(self: ?*anyopaque, address: ?*anyopaque) QtC.QGeoCodeReply {
        return qtc.QGeoCodingManager_Geocode(@ptrCast(self), @ptrCast(address));
    }
    ...
    ///
    pub fn Geocode2(self: ?*anyopaque, searchString: []const u8) QtC.QGeoCodeReply {
        const searchString_str = qtc.libqt_string{
            .len = searchString.len,
            .data = searchString.ptr,
        };
        return qtc.QGeoCodingManager_Geocode2(@ptrCast(self), searchString_str);
    }
    ...
    ///
    pub fn ReverseGeocode(self: ?*anyopaque, coordinate: ?*anyopaque) QtC.QGeoCodeReply {
        return qtc.QGeoCodingManager_ReverseGeocode(@ptrCast(self), @ptrCast(coordinate));
    }
    ...
    pub fn SetLocale(self: ?*anyopaque, locale: ?*anyopaque) void {
        qtc.QGeoCodingManager_SetLocale(@ptrCast(self), @ptrCast(locale));
    }
    ...
    pub fn Locale(self: ?*anyopaque) QtC.QLocale {
        return qtc.QGeoCodingManager_Locale(@ptrCast(self));
    }
    ...
    pub fn Finished(self: ?*anyopaque, reply: ?*anyopaque) void {
        qtc.QGeoCodingManager_Finished(@ptrCast(self), @ptrCast(reply));
    }
    ...
    ///
    pub fn Geocode22(self: ?*anyopaque, address: ?*anyopaque, bounds: ?*anyopaque) QtC.QGeoCodeReply {
        return qtc.QGeoCodingManager_Geocode22(@ptrCast(self), @ptrCast(address), @ptrCast(bounds));
    }
    ...
    /// ` limit: i32 `
    ///
    pub fn Geocode23(self: ?*anyopaque, searchString: []const u8, limit: i32) QtC.QGeoCodeReply {
        const searchString_str = qtc.libqt_string{
            .len = searchString.len,
            .data = searchString.ptr,
        };
    ...
    /// ` offset: i32 `
    ///
    pub fn Geocode3(self: ?*anyopaque, searchString: []const u8, limit: i32, offset: i32) QtC.QGeoCodeReply {
        const searchString_str = qtc.libqt_string{
            .len = searchString.len,
            .data = searchString.ptr,
        };
    ...
    /// ` bounds: QtC.QGeoShape `
    ///
    pub fn Geocode4(self: ?*anyopaque, searchString: []const u8, limit: i32, offset: i32, bounds: ?*anyopaque) QtC.QGeoCodeReply {
        const searchString_str = qtc.libqt_string{
            .len = searchString.len,
            .data = searchString.ptr,
        };
    ...
    /// ` bounds: QtC.QGeoShape `
    ///
    pub fn ReverseGeocode2(self: ?*anyopaque, coordinate: ?*anyopaque, bounds: ?*anyopaque) QtC.QGeoCodeReply {
        return qtc.QGeoCodingManager_ReverseGeocode2(@ptrCast(self), @ptrCast(coordinate), @ptrCast(bounds));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("qgeocodingmanager.Children: Memory allocation failed");
