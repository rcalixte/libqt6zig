...
pub const qplacesearchreply = struct {
    ...
    pub fn SuperMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QPlaceSearchReply_SuperMetaObject(@ptrCast(self));
    }
    ...
    pub fn SuperMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QPlaceSearchReply_SuperMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn SuperMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QPlaceSearchReply_SuperMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn SuperType(self: ?*anyopaque) i32 {
        return qtc.QPlaceSearchReply_SuperType(@ptrCast(self));
    }
    ...
    /// ` results: []QtC.QPlaceSearchResult `
    ///
    pub fn SuperSetResults(self: ?*anyopaque, results: []QtC.QPlaceSearchResult) void {
        const results_list = qtc.libqt_list{
            .len = results.len,
            .data = @ptrCast(results.ptr),
        };
        qtc.QPlaceSearchReply_SuperSetResults(@ptrCast(self), results_list);
    }
    ...
    pub fn SuperSetRequest(self: ?*anyopaque, request: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperSetRequest(@ptrCast(self), @ptrCast(request));
    }
    ...
    /// ` previous: QtC.QPlaceSearchRequest `
    ///
    pub fn SuperSetPreviousPageRequest(self: ?*anyopaque, previous: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperSetPreviousPageRequest(@ptrCast(self), @ptrCast(previous));
    }
    ...
    /// ` next: QtC.QPlaceSearchRequest `
    ///
    pub fn SuperSetNextPageRequest(self: ?*anyopaque, next: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperSetNextPageRequest(@ptrCast(self), @ptrCast(next));
    }
    ...
    pub fn SuperAbort(self: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperAbort(@ptrCast(self));
    }
    ...
    pub fn SuperEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QPlaceSearchReply_SuperEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.QPlaceSearchReply_SuperEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn SuperTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn SuperConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn SuperDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.QPlaceSearchReply_SuperDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn SuperSetFinished(self: ?*anyopaque, finished: bool) void {
        qtc.QPlaceSearchReply_SuperSetFinished(@ptrCast(self), finished);
    }
    ...
    pub fn SuperSetError(self: ?*anyopaque, errorVal: i32, errorString: []const u8) void {
        ...
        qtc.QPlaceSearchReply_SuperSetError(@ptrCast(self), @bitCast(errorVal), errorString_str);
    }
    ...
    pub fn SuperSender(self: ?*anyopaque) QtC.QObject {
        return qtc.QPlaceSearchReply_SuperSender(@ptrCast(self));
    }
    ...
    pub fn SuperSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.QPlaceSearchReply_SuperSenderSignalIndex(@ptrCast(self));
    }
    ...
    pub fn SuperReceivers(self: ?*anyopaque, signal: [:0]const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.QPlaceSearchReply_SuperReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn SuperIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.QPlaceSearchReply_SuperIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
