...
pub const qabstractitemdelegate = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QAbstractItemDelegate_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QAbstractItemDelegate_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QAbstractItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractItemDelegateeditor: QtC.QWidget) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractItemDelegateparam1: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractItemDelegateeditor: QtC.QWidget, hint: qabstractitemdelegate_enums.EndEditHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractItemDelegateparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractItemDelegate `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractItemDelegateobjectName: [*:0]const u8) callconv(.c) void `
    ///
