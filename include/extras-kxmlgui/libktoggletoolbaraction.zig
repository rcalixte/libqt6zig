...
pub const ktoggletoolbaraction = struct {
    ...
    ///
    /// ``` toolBar: QtC.KToolBar, text: []const u8, parent: QtC.QObject ```
    ...
    /// ``` self: QtC.KToggleToolBarAction, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KToggleToolBarAction_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KToggleToolBarAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KToggleToolBarAction_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KToggleToolBarAction_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KToggleToolBarAction_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KToggleToolBarAction_Tr(s_Cstring);
    ...
    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KToggleToolBarAction_OnEventFilter(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KToggleToolBarAction_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KToggleToolBarAction_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KToggleToolBarAction_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, group: QtC.QActionGroup ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, icon: QtC.QIcon ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, text: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, tip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, what: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, priority: qaction_enums.Priority ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, b: bool ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, shortcut: QtC.QKeySequence ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, shortcuts: []QtC.QKeySequence ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#setShortcuts)
    ///
    /// ``` self: QtC.KToggleToolBarAction, shortcuts: qkeysequence_enums.StandardKey ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, context: qnamespace_enums.ShortcutContext ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, autoRepeat: bool ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, font: QtC.QFont ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, checkable: bool ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, varVal: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, event: qaction_enums.ActionEvent ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, menuRole: qaction_enums.MenuRole ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, visible: bool ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, show: bool ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, checked: bool ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, enabled: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#changed)
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#enabledChanged)
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, enabled: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#checkableChanged)
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, checkable: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, param1: bool ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#toggled)
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, param1: bool) callconv(.c) void ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#showStatusText)
    ///
    /// ``` self: QtC.KToggleToolBarAction, object: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qaction.html#triggered)
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, checked: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KToggleToolBarAction, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KToggleToolBarAction, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("ktoggletoolbaraction.DynamicPropertyNames: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KToggleToolBarAction, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KToggleToolBarAction, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KToggleToolBarAction, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KToggleToolBarAction, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, param1: QtC.QEvent ```
    ...
    pub fn QBaseEvent(self: ?*anyopaque, param1: ?*anyopaque) bool {
        return qtc.KToggleToolBarAction_QBaseEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, param1: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KToggleToolBarAction_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, event: QtC.QTimerEvent ```
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToggleToolBarAction_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToggleToolBarAction_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, event: QtC.QChildEvent ```
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToggleToolBarAction_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToggleToolBarAction_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, event: QtC.QEvent ```
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KToggleToolBarAction_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToggleToolBarAction_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, signal: QtC.QMetaMethod ```
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KToggleToolBarAction_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToggleToolBarAction_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KToggleToolBarAction_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KToggleToolBarAction_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KToggleToolBarAction_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KToggleToolBarAction_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KToggleToolBarAction_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KToggleToolBarAction_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, signal: []const u8 ```
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KToggleToolBarAction_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KToggleToolBarAction_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KToggleToolBarAction_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KToggleToolBarAction_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.KToggleToolBarAction, callback: *const fn (self: QtC.KToggleToolBarAction, objectName: [*:0]const u8) callconv(.c) void ```
