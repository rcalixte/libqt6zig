...
pub const QColumnView = extern struct {
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QColumnView_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: QColumnView `
    ///
    pub fn asQPaintDevice(self: QColumnView) QPaintDevice {
    ...
    ///
    pub fn fromQPaintDevice(_qpaintdevice: anytype) QColumnView {
