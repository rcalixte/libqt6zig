...
pub const kselectionowner = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KSelectionOwner_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KSelectionOwner `
    ///
    /// ` callback: *const fn (self: QtC.KSelectionOwnerparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KSelectionOwner `
    ///
    /// ` callback: *const fn (self: QtC.KSelectionOwnerobjectName: [*:0]const u8) callconv(.c) void `
    ///
