...
pub const qlineedit = struct {
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditparam1: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditparam1: i32, param2: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEdittitle: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditicon: QtC.QIcon) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditiconText: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditpos: QtC.QPoint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QLineEdit `
    ///
    /// ` callback: *const fn (self: QtC.QLineEditobjectName: [*:0]const u8) callconv(.c) void `
    ///
