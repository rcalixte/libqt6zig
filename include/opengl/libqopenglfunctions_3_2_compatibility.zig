...
pub const QOpenGLFunctions_3_2_Compatibility = extern struct {
    ...
    /// ` length: []const i32 `
    ///
    pub fn GlShaderSource(self: QOpenGLFunctions_3_2_Compatibility, allocator: std.mem.Allocator, shader: u32, count: i32, string: []const [:0]const u8, length: []const i32) void {
        const string_chararr = allocator.alloc([*c]const u8, string.len) catch @panic("qopenglfunctions_3_2_compatibility.GlShaderSource: Memory allocation failed");
        defer allocator.free(string_chararr);
        for (string, 0..string.len) |str, i|
            string_chararr[i] = @ptrCast(str.ptr);
        qtc.QOpenGLFunctions_3_2_Compatibility_GlShaderSource(@ptrCast(self.ptr), @bitCast(shader), @bitCast(count), string_chararr.ptr, length.ptr);
    }
    ...
    /// ` values: []u16 `
    ///
    pub fn GlGetPixelMapusv(self: QOpenGLFunctions_3_2_Compatibility, map: u32, values: []u16) void {
        qtc.QOpenGLFunctions_3_2_Compatibility_GlGetPixelMapusv(@ptrCast(self.ptr), @bitCast(map), values.ptr);
    }
    ...
    /// ` values: []u32 `
    ///
    pub fn GlGetPixelMapuiv(self: QOpenGLFunctions_3_2_Compatibility, map: u32, values: []u32) void {
        qtc.QOpenGLFunctions_3_2_Compatibility_GlGetPixelMapuiv(@ptrCast(self.ptr), @bitCast(map), values.ptr);
    }
    ...
    /// ` values: []f32 `
    ///
    pub fn GlGetPixelMapfv(self: QOpenGLFunctions_3_2_Compatibility, map: u32, values: []f32) void {
        qtc.QOpenGLFunctions_3_2_Compatibility_GlGetPixelMapfv(@ptrCast(self.ptr), @bitCast(map), values.ptr);
    }
    ...
    /// ` values: []const u16 `
    ///
    pub fn GlPixelMapusv(self: QOpenGLFunctions_3_2_Compatibility, map: u32, mapsize: i32, values: []const u16) void {
        qtc.QOpenGLFunctions_3_2_Compatibility_GlPixelMapusv(@ptrCast(self.ptr), @bitCast(map), @bitCast(mapsize), values.ptr);
    }
    ...
    /// ` values: []const u32 `
    ///
    pub fn GlPixelMapuiv(self: QOpenGLFunctions_3_2_Compatibility, map: u32, mapsize: i32, values: []const u32) void {
        qtc.QOpenGLFunctions_3_2_Compatibility_GlPixelMapuiv(@ptrCast(self.ptr), @bitCast(map), @bitCast(mapsize), values.ptr);
    }
    ...
    /// ` values: []const f32 `
    ///
    pub fn GlPixelMapfv(self: QOpenGLFunctions_3_2_Compatibility, map: u32, mapsize: i32, values: []const f32) void {
        qtc.QOpenGLFunctions_3_2_Compatibility_GlPixelMapfv(@ptrCast(self.ptr), @bitCast(map), @bitCast(mapsize), values.ptr);
    }
