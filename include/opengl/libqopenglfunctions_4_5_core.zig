...
pub const qopenglfunctions_4_5_core = struct {
    ...
    pub fn GlMultiDrawElements(self: ?*anyopaque, mode: u32, count: *const i32, typeVal: u32, indices: ?*anyopaque, drawcount: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawElements(@ptrCast(self), @intCast(mode), @ptrCast(count), @intCast(typeVal), @ptrCast(@alignCast(indices)), @intCast(drawcount));
    }
    ...
    pub fn GlMultiDrawElementsBaseVertex(self: ?*anyopaque, mode: u32, count: *const i32, typeVal: u32, indices: ?*anyopaque, drawcount: i32, basevertex: *const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawElementsBaseVertex(@ptrCast(self), @intCast(mode), @ptrCast(count), @intCast(typeVal), @ptrCast(@alignCast(indices)), @intCast(drawcount), @ptrCast(basevertex));
    }
    ...
    pub fn GlShaderBinary(self: ?*anyopaque, count: i32, shaders: *const u32, binaryformat: u32, binary: ?*anyopaque, length: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlShaderBinary(@ptrCast(self), @intCast(count), @ptrCast(shaders), @intCast(binaryformat), @ptrCast(binary), @intCast(length));
    }
    ...
    pub fn GlGetObjectPtrLabel(self: ?*anyopaque, ptr: ?*anyopaque, bufSize: i32, length: *i32, label: *i8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetObjectPtrLabel(@ptrCast(self), @ptrCast(ptr), @intCast(bufSize), @ptrCast(length), @ptrCast(label));
    }
    ...
    pub fn GlObjectPtrLabel(self: ?*anyopaque, ptr: ?*anyopaque, length: i32, label: *const i8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlObjectPtrLabel(@ptrCast(self), @ptrCast(ptr), @intCast(length), @ptrCast(label));
    }
