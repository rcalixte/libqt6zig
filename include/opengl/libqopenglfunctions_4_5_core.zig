...
pub const qopenglfunctions_4_5_core = struct {
    ...
    pub fn GlDepthRange(self: ?*anyopaque, nearVal: f64, farVal: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDepthRange(@ptrCast(self), @floatCast(nearVal), @floatCast(farVal));
    }
    ...
    pub fn GlGetTexLevelParameteriv(self: ?*anyopaque, target: u32, level: i32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexLevelParameteriv(@ptrCast(self), @intCast(target), @intCast(level), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTexLevelParameterfv(self: ?*anyopaque, target: u32, level: i32, pname: u32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexLevelParameterfv(@ptrCast(self), @intCast(target), @intCast(level), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTexParameteriv(self: ?*anyopaque, target: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexParameteriv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTexParameterfv(self: ?*anyopaque, target: u32, pname: u32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexParameterfv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTexImage(self: ?*anyopaque, target: u32, level: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexImage(@ptrCast(self), @intCast(target), @intCast(level), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlGetString(self: ?*anyopaque, name: u32) []const u8 {
        const ret_str: ?[*:0]const u8 = qtc.QOpenGLFunctions_4_5_Core_GlGetString(@ptrCast(self), @intCast(name));
        if (ret_str == null) {
            return "";
        }
    ...
    pub fn GlGetIntegerv(self: ?*anyopaque, pname: u32, data: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetIntegerv(@ptrCast(self), @intCast(pname), data.ptr);
    }
    ...
    pub fn GlGetFloatv(self: ?*anyopaque, pname: u32, data: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetFloatv(@ptrCast(self), @intCast(pname), data.ptr);
    }
    ...
    pub fn GlGetDoublev(self: ?*anyopaque, pname: u32, data: []f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetDoublev(@ptrCast(self), @intCast(pname), data.ptr);
    }
    ...
    pub fn GlGetBooleanv(self: ?*anyopaque, pname: u32, data: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetBooleanv(@ptrCast(self), @intCast(pname), data.ptr);
    }
    ...
    pub fn GlReadPixels(self: ?*anyopaque, x: i32, y: i32, width: i32, height: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlReadPixels(@ptrCast(self), @intCast(x), @intCast(y), @intCast(width), @intCast(height), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlPixelStoref(self: ?*anyopaque, pname: u32, param: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPixelStoref(@ptrCast(self), @intCast(pname), @floatCast(param));
    }
    ...
    pub fn GlClearDepth(self: ?*anyopaque, depth: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearDepth(@ptrCast(self), @floatCast(depth));
    }
    ...
    pub fn GlClearColor(self: ?*anyopaque, red: f32, green: f32, blue: f32, alpha: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearColor(@ptrCast(self), @floatCast(red), @floatCast(green), @floatCast(blue), @floatCast(alpha));
    }
    ...
    pub fn GlTexImage2D(self: ?*anyopaque, target: u32, level: i32, internalformat: i32, width: i32, height: i32, border: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexImage2D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(internalformat), @intCast(width), @intCast(height), @intCast(border), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlTexImage1D(self: ?*anyopaque, target: u32, level: i32, internalformat: i32, width: i32, border: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexImage1D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(internalformat), @intCast(width), @intCast(border), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlTexParameteriv(self: ?*anyopaque, target: u32, pname: u32, params: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexParameteriv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlTexParameterfv(self: ?*anyopaque, target: u32, pname: u32, params: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexParameterfv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlTexParameterf(self: ?*anyopaque, target: u32, pname: u32, param: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexParameterf(@ptrCast(self), @intCast(target), @intCast(pname), @floatCast(param));
    }
    ...
    pub fn GlPointSize(self: ?*anyopaque, size: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPointSize(@ptrCast(self), @floatCast(size));
    }
    ...
    pub fn GlLineWidth(self: ?*anyopaque, width: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlLineWidth(@ptrCast(self), @floatCast(width));
    }
    ...
    pub fn GlGenTextures(self: ?*anyopaque, n: i32, textures: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenTextures(@ptrCast(self), @intCast(n), textures.ptr);
    }
    ...
    pub fn GlDeleteTextures(self: ?*anyopaque, n: i32, textures: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteTextures(@ptrCast(self), @intCast(n), textures.ptr);
    }
    ...
    pub fn GlTexSubImage2D(self: ?*anyopaque, target: u32, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexSubImage2D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(width), @intCast(height), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlTexSubImage1D(self: ?*anyopaque, target: u32, level: i32, xoffset: i32, width: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexSubImage1D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(xoffset), @intCast(width), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlPolygonOffset(self: ?*anyopaque, factor: f32, units: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPolygonOffset(@ptrCast(self), @floatCast(factor), @floatCast(units));
    }
    ...
    pub fn GlDrawElements(self: ?*anyopaque, mode: u32, count: i32, typeVal: u32, indices: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElements(@ptrCast(self), @intCast(mode), @intCast(count), @intCast(typeVal), @ptrCast(indices));
    }
    ...
    pub fn GlBlendColor(self: ?*anyopaque, red: f32, green: f32, blue: f32, alpha: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBlendColor(@ptrCast(self), @floatCast(red), @floatCast(green), @floatCast(blue), @floatCast(alpha));
    }
    ...
    pub fn GlTexSubImage3D(self: ?*anyopaque, target: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexSubImage3D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlTexImage3D(self: ?*anyopaque, target: u32, level: i32, internalformat: i32, width: i32, height: i32, depth: i32, border: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexImage3D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(internalformat), @intCast(width), @intCast(height), @intCast(depth), @intCast(border), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlDrawRangeElements(self: ?*anyopaque, mode: u32, start: u32, end: u32, count: i32, typeVal: u32, indices: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawRangeElements(@ptrCast(self), @intCast(mode), @intCast(start), @intCast(end), @intCast(count), @intCast(typeVal), @ptrCast(indices));
    }
    ...
    pub fn GlGetCompressedTexImage(self: ?*anyopaque, target: u32, level: i32, img: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetCompressedTexImage(@ptrCast(self), @intCast(target), @intCast(level), @ptrCast(img));
    }
    ...
    pub fn GlCompressedTexSubImage1D(self: ?*anyopaque, target: u32, level: i32, xoffset: i32, width: i32, format: u32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTexSubImage1D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(xoffset), @intCast(width), @intCast(format), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTexSubImage2D(self: ?*anyopaque, target: u32, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: u32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTexSubImage2D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(width), @intCast(height), @intCast(format), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTexSubImage3D(self: ?*anyopaque, target: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTexSubImage3D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(format), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTexImage1D(self: ?*anyopaque, target: u32, level: i32, internalformat: u32, width: i32, border: i32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTexImage1D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(internalformat), @intCast(width), @intCast(border), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTexImage2D(self: ?*anyopaque, target: u32, level: i32, internalformat: u32, width: i32, height: i32, border: i32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTexImage2D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(internalformat), @intCast(width), @intCast(height), @intCast(border), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTexImage3D(self: ?*anyopaque, target: u32, level: i32, internalformat: u32, width: i32, height: i32, depth: i32, border: i32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTexImage3D(@ptrCast(self), @intCast(target), @intCast(level), @intCast(internalformat), @intCast(width), @intCast(height), @intCast(depth), @intCast(border), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlSampleCoverage(self: ?*anyopaque, value: f32, invert: u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlSampleCoverage(@ptrCast(self), @floatCast(value), @intCast(invert));
    }
    ...
    pub fn GlPointParameteriv(self: ?*anyopaque, pname: u32, params: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPointParameteriv(@ptrCast(self), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlPointParameterfv(self: ?*anyopaque, pname: u32, params: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPointParameterfv(@ptrCast(self), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlPointParameterf(self: ?*anyopaque, pname: u32, param: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPointParameterf(@ptrCast(self), @intCast(pname), @floatCast(param));
    }
    ...
    pub fn GlMultiDrawElements(self: ?*anyopaque, mode: u32, count: []const i32, typeVal: u32, indices: ?*anyopaque, drawcount: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawElements(@ptrCast(self), @intCast(mode), count.ptr, @intCast(typeVal), @ptrCast(@alignCast(indices)), @intCast(drawcount));
    }
    ...
    pub fn GlMultiDrawArrays(self: ?*anyopaque, mode: u32, first: []const i32, count: []const i32, drawcount: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawArrays(@ptrCast(self), @intCast(mode), first.ptr, count.ptr, @intCast(drawcount));
    }
    ...
    pub fn GlGetBufferPointerv(self: ?*anyopaque, target: u32, pname: u32, params: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetBufferPointerv(@ptrCast(self), @intCast(target), @intCast(pname), @ptrCast(@alignCast(params)));
    }
    ...
    pub fn GlGetBufferParameteriv(self: ?*anyopaque, target: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetBufferParameteriv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, offset: isize, size: isize, data: ?*anyopaque ```
    pub fn GlGetBufferSubData(self: ?*anyopaque, target: u32, offset: isize, size: isize, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetBufferSubData(@ptrCast(self), @intCast(target), @intCast(offset), @intCast(size), @ptrCast(data));
    }
    ...
    pub fn GlBufferSubData(self: ?*anyopaque, target: u32, offset: isize, size: isize, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBufferSubData(@ptrCast(self), @intCast(target), @intCast(offset), @intCast(size), @ptrCast(data));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glBufferData)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, size: isize, data: ?*anyopaque, usage: u32 ```
    pub fn GlBufferData(self: ?*anyopaque, target: u32, size: isize, data: ?*anyopaque, usage: u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBufferData(@ptrCast(self), @intCast(target), @intCast(size), @ptrCast(data), @intCast(usage));
    }
    ...
    pub fn GlGenBuffers(self: ?*anyopaque, n: i32, buffers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenBuffers(@ptrCast(self), @intCast(n), buffers.ptr);
    }
    ...
    pub fn GlDeleteBuffers(self: ?*anyopaque, n: i32, buffers: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteBuffers(@ptrCast(self), @intCast(n), buffers.ptr);
    }
    ...
    pub fn GlGetQueryObjectuiv(self: ?*anyopaque, id: u32, pname: u32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetQueryObjectuiv(@ptrCast(self), @intCast(id), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetQueryObjectiv(self: ?*anyopaque, id: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetQueryObjectiv(@ptrCast(self), @intCast(id), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetQueryiv(self: ?*anyopaque, target: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetQueryiv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlDeleteQueries(self: ?*anyopaque, n: i32, ids: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteQueries(@ptrCast(self), @intCast(n), ids.ptr);
    }
    ...
    pub fn GlGenQueries(self: ?*anyopaque, n: i32, ids: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenQueries(@ptrCast(self), @intCast(n), ids.ptr);
    }
    ...
    pub fn GlVertexAttribPointer(self: ?*anyopaque, index: u32, size: i32, typeVal: u32, normalized: u8, stride: i32, pointer: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribPointer(@ptrCast(self), @intCast(index), @intCast(size), @intCast(typeVal), @intCast(normalized), @intCast(stride), @ptrCast(pointer));
    }
    ...
    pub fn GlVertexAttrib4usv(self: ?*anyopaque, index: u32, v: []const u16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4usv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4uiv(self: ?*anyopaque, index: u32, v: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4uiv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4ubv(self: ?*anyopaque, index: u32, v: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4ubv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4sv(self: ?*anyopaque, index: u32, v: []const i16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4sv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4iv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4iv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4fv(self: ?*anyopaque, index: u32, v: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4fv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4f(self: ?*anyopaque, index: u32, x: f32, y: f32, z: f32, w: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4f(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(z), @floatCast(w));
    }
    ...
    pub fn GlVertexAttrib4dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4d(self: ?*anyopaque, index: u32, x: f64, y: f64, z: f64, w: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4d(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(z), @floatCast(w));
    }
    ...
    pub fn GlVertexAttrib4bv(self: ?*anyopaque, index: u32, v: []const i8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4bv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4Nusv(self: ?*anyopaque, index: u32, v: []const u16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4Nusv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4Nuiv(self: ?*anyopaque, index: u32, v: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4Nuiv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4Nubv(self: ?*anyopaque, index: u32, v: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4Nubv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4Nsv(self: ?*anyopaque, index: u32, v: []const i16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4Nsv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4Niv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4Niv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib4Nbv(self: ?*anyopaque, index: u32, v: []const i8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib4Nbv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib3sv(self: ?*anyopaque, index: u32, v: []const i16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib3sv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib3fv(self: ?*anyopaque, index: u32, v: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib3fv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib3f(self: ?*anyopaque, index: u32, x: f32, y: f32, z: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib3f(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(z));
    }
    ...
    pub fn GlVertexAttrib3dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib3dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib3d(self: ?*anyopaque, index: u32, x: f64, y: f64, z: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib3d(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(z));
    }
    ...
    pub fn GlVertexAttrib2sv(self: ?*anyopaque, index: u32, v: []const i16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib2sv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib2fv(self: ?*anyopaque, index: u32, v: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib2fv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib2f(self: ?*anyopaque, index: u32, x: f32, y: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib2f(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y));
    }
    ...
    pub fn GlVertexAttrib2dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib2dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib2d(self: ?*anyopaque, index: u32, x: f64, y: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib2d(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y));
    }
    ...
    pub fn GlVertexAttrib1sv(self: ?*anyopaque, index: u32, v: []const i16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib1sv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib1fv(self: ?*anyopaque, index: u32, v: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib1fv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib1f(self: ?*anyopaque, index: u32, x: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib1f(@ptrCast(self), @intCast(index), @floatCast(x));
    }
    ...
    pub fn GlVertexAttrib1dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib1dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttrib1d(self: ?*anyopaque, index: u32, x: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttrib1d(@ptrCast(self), @intCast(index), @floatCast(x));
    }
    ...
    pub fn GlUniformMatrix4fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix4fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix3fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix3fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix2fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix2fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniform4iv(self: ?*anyopaque, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform4iv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform3iv(self: ?*anyopaque, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform3iv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform2iv(self: ?*anyopaque, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform2iv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform1iv(self: ?*anyopaque, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform1iv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform4fv(self: ?*anyopaque, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform4fv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform3fv(self: ?*anyopaque, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform3fv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform2fv(self: ?*anyopaque, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform2fv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform1fv(self: ?*anyopaque, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform1fv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform4f(self: ?*anyopaque, location: i32, v0: f32, v1: f32, v2: f32, v3: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform4f(@ptrCast(self), @intCast(location), @floatCast(v0), @floatCast(v1), @floatCast(v2), @floatCast(v3));
    }
    ...
    pub fn GlUniform3f(self: ?*anyopaque, location: i32, v0: f32, v1: f32, v2: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform3f(@ptrCast(self), @intCast(location), @floatCast(v0), @floatCast(v1), @floatCast(v2));
    }
    ...
    pub fn GlUniform2f(self: ?*anyopaque, location: i32, v0: f32, v1: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform2f(@ptrCast(self), @intCast(location), @floatCast(v0), @floatCast(v1));
    }
    ...
    pub fn GlUniform1f(self: ?*anyopaque, location: i32, v0: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform1f(@ptrCast(self), @intCast(location), @floatCast(v0));
    }
    ...
    pub fn GlGetVertexAttribPointerv(self: ?*anyopaque, index: u32, pname: u32, pointer: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribPointerv(@ptrCast(self), @intCast(index), @intCast(pname), @ptrCast(@alignCast(pointer)));
    }
    ...
    pub fn GlGetVertexAttribiv(self: ?*anyopaque, index: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribiv(@ptrCast(self), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetVertexAttribfv(self: ?*anyopaque, index: u32, pname: u32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribfv(@ptrCast(self), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetVertexAttribdv(self: ?*anyopaque, index: u32, pname: u32, params: []f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribdv(@ptrCast(self), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetUniformiv(self: ?*anyopaque, program: u32, location: i32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetUniformiv(@ptrCast(self), @intCast(program), @intCast(location), params.ptr);
    }
    ...
    pub fn GlGetUniformfv(self: ?*anyopaque, program: u32, location: i32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetUniformfv(@ptrCast(self), @intCast(program), @intCast(location), params.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetUniformLocation)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, name: []const u8 ```
    pub fn GlGetUniformLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetUniformLocation(@ptrCast(self), @intCast(program), name.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetShaderSource)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, shader: u32, bufSize: i32, length: []i32, source: []u8 ```
    pub fn GlGetShaderSource(self: ?*anyopaque, shader: u32, bufSize: i32, length: []i32, source: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetShaderSource(@ptrCast(self), @intCast(shader), @intCast(bufSize), length.ptr, source.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetShaderInfoLog)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, shader: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    pub fn GlGetShaderInfoLog(self: ?*anyopaque, shader: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetShaderInfoLog(@ptrCast(self), @intCast(shader), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlGetShaderiv(self: ?*anyopaque, shader: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetShaderiv(@ptrCast(self), @intCast(shader), @intCast(pname), params.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetProgramInfoLog)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    pub fn GlGetProgramInfoLog(self: ?*anyopaque, program: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramInfoLog(@ptrCast(self), @intCast(program), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlGetProgramiv(self: ?*anyopaque, program: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramiv(@ptrCast(self), @intCast(program), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetAttribLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetAttribLocation(@ptrCast(self), @intCast(program), name.ptr);
    }
    ...
    pub fn GlGetAttachedShaders(self: ?*anyopaque, program: u32, maxCount: i32, count: []i32, shaders: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetAttachedShaders(@ptrCast(self), @intCast(program), @intCast(maxCount), count.ptr, shaders.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, index: u32, name: []const u8 ```
    pub fn GlBindAttribLocation(self: ?*anyopaque, program: u32, index: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindAttribLocation(@ptrCast(self), @intCast(program), @intCast(index), name.ptr);
    }
    ...
    pub fn GlUniformMatrix4x3fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix4x3fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix3x4fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix3x4fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix4x2fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix4x2fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix2x4fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix2x4fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix3x2fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix3x2fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix2x3fv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix2x3fv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlGenVertexArrays(self: ?*anyopaque, n: i32, arrays: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenVertexArrays(@ptrCast(self), @intCast(n), arrays.ptr);
    }
    ...
    pub fn GlDeleteVertexArrays(self: ?*anyopaque, n: i32, arrays: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteVertexArrays(@ptrCast(self), @intCast(n), arrays.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, offset: isize, length: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, offset: isize, length: isize, access: u32 ```
    ...
    pub fn GlGetFramebufferAttachmentParameteriv(self: ?*anyopaque, target: u32, attachment: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetFramebufferAttachmentParameteriv(@ptrCast(self), @intCast(target), @intCast(attachment), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGenFramebuffers(self: ?*anyopaque, n: i32, framebuffers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenFramebuffers(@ptrCast(self), @intCast(n), framebuffers.ptr);
    }
    ...
    pub fn GlDeleteFramebuffers(self: ?*anyopaque, n: i32, framebuffers: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteFramebuffers(@ptrCast(self), @intCast(n), framebuffers.ptr);
    }
    ...
    pub fn GlGetRenderbufferParameteriv(self: ?*anyopaque, target: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetRenderbufferParameteriv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGenRenderbuffers(self: ?*anyopaque, n: i32, renderbuffers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenRenderbuffers(@ptrCast(self), @intCast(n), renderbuffers.ptr);
    }
    ...
    pub fn GlDeleteRenderbuffers(self: ?*anyopaque, n: i32, renderbuffers: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteRenderbuffers(@ptrCast(self), @intCast(n), renderbuffers.ptr);
    }
    ...
    pub fn GlGetStringi(self: ?*anyopaque, name: u32, index: u32) []const u8 {
        const ret_str: ?[*:0]const u8 = qtc.QOpenGLFunctions_4_5_Core_GlGetStringi(@ptrCast(self), @intCast(name), @intCast(index));
        if (ret_str == null) {
            return "";
        }
        return std.mem.span(ret_str.?);
    ...
    pub fn GlClearBufferfi(self: ?*anyopaque, buffer: u32, drawbuffer: i32, depth: f32, stencil: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearBufferfi(@ptrCast(self), @intCast(buffer), @intCast(drawbuffer), @floatCast(depth), @intCast(stencil));
    }
    ...
    pub fn GlClearBufferfv(self: ?*anyopaque, buffer: u32, drawbuffer: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearBufferfv(@ptrCast(self), @intCast(buffer), @intCast(drawbuffer), value.ptr);
    }
    ...
    pub fn GlClearBufferuiv(self: ?*anyopaque, buffer: u32, drawbuffer: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearBufferuiv(@ptrCast(self), @intCast(buffer), @intCast(drawbuffer), value.ptr);
    }
    ...
    pub fn GlClearBufferiv(self: ?*anyopaque, buffer: u32, drawbuffer: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearBufferiv(@ptrCast(self), @intCast(buffer), @intCast(drawbuffer), value.ptr);
    }
    ...
    pub fn GlGetTexParameterIuiv(self: ?*anyopaque, target: u32, pname: u32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexParameterIuiv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTexParameterIiv(self: ?*anyopaque, target: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTexParameterIiv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlTexParameterIuiv(self: ?*anyopaque, target: u32, pname: u32, params: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexParameterIuiv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlTexParameterIiv(self: ?*anyopaque, target: u32, pname: u32, params: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTexParameterIiv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlUniform4uiv(self: ?*anyopaque, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform4uiv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform3uiv(self: ?*anyopaque, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform3uiv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform2uiv(self: ?*anyopaque, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform2uiv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform1uiv(self: ?*anyopaque, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform1uiv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlGetFragDataLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetFragDataLocation(@ptrCast(self), @intCast(program), name.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glBindFragDataLocation)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, color: u32, name: []const u8 ```
    pub fn GlBindFragDataLocation(self: ?*anyopaque, program: u32, color: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindFragDataLocation(@ptrCast(self), @intCast(program), @intCast(color), name.ptr);
    }
    ...
    pub fn GlGetUniformuiv(self: ?*anyopaque, program: u32, location: i32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetUniformuiv(@ptrCast(self), @intCast(program), @intCast(location), params.ptr);
    }
    ...
    pub fn GlVertexAttribI4usv(self: ?*anyopaque, index: u32, v: []const u16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI4usv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI4ubv(self: ?*anyopaque, index: u32, v: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI4ubv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI4sv(self: ?*anyopaque, index: u32, v: []const i16) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI4sv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI4bv(self: ?*anyopaque, index: u32, v: []const i8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI4bv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI4uiv(self: ?*anyopaque, index: u32, v: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI4uiv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI3uiv(self: ?*anyopaque, index: u32, v: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI3uiv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI2uiv(self: ?*anyopaque, index: u32, v: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI2uiv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI1uiv(self: ?*anyopaque, index: u32, v: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI1uiv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI4iv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI4iv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI3iv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI3iv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI2iv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI2iv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribI1iv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribI1iv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlGetVertexAttribIuiv(self: ?*anyopaque, index: u32, pname: u32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribIuiv(@ptrCast(self), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetVertexAttribIiv(self: ?*anyopaque, index: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribIiv(@ptrCast(self), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlVertexAttribIPointer(self: ?*anyopaque, index: u32, size: i32, typeVal: u32, stride: i32, pointer: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribIPointer(@ptrCast(self), @intCast(index), @intCast(size), @intCast(typeVal), @intCast(stride), @ptrCast(pointer));
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, index: u32, buffer: u32, offset: isize, size: isize ```
    ...
    pub fn GlGetIntegeriV(self: ?*anyopaque, target: u32, index: u32, data: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetIntegeriV(@ptrCast(self), @intCast(target), @intCast(index), data.ptr);
    }
    ...
    pub fn GlGetBooleaniV(self: ?*anyopaque, target: u32, index: u32, data: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetBooleaniV(@ptrCast(self), @intCast(target), @intCast(index), data.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, uniformBlockIndex: u32, bufSize: i32, length: []i32, uniformBlockName: []u8 ```
    pub fn GlGetActiveUniformBlockName(self: ?*anyopaque, program: u32, uniformBlockIndex: u32, bufSize: i32, length: []i32, uniformBlockName: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveUniformBlockName(@ptrCast(self), @intCast(program), @intCast(uniformBlockIndex), @intCast(bufSize), length.ptr, uniformBlockName.ptr);
    }
    ...
    pub fn GlGetActiveUniformBlockiv(self: ?*anyopaque, program: u32, uniformBlockIndex: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveUniformBlockiv(@ptrCast(self), @intCast(program), @intCast(uniformBlockIndex), @intCast(pname), params.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetUniformBlockIndex)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, uniformBlockName: []const u8 ```
    pub fn GlGetUniformBlockIndex(self: ?*anyopaque, program: u32, uniformBlockName: []const u8) u32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetUniformBlockIndex(@ptrCast(self), @intCast(program), uniformBlockName.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetActiveUniformName)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, uniformIndex: u32, bufSize: i32, length: []i32, uniformName: []u8 ```
    pub fn GlGetActiveUniformName(self: ?*anyopaque, program: u32, uniformIndex: u32, bufSize: i32, length: []i32, uniformName: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveUniformName(@ptrCast(self), @intCast(program), @intCast(uniformIndex), @intCast(bufSize), length.ptr, uniformName.ptr);
    }
    ...
    pub fn GlGetActiveUniformsiv(self: ?*anyopaque, program: u32, uniformCount: i32, uniformIndices: []const u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveUniformsiv(@ptrCast(self), @intCast(program), @intCast(uniformCount), uniformIndices.ptr, @intCast(pname), params.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glCopyBufferSubData)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, readTarget: u32, writeTarget: u32, readOffset: isize, writeOffset: isize, size: isize ```
    ...
    pub fn GlDrawElementsInstanced(self: ?*anyopaque, mode: u32, count: i32, typeVal: u32, indices: ?*anyopaque, instancecount: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElementsInstanced(@ptrCast(self), @intCast(mode), @intCast(count), @intCast(typeVal), @ptrCast(indices), @intCast(instancecount));
    }
    ...
    pub fn GlGetMultisamplefv(self: ?*anyopaque, pname: u32, index: u32, val: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetMultisamplefv(@ptrCast(self), @intCast(pname), @intCast(index), val.ptr);
    }
    ...
    pub fn GlGetBufferParameteri64v(self: ?*anyopaque, target: u32, pname: u32, params: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetBufferParameteri64v(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetInteger64iV(self: ?*anyopaque, target: u32, index: u32, data: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetInteger64iV(@ptrCast(self), @intCast(target), @intCast(index), data.ptr);
    }
    ...
    pub fn GlGetInteger64v(self: ?*anyopaque, pname: u32, data: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetInteger64v(@ptrCast(self), @intCast(pname), data.ptr);
    }
    ...
    pub fn GlMultiDrawElementsBaseVertex(self: ?*anyopaque, mode: u32, count: []const i32, typeVal: u32, indices: ?*anyopaque, drawcount: i32, basevertex: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawElementsBaseVertex(@ptrCast(self), @intCast(mode), count.ptr, @intCast(typeVal), @ptrCast(@alignCast(indices)), @intCast(drawcount), basevertex.ptr);
    }
    ...
    pub fn GlDrawElementsInstancedBaseVertex(self: ?*anyopaque, mode: u32, count: i32, typeVal: u32, indices: ?*anyopaque, instancecount: i32, basevertex: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElementsInstancedBaseVertex(@ptrCast(self), @intCast(mode), @intCast(count), @intCast(typeVal), @ptrCast(indices), @intCast(instancecount), @intCast(basevertex));
    }
    ...
    pub fn GlDrawRangeElementsBaseVertex(self: ?*anyopaque, mode: u32, start: u32, end: u32, count: i32, typeVal: u32, indices: ?*anyopaque, basevertex: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawRangeElementsBaseVertex(@ptrCast(self), @intCast(mode), @intCast(start), @intCast(end), @intCast(count), @intCast(typeVal), @ptrCast(indices), @intCast(basevertex));
    }
    ...
    pub fn GlDrawElementsBaseVertex(self: ?*anyopaque, mode: u32, count: i32, typeVal: u32, indices: ?*anyopaque, basevertex: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElementsBaseVertex(@ptrCast(self), @intCast(mode), @intCast(count), @intCast(typeVal), @ptrCast(indices), @intCast(basevertex));
    }
    ...
    pub fn GlVertexAttribP4uiv(self: ?*anyopaque, index: u32, typeVal: u32, normalized: u8, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribP4uiv(@ptrCast(self), @intCast(index), @intCast(typeVal), @intCast(normalized), value.ptr);
    }
    ...
    pub fn GlVertexAttribP3uiv(self: ?*anyopaque, index: u32, typeVal: u32, normalized: u8, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribP3uiv(@ptrCast(self), @intCast(index), @intCast(typeVal), @intCast(normalized), value.ptr);
    }
    ...
    pub fn GlVertexAttribP2uiv(self: ?*anyopaque, index: u32, typeVal: u32, normalized: u8, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribP2uiv(@ptrCast(self), @intCast(index), @intCast(typeVal), @intCast(normalized), value.ptr);
    }
    ...
    pub fn GlVertexAttribP1uiv(self: ?*anyopaque, index: u32, typeVal: u32, normalized: u8, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribP1uiv(@ptrCast(self), @intCast(index), @intCast(typeVal), @intCast(normalized), value.ptr);
    }
    ...
    pub fn GlGetQueryObjectui64v(self: ?*anyopaque, id: u32, pname: u32, params: []u64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetQueryObjectui64v(@ptrCast(self), @intCast(id), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetQueryObjecti64v(self: ?*anyopaque, id: u32, pname: u32, params: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetQueryObjecti64v(@ptrCast(self), @intCast(id), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetSamplerParameterIuiv(self: ?*anyopaque, sampler: u32, pname: u32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetSamplerParameterIuiv(@ptrCast(self), @intCast(sampler), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetSamplerParameterfv(self: ?*anyopaque, sampler: u32, pname: u32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetSamplerParameterfv(@ptrCast(self), @intCast(sampler), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetSamplerParameterIiv(self: ?*anyopaque, sampler: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetSamplerParameterIiv(@ptrCast(self), @intCast(sampler), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetSamplerParameteriv(self: ?*anyopaque, sampler: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetSamplerParameteriv(@ptrCast(self), @intCast(sampler), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlSamplerParameterIuiv(self: ?*anyopaque, sampler: u32, pname: u32, param: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlSamplerParameterIuiv(@ptrCast(self), @intCast(sampler), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlSamplerParameterIiv(self: ?*anyopaque, sampler: u32, pname: u32, param: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlSamplerParameterIiv(@ptrCast(self), @intCast(sampler), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlSamplerParameterfv(self: ?*anyopaque, sampler: u32, pname: u32, param: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlSamplerParameterfv(@ptrCast(self), @intCast(sampler), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlSamplerParameterf(self: ?*anyopaque, sampler: u32, pname: u32, param: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlSamplerParameterf(@ptrCast(self), @intCast(sampler), @intCast(pname), @floatCast(param));
    }
    ...
    pub fn GlSamplerParameteriv(self: ?*anyopaque, sampler: u32, pname: u32, param: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlSamplerParameteriv(@ptrCast(self), @intCast(sampler), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlDeleteSamplers(self: ?*anyopaque, count: i32, samplers: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteSamplers(@ptrCast(self), @intCast(count), samplers.ptr);
    }
    ...
    pub fn GlGenSamplers(self: ?*anyopaque, count: i32, samplers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenSamplers(@ptrCast(self), @intCast(count), samplers.ptr);
    }
    ...
    pub fn GlGetFragDataIndex(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetFragDataIndex(@ptrCast(self), @intCast(program), name.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glBindFragDataLocationIndexed)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, colorNumber: u32, index: u32, name: []const u8 ```
    pub fn GlBindFragDataLocationIndexed(self: ?*anyopaque, program: u32, colorNumber: u32, index: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindFragDataLocationIndexed(@ptrCast(self), @intCast(program), @intCast(colorNumber), @intCast(index), name.ptr);
    }
    ...
    pub fn GlGetQueryIndexediv(self: ?*anyopaque, target: u32, index: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetQueryIndexediv(@ptrCast(self), @intCast(target), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGenTransformFeedbacks(self: ?*anyopaque, n: i32, ids: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenTransformFeedbacks(@ptrCast(self), @intCast(n), ids.ptr);
    }
    ...
    pub fn GlDeleteTransformFeedbacks(self: ?*anyopaque, n: i32, ids: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteTransformFeedbacks(@ptrCast(self), @intCast(n), ids.ptr);
    }
    ...
    pub fn GlPatchParameterfv(self: ?*anyopaque, pname: u32, values: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPatchParameterfv(@ptrCast(self), @intCast(pname), values.ptr);
    }
    ...
    pub fn GlGetProgramStageiv(self: ?*anyopaque, program: u32, shadertype: u32, pname: u32, values: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramStageiv(@ptrCast(self), @intCast(program), @intCast(shadertype), @intCast(pname), values.ptr);
    }
    ...
    pub fn GlGetUniformSubroutineuiv(self: ?*anyopaque, shadertype: u32, location: i32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetUniformSubroutineuiv(@ptrCast(self), @intCast(shadertype), @intCast(location), params.ptr);
    }
    ...
    pub fn GlUniformSubroutinesuiv(self: ?*anyopaque, shadertype: u32, count: i32, indices: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformSubroutinesuiv(@ptrCast(self), @intCast(shadertype), @intCast(count), indices.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetActiveSubroutineName)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8 ```
    pub fn GlGetActiveSubroutineName(self: ?*anyopaque, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveSubroutineName(@ptrCast(self), @intCast(program), @intCast(shadertype), @intCast(index), @intCast(bufsize), length.ptr, name.ptr);
    }
    ...
    pub fn GlGetActiveSubroutineUniformName(self: ?*anyopaque, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveSubroutineUniformName(@ptrCast(self), @intCast(program), @intCast(shadertype), @intCast(index), @intCast(bufsize), length.ptr, name.ptr);
    }
    ...
    pub fn GlGetActiveSubroutineUniformiv(self: ?*anyopaque, program: u32, shadertype: u32, index: u32, pname: u32, values: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveSubroutineUniformiv(@ptrCast(self), @intCast(program), @intCast(shadertype), @intCast(index), @intCast(pname), values.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetSubroutineIndex)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, shadertype: u32, name: []const u8 ```
    pub fn GlGetSubroutineIndex(self: ?*anyopaque, program: u32, shadertype: u32, name: []const u8) u32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetSubroutineIndex(@ptrCast(self), @intCast(program), @intCast(shadertype), name.ptr);
    }
    ...
    pub fn GlGetSubroutineUniformLocation(self: ?*anyopaque, program: u32, shadertype: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetSubroutineUniformLocation(@ptrCast(self), @intCast(program), @intCast(shadertype), name.ptr);
    }
    ...
    pub fn GlGetUniformdv(self: ?*anyopaque, program: u32, location: i32, params: []f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetUniformdv(@ptrCast(self), @intCast(program), @intCast(location), params.ptr);
    }
    ...
    pub fn GlUniformMatrix4x3dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix4x3dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix4x2dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix4x2dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix3x4dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix3x4dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix3x2dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix3x2dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix2x4dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix2x4dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix2x3dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix2x3dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix4dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix4dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix3dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix3dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniformMatrix2dv(self: ?*anyopaque, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniformMatrix2dv(@ptrCast(self), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlUniform4dv(self: ?*anyopaque, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform4dv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform3dv(self: ?*anyopaque, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform3dv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform2dv(self: ?*anyopaque, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform2dv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform1dv(self: ?*anyopaque, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform1dv(@ptrCast(self), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlUniform4d(self: ?*anyopaque, location: i32, x: f64, y: f64, z: f64, w: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform4d(@ptrCast(self), @intCast(location), @floatCast(x), @floatCast(y), @floatCast(z), @floatCast(w));
    }
    ...
    pub fn GlUniform3d(self: ?*anyopaque, location: i32, x: f64, y: f64, z: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform3d(@ptrCast(self), @intCast(location), @floatCast(x), @floatCast(y), @floatCast(z));
    }
    ...
    pub fn GlUniform2d(self: ?*anyopaque, location: i32, x: f64, y: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform2d(@ptrCast(self), @intCast(location), @floatCast(x), @floatCast(y));
    }
    ...
    pub fn GlUniform1d(self: ?*anyopaque, location: i32, x: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlUniform1d(@ptrCast(self), @intCast(location), @floatCast(x));
    }
    ...
    pub fn GlDrawElementsIndirect(self: ?*anyopaque, mode: u32, typeVal: u32, indirect: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElementsIndirect(@ptrCast(self), @intCast(mode), @intCast(typeVal), @ptrCast(indirect));
    }
    ...
    pub fn GlDrawArraysIndirect(self: ?*anyopaque, mode: u32, indirect: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawArraysIndirect(@ptrCast(self), @intCast(mode), @ptrCast(indirect));
    }
    ...
    pub fn GlMinSampleShading(self: ?*anyopaque, value: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMinSampleShading(@ptrCast(self), @floatCast(value));
    }
    ...
    pub fn GlGetDoubleiV(self: ?*anyopaque, target: u32, index: u32, data: []f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetDoubleiV(@ptrCast(self), @intCast(target), @intCast(index), data.ptr);
    }
    ...
    pub fn GlGetFloatiV(self: ?*anyopaque, target: u32, index: u32, data: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetFloatiV(@ptrCast(self), @intCast(target), @intCast(index), data.ptr);
    }
    ...
    pub fn GlDepthRangeIndexed(self: ?*anyopaque, index: u32, n: f64, f: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDepthRangeIndexed(@ptrCast(self), @intCast(index), @floatCast(n), @floatCast(f));
    }
    ...
    pub fn GlDepthRangeArrayv(self: ?*anyopaque, first: u32, count: i32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDepthRangeArrayv(@ptrCast(self), @intCast(first), @intCast(count), v.ptr);
    }
    ...
    pub fn GlScissorIndexedv(self: ?*anyopaque, index: u32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlScissorIndexedv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlScissorArrayv(self: ?*anyopaque, first: u32, count: i32, v: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlScissorArrayv(@ptrCast(self), @intCast(first), @intCast(count), v.ptr);
    }
    ...
    pub fn GlViewportIndexedfv(self: ?*anyopaque, index: u32, v: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlViewportIndexedfv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlViewportIndexedf(self: ?*anyopaque, index: u32, x: f32, y: f32, w: f32, h: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlViewportIndexedf(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(w), @floatCast(h));
    }
    ...
    pub fn GlViewportArrayv(self: ?*anyopaque, first: u32, count: i32, v: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlViewportArrayv(@ptrCast(self), @intCast(first), @intCast(count), v.ptr);
    }
    ...
    pub fn GlGetVertexAttribLdv(self: ?*anyopaque, index: u32, pname: u32, params: []f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexAttribLdv(@ptrCast(self), @intCast(index), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlVertexAttribLPointer(self: ?*anyopaque, index: u32, size: i32, typeVal: u32, stride: i32, pointer: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribLPointer(@ptrCast(self), @intCast(index), @intCast(size), @intCast(typeVal), @intCast(stride), @ptrCast(pointer));
    }
    ...
    pub fn GlVertexAttribL4dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL4dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribL3dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL3dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribL2dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL2dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribL1dv(self: ?*anyopaque, index: u32, v: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL1dv(@ptrCast(self), @intCast(index), v.ptr);
    }
    ...
    pub fn GlVertexAttribL4d(self: ?*anyopaque, index: u32, x: f64, y: f64, z: f64, w: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL4d(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(z), @floatCast(w));
    }
    ...
    pub fn GlVertexAttribL3d(self: ?*anyopaque, index: u32, x: f64, y: f64, z: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL3d(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y), @floatCast(z));
    }
    ...
    pub fn GlVertexAttribL2d(self: ?*anyopaque, index: u32, x: f64, y: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL2d(@ptrCast(self), @intCast(index), @floatCast(x), @floatCast(y));
    }
    ...
    pub fn GlVertexAttribL1d(self: ?*anyopaque, index: u32, x: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexAttribL1d(@ptrCast(self), @intCast(index), @floatCast(x));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetProgramPipelineInfoLog)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, pipeline: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    pub fn GlGetProgramPipelineInfoLog(self: ?*anyopaque, pipeline: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramPipelineInfoLog(@ptrCast(self), @intCast(pipeline), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix4x3dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix4x3dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix3x4dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix3x4dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix4x2dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix4x2dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix2x4dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix2x4dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix3x2dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix3x2dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix2x3dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix2x3dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix4x3fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix4x3fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix3x4fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix3x4fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix4x2fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix4x2fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix2x4fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix2x4fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix3x2fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix3x2fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix2x3fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix2x3fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix4dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix4dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix3dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix3dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix2dv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix2dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix4fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix4fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix3fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix3fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniformMatrix2fv(self: ?*anyopaque, program: u32, location: i32, count: i32, transpose: u8, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniformMatrix2fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), @intCast(transpose), value.ptr);
    }
    ...
    pub fn GlProgramUniform4uiv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform4uiv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform4dv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform4dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform4d(self: ?*anyopaque, program: u32, location: i32, v0: f64, v1: f64, v2: f64, v3: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform4d(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0), @floatCast(v1), @floatCast(v2), @floatCast(v3));
    }
    ...
    pub fn GlProgramUniform4fv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform4fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform4f(self: ?*anyopaque, program: u32, location: i32, v0: f32, v1: f32, v2: f32, v3: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform4f(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0), @floatCast(v1), @floatCast(v2), @floatCast(v3));
    }
    ...
    pub fn GlProgramUniform4iv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform4iv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform3uiv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform3uiv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform3dv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform3dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform3d(self: ?*anyopaque, program: u32, location: i32, v0: f64, v1: f64, v2: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform3d(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0), @floatCast(v1), @floatCast(v2));
    }
    ...
    pub fn GlProgramUniform3fv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform3fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform3f(self: ?*anyopaque, program: u32, location: i32, v0: f32, v1: f32, v2: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform3f(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0), @floatCast(v1), @floatCast(v2));
    }
    ...
    pub fn GlProgramUniform3iv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform3iv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform2uiv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform2uiv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform2dv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform2dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform2d(self: ?*anyopaque, program: u32, location: i32, v0: f64, v1: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform2d(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0), @floatCast(v1));
    }
    ...
    pub fn GlProgramUniform2fv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform2fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform2f(self: ?*anyopaque, program: u32, location: i32, v0: f32, v1: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform2f(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0), @floatCast(v1));
    }
    ...
    pub fn GlProgramUniform2iv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform2iv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform1uiv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform1uiv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform1dv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform1dv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform1d(self: ?*anyopaque, program: u32, location: i32, v0: f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform1d(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0));
    }
    ...
    pub fn GlProgramUniform1fv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform1fv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlProgramUniform1f(self: ?*anyopaque, program: u32, location: i32, v0: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform1f(@ptrCast(self), @intCast(program), @intCast(location), @floatCast(v0));
    }
    ...
    pub fn GlProgramUniform1iv(self: ?*anyopaque, program: u32, location: i32, count: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramUniform1iv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(count), value.ptr);
    }
    ...
    pub fn GlGetProgramPipelineiv(self: ?*anyopaque, pipeline: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramPipelineiv(@ptrCast(self), @intCast(pipeline), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGenProgramPipelines(self: ?*anyopaque, n: i32, pipelines: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGenProgramPipelines(@ptrCast(self), @intCast(n), pipelines.ptr);
    }
    ...
    pub fn GlDeleteProgramPipelines(self: ?*anyopaque, n: i32, pipelines: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDeleteProgramPipelines(@ptrCast(self), @intCast(n), pipelines.ptr);
    }
    ...
    pub fn GlProgramBinary(self: ?*anyopaque, program: u32, binaryFormat: u32, binary: ?*anyopaque, length: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlProgramBinary(@ptrCast(self), @intCast(program), @intCast(binaryFormat), @ptrCast(binary), @intCast(length));
    }
    ...
    pub fn GlClearDepthf(self: ?*anyopaque, dd: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearDepthf(@ptrCast(self), @floatCast(dd));
    }
    ...
    pub fn GlDepthRangef(self: ?*anyopaque, n: f32, f: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDepthRangef(@ptrCast(self), @floatCast(n), @floatCast(f));
    }
    ...
    pub fn GlGetShaderPrecisionFormat(self: ?*anyopaque, shadertype: u32, precisiontype: u32, range: []i32, precision: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetShaderPrecisionFormat(@ptrCast(self), @intCast(shadertype), @intCast(precisiontype), range.ptr, precision.ptr);
    }
    ...
    pub fn GlShaderBinary(self: ?*anyopaque, count: i32, shaders: []const u32, binaryformat: u32, binary: ?*anyopaque, length: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlShaderBinary(@ptrCast(self), @intCast(count), shaders.ptr, @intCast(binaryformat), @ptrCast(binary), @intCast(length));
    }
    ...
    pub fn GlGetActiveAtomicCounterBufferiv(self: ?*anyopaque, program: u32, bufferIndex: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetActiveAtomicCounterBufferiv(@ptrCast(self), @intCast(program), @intCast(bufferIndex), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetInternalformativ(self: ?*anyopaque, target: u32, internalformat: u32, pname: u32, bufSize: i32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetInternalformativ(@ptrCast(self), @intCast(target), @intCast(internalformat), @intCast(pname), @intCast(bufSize), params.ptr);
    }
    ...
    pub fn GlDrawElementsInstancedBaseVertexBaseInstance(self: ?*anyopaque, mode: u32, count: i32, typeVal: u32, indices: ?*anyopaque, instancecount: i32, basevertex: i32, baseinstance: u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElementsInstancedBaseVertexBaseInstance(@ptrCast(self), @intCast(mode), @intCast(count), @intCast(typeVal), @ptrCast(indices), @intCast(instancecount), @intCast(basevertex), @intCast(baseinstance));
    }
    ...
    pub fn GlDrawElementsInstancedBaseInstance(self: ?*anyopaque, mode: u32, count: i32, typeVal: u32, indices: ?*anyopaque, instancecount: i32, baseinstance: u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDrawElementsInstancedBaseInstance(@ptrCast(self), @intCast(mode), @intCast(count), @intCast(typeVal), @ptrCast(indices), @intCast(instancecount), @intCast(baseinstance));
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, ptr: ?*anyopaque, bufSize: i32, length: []i32, label: []u8 ```
    pub fn GlGetObjectPtrLabel(self: ?*anyopaque, ptr: ?*anyopaque, bufSize: i32, length: []i32, label: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetObjectPtrLabel(@ptrCast(self), @ptrCast(ptr), @intCast(bufSize), length.ptr, label.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glObjectPtrLabel)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, ptr: ?*anyopaque, length: i32, label: []const u8 ```
    pub fn GlObjectPtrLabel(self: ?*anyopaque, ptr: ?*anyopaque, length: i32, label: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlObjectPtrLabel(@ptrCast(self), @ptrCast(ptr), @intCast(length), label.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetObjectLabel)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, identifier: u32, name: u32, bufSize: i32, length: []i32, label: []u8 ```
    pub fn GlGetObjectLabel(self: ?*anyopaque, identifier: u32, name: u32, bufSize: i32, length: []i32, label: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetObjectLabel(@ptrCast(self), @intCast(identifier), @intCast(name), @intCast(bufSize), length.ptr, label.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glObjectLabel)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, identifier: u32, name: u32, length: i32, label: []const u8 ```
    pub fn GlObjectLabel(self: ?*anyopaque, identifier: u32, name: u32, length: i32, label: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlObjectLabel(@ptrCast(self), @intCast(identifier), @intCast(name), @intCast(length), label.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, source: u32, id: u32, length: i32, message: []const u8 ```
    pub fn GlPushDebugGroup(self: ?*anyopaque, source: u32, id: u32, length: i32, message: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlPushDebugGroup(@ptrCast(self), @intCast(source), @intCast(id), @intCast(length), message.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glDebugMessageInsert)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, source: u32, typeVal: u32, id: u32, severity: u32, length: i32, buf: []const u8 ```
    pub fn GlDebugMessageInsert(self: ?*anyopaque, source: u32, typeVal: u32, id: u32, severity: u32, length: i32, buf: []const u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDebugMessageInsert(@ptrCast(self), @intCast(source), @intCast(typeVal), @intCast(id), @intCast(severity), @intCast(length), buf.ptr);
    }
    ...
    pub fn GlDebugMessageControl(self: ?*anyopaque, source: u32, typeVal: u32, severity: u32, count: i32, ids: []const u32, enabled: u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlDebugMessageControl(@ptrCast(self), @intCast(source), @intCast(typeVal), @intCast(severity), @intCast(count), ids.ptr, @intCast(enabled));
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, bindingindex: u32, buffer: u32, offset: isize, stride: i32 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, internalformat: u32, buffer: u32, offset: isize, size: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, programInterface: u32, name: []const u8 ```
    pub fn GlGetProgramResourceLocationIndex(self: ?*anyopaque, program: u32, programInterface: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetProgramResourceLocationIndex(@ptrCast(self), @intCast(program), @intCast(programInterface), name.ptr);
    }
    ...
    pub fn GlGetProgramResourceLocation(self: ?*anyopaque, program: u32, programInterface: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetProgramResourceLocation(@ptrCast(self), @intCast(program), @intCast(programInterface), name.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetProgramResourceName)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, program: u32, programInterface: u32, index: u32, bufSize: i32, length: []i32, name: []u8 ```
    pub fn GlGetProgramResourceName(self: ?*anyopaque, program: u32, programInterface: u32, index: u32, bufSize: i32, length: []i32, name: []u8) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramResourceName(@ptrCast(self), @intCast(program), @intCast(programInterface), @intCast(index), @intCast(bufSize), length.ptr, name.ptr);
    }
    ...
    pub fn GlGetProgramResourceIndex(self: ?*anyopaque, program: u32, programInterface: u32, name: []const u8) u32 {
        return qtc.QOpenGLFunctions_4_5_Core_GlGetProgramResourceIndex(@ptrCast(self), @intCast(program), @intCast(programInterface), name.ptr);
    }
    ...
    pub fn GlGetProgramInterfaceiv(self: ?*anyopaque, program: u32, programInterface: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetProgramInterfaceiv(@ptrCast(self), @intCast(program), @intCast(programInterface), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlMultiDrawElementsIndirect(self: ?*anyopaque, mode: u32, typeVal: u32, indirect: ?*anyopaque, drawcount: i32, stride: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawElementsIndirect(@ptrCast(self), @intCast(mode), @intCast(typeVal), @ptrCast(indirect), @intCast(drawcount), @intCast(stride));
    }
    ...
    pub fn GlMultiDrawArraysIndirect(self: ?*anyopaque, mode: u32, indirect: ?*anyopaque, drawcount: i32, stride: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlMultiDrawArraysIndirect(@ptrCast(self), @intCast(mode), @ptrCast(indirect), @intCast(drawcount), @intCast(stride));
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, buffer: u32, offset: isize, length: isize ```
    ...
    pub fn GlGetInternalformati64v(self: ?*anyopaque, target: u32, internalformat: u32, pname: u32, bufSize: i32, params: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetInternalformati64v(@ptrCast(self), @intCast(target), @intCast(internalformat), @intCast(pname), @intCast(bufSize), params.ptr);
    }
    ...
    pub fn GlGetFramebufferParameteriv(self: ?*anyopaque, target: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetFramebufferParameteriv(@ptrCast(self), @intCast(target), @intCast(pname), params.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, indirect: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, internalformat: u32, offset: isize, size: isize, format: u32, typeVal: u32, data: ?*anyopaque ```
    pub fn GlClearBufferSubData(self: ?*anyopaque, target: u32, internalformat: u32, offset: isize, size: isize, format: u32, typeVal: u32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearBufferSubData(@ptrCast(self), @intCast(target), @intCast(internalformat), @intCast(offset), @intCast(size), @intCast(format), @intCast(typeVal), @ptrCast(data));
    }
    ...
    pub fn GlClearBufferData(self: ?*anyopaque, target: u32, internalformat: u32, format: u32, typeVal: u32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearBufferData(@ptrCast(self), @intCast(target), @intCast(internalformat), @intCast(format), @intCast(typeVal), @ptrCast(data));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glBindVertexBuffers)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, first: u32, count: i32, buffers: []const u32, offsets: []const isize, strides: []const i32 ```
    pub fn GlBindVertexBuffers(self: ?*anyopaque, first: u32, count: i32, buffers: []const u32, offsets: []const isize, strides: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindVertexBuffers(@ptrCast(self), @intCast(first), @intCast(count), buffers.ptr, offsets.ptr, strides.ptr);
    }
    ...
    pub fn GlBindImageTextures(self: ?*anyopaque, first: u32, count: i32, textures: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindImageTextures(@ptrCast(self), @intCast(first), @intCast(count), textures.ptr);
    }
    ...
    pub fn GlBindSamplers(self: ?*anyopaque, first: u32, count: i32, samplers: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindSamplers(@ptrCast(self), @intCast(first), @intCast(count), samplers.ptr);
    }
    ...
    pub fn GlBindTextures(self: ?*anyopaque, first: u32, count: i32, textures: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindTextures(@ptrCast(self), @intCast(first), @intCast(count), textures.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glBindBuffersRange)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, first: u32, count: i32, buffers: []const u32, offsets: []const isize, sizes: []const isize ```
    pub fn GlBindBuffersRange(self: ?*anyopaque, target: u32, first: u32, count: i32, buffers: []const u32, offsets: []const isize, sizes: []const isize) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindBuffersRange(@ptrCast(self), @intCast(target), @intCast(first), @intCast(count), buffers.ptr, offsets.ptr, sizes.ptr);
    }
    ...
    pub fn GlBindBuffersBase(self: ?*anyopaque, target: u32, first: u32, count: i32, buffers: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBindBuffersBase(@ptrCast(self), @intCast(target), @intCast(first), @intCast(count), buffers.ptr);
    }
    ...
    pub fn GlClearTexSubImage(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, typeVal: u32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearTexSubImage(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(format), @intCast(typeVal), @ptrCast(data));
    }
    ...
    pub fn GlClearTexImage(self: ?*anyopaque, texture: u32, level: i32, format: u32, typeVal: u32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearTexImage(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(format), @intCast(typeVal), @ptrCast(data));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glBufferStorage)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, target: u32, size: isize, data: ?*anyopaque, flags: u32 ```
    pub fn GlBufferStorage(self: ?*anyopaque, target: u32, size: isize, data: ?*anyopaque, flags: u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlBufferStorage(@ptrCast(self), @intCast(target), @intCast(size), @ptrCast(data), @intCast(flags));
    }
    ...
    pub fn GlReadnPixels(self: ?*anyopaque, x: i32, y: i32, width: i32, height: i32, format: u32, typeVal: u32, bufSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlReadnPixels(@ptrCast(self), @intCast(x), @intCast(y), @intCast(width), @intCast(height), @intCast(format), @intCast(typeVal), @intCast(bufSize), @ptrCast(data));
    }
    ...
    pub fn GlGetnUniformuiv(self: ?*anyopaque, program: u32, location: i32, bufSize: i32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetnUniformuiv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(bufSize), params.ptr);
    }
    ...
    pub fn GlGetnUniformiv(self: ?*anyopaque, program: u32, location: i32, bufSize: i32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetnUniformiv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(bufSize), params.ptr);
    }
    ...
    pub fn GlGetnUniformfv(self: ?*anyopaque, program: u32, location: i32, bufSize: i32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetnUniformfv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(bufSize), params.ptr);
    }
    ...
    pub fn GlGetnUniformdv(self: ?*anyopaque, program: u32, location: i32, bufSize: i32, params: []f64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetnUniformdv(@ptrCast(self), @intCast(program), @intCast(location), @intCast(bufSize), params.ptr);
    }
    ...
    pub fn GlGetnTexImage(self: ?*anyopaque, target: u32, level: i32, format: u32, typeVal: u32, bufSize: i32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetnTexImage(@ptrCast(self), @intCast(target), @intCast(level), @intCast(format), @intCast(typeVal), @intCast(bufSize), @ptrCast(pixels));
    }
    ...
    pub fn GlGetnCompressedTexImage(self: ?*anyopaque, target: u32, lod: i32, bufSize: i32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetnCompressedTexImage(@ptrCast(self), @intCast(target), @intCast(lod), @intCast(bufSize), @ptrCast(pixels));
    }
    ...
    pub fn GlGetCompressedTextureSubImage(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, bufSize: i32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetCompressedTextureSubImage(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(bufSize), @ptrCast(pixels));
    }
    ...
    pub fn GlGetTextureSubImage(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, typeVal: u32, bufSize: i32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureSubImage(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(format), @intCast(typeVal), @intCast(bufSize), @ptrCast(pixels));
    }
    ...
    pub fn GlCreateQueries(self: ?*anyopaque, target: u32, n: i32, ids: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateQueries(@ptrCast(self), @intCast(target), @intCast(n), ids.ptr);
    }
    ...
    pub fn GlCreateProgramPipelines(self: ?*anyopaque, n: i32, pipelines: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateProgramPipelines(@ptrCast(self), @intCast(n), pipelines.ptr);
    }
    ...
    pub fn GlCreateSamplers(self: ?*anyopaque, n: i32, samplers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateSamplers(@ptrCast(self), @intCast(n), samplers.ptr);
    }
    ...
    pub fn GlGetVertexArrayIndexed64iv(self: ?*anyopaque, vaobj: u32, index: u32, pname: u32, param: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexArrayIndexed64iv(@ptrCast(self), @intCast(vaobj), @intCast(index), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlGetVertexArrayIndexediv(self: ?*anyopaque, vaobj: u32, index: u32, pname: u32, param: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexArrayIndexediv(@ptrCast(self), @intCast(vaobj), @intCast(index), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlGetVertexArrayiv(self: ?*anyopaque, vaobj: u32, pname: u32, param: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetVertexArrayiv(@ptrCast(self), @intCast(vaobj), @intCast(pname), param.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, vaobj: u32, first: u32, count: i32, buffers: []const u32, offsets: []const isize, strides: []const i32 ```
    pub fn GlVertexArrayVertexBuffers(self: ?*anyopaque, vaobj: u32, first: u32, count: i32, buffers: []const u32, offsets: []const isize, strides: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlVertexArrayVertexBuffers(@ptrCast(self), @intCast(vaobj), @intCast(first), @intCast(count), buffers.ptr, offsets.ptr, strides.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glVertexArrayVertexBuffer)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, vaobj: u32, bindingindex: u32, buffer: u32, offset: isize, stride: i32 ```
    ...
    pub fn GlCreateVertexArrays(self: ?*anyopaque, n: i32, arrays: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateVertexArrays(@ptrCast(self), @intCast(n), arrays.ptr);
    }
    ...
    pub fn GlGetTextureParameteriv(self: ?*anyopaque, texture: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureParameteriv(@ptrCast(self), @intCast(texture), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTextureParameterIuiv(self: ?*anyopaque, texture: u32, pname: u32, params: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureParameterIuiv(@ptrCast(self), @intCast(texture), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTextureParameterIiv(self: ?*anyopaque, texture: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureParameterIiv(@ptrCast(self), @intCast(texture), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTextureParameterfv(self: ?*anyopaque, texture: u32, pname: u32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureParameterfv(@ptrCast(self), @intCast(texture), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTextureLevelParameteriv(self: ?*anyopaque, texture: u32, level: i32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureLevelParameteriv(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetTextureLevelParameterfv(self: ?*anyopaque, texture: u32, level: i32, pname: u32, params: []f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureLevelParameterfv(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetCompressedTextureImage(self: ?*anyopaque, texture: u32, level: i32, bufSize: i32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetCompressedTextureImage(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(bufSize), @ptrCast(pixels));
    }
    ...
    pub fn GlGetTextureImage(self: ?*anyopaque, texture: u32, level: i32, format: u32, typeVal: u32, bufSize: i32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTextureImage(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(format), @intCast(typeVal), @intCast(bufSize), @ptrCast(pixels));
    }
    ...
    pub fn GlTextureParameteriv(self: ?*anyopaque, texture: u32, pname: u32, param: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureParameteriv(@ptrCast(self), @intCast(texture), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlTextureParameterIuiv(self: ?*anyopaque, texture: u32, pname: u32, params: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureParameterIuiv(@ptrCast(self), @intCast(texture), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlTextureParameterIiv(self: ?*anyopaque, texture: u32, pname: u32, params: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureParameterIiv(@ptrCast(self), @intCast(texture), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlTextureParameterfv(self: ?*anyopaque, texture: u32, pname: u32, param: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureParameterfv(@ptrCast(self), @intCast(texture), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlTextureParameterf(self: ?*anyopaque, texture: u32, pname: u32, param: f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureParameterf(@ptrCast(self), @intCast(texture), @intCast(pname), @floatCast(param));
    }
    ...
    pub fn GlCompressedTextureSubImage3D(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTextureSubImage3D(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(format), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTextureSubImage2D(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: u32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTextureSubImage2D(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(width), @intCast(height), @intCast(format), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlCompressedTextureSubImage1D(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, width: i32, format: u32, imageSize: i32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCompressedTextureSubImage1D(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(width), @intCast(format), @intCast(imageSize), @ptrCast(data));
    }
    ...
    pub fn GlTextureSubImage3D(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, zoffset: i32, width: i32, height: i32, depth: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureSubImage3D(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(zoffset), @intCast(width), @intCast(height), @intCast(depth), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlTextureSubImage2D(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, yoffset: i32, width: i32, height: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureSubImage2D(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(yoffset), @intCast(width), @intCast(height), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    pub fn GlTextureSubImage1D(self: ?*anyopaque, texture: u32, level: i32, xoffset: i32, width: i32, format: u32, typeVal: u32, pixels: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlTextureSubImage1D(@ptrCast(self), @intCast(texture), @intCast(level), @intCast(xoffset), @intCast(width), @intCast(format), @intCast(typeVal), @ptrCast(pixels));
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, texture: u32, internalformat: u32, buffer: u32, offset: isize, size: i32 ```
    ...
    pub fn GlCreateTextures(self: ?*anyopaque, target: u32, n: i32, textures: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateTextures(@ptrCast(self), @intCast(target), @intCast(n), textures.ptr);
    }
    ...
    pub fn GlGetNamedRenderbufferParameteriv(self: ?*anyopaque, renderbuffer: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedRenderbufferParameteriv(@ptrCast(self), @intCast(renderbuffer), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlCreateRenderbuffers(self: ?*anyopaque, n: i32, renderbuffers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateRenderbuffers(@ptrCast(self), @intCast(n), renderbuffers.ptr);
    }
    ...
    pub fn GlGetNamedFramebufferAttachmentParameteriv(self: ?*anyopaque, framebuffer: u32, attachment: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedFramebufferAttachmentParameteriv(@ptrCast(self), @intCast(framebuffer), @intCast(attachment), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetNamedFramebufferParameteriv(self: ?*anyopaque, framebuffer: u32, pname: u32, param: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedFramebufferParameteriv(@ptrCast(self), @intCast(framebuffer), @intCast(pname), param.ptr);
    }
    ...
    pub fn GlClearNamedFramebufferfi(self: ?*anyopaque, framebuffer: u32, buffer: u32, depth: f32, stencil: i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearNamedFramebufferfi(@ptrCast(self), @intCast(framebuffer), @intCast(buffer), @floatCast(depth), @intCast(stencil));
    }
    ...
    pub fn GlClearNamedFramebufferfv(self: ?*anyopaque, framebuffer: u32, buffer: u32, drawbuffer: i32, value: []const f32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearNamedFramebufferfv(@ptrCast(self), @intCast(framebuffer), @intCast(buffer), @intCast(drawbuffer), value.ptr);
    }
    ...
    pub fn GlClearNamedFramebufferuiv(self: ?*anyopaque, framebuffer: u32, buffer: u32, drawbuffer: i32, value: []const u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearNamedFramebufferuiv(@ptrCast(self), @intCast(framebuffer), @intCast(buffer), @intCast(drawbuffer), value.ptr);
    }
    ...
    pub fn GlClearNamedFramebufferiv(self: ?*anyopaque, framebuffer: u32, buffer: u32, drawbuffer: i32, value: []const i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearNamedFramebufferiv(@ptrCast(self), @intCast(framebuffer), @intCast(buffer), @intCast(drawbuffer), value.ptr);
    }
    ...
    pub fn GlCreateFramebuffers(self: ?*anyopaque, n: i32, framebuffers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateFramebuffers(@ptrCast(self), @intCast(n), framebuffers.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glGetNamedBufferSubData)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, buffer: u32, offset: isize, size: isize, data: ?*anyopaque ```
    pub fn GlGetNamedBufferSubData(self: ?*anyopaque, buffer: u32, offset: isize, size: isize, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedBufferSubData(@ptrCast(self), @intCast(buffer), @intCast(offset), @intCast(size), @ptrCast(data));
    }
    ...
    pub fn GlGetNamedBufferPointerv(self: ?*anyopaque, buffer: u32, pname: u32, params: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedBufferPointerv(@ptrCast(self), @intCast(buffer), @intCast(pname), @ptrCast(@alignCast(params)));
    }
    ...
    pub fn GlGetNamedBufferParameteri64v(self: ?*anyopaque, buffer: u32, pname: u32, params: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedBufferParameteri64v(@ptrCast(self), @intCast(buffer), @intCast(pname), params.ptr);
    }
    ...
    pub fn GlGetNamedBufferParameteriv(self: ?*anyopaque, buffer: u32, pname: u32, params: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetNamedBufferParameteriv(@ptrCast(self), @intCast(buffer), @intCast(pname), params.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, buffer: u32, offset: isize, length: isize, access: u32 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, buffer: u32, internalformat: u32, offset: isize, size: isize, format: u32, typeVal: u32, data: ?*anyopaque ```
    pub fn GlClearNamedBufferSubData(self: ?*anyopaque, buffer: u32, internalformat: u32, offset: isize, size: isize, format: u32, typeVal: u32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearNamedBufferSubData(@ptrCast(self), @intCast(buffer), @intCast(internalformat), @intCast(offset), @intCast(size), @intCast(format), @intCast(typeVal), @ptrCast(data));
    }
    ...
    pub fn GlClearNamedBufferData(self: ?*anyopaque, buffer: u32, internalformat: u32, format: u32, typeVal: u32, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlClearNamedBufferData(@ptrCast(self), @intCast(buffer), @intCast(internalformat), @intCast(format), @intCast(typeVal), @ptrCast(data));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glCopyNamedBufferSubData)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, readBuffer: u32, writeBuffer: u32, readOffset: isize, writeOffset: isize, size: isize ```
    ...
    pub fn GlNamedBufferSubData(self: ?*anyopaque, buffer: u32, offset: isize, size: isize, data: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_5_Core_GlNamedBufferSubData(@ptrCast(self), @intCast(buffer), @intCast(offset), @intCast(size), @ptrCast(data));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glNamedBufferData)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, buffer: u32, size: isize, data: ?*anyopaque, usage: u32 ```
    pub fn GlNamedBufferData(self: ?*anyopaque, buffer: u32, size: isize, data: ?*anyopaque, usage: u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlNamedBufferData(@ptrCast(self), @intCast(buffer), @intCast(size), @ptrCast(data), @intCast(usage));
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glNamedBufferStorage)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, buffer: u32, size: isize, data: ?*anyopaque, flags: u32 ```
    pub fn GlNamedBufferStorage(self: ?*anyopaque, buffer: u32, size: isize, data: ?*anyopaque, flags: u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlNamedBufferStorage(@ptrCast(self), @intCast(buffer), @intCast(size), @ptrCast(data), @intCast(flags));
    }
    ...
    pub fn GlCreateBuffers(self: ?*anyopaque, n: i32, buffers: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateBuffers(@ptrCast(self), @intCast(n), buffers.ptr);
    }
    ...
    pub fn GlGetTransformFeedbacki64V(self: ?*anyopaque, xfb: u32, pname: u32, index: u32, param: []i64) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTransformFeedbacki64V(@ptrCast(self), @intCast(xfb), @intCast(pname), @intCast(index), param.ptr);
    }
    ...
    pub fn GlGetTransformFeedbackiV(self: ?*anyopaque, xfb: u32, pname: u32, index: u32, param: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTransformFeedbackiV(@ptrCast(self), @intCast(xfb), @intCast(pname), @intCast(index), param.ptr);
    }
    ...
    pub fn GlGetTransformFeedbackiv(self: ?*anyopaque, xfb: u32, pname: u32, param: []i32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlGetTransformFeedbackiv(@ptrCast(self), @intCast(xfb), @intCast(pname), param.ptr);
    }

    /// [Upstream resources](https://doc.qt.io/qt-6/qopenglfunctions-4-5-core.html#glTransformFeedbackBufferRange)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_5_Core, xfb: u32, index: u32, buffer: u32, offset: isize, size: isize ```
    ...
    pub fn GlCreateTransformFeedbacks(self: ?*anyopaque, n: i32, ids: []u32) void {
        qtc.QOpenGLFunctions_4_5_Core_GlCreateTransformFeedbacks(@ptrCast(self), @intCast(n), ids.ptr);
    }
