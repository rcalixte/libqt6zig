...
pub const qopenglfunctions_4_1_core = struct {
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, target: u32, offset: isize, size: isize, data: *void ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, target: u32, size: isize, data: *void, usage: u32 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, shader: u32, bufSize: i32, length: []i32, source: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, shader: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, index: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, target: u32, offset: isize, length: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, target: u32, offset: isize, length: isize, access: u32 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, color: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, target: u32, index: u32, buffer: u32, offset: isize, size: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, readTarget: u32, writeTarget: u32, readOffset: isize, writeOffset: isize, size: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, uniformBlockIndex: u32, bufSize: i32, length: []i32, uniformBlockName: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, uniformBlockName: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, uniformIndex: u32, bufSize: i32, length: []i32, uniformName: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, colorNumber: u32, index: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, program: u32, shadertype: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_1_Core, pipeline: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    ...
    pub fn GlShaderBinary(self: ?*anyopaque, count: i32, shaders: []const u32, binaryformat: u32, binary: *const void, length: i32) void {
        qtc.QOpenGLFunctions_4_1_Core_GlShaderBinary(@ptrCast(self), @intCast(count), shaders.ptr, @intCast(binaryformat), binary, @intCast(length));
    }
