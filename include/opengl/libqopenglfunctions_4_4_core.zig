...
pub const QOpenGLFunctions_4_4_Core = extern struct {
    ...
    /// ` length: []const i32 `
    ///
    pub fn GlShaderSource(self: QOpenGLFunctions_4_4_Core, allocator: std.mem.Allocator, shader: u32, count: i32, stringVal: []const [:0]const u8, length: []const i32) void {
        ...
        qtc.QOpenGLFunctions_4_4_Core_GlShaderSource(@ptrCast(self.ptr), @bitCast(shader), @bitCast(count), stringVal_chararr.ptr, length.ptr);
    }
    ...
    pub fn GlTransformFeedbackVaryings(self: QOpenGLFunctions_4_4_Core, allocator: std.mem.Allocator, program: u32, count: i32, varyings: []const [:0]const u8, bufferMode: u32) void {
        ...
        qtc.QOpenGLFunctions_4_4_Core_GlTransformFeedbackVaryings(@ptrCast(self.ptr), @bitCast(program), @bitCast(count), varyings_chararr.ptr, @bitCast(bufferMode));
    }
    ...
    pub fn GlGetUniformIndices(self: QOpenGLFunctions_4_4_Core, allocator: std.mem.Allocator, program: u32, uniformCount: i32, uniformNames: []const [:0]const u8, uniformIndices: []u32) void {
        ...
        qtc.QOpenGLFunctions_4_4_Core_GlGetUniformIndices(@ptrCast(self.ptr), @bitCast(program), @bitCast(uniformCount), uniformNames_chararr.ptr, uniformIndices.ptr);
    }
    ...
    pub fn GlCreateShaderProgramv(self: QOpenGLFunctions_4_4_Core, allocator: std.mem.Allocator, typeVal: u32, count: i32, strings: []const [:0]const u8) u32 {
        ...
        return qtc.QOpenGLFunctions_4_4_Core_GlCreateShaderProgramv(@ptrCast(self.ptr), @bitCast(typeVal), @bitCast(count), strings_chararr.ptr);
    }
