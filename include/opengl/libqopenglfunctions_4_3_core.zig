...
pub const qopenglfunctions_4_3_core = struct {
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, offset: isize, size: isize, data: *void ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, size: isize, data: *void, usage: u32 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, name: []const u8 ```
    pub fn GlGetUniformLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetUniformLocation(@ptrCast(self), @intCast(program), name.ptr);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qopenglfunctions-4-3-core.html#glGetShaderSource)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, shader: u32, bufSize: i32, length: []i32, source: []u8 ```
    pub fn GlGetShaderSource(self: ?*anyopaque, shader: u32, bufSize: i32, length: []i32, source: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetShaderSource(@ptrCast(self), @intCast(shader), @intCast(bufSize), length.ptr, source.ptr);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qopenglfunctions-4-3-core.html#glGetShaderInfoLog)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, shader: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    pub fn GlGetShaderInfoLog(self: ?*anyopaque, shader: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetShaderInfoLog(@ptrCast(self), @intCast(shader), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    pub fn GlGetProgramInfoLog(self: ?*anyopaque, program: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetProgramInfoLog(@ptrCast(self), @intCast(program), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlGetAttribLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetAttribLocation(@ptrCast(self), @intCast(program), name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, index: u32, name: []const u8 ```
    pub fn GlBindAttribLocation(self: ?*anyopaque, program: u32, index: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlBindAttribLocation(@ptrCast(self), @intCast(program), @intCast(index), name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, offset: isize, length: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, offset: isize, length: isize, access: u32 ```
    ...
    pub fn GlGetFragDataLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetFragDataLocation(@ptrCast(self), @intCast(program), name.ptr);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qopenglfunctions-4-3-core.html#glBindFragDataLocation)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, color: u32, name: []const u8 ```
    pub fn GlBindFragDataLocation(self: ?*anyopaque, program: u32, color: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlBindFragDataLocation(@ptrCast(self), @intCast(program), @intCast(color), name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, index: u32, buffer: u32, offset: isize, size: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, readTarget: u32, writeTarget: u32, readOffset: isize, writeOffset: isize, size: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, uniformBlockIndex: u32, bufSize: i32, length: []i32, uniformBlockName: []u8 ```
    pub fn GlGetActiveUniformBlockName(self: ?*anyopaque, program: u32, uniformBlockIndex: u32, bufSize: i32, length: []i32, uniformBlockName: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetActiveUniformBlockName(@ptrCast(self), @intCast(program), @intCast(uniformBlockIndex), @intCast(bufSize), length.ptr, uniformBlockName.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, uniformBlockName: []const u8 ```
    pub fn GlGetUniformBlockIndex(self: ?*anyopaque, program: u32, uniformBlockName: []const u8) u32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetUniformBlockIndex(@ptrCast(self), @intCast(program), uniformBlockName.ptr);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qopenglfunctions-4-3-core.html#glGetActiveUniformName)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, uniformIndex: u32, bufSize: i32, length: []i32, uniformName: []u8 ```
    pub fn GlGetActiveUniformName(self: ?*anyopaque, program: u32, uniformIndex: u32, bufSize: i32, length: []i32, uniformName: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetActiveUniformName(@ptrCast(self), @intCast(program), @intCast(uniformIndex), @intCast(bufSize), length.ptr, uniformName.ptr);
    }
    ...
    pub fn GlGetFragDataIndex(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetFragDataIndex(@ptrCast(self), @intCast(program), name.ptr);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qopenglfunctions-4-3-core.html#glBindFragDataLocationIndexed)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, colorNumber: u32, index: u32, name: []const u8 ```
    pub fn GlBindFragDataLocationIndexed(self: ?*anyopaque, program: u32, colorNumber: u32, index: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlBindFragDataLocationIndexed(@ptrCast(self), @intCast(program), @intCast(colorNumber), @intCast(index), name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8 ```
    pub fn GlGetActiveSubroutineName(self: ?*anyopaque, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetActiveSubroutineName(@ptrCast(self), @intCast(program), @intCast(shadertype), @intCast(index), @intCast(bufsize), length.ptr, name.ptr);
    }
    ...
    pub fn GlGetActiveSubroutineUniformName(self: ?*anyopaque, program: u32, shadertype: u32, index: u32, bufsize: i32, length: []i32, name: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetActiveSubroutineUniformName(@ptrCast(self), @intCast(program), @intCast(shadertype), @intCast(index), @intCast(bufsize), length.ptr, name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, shadertype: u32, name: []const u8 ```
    pub fn GlGetSubroutineIndex(self: ?*anyopaque, program: u32, shadertype: u32, name: []const u8) u32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetSubroutineIndex(@ptrCast(self), @intCast(program), @intCast(shadertype), name.ptr);
    }
    ...
    pub fn GlGetSubroutineUniformLocation(self: ?*anyopaque, program: u32, shadertype: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetSubroutineUniformLocation(@ptrCast(self), @intCast(program), @intCast(shadertype), name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, pipeline: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    pub fn GlGetProgramPipelineInfoLog(self: ?*anyopaque, pipeline: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetProgramPipelineInfoLog(@ptrCast(self), @intCast(pipeline), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlShaderBinary(self: ?*anyopaque, count: i32, shaders: []const u32, binaryformat: u32, binary: *const void, length: i32) void {
        qtc.QOpenGLFunctions_4_3_Core_GlShaderBinary(@ptrCast(self), @intCast(count), shaders.ptr, @intCast(binaryformat), binary, @intCast(length));
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, internalformat: u32, buffer: u32, offset: isize, size: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, programInterface: u32, name: []const u8 ```
    pub fn GlGetProgramResourceLocationIndex(self: ?*anyopaque, program: u32, programInterface: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetProgramResourceLocationIndex(@ptrCast(self), @intCast(program), @intCast(programInterface), name.ptr);
    }
    ...
    pub fn GlGetProgramResourceLocation(self: ?*anyopaque, program: u32, programInterface: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetProgramResourceLocation(@ptrCast(self), @intCast(program), @intCast(programInterface), name.ptr);
    }

    /// [Qt documentation](https://doc.qt.io/qt-6/qopenglfunctions-4-3-core.html#glGetProgramResourceName)
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, program: u32, programInterface: u32, index: u32, bufSize: i32, length: []i32, name: []u8 ```
    pub fn GlGetProgramResourceName(self: ?*anyopaque, program: u32, programInterface: u32, index: u32, bufSize: i32, length: []i32, name: []u8) void {
        qtc.QOpenGLFunctions_4_3_Core_GlGetProgramResourceName(@ptrCast(self), @intCast(program), @intCast(programInterface), @intCast(index), @intCast(bufSize), length.ptr, name.ptr);
    }
    ...
    pub fn GlGetProgramResourceIndex(self: ?*anyopaque, program: u32, programInterface: u32, name: []const u8) u32 {
        return qtc.QOpenGLFunctions_4_3_Core_GlGetProgramResourceIndex(@ptrCast(self), @intCast(program), @intCast(programInterface), name.ptr);
    }
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, buffer: u32, offset: isize, length: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, bindingindex: u32, buffer: u32, offset: isize, stride: i32 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, indirect: isize ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_4_3_Core, target: u32, internalformat: u32, offset: isize, size: isize, format: u32, typeVal: u32, data: ?*anyopaque ```
