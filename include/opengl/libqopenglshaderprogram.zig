...
pub const qopenglshader = struct {
    ...
    /// ` self: QtC.QOpenGLShader `
    ///
    /// ` callback: *const fn (self: QtC.QOpenGLShaderparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QOpenGLShader `
    ///
    /// ` callback: *const fn (self: QtC.QOpenGLShaderobjectName: [*:0]const u8) callconv(.c) void `
    ///
...
pub const qopenglshaderprogram = struct {
    ...
    /// ` self: QtC.QOpenGLShaderProgram `
    ///
    /// ` callback: *const fn (self: QtC.QOpenGLShaderProgramparam1: QtC.QObject) callconv(.c) void `
    ///
    pub fn OnDestroyed1(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QObject_Connect_Destroyed1(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.QOpenGLShaderProgram `
    ///
    /// ` callback: *const fn (self: QtC.QOpenGLShaderProgramobjectName: [*:0]const u8) callconv(.c) void `
    ///
    pub fn OnObjectNameChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) void) void {
        qtc.QObject_Connect_ObjectNameChanged(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
