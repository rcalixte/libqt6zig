...
pub const QOpenGLFunctions_1_1 = extern struct {
    ...
    /// Allocate a new QOpenGLFunctions_1_1 object in C++ memory
    ///
    ...
    /// ` values: []u16 `
    ///
    pub fn glGetPixelMapusv(self: QOpenGLFunctions_1_1, map: u32, values: []u16) void {
        qtc.QOpenGLFunctions_1_1_GlGetPixelMapusv(@ptrCast(self.ptr), @bitCast(map), values.ptr);
    }
    ...
    /// ` values: []u32 `
    ///
    pub fn glGetPixelMapuiv(self: QOpenGLFunctions_1_1, map: u32, values: []u32) void {
        qtc.QOpenGLFunctions_1_1_GlGetPixelMapuiv(@ptrCast(self.ptr), @bitCast(map), values.ptr);
    }
    ...
    /// ` values: []f32 `
    ///
    pub fn glGetPixelMapfv(self: QOpenGLFunctions_1_1, map: u32, values: []f32) void {
        qtc.QOpenGLFunctions_1_1_GlGetPixelMapfv(@ptrCast(self.ptr), @bitCast(map), values.ptr);
    }
    ...
    /// ` values: []const u16 `
    ///
    pub fn glPixelMapusv(self: QOpenGLFunctions_1_1, map: u32, mapsize: i32, values: []const u16) void {
        qtc.QOpenGLFunctions_1_1_GlPixelMapusv(@ptrCast(self.ptr), @bitCast(map), @bitCast(mapsize), values.ptr);
    }
    ...
    /// ` values: []const u32 `
    ///
    pub fn glPixelMapuiv(self: QOpenGLFunctions_1_1, map: u32, mapsize: i32, values: []const u32) void {
        qtc.QOpenGLFunctions_1_1_GlPixelMapuiv(@ptrCast(self.ptr), @bitCast(map), @bitCast(mapsize), values.ptr);
    }
    ...
    /// ` values: []const f32 `
    ///
    pub fn glPixelMapfv(self: QOpenGLFunctions_1_1, map: u32, mapsize: i32, values: []const f32) void {
        qtc.QOpenGLFunctions_1_1_GlPixelMapfv(@ptrCast(self.ptr), @bitCast(map), @bitCast(mapsize), values.ptr);
    }
