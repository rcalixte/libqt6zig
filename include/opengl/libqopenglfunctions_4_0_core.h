#pragma once
#ifndef OPENGL_LIBQOPENGLFUNCTIONS_4_0_CORE_H
#define OPENGL_LIBQOPENGLFUNCTIONS_4_0_CORE_H
...
void QOpenGLFunctions_4_0_Core_GlShaderSource(QOpenGLFunctions_4_0_Core* self, uint32_t shader, int32_t count, const GLchar** string, const int32_t* length);
