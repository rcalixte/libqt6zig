...
pub const signon__authsession = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.SignOn__AuthSession_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Name(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.SignOn__AuthSession_Name(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` sessionData: QtC.SignOn__SessionData `
    ///
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` params: QtC.SignOn__SessionData `
    ///
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` callback: *const fn (self: QtC.SignOn__AuthSession, err: QtC.SignOn__Error) callconv(.c) void `
    ///
    pub fn OnError(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.SignOn__AuthSession_Connect_Error(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnMechanismsAvailable(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?[*:null]?[*:0]const u8) callconv(.c) void) void {
        qtc.SignOn__AuthSession_Connect_MechanismsAvailable(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` callback: *const fn (self: QtC.SignOn__AuthSession, sessionData: QtC.SignOn__SessionData) callconv(.c) void `
    ///
    pub fn OnResponse(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.SignOn__AuthSession_Connect_Response(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn StateChanged(self: ?*anyopaque, state: i32, message: []const u8) void {
        ...
        qtc.SignOn__AuthSession_StateChanged(@ptrCast(self), @bitCast(state), message_str);
    }
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` callback: *const fn (self: QtC.SignOn__AuthSession, state: authsession_enums.AuthSessionState, message: [*:0]const u8) callconv(.c) void `
    ///
    pub fn OnStateChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, [*:0]const u8) callconv(.c) void) void {
        qtc.SignOn__AuthSession_Connect_StateChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("signon__authsession.Children: Memory allocation failed");
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` callback: *const fn (self: QtC.SignOn__AuthSession) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` callback: *const fn (self: QtC.SignOn__AuthSession, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.SignOn__AuthSession `
    ///
    /// ` callback: *const fn (self: QtC.SignOn__AuthSession, objectName: [*:0]const u8) callconv(.c) void `
    ///
