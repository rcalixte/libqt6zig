...
pub const qvideoframeinput = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QVideoFrameInput_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QVideoFrameInput_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QVideoFrameInput `
    ///
    /// ` callback: *const fn (self: QtC.QVideoFrameInputparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QVideoFrameInput `
    ///
    /// ` callback: *const fn (self: QtC.QVideoFrameInputobjectName: [*:0]const u8) callconv(.c) void `
    ///
