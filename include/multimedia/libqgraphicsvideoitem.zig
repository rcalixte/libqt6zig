...
pub const QGraphicsVideoItem = extern struct {
    ...
    pub fn new2(_parent: anytype) QGraphicsVideoItem {
        ...
        return .{ .ptr = qtc.QGraphicsVideoItem_new2(@ptrCast(_parent_.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QGraphicsVideoItem_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QGraphicsVideoItem_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QGraphicsVideoItem_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn collidesWithItem(self: QGraphicsVideoItem, other: anytype, mode: i32) bool {
        comptime _ = @TypeOf(other)._is_QGraphicsItem;
        const other_ = if (@hasDecl(@TypeOf(other), "asQGraphicsItem")) other.asQGraphicsItem() else other;
        return qtc.QGraphicsVideoItem_CollidesWithItem(@ptrCast(self.ptr), @ptrCast(other_.ptr), @bitCast(mode));
    }
    ...
    pub fn superCollidesWithItem(self: QGraphicsVideoItem, other: anytype, mode: i32) bool {
        comptime _ = @TypeOf(other)._is_QGraphicsItem;
        const other_ = if (@hasDecl(@TypeOf(other), "asQGraphicsItem")) other.asQGraphicsItem() else other;
        return qtc.QGraphicsVideoItem_SuperCollidesWithItem(@ptrCast(self.ptr), @ptrCast(other_.ptr), @bitCast(mode));
    }
    ...
    pub fn isObscuredBy(self: QGraphicsVideoItem, item: anytype) bool {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        return qtc.QGraphicsVideoItem_IsObscuredBy(@ptrCast(self.ptr), @ptrCast(item_.ptr));
    }
    ...
    pub fn superIsObscuredBy(self: QGraphicsVideoItem, item: anytype) bool {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        return qtc.QGraphicsVideoItem_SuperIsObscuredBy(@ptrCast(self.ptr), @ptrCast(item_.ptr));
    }
    ...
    pub fn sceneEventFilter(self: QGraphicsVideoItem, watched: anytype, _event: anytype) bool {
        ...
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QGraphicsVideoItem_SceneEventFilter(@ptrCast(self.ptr), @ptrCast(watched_.ptr), @ptrCast(_event.ptr));
    }
    ...
    pub fn superSceneEventFilter(self: QGraphicsVideoItem, watched: anytype, _event: anytype) bool {
        ...
        const watched_ = if (@hasDecl(@TypeOf(watched), "asQGraphicsItem")) watched.asQGraphicsItem() else watched;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QGraphicsVideoItem_SuperSceneEventFilter(@ptrCast(self.ptr), @ptrCast(watched_.ptr), @ptrCast(_event.ptr));
    }
