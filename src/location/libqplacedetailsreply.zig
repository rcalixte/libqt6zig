...
pub const QPlaceDetailsReply = extern struct {
    ...
    /// ` parent: QObject `
    ///
    pub fn New2(parent: anytype) QPlaceDetailsReply {
        comptime _ = @TypeOf(parent)._is_QObject;
        return .{ .ptr = qtc.QPlaceDetailsReply_new2(@ptrCast(parent.ptr)) };
    }
    ...
    ///
    pub fn Type(self: QPlaceDetailsReply) i32 {
    ...
    /// ` place: QPlace `
    ///
    pub fn SetPlace(self: QPlaceDetailsReply, place: anytype) void {
        comptime _ = @TypeOf(place)._is_QPlace;
        qtc.QPlaceDetailsReply_SetPlace(@ptrCast(self.ptr), @ptrCast(place.ptr));
    }
    ...
    ///
    pub const QBaseSetPlace = SuperSetPlace;
    ...
    /// ` place: QPlace `
    ///
    pub fn SuperSetPlace(self: QPlaceDetailsReply, place: anytype) void {
        comptime _ = @TypeOf(place)._is_QPlace;
        qtc.QPlaceDetailsReply_SuperSetPlace(@ptrCast(self.ptr), @ptrCast(place.ptr));
    }
    ...
    ///
    pub fn Error(self: QPlaceDetailsReply) i32 {
    ...
    ///
    pub fn ErrorOccurred2(self: QPlaceDetailsReply, errorVal: i32, errorString: []const u8) void {
    ...
    /// ` thread: QThread `
    ///
    pub fn MoveToThread(self: QPlaceDetailsReply, thread: anytype) bool {
    ...
    /// ` parent: QObject `
    ///
    pub fn SetParent(self: QPlaceDetailsReply, parent: anytype) void {
        comptime _ = @TypeOf(parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn Connect3(self: QPlaceDetailsReply, sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn Connect4(self: QPlaceDetailsReply, sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` event: QEvent `
    ///
    pub fn Event(self: QPlaceDetailsReply, event: anytype) bool {
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.QPlaceDetailsReply_Event(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperEvent(self: QPlaceDetailsReply, event: anytype) bool {
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.QPlaceDetailsReply_SuperEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn EventFilter(self: QPlaceDetailsReply, watched: anytype, event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.QPlaceDetailsReply_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperEventFilter(self: QPlaceDetailsReply, watched: anytype, event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.QPlaceDetailsReply_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QTimerEvent `
    ///
    pub fn TimerEvent(self: QPlaceDetailsReply, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QTimerEvent;
        qtc.QPlaceDetailsReply_TimerEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QTimerEvent `
    ///
    pub fn SuperTimerEvent(self: QPlaceDetailsReply, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QTimerEvent;
        qtc.QPlaceDetailsReply_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QChildEvent `
    ///
    pub fn ChildEvent(self: QPlaceDetailsReply, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QChildEvent;
        qtc.QPlaceDetailsReply_ChildEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QChildEvent `
    ///
    pub fn SuperChildEvent(self: QPlaceDetailsReply, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QChildEvent;
        qtc.QPlaceDetailsReply_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn CustomEvent(self: QPlaceDetailsReply, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QEvent;
        qtc.QPlaceDetailsReply_CustomEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperCustomEvent(self: QPlaceDetailsReply, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QEvent;
        qtc.QPlaceDetailsReply_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` finished: bool `
    ///
    pub fn SetFinished(self: QPlaceDetailsReply, finished: bool) void {
        qtc.QPlaceDetailsReply_SetFinished(@ptrCast(self.ptr), finished);
    }
    ...
    /// ` finished: bool `
    ///
    pub fn SuperSetFinished(self: QPlaceDetailsReply, finished: bool) void {
        qtc.QPlaceDetailsReply_SuperSetFinished(@ptrCast(self.ptr), finished);
    }
    ...
    /// ` errorString: []const u8 `
    ///
    pub fn SetError(self: QPlaceDetailsReply, errorVal: i32, errorString: []const u8) void {
        const errorString_str = qtc.libqt_string{
            .len = errorString.len,
            .data = errorString.ptr,
        };
    ...
    /// ` errorString: []const u8 `
    ///
    pub fn SuperSetError(self: QPlaceDetailsReply, errorVal: i32, errorString: []const u8) void {
        const errorString_str = qtc.libqt_string{
            .len = errorString.len,
            .data = errorString.ptr,
        };
