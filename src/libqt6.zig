...
pub const types = struct {
    ...
    pub const ArrayMap_i32_SignOnAuthServiceIdentityRegExp = std.array_hash_map.Auto(i32, SignOn__AuthService__IdentityRegExp);
    ...
    pub const ArrayMap_i32_constu8 = std.array_hash_map.Auto(i32, []const u8);
...
pub const AbstractKirigamiApplication = @import("extras-kirigami/libabstractkirigamiapplication.zig").AbstractKirigamiApplication;
...
pub const KFuzzyMatcher = @import("extras-kcoreaddons/libkfuzzymatcher.zig").KFuzzyMatcher;
...
pub const KLocalization = @import("extras-ki18n/libklocalizedqmlcontext.zig").KLocalization;
...
pub const KQuickIconProvider = @import("extras-kiconthemes/libkquickiconprovider.zig").KQuickIconProvider;
...
pub const KSyntaxHighlighting__WildcardMatcher = @import("extras-ksyntaxhighlighting/libwildcardmatcher.zig").KSyntaxHighlighting__WildcardMatcher;
...
pub const KirigamiActionCollection = @import("extras-kirigami/libkirigamiactioncollection.zig").KirigamiActionCollection;
pub const Kirigami__Platform__IconSizes = @import("extras-kirigami/libunits.zig").Kirigami__Platform__IconSizes;
pub const Kirigami__Platform__PlatformPluginFactory = @import("extras-kirigami/libplatformpluginfactory.zig").Kirigami__Platform__PlatformPluginFactory;
pub const Kirigami__Platform__PlatformTheme = @import("extras-kirigami/libplatformtheme.zig").Kirigami__Platform__PlatformTheme;
pub const Kirigami__Platform__PlatformThemeChangeTracker = @import("extras-kirigami/libplatformtheme.zig").Kirigami__Platform__PlatformThemeChangeTracker;
pub const Kirigami__Platform__StyleSelector = @import("extras-kirigami/libstyleselector.zig").Kirigami__Platform__StyleSelector;
pub const Kirigami__Platform__TabletModeChangedEvent = @import("extras-kirigami/libtabletmodewatcher.zig").Kirigami__Platform__TabletModeChangedEvent;
pub const Kirigami__Platform__TabletModeWatcher = @import("extras-kirigami/libtabletmodewatcher.zig").Kirigami__Platform__TabletModeWatcher;
pub const Kirigami__Platform__Units = @import("extras-kirigami/libunits.zig").Kirigami__Platform__Units;
pub const Kirigami__Platform__VirtualKeyboardWatcher = @import("extras-kirigami/libvirtualkeyboardwatcher.zig").Kirigami__Platform__VirtualKeyboardWatcher;
...
pub const QByteArray = @import("libqbytearray.zig").QByteArray;
...
pub const QByteArray__FromBase64Result = @import("libqbytearray.zig").QByteArray__FromBase64Result;
...
pub const QJSEngine = @import("qml/libqjsengine.zig").QJSEngine;
pub const QJSListForInIterator = @import("qml/libqjslist.zig").QJSListForInIterator;
pub const QJSListForOfIterator = @import("qml/libqjslist.zig").QJSListForOfIterator;
pub const QJSListIndexClamp = @import("qml/libqjslist.zig").QJSListIndexClamp;
pub const QJSManagedValue = @import("qml/libqjsmanagedvalue.zig").QJSManagedValue;
pub const QJSNumberCoercion = @import("qml/libqjsnumbercoercion.zig").QJSNumberCoercion;
pub const QJSPrimitiveNull = @import("qml/libqjsprimitivevalue.zig").QJSPrimitiveNull;
pub const QJSPrimitiveUndefined = @import("qml/libqjsprimitivevalue.zig").QJSPrimitiveUndefined;
pub const QJSPrimitiveValue = @import("qml/libqjsprimitivevalue.zig").QJSPrimitiveValue;
pub const QJSValue = @import("qml/libqjsvalue.zig").QJSValue;
pub const QJSValueIterator = @import("qml/libqjsvalueiterator.zig").QJSValueIterator;
...
pub const QPolygon = @import("libqpolygon.zig").QPolygon;
pub const QPolygonF = @import("libqpolygon.zig").QPolygonF;
...
pub const QQmlAbstractUrlInterceptor = @import("qml/libqqmlabstracturlinterceptor.zig").QQmlAbstractUrlInterceptor;
pub const QQmlApplicationEngine = @import("qml/libqqmlapplicationengine.zig").QQmlApplicationEngine;
pub const QQmlComponent = @import("qml/libqqmlcomponent.zig").QQmlComponent;
pub const QQmlContext = @import("qml/libqqmlcontext.zig").QQmlContext;
pub const QQmlContext__PropertyPair = @import("qml/libqqmlcontext.zig").QQmlContext__PropertyPair;
pub const QQmlDebuggingEnabler = @import("qml/libqqmldebug.zig").QQmlDebuggingEnabler;
pub const QQmlEngine = @import("qml/libqqmlengine.zig").QQmlEngine;
pub const QQmlEngineExtensionInterface = @import("qml/libqqmlextensioninterface.zig").QQmlEngineExtensionInterface;
pub const QQmlEngineExtensionPlugin = @import("qml/libqqmlextensionplugin.zig").QQmlEngineExtensionPlugin;
pub const QQmlError = @import("qml/libqqmlerror.zig").QQmlError;
pub const QQmlExpression = @import("qml/libqqmlexpression.zig").QQmlExpression;
pub const QQmlExtensionInterface = @import("qml/libqqmlextensioninterface.zig").QQmlExtensionInterface;
pub const QQmlExtensionPlugin = @import("qml/libqqmlextensionplugin.zig").QQmlExtensionPlugin;
pub const QQmlFile = @import("qml/libqqmlfile.zig").QQmlFile;
pub const QQmlFileSelector = @import("qml/libqqmlfileselector.zig").QQmlFileSelector;
pub const QQmlImageProviderBase = @import("qml/libqqmlengine.zig").QQmlImageProviderBase;
pub const QQmlIncubationController = @import("qml/libqqmlincubator.zig").QQmlIncubationController;
pub const QQmlIncubator = @import("qml/libqqmlincubator.zig").QQmlIncubator;
pub const QQmlInfo = @import("qml/libqqmlinfo.zig").QQmlInfo;
pub const QQmlListReference = @import("qml/libqqmllist.zig").QQmlListReference;
pub const QQmlModuleRegistration = @import("qml/libqqmlmoduleregistration.zig").QQmlModuleRegistration;
pub const QQmlNetworkAccessManagerFactory = @import("qml/libqqmlnetworkaccessmanagerfactory.zig").QQmlNetworkAccessManagerFactory;
pub const QQmlParserStatus = @import("qml/libqqmlparserstatus.zig").QQmlParserStatus;
pub const QQmlProperty = @import("qml/libqqmlproperty.zig").QQmlProperty;
pub const QQmlPropertyMap = @import("qml/libqqmlpropertymap.zig").QQmlPropertyMap;
pub const QQmlPropertyValueSource = @import("qml/libqqmlpropertyvaluesource.zig").QQmlPropertyValueSource;
pub const QQmlScriptString = @import("qml/libqqmlscriptstring.zig").QQmlScriptString;
pub const QQmlTypeNotAvailable = @import("qml/libqqml.zig").QQmlTypeNotAvailable;
pub const QQmlTypesExtensionInterface = @import("qml/libqqmlextensioninterface.zig").QQmlTypesExtensionInterface;
pub const QQuaternion = @import("libqquaternion.zig").QQuaternion;
pub const QQuickAsyncImageProvider = @import("quick/libqquickimageprovider.zig").QQuickAsyncImageProvider;
pub const QQuickAttachedPropertyPropagator = @import("quick/libqquickattachedpropertypropagator.zig").QQuickAttachedPropertyPropagator;
pub const QQuickFramebufferObject = @import("quick/libqquickframebufferobject.zig").QQuickFramebufferObject;
pub const QQuickFramebufferObject__Renderer = @import("quick/libqquickframebufferobject.zig").QQuickFramebufferObject__Renderer;
pub const QQuickGraphicsConfiguration = @import("quick/libqquickgraphicsconfiguration.zig").QQuickGraphicsConfiguration;
pub const QQuickGraphicsDevice = @import("quick/libqquickgraphicsdevice.zig").QQuickGraphicsDevice;
pub const QQuickImageProvider = @import("quick/libqquickimageprovider.zig").QQuickImageProvider;
pub const QQuickImageResponse = @import("quick/libqquickimageprovider.zig").QQuickImageResponse;
pub const QQuickItem = @import("quick/libqquickitem.zig").QQuickItem;
pub const QQuickItemGrabResult = @import("quick/libqquickitemgrabresult.zig").QQuickItemGrabResult;
pub const QQuickItem__ItemChangeData = @import("quick/libqquickitem.zig").QQuickItem__ItemChangeData;
pub const QQuickItem__UpdatePaintNodeData = @import("quick/libqquickitem.zig").QQuickItem__UpdatePaintNodeData;
pub const QQuickOpenGLUtils = @import("quick/libqquickopenglutils.zig").QQuickOpenGLUtils;
pub const QQuickPaintedItem = @import("quick/libqquickpainteditem.zig").QQuickPaintedItem;
pub const QQuickRenderControl = @import("quick/libqquickrendercontrol.zig").QQuickRenderControl;
pub const QQuickRenderTarget = @import("quick/libqquickrendertarget.zig").QQuickRenderTarget;
pub const QQuickRhiItem = @import("quick/libqquickrhiitem.zig").QQuickRhiItem;
pub const QQuickRhiItemRenderer = @import("quick/libqquickrhiitem.zig").QQuickRhiItemRenderer;
pub const QQuickStyle = @import("quick/libqquickstyle.zig").QQuickStyle;
pub const QQuickTextDocument = @import("quick/libqquicktextdocument.zig").QQuickTextDocument;
pub const QQuickTextureFactory = @import("quick/libqquickimageprovider.zig").QQuickTextureFactory;
pub const QQuickTransform = @import("quick/libqquickitem.zig").QQuickTransform;
pub const QQuickView = @import("quick/libqquickview.zig").QQuickView;
pub const QQuickWidget = @import("quick/libqquickwidget.zig").QQuickWidget;
pub const QQuickWindow = @import("quick/libqquickwindow.zig").QQuickWindow;
pub const QQuickWindow__GraphicsStateInfo = @import("quick/libqquickwindow.zig").QQuickWindow__GraphicsStateInfo;
...
pub const QSGBasicGeometryNode = @import("quick/libqsgnode.zig").QSGBasicGeometryNode;
pub const QSGClipNode = @import("quick/libqsgnode.zig").QSGClipNode;
pub const QSGDynamicTexture = @import("quick/libqsgtexture.zig").QSGDynamicTexture;
pub const QSGFlatColorMaterial = @import("quick/libqsgflatcolormaterial.zig").QSGFlatColorMaterial;
pub const QSGGeometry = @import("quick/libqsggeometry.zig").QSGGeometry;
pub const QSGGeometryNode = @import("quick/libqsgnode.zig").QSGGeometryNode;
pub const QSGGeometry__Attribute = @import("quick/libqsggeometry.zig").QSGGeometry__Attribute;
pub const QSGGeometry__AttributeSet = @import("quick/libqsggeometry.zig").QSGGeometry__AttributeSet;
pub const QSGGeometry__ColoredPoint2D = @import("quick/libqsggeometry.zig").QSGGeometry__ColoredPoint2D;
pub const QSGGeometry__Point2D = @import("quick/libqsggeometry.zig").QSGGeometry__Point2D;
pub const QSGGeometry__TexturedPoint2D = @import("quick/libqsggeometry.zig").QSGGeometry__TexturedPoint2D;
pub const QSGImageNode = @import("quick/libqsgimagenode.zig").QSGImageNode;
pub const QSGMaterial = @import("quick/libqsgmaterial.zig").QSGMaterial;
pub const QSGMaterialShader = @import("quick/libqsgmaterialshader.zig").QSGMaterialShader;
pub const QSGMaterialShader__GraphicsPipelineState = @import("quick/libqsgmaterialshader.zig").QSGMaterialShader__GraphicsPipelineState;
pub const QSGMaterialShader__RenderState = @import("quick/libqsgmaterialshader.zig").QSGMaterialShader__RenderState;
pub const QSGMaterialType = @import("quick/libqsgmaterialtype.zig").QSGMaterialType;
pub const QSGNinePatchNode = @import("quick/libqsgninepatchnode.zig").QSGNinePatchNode;
pub const QSGNode = @import("quick/libqsgnode.zig").QSGNode;
pub const QSGNodeVisitor = @import("quick/libqsgnode.zig").QSGNodeVisitor;
pub const QSGOpacityNode = @import("quick/libqsgnode.zig").QSGOpacityNode;
pub const QSGOpaqueTextureMaterial = @import("quick/libqsgtexturematerial.zig").QSGOpaqueTextureMaterial;
pub const QSGRectangleNode = @import("quick/libqsgrectanglenode.zig").QSGRectangleNode;
pub const QSGRenderNode = @import("quick/libqsgrendernode.zig").QSGRenderNode;
pub const QSGRenderNode__RenderState = @import("quick/libqsgrendernode.zig").QSGRenderNode__RenderState;
pub const QSGRendererInterface = @import("quick/libqsgrendererinterface.zig").QSGRendererInterface;
pub const QSGRootNode = @import("quick/libqsgnode.zig").QSGRootNode;
pub const QSGSimpleRectNode = @import("quick/libqsgsimplerectnode.zig").QSGSimpleRectNode;
pub const QSGSimpleTextureNode = @import("quick/libqsgsimpletexturenode.zig").QSGSimpleTextureNode;
pub const QSGTextNode = @import("quick/libqsgtextnode.zig").QSGTextNode;
pub const QSGTexture = @import("quick/libqsgtexture.zig").QSGTexture;
pub const QSGTextureMaterial = @import("quick/libqsgtexturematerial.zig").QSGTextureMaterial;
pub const QSGTextureProvider = @import("quick/libqsgtextureprovider.zig").QSGTextureProvider;
pub const QSGTransformNode = @import("quick/libqsgnode.zig").QSGTransformNode;
pub const QSGVertexColorMaterial = @import("quick/libqsgvertexcolormaterial.zig").QSGVertexColorMaterial;
...
pub const QString = @import("libqstring.zig").QString;
...
pub const QVirtualKeyboardAbstractInputMethod = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardabstractinputmethod.zig").QVirtualKeyboardAbstractInputMethod;
pub const QVirtualKeyboardDictionary = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboarddictionary.zig").QVirtualKeyboardDictionary;
pub const QVirtualKeyboardDictionaryManager = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboarddictionarymanager.zig").QVirtualKeyboardDictionaryManager;
pub const QVirtualKeyboardInputContext = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardinputcontext.zig").QVirtualKeyboardInputContext;
pub const QVirtualKeyboardInputEngine = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardinputengine.zig").QVirtualKeyboardInputEngine;
pub const QVirtualKeyboardObserver = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardobserver.zig").QVirtualKeyboardObserver;
pub const QVirtualKeyboardSelectionListModel = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardselectionlistmodel.zig").QVirtualKeyboardSelectionListModel;
pub const QVirtualKeyboardTrace = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardtrace.zig").QVirtualKeyboardTrace;
...
pub const TextAddonsWidgets__SelectSpecialCharDialog = @import("restricted-extras-ktextaddons/libselectspecialchardialog.zig").TextAddonsWidgets__SelectSpecialCharDialog;
pub const TextAddonsWidgets__SlideContainer = @import("restricted-extras-ktextaddons/libslidecontainer.zig").TextAddonsWidgets__SlideContainer;
pub const TextAutoCorrectionCore__AutoCorrection = @import("restricted-extras-ktextaddons/libautocorrection.zig").TextAutoCorrectionCore__AutoCorrection;
pub const TextAutoCorrectionCore__AutoCorrectionSettings = @import("restricted-extras-ktextaddons/libautocorrectionsettings.zig").TextAutoCorrectionCore__AutoCorrectionSettings;
pub const TextAutoCorrectionCore__AutoCorrectionUtils = @import("restricted-extras-ktextaddons/libautocorrectionutils.zig").TextAutoCorrectionCore__AutoCorrectionUtils;
pub const TextAutoCorrectionCore__AutoCorrectionUtils__TypographicQuotes = @import("restricted-extras-ktextaddons/libautocorrectionutils.zig").TextAutoCorrectionCore__AutoCorrectionUtils__TypographicQuotes;
pub const TextAutoCorrectionCore__ImportAbstractAutocorrection = @import("restricted-extras-ktextaddons/libimportabstractautocorrection.zig").TextAutoCorrectionCore__ImportAbstractAutocorrection;
pub const TextAutoCorrectionCore__ImportKMailAutocorrection = @import("restricted-extras-ktextaddons/libimportkmailautocorrection.zig").TextAutoCorrectionCore__ImportKMailAutocorrection;
pub const TextAutoCorrectionCore__ImportLibreOfficeAutocorrection = @import("restricted-extras-ktextaddons/libimportlibreofficeautocorrection.zig").TextAutoCorrectionCore__ImportLibreOfficeAutocorrection;
pub const TextAutoCorrectionCore__TextAutoCorrectionSettings = @import("restricted-extras-ktextaddons/libtextautocorrectionsettings.zig").TextAutoCorrectionCore__TextAutoCorrectionSettings;
pub const TextAutoCorrectionCore__TextAutoCorrectionSettingsBase = @import("restricted-extras-ktextaddons/libtextautocorrectionsetting_base.zig").TextAutoCorrectionCore__TextAutoCorrectionSettingsBase;
pub const TextAutoCorrectionWidgets__AutoCorrectionLanguage = @import("restricted-extras-ktextaddons/libautocorrectionlanguage.zig").TextAutoCorrectionWidgets__AutoCorrectionLanguage;
pub const TextAutoCorrectionWidgets__AutoCorrectionTextEdit = @import("restricted-extras-ktextaddons/libautocorrectiontextedit.zig").TextAutoCorrectionWidgets__AutoCorrectionTextEdit;
pub const TextAutoCorrectionWidgets__AutoCorrectionWidget = @import("restricted-extras-ktextaddons/libautocorrectionwidget.zig").TextAutoCorrectionWidgets__AutoCorrectionWidget;
pub const TextCustomEditor__PlainTextEditFindBar = @import("restricted-extras-ktextaddons/libplaintexteditfindbar.zig").TextCustomEditor__PlainTextEditFindBar;
pub const TextCustomEditor__PlainTextEditor = @import("restricted-extras-ktextaddons/libplaintexteditor.zig").TextCustomEditor__PlainTextEditor;
pub const TextCustomEditor__PlainTextEditorWidget = @import("restricted-extras-ktextaddons/libplaintexteditorwidget.zig").TextCustomEditor__PlainTextEditorWidget;
pub const TextCustomEditor__PlainTextSyntaxSpellCheckingHighlighter = @import("restricted-extras-ktextaddons/libplaintextsyntaxspellcheckinghighlighter.zig").TextCustomEditor__PlainTextSyntaxSpellCheckingHighlighter;
pub const TextCustomEditor__RichTextBrowser = @import("restricted-extras-ktextaddons/librichtextbrowser.zig").TextCustomEditor__RichTextBrowser;
pub const TextCustomEditor__RichTextBrowserFindBar = @import("restricted-extras-ktextaddons/librichtextbrowserfindbar.zig").TextCustomEditor__RichTextBrowserFindBar;
pub const TextCustomEditor__RichTextBrowserWidget = @import("restricted-extras-ktextaddons/librichtextbrowserwidget.zig").TextCustomEditor__RichTextBrowserWidget;
pub const TextCustomEditor__RichTextEditFindBar = @import("restricted-extras-ktextaddons/librichtexteditfindbar.zig").TextCustomEditor__RichTextEditFindBar;
pub const TextCustomEditor__RichTextEditor = @import("restricted-extras-ktextaddons/librichtexteditor.zig").TextCustomEditor__RichTextEditor;
pub const TextCustomEditor__RichTextEditorWidget = @import("restricted-extras-ktextaddons/librichtexteditorwidget.zig").TextCustomEditor__RichTextEditorWidget;
pub const TextCustomEditor__TextEditFindBarBase = @import("restricted-extras-ktextaddons/libtexteditfindbarbase.zig").TextCustomEditor__TextEditFindBarBase;
pub const TextCustomEditor__TextEditorCompleter = @import("restricted-extras-ktextaddons/libtexteditorcompleter.zig").TextCustomEditor__TextEditorCompleter;
pub const TextCustomEditor__TextGoToLineWidget = @import("restricted-extras-ktextaddons/libtextgotolinewidget.zig").TextCustomEditor__TextGoToLineWidget;
pub const TextEditTextToSpeech__TextToSpeech = @import("restricted-extras-ktextaddons/libtexttospeech.zig").TextEditTextToSpeech__TextToSpeech;
pub const TextEditTextToSpeech__TextToSpeechActions = @import("restricted-extras-ktextaddons/libtexttospeechactions.zig").TextEditTextToSpeech__TextToSpeechActions;
pub const TextEditTextToSpeech__TextToSpeechConfigDialog = @import("restricted-extras-ktextaddons/libtexttospeechconfigdialog.zig").TextEditTextToSpeech__TextToSpeechConfigDialog;
pub const TextEditTextToSpeech__TextToSpeechConfigWidget = @import("restricted-extras-ktextaddons/libtexttospeechconfigwidget.zig").TextEditTextToSpeech__TextToSpeechConfigWidget;
pub const TextEditTextToSpeech__TextToSpeechContainerWidget = @import("restricted-extras-ktextaddons/libtexttospeechcontainerwidget.zig").TextEditTextToSpeech__TextToSpeechContainerWidget;
pub const TextEditTextToSpeech__TextToSpeechInterface = @import("restricted-extras-ktextaddons/libtexttospeechinterface.zig").TextEditTextToSpeech__TextToSpeechInterface;
pub const TextEditTextToSpeech__TextToSpeechWidget = @import("restricted-extras-ktextaddons/libtexttospeechwidget.zig").TextEditTextToSpeech__TextToSpeechWidget;
pub const TextEmoticonsCore__CustomEmoji = @import("restricted-extras-ktextaddons/libcustomemoji.zig").TextEmoticonsCore__CustomEmoji;
pub const TextEmoticonsCore__CustomEmojiIconManager = @import("restricted-extras-ktextaddons/libcustomemojiiconmanager.zig").TextEmoticonsCore__CustomEmojiIconManager;
pub const TextEmoticonsCore__EmojiModel = @import("restricted-extras-ktextaddons/libemojimodel.zig").TextEmoticonsCore__EmojiModel;
pub const TextEmoticonsCore__EmojiModelManager = @import("restricted-extras-ktextaddons/libemojimodelmanager.zig").TextEmoticonsCore__EmojiModelManager;
pub const TextEmoticonsCore__EmojiProxyModel = @import("restricted-extras-ktextaddons/libemojiproxymodel.zig").TextEmoticonsCore__EmojiProxyModel;
pub const TextEmoticonsCore__EmoticonCategory = @import("restricted-extras-ktextaddons/libemoticoncategory.zig").TextEmoticonsCore__EmoticonCategory;
pub const TextEmoticonsCore__EmoticonUnicodeUtils = @import("restricted-extras-ktextaddons/libemoticonunicodeutils.zig").TextEmoticonsCore__EmoticonUnicodeUtils;
pub const TextEmoticonsCore__RunningAnimatedImage = @import("restricted-extras-ktextaddons/librunninganimatedimage.zig").TextEmoticonsCore__RunningAnimatedImage;
pub const TextEmoticonsCore__UnicodeEmoticon = @import("restricted-extras-ktextaddons/libunicodeemoticon.zig").TextEmoticonsCore__UnicodeEmoticon;
pub const TextEmoticonsCore__UnicodeEmoticonManager = @import("restricted-extras-ktextaddons/libunicodeemoticonmanager.zig").TextEmoticonsCore__UnicodeEmoticonManager;
pub const TextEmoticonsCore__UnicodeEmoticonParser = @import("restricted-extras-ktextaddons/libunicodeemoticonparser.zig").TextEmoticonsCore__UnicodeEmoticonParser;
pub const TextEmoticonsWidgets__EmoticonTextEditAction = @import("restricted-extras-ktextaddons/libemoticontexteditaction.zig").TextEmoticonsWidgets__EmoticonTextEditAction;
pub const TextEmoticonsWidgets__EmoticonTextEditSelector = @import("restricted-extras-ktextaddons/libemoticontexteditselector.zig").TextEmoticonsWidgets__EmoticonTextEditSelector;
pub const TextGrammarCheck__GrammalecteConfigDialog = @import("restricted-extras-ktextaddons/libgrammalecteconfigdialog.zig").TextGrammarCheck__GrammalecteConfigDialog;
pub const TextGrammarCheck__GrammalecteConfigWidget = @import("restricted-extras-ktextaddons/libgrammalecteconfigwidget.zig").TextGrammarCheck__GrammalecteConfigWidget;
pub const TextGrammarCheck__GrammalecteGenerateConfigOptionJob = @import("restricted-extras-ktextaddons/libgrammalectegenerateconfigoptionjob.zig").TextGrammarCheck__GrammalecteGenerateConfigOptionJob;
pub const TextGrammarCheck__GrammalecteGenerateConfigOptionJob__Option = @import("restricted-extras-ktextaddons/libgrammalectegenerateconfigoptionjob.zig").TextGrammarCheck__GrammalecteGenerateConfigOptionJob__Option;
pub const TextGrammarCheck__GrammalecteManager = @import("restricted-extras-ktextaddons/libgrammalectemanager.zig").TextGrammarCheck__GrammalecteManager;
pub const TextGrammarCheck__GrammalecteResultJob = @import("restricted-extras-ktextaddons/libgrammalecteresultjob.zig").TextGrammarCheck__GrammalecteResultJob;
pub const TextGrammarCheck__GrammalecteResultWidget = @import("restricted-extras-ktextaddons/libgrammalecteresultwidget.zig").TextGrammarCheck__GrammalecteResultWidget;
pub const TextGrammarCheck__GrammarAction = @import("restricted-extras-ktextaddons/libgrammaraction.zig").TextGrammarCheck__GrammarAction;
pub const TextGrammarCheck__GrammarError = @import("restricted-extras-ktextaddons/libgrammarerror.zig").TextGrammarCheck__GrammarError;
pub const TextGrammarCheck__GrammarResultTextEdit = @import("restricted-extras-ktextaddons/libgrammarresulttextedit.zig").TextGrammarCheck__GrammarResultTextEdit;
pub const TextGrammarCheck__GrammarResultWidget = @import("restricted-extras-ktextaddons/libgrammarresultwidget.zig").TextGrammarCheck__GrammarResultWidget;
pub const TextGrammarCheck__LanguageToolComboBox = @import("restricted-extras-ktextaddons/liblanguagetoolcombobox.zig").TextGrammarCheck__LanguageToolComboBox;
pub const TextGrammarCheck__LanguageToolConfigDialog = @import("restricted-extras-ktextaddons/liblanguagetoolconfigdialog.zig").TextGrammarCheck__LanguageToolConfigDialog;
pub const TextGrammarCheck__LanguageToolConfigWidget = @import("restricted-extras-ktextaddons/liblanguagetoolconfigwidget.zig").TextGrammarCheck__LanguageToolConfigWidget;
pub const TextGrammarCheck__LanguageToolGetListOfLanguageJob = @import("restricted-extras-ktextaddons/liblanguagetoolgetlistoflanguagejob.zig").TextGrammarCheck__LanguageToolGetListOfLanguageJob;
pub const TextGrammarCheck__LanguageToolManager = @import("restricted-extras-ktextaddons/liblanguagetoolmanager.zig").TextGrammarCheck__LanguageToolManager;
pub const TextGrammarCheck__LanguageToolResultWidget = @import("restricted-extras-ktextaddons/liblanguagetoolresultwidget.zig").TextGrammarCheck__LanguageToolResultWidget;
pub const TextTranslator__TranslatorConfigureDialog = @import("restricted-extras-ktextaddons/libtranslatorconfiguredialog.zig").TextTranslator__TranslatorConfigureDialog;
pub const TextTranslator__TranslatorConfigureLanguageListWidget = @import("restricted-extras-ktextaddons/libtranslatorconfigurelanguagelistwidget.zig").TextTranslator__TranslatorConfigureLanguageListWidget;
pub const TextTranslator__TranslatorConfigureListsWidget = @import("restricted-extras-ktextaddons/libtranslatorconfigurelistswidget.zig").TextTranslator__TranslatorConfigureListsWidget;
pub const TextTranslator__TranslatorEngineAccessManager = @import("restricted-extras-ktextaddons/libtranslatorengineaccessmanager.zig").TextTranslator__TranslatorEngineAccessManager;
pub const TextTranslator__TranslatorEngineClient = @import("restricted-extras-ktextaddons/libtranslatorengineclient.zig").TextTranslator__TranslatorEngineClient;
pub const TextTranslator__TranslatorEngineLoader = @import("restricted-extras-ktextaddons/libtranslatorengineloader.zig").TextTranslator__TranslatorEngineLoader;
pub const TextTranslator__TranslatorEnginePlugin = @import("restricted-extras-ktextaddons/libtranslatorengineplugin.zig").TextTranslator__TranslatorEnginePlugin;
pub const TextTranslator__TranslatorMenu = @import("restricted-extras-ktextaddons/libtranslatormenu.zig").TextTranslator__TranslatorMenu;
pub const TextTranslator__TranslatorTextEdit = @import("restricted-extras-ktextaddons/libtranslatorwidget.zig").TextTranslator__TranslatorTextEdit;
pub const TextTranslator__TranslatorUtil = @import("restricted-extras-ktextaddons/libtranslatorutil.zig").TextTranslator__TranslatorUtil;
pub const TextTranslator__TranslatorUtil__TranslatorSettings = @import("restricted-extras-ktextaddons/libtranslatorutil.zig").TextTranslator__TranslatorUtil__TranslatorSettings;
pub const TextTranslator__TranslatorWidget = @import("restricted-extras-ktextaddons/libtranslatorwidget.zig").TextTranslator__TranslatorWidget;
pub const TextUtils__ConvertText = @import("restricted-extras-ktextaddons/libconverttext.zig").TextUtils__ConvertText;
...
pub const autocorrectionwidget_enums = @import("restricted-extras-ktextaddons/libautocorrectionwidget.zig").enums;
...
pub const emojimodel_enums = @import("restricted-extras-ktextaddons/libemojimodel.zig").enums;
...
pub const grammalecteresultjob_enums = @import("restricted-extras-ktextaddons/libgrammalecteresultjob.zig").enums;
...
pub const importabstractautocorrection_enums = @import("restricted-extras-ktextaddons/libimportabstractautocorrection.zig").enums;
...
pub const kfileitem_h = @import("extras-kio/libkfileitem.zig").kfileitem_h;
...
pub const klocalizedstring_h = @import("extras-ki18n/libklocalizedstring.zig").klocalizedstring_h;
...
pub const kpluginmetadata_h = @import("extras-kcoreaddons/libkpluginmetadata.zig").kpluginmetadata_h;
...
pub const plaintexteditor_enums = @import("restricted-extras-ktextaddons/libplaintexteditor.zig").enums;
pub const platformtheme_enums = @import("extras-kirigami/libplatformtheme.zig").enums;
...
pub const qaccessible_h = @import("libqaccessible.zig").qaccessible_h;
pub const qaction_enums = @import("libqaction.zig").enums;
pub const qactiongroup_enums = @import("libqactiongroup.zig").enums;
pub const qalgorithms = @import("libqalgorithms.zig").qalgorithms;
...
pub const qassert = @import("libqassert.zig").qassert;
...
pub const qbytearray = @import("libqbytearray.zig").qbytearray;
pub const qbytearray_enums = @import("libqbytearray.zig").enums;
pub const qbytearrayalgorithms = @import("libqbytearrayalgorithms.zig").qbytearrayalgorithms;
pub const qbytearrayview = @import("libqbytearrayview.zig").qbytearrayview;
...
pub const qcborarray = @import("cbor/libqcborarray.zig").qcborarray;
pub const qcborcommon = @import("cbor/libqcborcommon.zig").qcborcommon;
...
pub const qdbusextratypes_h = @import("posix-extras-dbus/libqdbusextratypes.zig").qdbusextratypes_h;
pub const qdbusmessage_enums = @import("posix-extras-dbus/libqdbusmessage.zig").enums;
pub const qdbusreply_h = @import("posix-extras-dbus/libqdbusreply.zig").qdbusreply_h;
...
pub const qdrawutil_h = @import("libqdrawutil.zig").qdrawutil_h;
...
pub const qexceptionhandling = @import("libqexceptionhandling.zig").qexceptionhandling;
...
pub const qfont_h = @import("libqfont.zig").qfont_h;
...
pub const qgeoaddress_h = @import("positioning/libqgeoaddress.zig").qgeoaddress_h;
pub const qgeoareamonitorinfo_h = @import("positioning/libqgeoareamonitorinfo.zig").qgeoareamonitorinfo_h;
...
pub const qgeocoordinate_h = @import("positioning/libqgeocoordinate.zig").qgeocoordinate_h;
pub const qgeolocation_h = @import("positioning/libqgeolocation.zig").qgeolocation_h;
...
pub const qgeopositioninfo_h = @import("positioning/libqgeopositioninfo.zig").qgeopositioninfo_h;
...
pub const qgeosatelliteinfo_h = @import("positioning/libqgeosatelliteinfo.zig").qgeosatelliteinfo_h;
...
pub const qgeoshape_h = @import("positioning/libqgeoshape.zig").qgeoshape_h;
...
pub const qhashfunctions = @import("libqhashfunctions.zig").qhashfunctions;
...
pub const qhostaddress_h = @import("network/libqhostaddress.zig").qhostaddress_h;
...
pub const qicon_h = @import("libqicon.zig").qicon_h;
...
pub const qjsengine_enums = @import("qml/libqjsengine.zig").enums;
pub const qjsengine_h = @import("qml/libqjsengine.zig").qjsengine_h;
pub const qjsmanagedvalue_enums = @import("qml/libqjsmanagedvalue.zig").enums;
pub const qjsonarray = @import("libqjsonarray.zig").qjsonarray;
pub const qjsondocument_enums = @import("libqjsondocument.zig").enums;
pub const qjsonobject = @import("libqjsonobject.zig").qjsonobject;
pub const qjsonvalue = @import("libqjsonvalue.zig").qjsonvalue;
pub const qjsonvalue_enums = @import("libqjsonvalue.zig").enums;
pub const qjsprimitivevalue_enums = @import("qml/libqjsprimitivevalue.zig").enums;
pub const qjsvalue_enums = @import("qml/libqjsvalue.zig").enums;
pub const qkeysequence_enums = @import("libqkeysequence.zig").enums;
pub const qkeysequence_h = @import("libqkeysequence.zig").qkeysequence_h;
...
pub const qlogging = @import("libqlogging.zig").qlogging;
...
pub const qmalloc = @import("libqmalloc.zig").qmalloc;
pub const qmath = @import("libqmath.zig").qmath;
...
pub const qmessagebox_h = @import("libqmessagebox.zig").qmessagebox_h;
...
pub const qnumeric = @import("libqnumeric.zig").qnumeric;
pub const qobject = @import("libqobject.zig").qobject;
pub const qobject_enums = @import("libqobject.zig").enums;
pub const qobjectdefs = @import("libqobjectdefs.zig").qobjectdefs;
...
pub const qocspresponse_h = @import("network/libqocspresponse.zig").qocspresponse_h;
...
pub const qopenglversionfunctions_h = @import("opengl/libqopenglversionfunctions.zig").qopenglversionfunctions_h;
pub const qopenglversionprofile_h = @import("opengl/libqopenglversionprofile.zig").qopenglversionprofile_h;
...
pub const qpixelformat_h = @import("libqpixelformat.zig").qpixelformat_h;
...
pub const qplugin = @import("libqplugin.zig").qplugin;
pub const qpoint = @import("libqpoint.zig").qpoint;
pub const qpointingdevice_enums = @import("libqpointingdevice.zig").enums;
pub const qpointingdevice_h = @import("libqpointingdevice.zig").qpointingdevice_h;
...
pub const qqml_enums = @import("qml/libqqml.zig").enums;
pub const qqml_h = @import("qml/libqqml.zig").qqml_h;
pub const qqmlabstracturlinterceptor_enums = @import("qml/libqqmlabstracturlinterceptor.zig").enums;
pub const qqmlcomponent_enums = @import("qml/libqqmlcomponent.zig").enums;
pub const qqmldebug_enums = @import("qml/libqqmldebug.zig").enums;
pub const qqmlengine_enums = @import("qml/libqqmlengine.zig").enums;
pub const qqmlfile_enums = @import("qml/libqqmlfile.zig").enums;
pub const qqmlincubator_enums = @import("qml/libqqmlincubator.zig").enums;
pub const qqmlinfo_h = @import("qml/libqqmlinfo.zig").qqmlinfo_h;
pub const qqmlprivate_enums = @import("qml/libqqmlprivate.zig").enums;
pub const qqmlprivate_h = @import("qml/libqqmlprivate.zig").qqmlprivate_h;
pub const qqmlproperty_enums = @import("qml/libqqmlproperty.zig").enums;
pub const qqmlproperty_h = @import("qml/libqqmlproperty.zig").qqmlproperty_h;
pub const qquaternion_h = @import("libqquaternion.zig").qquaternion_h;
pub const qquickitem_enums = @import("quick/libqquickitem.zig").enums;
pub const qquickpainteditem_enums = @import("quick/libqquickpainteditem.zig").enums;
pub const qquickrendertarget_enums = @import("quick/libqquickrendertarget.zig").enums;
pub const qquickrhiitem_enums = @import("quick/libqquickrhiitem.zig").enums;
pub const qquicktextdocument_enums = @import("quick/libqquicktextdocument.zig").enums;
pub const qquickview_enums = @import("quick/libqquickview.zig").enums;
pub const qquickwidget_enums = @import("quick/libqquickwidget.zig").enums;
pub const qquickwindow_enums = @import("quick/libqquickwindow.zig").enums;
pub const qrawfont_enums = @import("libqrawfont.zig").enums;
pub const qrawfont_h = @import("libqrawfont.zig").qrawfont_h;
...
pub const qrgb_h = @import("libqrgb.zig").qrgb_h;
pub const qrgba64_h = @import("libqrgba64.zig").qrgba64_h;
...
pub const qsggeometry_enums = @import("quick/libqsggeometry.zig").enums;
pub const qsgimagenode_enums = @import("quick/libqsgimagenode.zig").enums;
pub const qsgmaterial_enums = @import("quick/libqsgmaterial.zig").enums;
pub const qsgmaterialshader_enums = @import("quick/libqsgmaterialshader.zig").enums;
pub const qsgnode_enums = @import("quick/libqsgnode.zig").enums;
pub const qsgnode_h = @import("quick/libqsgnode.zig").qsgnode_h;
pub const qsgrendererinterface_enums = @import("quick/libqsgrendererinterface.zig").enums;
pub const qsgrendernode_enums = @import("quick/libqsgrendernode.zig").enums;
pub const qsgsimpletexturenode_enums = @import("quick/libqsgsimpletexturenode.zig").enums;
pub const qsgtextnode_enums = @import("quick/libqsgtextnode.zig").enums;
pub const qsgtexture_enums = @import("quick/libqsgtexture.zig").enums;
...
pub const qsslcertificate_h = @import("network/libqsslcertificate.zig").qsslcertificate_h;
...
pub const qssldiffiehellmanparameters_h = @import("network/libqssldiffiehellmanparameters.zig").qssldiffiehellmanparameters_h;
pub const qsslellipticcurve_h = @import("network/libqsslellipticcurve.zig").qsslellipticcurve_h;
pub const qsslerror_enums = @import("network/libqsslerror.zig").enums;
pub const qsslerror_h = @import("network/libqsslerror.zig").qsslerror_h;
...
pub const qstring_enums = @import("libqstring.zig").enums;
...
pub const qtenvironmentvariables = @import("libqtenvironmentvariables.zig").qtenvironmentvariables;
pub const qtermwidget_interface_enums = @import("posix-restricted-qtermwidget/libqtermwidget_interface.zig").enums;
pub const qtestsupport_gui_h = @import("libqtestsupport_gui.zig").qtestsupport_gui_h;
...
pub const qtquickcontrols2global_h = @import("quick/libqtquickcontrols2global.zig").qtquickcontrols2global_h;
pub const qtransform_enums = @import("libqtransform.zig").enums;
pub const qtransform_h = @import("libqtransform.zig").qtransform_h;
...
pub const qttranslation = @import("libqttranslation.zig").qttranslation;
pub const qtvideo_enums = @import("multimedia/libqtvideo.zig").enums;
pub const qtwebenginecoreglobal_h = @import("webengine/libqtwebenginecoreglobal.zig").qtwebenginecoreglobal_h;
...
pub const qvirtualkeyboardinputengine_enums = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardinputengine.zig").enums;
pub const qvirtualkeyboardinputengine_h = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardinputengine.zig").qvirtualkeyboardinputengine_h;
pub const qvirtualkeyboardselectionlistmodel_enums = @import("restricted-extras-virtualkeyboard/libqvirtualkeyboardselectionlistmodel.zig").enums;
...
pub const qyieldcpu = @import("libqyieldcpu.zig").qyieldcpu;
pub const repository_enums = @import("extras-ksyntaxhighlighting/librepository.zig").enums;
pub const richtextbrowser_enums = @import("restricted-extras-ktextaddons/librichtextbrowser.zig").enums;
pub const richtexteditor_enums = @import("restricted-extras-ktextaddons/librichtexteditor.zig").enums;
...
pub const texteditfindbarbase_enums = @import("restricted-extras-ktextaddons/libtexteditfindbarbase.zig").enums;
pub const texttospeech_enums = @import("restricted-extras-ktextaddons/libtexttospeech.zig").enums;
pub const texttospeechwidget_enums = @import("restricted-extras-ktextaddons/libtexttospeechwidget.zig").enums;
...
pub const translatorengineclient_enums = @import("restricted-extras-ktextaddons/libtranslatorengineclient.zig").enums;
pub const translatorutil_enums = @import("restricted-extras-ktextaddons/libtranslatorutil.zig").enums;
