...
pub const all_types = struct {
    ...
    pub const map_constu8_sliceconstconstu8 = std.StringHashMapUnmanaged([]const []const u8);
    ...
    pub const map_i32_qtcktexteditormark = std.AutoHashMapUnmanaged(i32, C.KTextEditor__Mark);
    pub const map_i32_qtcqcpmargingroup = std.AutoHashMapUnmanaged(i32, C.QCPMarginGroup);
    pub const map_i32_qtcqicon = std.AutoHashMapUnmanaged(i32, C.QIcon);
    pub const map_i32_qtcqvariant = std.AutoHashMapUnmanaged(i32, C.QVariant);
    pub const map_i32_u8 = std.AutoHashMapUnmanaged(i32, []u8);
    pub const map_qtcqchar_constu8 = std.AutoHashMapUnmanaged(C.QChar, []const u8);
    pub const map_qtcqchar_sliceconstconstu8 = std.AutoHashMapUnmanaged(C.QChar, []const []const u8);
    ...
    pub const set_qtcqabstractstate = std.AutoHashMapUnmanaged(C.QAbstractState, void);
    ...
    pub const struct_f64_qtcqcolor = extern struct { first: f64, second: C.QColor };
    pub const struct_f64_qtcqpointf = extern struct { first: f64, second: C.QPointF };
    pub const struct_f64_qtcqvariant = extern struct { first: f64, second: C.QVariant };
    pub const struct_i32_i32 = extern struct { first: i32, second: i32 };
    pub const struct_qtckguiitem_qtckguiitem = extern struct { first: C.KGuiItem, second: C.KGuiItem };
    pub const struct_qtcqaccessibleinterface_i32 = extern struct { first: C.QAccessibleInterface, second: i32 };
    pub const struct_qtcqcborvalue_qtcqcborvalue = extern struct { first: C.QCborValue, second: C.QCborValue };
    pub const struct_qtcqchar_constu8 = struct { first: C.QChar, second: []const u8 };
    pub const struct_qtcqcpdatarange_qtcqcpdatarange = extern struct { first: C.QCPDataRange, second: C.QCPDataRange };
    pub const struct_qtcqhostaddress_i32 = extern struct { first: C.QHostAddress, second: i32 };
