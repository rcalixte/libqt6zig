...
pub const all_types = struct {
    ...
    pub const map_constu8_sliceqtcqaction = std.StringHashMapUnmanaged([]C.QAction);
    pub const map_constu8_u8 = std.StringHashMapUnmanaged([]u8);
    pub const map_f64_constu8 = std.AutoHashMapUnmanaged(f64, []const u8);
    pub const map_f64_qtcqcolor = std.AutoHashMapUnmanaged(f64, C.QColor);
    ...
    pub const map_i32_qtcqplacecontent = std.AutoHashMapUnmanaged(i32, C.QPlaceContent);
    pub const map_i32_qtcqvariant = std.AutoHashMapUnmanaged(i32, C.QVariant);
    pub const map_i32_sliceconstconstu8 = std.AutoHashMapUnmanaged(i32, []const []const u8);
    pub const map_i32_sliceqtcqkeysequence = std.AutoHashMapUnmanaged(i32, []C.QKeySequence);
    pub const map_i32_sliceqtcqvariant = std.AutoHashMapUnmanaged(i32, []C.QVariant);
    ...
    pub const map_qtcqdate_constu8 = std.AutoHashMapUnmanaged(C.QDate, []const u8);
    pub const map_qtcqdate_qtcqtextcharformat = std.AutoHashMapUnmanaged(C.QDate, C.QTextCharFormat);
    pub const map_u8_qtcqvariant = std.StringHashMapUnmanaged(C.QVariant);
