...
pub const qsessionmanager = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QSessionManager_MetaObject(@ptrCast(self));
    }
    ...
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        ...
        return qtc.QSessionManager_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QSessionManager_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QSessionManager `
    ///
    /// ` callback: *const fn (self: QtC.QSessionManager) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSessionManager `
    ///
    /// ` callback: *const fn (self: QtC.QSessionManager, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSessionManager `
    ///
    /// ` callback: *const fn (self: QtC.QSessionManager, objectName: [*:0]const u8) callconv(.c) void `
    ///
