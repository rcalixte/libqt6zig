...
pub const qsessionmanager = struct {
    ...
    /// ``` self: QtC.QSessionManager, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QSessionManager_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.QSessionManager, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    ...
    ///
    /// ``` self: QtC.QSessionManager, callback: *const fn (self: QtC.QSessionManager, objectName: [*:0]const u8) callconv(.c) void ```
