...
pub const qsessionmanager = struct {
    ...
    /// ` self: QtC.QSessionManager `
    ///
    /// ` callback: *const fn (self: QtC.QSessionManagerparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSessionManager `
    ///
    /// ` callback: *const fn (self: QtC.QSessionManagerobjectName: [*:0]const u8) callconv(.c) void `
    ///
