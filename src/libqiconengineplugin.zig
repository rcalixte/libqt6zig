...
pub const qiconengineplugin = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QIconEnginePlugin_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QIconEnginePlugin_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QIconEnginePlugin `
    ///
    /// ` callback: *const fn (self: QtC.QIconEnginePluginparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QIconEnginePlugin `
    ///
    /// ` callback: *const fn (self: QtC.QIconEnginePluginobjectName: [*:0]const u8) callconv(.c) void `
    ///
