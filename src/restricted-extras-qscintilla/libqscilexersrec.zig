...
pub const qscilexersrec = struct {
    ...
    /// ` self: QtC.QsciLexerSRec `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerSRecc: QtC.QColor, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerSRec `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerSReceolfilled: bool, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerSRec `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerSRecf: QtC.QFont, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerSRec `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerSRecprop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerSRec `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerSRecparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerSRec `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerSRecobjectName: [*:0]const u8) callconv(.c) void `
    ///
