...
class VirtualQsciLexerSpice final : public QsciLexerSpice {
  ...
  public:
    ...
    ~VirtualQsciLexerSpice() {
        qscilexerspice_metaobject_callback = nullptr;
        qscilexerspice_metacast_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexerspice_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexerspice_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerSpice::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexerspice_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexerspice_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexerspice_autocompletionwordseparators_callback();
    ...
    QString bytesAsText(const char* bytes, int size) const {
        if (qscilexerspice_bytesastext_isbase) {
            ...
            const char* callback_ret = qscilexerspice_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerSpice::bytesAsText(bytes, size);
