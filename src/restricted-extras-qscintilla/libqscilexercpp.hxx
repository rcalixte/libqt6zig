...
class VirtualQsciLexerCPP final : public QsciLexerCPP {
  ...
  public:
    ...
    ~VirtualQsciLexerCPP() {
        qscilexercpp_metaobject_callback = nullptr;
        qscilexercpp_metacast_callback = nullptr;
        ...
        qscilexercpp_defaultcolor2_callback = nullptr;
        qscilexercpp_defaulteolfill_callback = nullptr;
        qscilexercpp_defaultfont2_callback = nullptr;
        qscilexercpp_defaultpaper2_callback = nullptr;
        ...
        qscilexercpp_textasbytes_callback = nullptr;
        qscilexercpp_bytesastext_callback = nullptr;
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        } else if (qscilexercpp_metaobject_callback != nullptr) {
            QMetaObject* callback_ret = qscilexercpp_metaobject_callback();
            return callback_ret;
        } else {
            return QsciLexerCPP::metaObject();
        }
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        } else if (qscilexercpp_metacast_callback != nullptr) {
    ...
    virtual QList<QString> autoCompletionWordSeparators() const override {
        if (qscilexercpp_autocompletionwordseparators_isbase) {
            ...
            const char** callback_ret = qscilexercpp_autocompletionwordseparators_callback();
    ...
    virtual QColor defaultColor(int style) const override {
        ...
        } else if (qscilexercpp_defaultcolor2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QFont defaultFont(int style) const override {
        ...
        } else if (qscilexercpp_defaultfont2_callback != nullptr) {
            int cbval1 = style;
    ...
    virtual QColor defaultPaper(int style) const override {
        ...
        } else if (qscilexercpp_defaultpaper2_callback != nullptr) {
            int cbval1 = style;
    ...
    QByteArray textAsBytes(const QString& text) const {
        ...
        } else if (qscilexercpp_textasbytes_callback != nullptr) {
    ...
    QString bytesAsText(const char* bytes, int size) const {
        ...
        } else if (qscilexercpp_bytesastext_callback != nullptr) {
            const char* cbval1 = (const char*)bytes;
            int cbval2 = size;

            const char* callback_ret = qscilexercpp_bytesastext_callback(this, cbval1, cbval2);
            QString callback_ret_QString = QString::fromUtf8(callback_ret);
            return callback_ret_QString;
        } else {
            return QsciLexerCPP::bytesAsText(bytes, size);
    ...
    friend libqt_string QsciLexerCPP_QBaseTextAsBytes(const QsciLexerCPP* self, const libqt_string text);
    friend libqt_string QsciLexerCPP_BytesAsText(const QsciLexerCPP* self, const char* bytes, int size);
    friend libqt_string QsciLexerCPP_QBaseBytesAsText(const QsciLexerCPP* self, const char* bytes, int size);
