...
pub const qscilexermasm = struct {
    ...
    /// ` self: QtC.QsciLexerMASM `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASMc: QtC.QColor, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerMASM `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASMeolfilled: bool, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerMASM `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASMf: QtC.QFont, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerMASM `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASMprop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerMASM `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASMparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerMASM`
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASM, text: [*:0]const u8) callconv(.c) [*:0]u8 `
    ///
    ...
    /// ` self: QtC.QsciLexerMASM `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerMASMobjectName: [*:0]const u8) callconv(.c) void `
    ///
