...
pub const qscilexermasm = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QsciLexerMASM_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseColor(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerMASM_QBaseColor(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseEolFill(self: ?*anyopaque, style: i32) bool {
        return qtc.QsciLexerMASM_QBaseEolFill(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseFont(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerMASM_QBaseFont(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseKeywords(self: ?*anyopaque, set: i32) [:0]const u8 {
        const _ret = qtc.QsciLexerMASM_QBaseKeywords(@ptrCast(self), @bitCast(set));
        return std.mem.span(_ret);
    }
    ...
    pub fn QBaseDescription(self: ?*anyopaque, style: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QsciLexerMASM_QBaseDescription(@ptrCast(self), @bitCast(style));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("qscilexermasm.Description: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    ...
    pub fn QBasePaper(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerMASM_QBasePaper(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultColor2(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerMASM_QBaseDefaultColor2(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultEolFill(self: ?*anyopaque, style: i32) bool {
        return qtc.QsciLexerMASM_QBaseDefaultEolFill(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultFont2(self: ?*anyopaque, style: i32) QtC.QFont {
        return qtc.QsciLexerMASM_QBaseDefaultFont2(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseDefaultPaper2(self: ?*anyopaque, style: i32) QtC.QColor {
        return qtc.QsciLexerMASM_QBaseDefaultPaper2(@ptrCast(self), @bitCast(style));
    }
    ...
    pub fn QBaseSetAutoIndentStyle(self: ?*anyopaque, autoindentstyle: i32) void {
        qtc.QsciLexerMASM_QBaseSetAutoIndentStyle(@ptrCast(self), @bitCast(autoindentstyle));
    }
    ...
    pub fn QBaseSetColor(self: ?*anyopaque, c: ?*anyopaque, style: i32) void {
        qtc.QsciLexerMASM_QBaseSetColor(@ptrCast(self), @ptrCast(c), @bitCast(style));
    }
    ...
    pub fn QBaseSetEolFill(self: ?*anyopaque, eoffill: bool, style: i32) void {
        qtc.QsciLexerMASM_QBaseSetEolFill(@ptrCast(self), eoffill, @bitCast(style));
    }
    ...
    pub fn QBaseSetFont(self: ?*anyopaque, f: ?*anyopaque, style: i32) void {
        qtc.QsciLexerMASM_QBaseSetFont(@ptrCast(self), @ptrCast(f), @bitCast(style));
    }
    ...
    pub fn QBaseSetPaper(self: ?*anyopaque, c: ?*anyopaque, style: i32) void {
        qtc.QsciLexerMASM_QBaseSetPaper(@ptrCast(self), @ptrCast(c), @bitCast(style));
    }
    ...
    pub fn QBaseBytesAsText(self: ?*anyopaque, bytes: [:0]const u8, size: i32, allocator: std.mem.Allocator) []const u8 {
        const bytes_Cstring = bytes.ptr;
        var _str = qtc.QsciLexerMASM_QBaseBytesAsText(@ptrCast(self), bytes_Cstring, @bitCast(size));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("qscilexermasm.BytesAsText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
