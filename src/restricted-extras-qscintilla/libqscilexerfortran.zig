...
pub const QsciLexerFortran = extern struct {
    ...
    /// Allocate a new QsciLexerFortran object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_parent: anytype) QsciLexerFortran {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QsciLexerFortran_new2(@ptrCast(_parent.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QsciLexerFortran_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QsciLexerFortran_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QsciLexerFortran_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    pub fn setAPIs(self: QsciLexerFortran, _apis: anytype) void {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QsciLexerFortran, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QsciLexerFortran, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QsciLexerFortran, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QsciLexerFortran, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QsciLexerFortran.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QsciLexerFortran, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn autoCompletionWordSeparators(self: QsciLexerFortran, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QsciLexerFortran.autoCompletionWordSeparators: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    ///
    pub fn setEditor(self: QsciLexerFortran, _editor: anytype) void {
        comptime _ = @TypeOf(_editor)._is_QsciScintilla;
        qtc.QsciLexerFortran_SetEditor(@ptrCast(self.ptr), @ptrCast(_editor.ptr));
    }
    ...
    /// ` _editor: QsciScintilla `
    ///
    pub fn superSetEditor(self: QsciLexerFortran, _editor: anytype) void {
        comptime _ = @TypeOf(_editor)._is_QsciScintilla;
        qtc.QsciLexerFortran_SuperSetEditor(@ptrCast(self.ptr), @ptrCast(_editor.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QsciLexerFortran, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerFortran_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QsciLexerFortran, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerFortran_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QsciLexerFortran, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerFortran_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QsciLexerFortran, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QsciLexerFortran_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QsciLexerFortran, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QsciLexerFortran_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QsciLexerFortran, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QsciLexerFortran_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QsciLexerFortran, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QsciLexerFortran_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QsciLexerFortran, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QsciLexerFortran_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QsciLexerFortran, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QsciLexerFortran_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QsciLexerFortran, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QsciLexerFortran_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
