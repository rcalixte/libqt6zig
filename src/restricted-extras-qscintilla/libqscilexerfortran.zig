...
pub const qscilexerfortran = struct {
    ...
    /// ` self: QtC.QsciLexerFortran `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerFortranc: QtC.QColor, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerFortran `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerFortraneolfilled: bool, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerFortran `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerFortranf: QtC.QFont, style: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerFortran `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerFortranprop: [*:0]const u8, val: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QsciLexerFortran `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerFortranparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    pub fn QBaseTextAsBytes(self: ?*anyopaque, text: []const u8, allocator: std.mem.Allocator) []u8 {
        ...
        var _bytearray: qtc.libqt_string = qtc.QsciLexerFortran_QBaseTextAsBytes(@ptrCast(self), text_str);
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("qscilexerfortran.TextAsBytes: Memory allocation failed");
        @memcpy(_ret, _bytearray.data[0.._bytearray.len]);
        return _ret;
    ...
    /// ` self: QtC.QsciLexerFortran `
    ///
    /// ` callback: *const fn (self: QtC.QsciLexerFortranobjectName: [*:0]const u8) callconv(.c) void `
    ///
