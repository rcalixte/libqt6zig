...
pub const KCategorizedSortFilterProxyModel = extern struct {
    ...
    pub fn ItemData(self: KCategorizedSortFilterProxyModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kcategorizedsortfilterproxymodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: KCategorizedSortFilterProxyModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kcategorizedsortfilterproxymodel.RoleNames: Total capacity allocation failed");
        defer {
