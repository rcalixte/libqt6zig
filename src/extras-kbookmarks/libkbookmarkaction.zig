...
pub const kbookmarkaction = struct {
    ...
    ///
    /// ``` bk: QtC.KBookmark, owner: QtC.KBookmarkOwner, parent: QtC.QObject ```
    ...
    /// ``` self: QtC.KBookmarkAction, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KBookmarkAction_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KBookmarkAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KBookmarkAction_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }

    /// Allows for overriding the related default method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    pub fn OnMetacall(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32, i32, ?*anyopaque) callconv(.c) i32) void {
        qtc.KBookmarkAction_OnMetacall(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KBookmarkAction_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, mb: flag of qnamespace_enums.MouseButton, km: flag of qnamespace_enums.KeyboardModifier ```
    pub fn SlotSelected(self: ?*anyopaque, mb: i64, km: i64) void {
        qtc.KBookmarkAction_SlotSelected(@ptrCast(self), @intCast(mb), @intCast(km));
    }
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, group: QtC.QActionGroup ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, icon: QtC.QIcon ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, text: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, tip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, statusTip: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, what: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, priority: qaction_enums.Priority ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, b: bool ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, shortcut: QtC.QKeySequence ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, shortcuts: []QtC.QKeySequence ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#setShortcuts)
    ///
    /// ``` self: QtC.KBookmarkAction, shortcuts: qkeysequence_enums.StandardKey ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, context: qnamespace_enums.ShortcutContext ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, autoRepeat: bool ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, font: QtC.QFont ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, checkable: bool ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, varVal: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, event: qaction_enums.ActionEvent ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, menuRole: qaction_enums.MenuRole ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, visible: bool ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, show: bool ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, checked: bool ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, enabled: bool ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#changed)
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction) callconv(.c) void ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#enabledChanged)
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, enabled: bool) callconv(.c) void ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#checkableChanged)
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, checkable: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, param1: bool ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#toggled)
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, param1: bool) callconv(.c) void ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#showStatusText)
    ///
    /// ``` self: QtC.KBookmarkAction, object: QtC.QObject ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qaction.html#triggered)
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, checked: bool) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, id: i32 ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KBookmarkAction, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, obj: QtC.QObject ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KBookmarkAction, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, name: []const u8, value: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, classname: []const u8 ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KBookmarkAction, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KBookmarkAction, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KBookmarkAction, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KBookmarkAction, param1: QtC.QObject ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, param1: QtC.QEvent ```
    ...
    pub fn QBaseEvent(self: ?*anyopaque, param1: ?*anyopaque) bool {
        return qtc.KBookmarkAction_QBaseEvent(@ptrCast(self), @ptrCast(param1));
    }
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, param1: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KBookmarkAction_OnEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KBookmarkAction_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KBookmarkAction_OnEventFilter(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, event: QtC.QTimerEvent ```
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KBookmarkAction_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, event: QtC.QTimerEvent) callconv(.c) void ```
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KBookmarkAction_OnTimerEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, event: QtC.QChildEvent ```
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KBookmarkAction_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, event: QtC.QChildEvent) callconv(.c) void ```
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KBookmarkAction_OnChildEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, event: QtC.QEvent ```
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KBookmarkAction_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, event: QtC.QEvent) callconv(.c) void ```
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KBookmarkAction_OnCustomEvent(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, signal: QtC.QMetaMethod ```
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KBookmarkAction_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, signal: QtC.QMetaMethod) callconv(.c) void ```
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KBookmarkAction_OnConnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KBookmarkAction_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KBookmarkAction_OnDisconnectNotify(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KBookmarkAction_QBaseSender(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn () callconv(.c) QtC.QObject ```
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KBookmarkAction_OnSender(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KBookmarkAction_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn () callconv(.c) i32 ```
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KBookmarkAction_OnSenderSignalIndex(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, signal: []const u8 ```
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KBookmarkAction_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, signal: [*:0]const u8) callconv(.c) i32 ```
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KBookmarkAction_OnReceivers(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KBookmarkAction_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, signal: QtC.QMetaMethod) callconv(.c) bool ```
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KBookmarkAction_OnIsSignalConnected(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    ///
    /// ``` self: QtC.KBookmarkAction, callback: *const fn (self: QtC.KBookmarkAction, objectName: [*:0]const u8) callconv(.c) void ```
