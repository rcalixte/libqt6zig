...
class VirtualQAbstractButton : public QAbstractButton {
  ...
  public:
    ...
    friend void QAbstractButton_SuperPaintEvent(QAbstractButton* self, QPaintEvent* e);
    ...
    friend void QAbstractButton_SuperUpdateMicroFocus(QAbstractButton* self);
    friend void QAbstractButton_Create(QAbstractButton* self);
    friend void QAbstractButton_SuperCreate(QAbstractButton* self);
    friend void QAbstractButton_Destroy(QAbstractButton* self);
    friend void QAbstractButton_SuperDestroy(QAbstractButton* self);
    friend bool QAbstractButton_FocusNextChild(QAbstractButton* self);
    friend bool QAbstractButton_SuperFocusNextChild(QAbstractButton* self);
    friend bool QAbstractButton_FocusPreviousChild(QAbstractButton* self);
    friend bool QAbstractButton_SuperFocusPreviousChild(QAbstractButton* self);
    friend QObject* QAbstractButton_Sender(const QAbstractButton* self);
    friend QObject* QAbstractButton_SuperSender(const QAbstractButton* self);
    friend int QAbstractButton_SenderSignalIndex(const QAbstractButton* self);
    friend int QAbstractButton_SuperSenderSignalIndex(const QAbstractButton* self);
    friend int QAbstractButton_Receivers(const QAbstractButton* self, const char* signal);
    friend int QAbstractButton_SuperReceivers(const QAbstractButton* self, const char* signal);
    friend bool QAbstractButton_IsSignalConnected(const QAbstractButton* self, const QMetaMethod* signal);
    friend bool QAbstractButton_SuperIsSignalConnected(const QAbstractButton* self, const QMetaMethod* signal);
    friend double QAbstractButton_GetDecodedMetricF(const QAbstractButton* self, int metricA, int metricB);
    friend double QAbstractButton_SuperGetDecodedMetricF(const QAbstractButton* self, int metricA, int metricB);
};
