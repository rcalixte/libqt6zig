...
pub const kio__simplejob = struct {
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
