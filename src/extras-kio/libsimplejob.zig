...
pub const kio__simplejob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__SimpleJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn AddMetaData2(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        ...
        const values_values = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::simplejob.AddMetaData2: Memory allocation failed");
    ...
    pub fn MergeMetaData(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        ...
        defer allocator.free(values_keys);
        const values_values = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::simplejob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_values);
        var i: usize = 0;
        var values_it = values.iterator();
        while (values_it.next()) |entry| : (i += 1) {
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, job: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__SimpleJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__SimpleJob, objectName: [*:0]const u8) callconv(.c) void `
    ///
