...
pub const KFilePlacesModel = extern struct {
    ...
    pub fn RoleNames(self: KFilePlacesModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kfileplacesmodel.RoleNames: Total capacity allocation failed");
        defer {
    ...
    pub fn ItemData(self: KFilePlacesModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kfileplacesmodel.ItemData: Total capacity allocation failed");
        defer {
            qtc.libqt_free(_map.keys);
            qtc.libqt_free(_map.values);
        }
