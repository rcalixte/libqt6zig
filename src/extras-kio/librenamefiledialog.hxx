...
class VirtualKIORenameFileDialog final : public KIO::RenameFileDialog {
  ...
  public:
    ...
    friend void KIO__RenameFileDialog_SuperAdjustPosition(KIO::RenameFileDialog* self, QWidget* param1);
    friend void KIO__RenameFileDialog_UpdateMicroFocus(KIO::RenameFileDialog* self);
    friend void KIO__RenameFileDialog_SuperUpdateMicroFocus(KIO::RenameFileDialog* self);
    friend void KIO__RenameFileDialog_Create(KIO::RenameFileDialog* self);
    friend void KIO__RenameFileDialog_SuperCreate(KIO::RenameFileDialog* self);
    friend void KIO__RenameFileDialog_Destroy(KIO::RenameFileDialog* self);
    friend void KIO__RenameFileDialog_SuperDestroy(KIO::RenameFileDialog* self);
    friend bool KIO__RenameFileDialog_FocusNextChild(KIO::RenameFileDialog* self);
    friend bool KIO__RenameFileDialog_SuperFocusNextChild(KIO::RenameFileDialog* self);
    friend bool KIO__RenameFileDialog_FocusPreviousChild(KIO::RenameFileDialog* self);
    friend bool KIO__RenameFileDialog_SuperFocusPreviousChild(KIO::RenameFileDialog* self);
    friend QObject* KIO__RenameFileDialog_Sender(const KIO::RenameFileDialog* self);
    friend QObject* KIO__RenameFileDialog_SuperSender(const KIO::RenameFileDialog* self);
    friend int KIO__RenameFileDialog_SenderSignalIndex(const KIO::RenameFileDialog* self);
    friend int KIO__RenameFileDialog_SuperSenderSignalIndex(const KIO::RenameFileDialog* self);
    friend int KIO__RenameFileDialog_Receivers(const KIO::RenameFileDialog* self, const char* signal);
    friend int KIO__RenameFileDialog_SuperReceivers(const KIO::RenameFileDialog* self, const char* signal);
    friend bool KIO__RenameFileDialog_IsSignalConnected(const KIO::RenameFileDialog* self, const QMetaMethod* signal);
    friend bool KIO__RenameFileDialog_SuperIsSignalConnected(const KIO::RenameFileDialog* self, const QMetaMethod* signal);
    friend double KIO__RenameFileDialog_GetDecodedMetricF(const KIO::RenameFileDialog* self, int metricA, int metricB);
    friend double KIO__RenameFileDialog_SuperGetDecodedMetricF(const KIO::RenameFileDialog* self, int metricA, int metricB);
};
