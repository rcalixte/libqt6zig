...
pub const KIO__BatchRenameJob = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KIO__BatchRenameJob_Tr(s_Cstring);
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KIO__BatchRenameJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KIO__BatchRenameJob_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn detailedErrorStrings(self: KIO__BatchRenameJob, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__BatchRenameJob.detailedErrorStrings: Memory allocation failed");
    ...
    /// ` _parentJob: KIO__Job `
    ///
    pub fn setParentJob(self: KIO__BatchRenameJob, _parentJob: anytype) void {
    ...
    ///
    pub fn setMetaData(self: KIO__BatchRenameJob, _metaData: anytype) void {
    ...
    pub fn detailedErrorStrings1(self: KIO__BatchRenameJob, allocator: std.mem.Allocator, reqUrl: anytype) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__BatchRenameJob.detailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn detailedErrorStrings2(self: KIO__BatchRenameJob, allocator: std.mem.Allocator, reqUrl: anytype, method: i32) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__BatchRenameJob.detailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` self: KIO__BatchRenameJob `
    ///
    pub fn suspend0(self: KIO__BatchRenameJob) bool {
    ...
    /// ` self: KIO__BatchRenameJob `
    ///
    pub fn resume0(self: KIO__BatchRenameJob) bool {
    ...
    /// ` self: KIO__BatchRenameJob `
    ///
    pub fn error0(self: KIO__BatchRenameJob) i32 {
    ...
    /// ` _speed: usize `
    ///
    pub fn speed(self: KIO__BatchRenameJob, job: anytype, _speed: usize) void {
        comptime _ = @TypeOf(job)._is_KJob;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KIO__BatchRenameJob, _event: anytype) bool {
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KIO__BatchRenameJob, watched: anytype, _event: anytype) bool {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KIO__BatchRenameJob, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KIO__BatchRenameJob, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KIO__BatchRenameJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KIO__BatchRenameJob, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__BatchRenameJob.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KIO__BatchRenameJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
...
pub const KIO = extern struct {
    ...
    /// ### DEPRECATED: Use `batchRename` instead
    ///
    pub const BatchRename = batchRename;
