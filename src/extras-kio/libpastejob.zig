...
pub const kio__pastejob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__PasteJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, url: QtC.QUrl) callconv(.c) void `
    ///
    pub fn OnItemCreated(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__PasteJob_Connect_ItemCreated(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KIO__CopyJob) callconv(.c) void `
    ///
    pub fn OnCopyJobStarted(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__PasteJob_Connect_CopyJobStarted(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__pastejob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__PasteJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__PasteJob, objectName: [*:0]const u8) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn Paste(param1: ?*anyopaque, param2: ?*anyopaque, param3: i32) QtC.KIO__PasteJob {
        return qtc.KIO_Paste(@ptrCast(param1), @ptrCast(param2), @bitCast(param3));
    }
};
