...
pub const kio__mkdirjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__MkdirJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn OnRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__MkdirJob_Connect_Redirection(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnPermanentRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__MkdirJob_Connect_PermanentRedirection(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__MkdirJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkdirJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__mkdirjob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__MkdirJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkdirJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkdirJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkdirJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn Mkdir(param1: ?*anyopaque, param2: i32) QtC.KIO__MkdirJob {
        return qtc.KIO_Mkdir(@ptrCast(param1), @bitCast(param2));
    }
};
