...
pub const kio__mkdirjob = struct {
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: QtC.KIO__MkdirJob ```
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KIO__MkdirJob_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KIO__MkdirJob, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KIO__MkdirJob_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KIO__MkdirJob, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__MkdirJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__MkdirJob_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.Tr: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, job: QtC.KIO__Job, url: QtC.QUrl ```
    pub fn Redirection(self: ?*anyopaque, job: ?*anyopaque, url: ?*anyopaque) void {
        qtc.KIO__MkdirJob_Redirection(@ptrCast(self), @ptrCast(job), @ptrCast(url));
    }

    /// [Qt documentation](https://api.kde.org/kio-mkdirjob.html#redirection)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl ```
    pub fn PermanentRedirection(self: ?*anyopaque, job: ?*anyopaque, fromUrl: ?*anyopaque, toUrl: ?*anyopaque) void {
        qtc.KIO__MkdirJob_PermanentRedirection(@ptrCast(self), @ptrCast(job), @ptrCast(fromUrl), @ptrCast(toUrl));
    }

    /// [Qt documentation](https://api.kde.org/kio-mkdirjob.html#permanentRedirection)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void ```
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__MkdirJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KIO__MkdirJob_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, handle: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, param1: i32, param2: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, extension: QtC.KIO__JobUiDelegateExtension ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, allocator: std.mem.Allocator ```
    pub fn ErrorString(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KIO__Job_ErrorString(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.ErrorString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn DetailedErrorStrings(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::mkdirjob.DetailedErrorStrings: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkdirjob.DetailedErrorStrings: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, parentJob: QtC.KIO__Job ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, metaData: QtC.KIO__MetaData ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, key: []const u8, value: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#addMetaData)
    ///
    /// ``` self: QtC.KIO__MkdirJob, values: map_constu8_constu8, allocator: std.mem.Allocator ```
    pub fn AddMetaData2(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::mkdirjob.AddMetaData2: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::mkdirjob.AddMetaData2: Memory allocation failed");
    ...
    pub fn MergeMetaData(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::mkdirjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::mkdirjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_values);
        var i: usize = 0;
        var values_it = values.iterator();
        while (values_it.next()) |entry| {
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, key: []const u8, allocator: std.mem.Allocator ```
    pub fn QueryMetaData(self: ?*anyopaque, key: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.QueryMetaData: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, job: QtC.KIO__Job ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__MkdirJob, reqUrl: QtC.QUrl, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings1(self: ?*anyopaque, reqUrl: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::mkdirjob.DetailedErrorStrings1: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkdirjob.DetailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__MkdirJob, reqUrl: QtC.QUrl, method: i32, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings2(self: ?*anyopaque, reqUrl: ?*anyopaque, method: i32, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::mkdirjob.DetailedErrorStrings2: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkdirjob.DetailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, delegate: QtC.KJobUiDelegate ```
    ...
    pub fn ErrorText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.ErrorText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, unit: kjob_enums.Unit ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, autodelete: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, job: QtC.KJob, message: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, job: QtC.KJob, size: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, job: QtC.KJob, speed: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#kill)
    ///
    /// ``` self: QtC.KIO__MkdirJob, verbosity: kjob_enums.KillVerbosity ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#setFinishedNotificationHidden)
    ///
    /// ``` self: QtC.KIO__MkdirJob, hide: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkdirjob.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, interval: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KIO__MkdirJob, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio::mkdirjob.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__MkdirJob, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("kio::mkdirjob.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkdirjob.DynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KIO__MkdirJob, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KIO__MkdirJob, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__MkdirJob, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkdirJob, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkdirJob, callback: *const fn (self: QtC.KIO__MkdirJob, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KIO__MkdirJob_Delete(@ptrCast(self));
    }
};
...
pub const kio = struct {
    ...
    ///
    /// ``` param1: QtC.QUrl, param2: i32 ```
    pub fn Mkdir(param1: ?*anyopaque, param2: i32) QtC.KIO__MkdirJob {
        return qtc.KIO_Mkdir(@ptrCast(param1), @intCast(param2));
    }
};
