...
pub const KIO__SpecialJob = extern struct {
    ...
    /// Allocate a new KIO::SpecialJob object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    /// ` _url: QUrl `
    ///
    pub fn new(_url: anytype) KIO__SpecialJob {
        comptime _ = @TypeOf(_url)._is_QUrl;
        return .{ .ptr = qtc.KIO__SpecialJob_new(@ptrCast(_url.ptr)) };
    }
    ...
    /// ` _data: []u8 `
    ///
    pub fn new2(_url: anytype, _data: []u8) KIO__SpecialJob {
        comptime _ = @TypeOf(_url)._is_QUrl;
        const data_str = qtc.libqt_string{
            .len = _data.len,
            .data = _data.ptr,
        };
        return .{ .ptr = qtc.KIO__SpecialJob_new2(@ptrCast(_url.ptr), data_str) };
    }
    ...
    /// ` _data: []u8 `
    ///
    pub fn setArguments(self: KIO__SpecialJob, _data: []u8) void {
        const data_str = qtc.libqt_string{
            .len = _data.len,
            .data = _data.ptr,
        };
    ...
    /// ` _data: []u8 `
    ///
    pub fn sendAsyncData(self: KIO__SpecialJob, _data: []u8) void {
        const data_str = qtc.libqt_string{
            .len = _data.len,
            .data = _data.ptr,
        };
    ...
    /// ` _data: []u8 `
    ///
    pub fn data(self: KIO__SpecialJob, job: anytype, _data: []u8) void {
    ...
    /// ` _data: []u8 `
    ///
    pub fn dataReq(self: KIO__SpecialJob, job: anytype, _data: []u8) void {
        comptime _ = @TypeOf(job)._is_KIO__Job;
        const data_str = qtc.libqt_string{
            .len = _data.len,
            .data = _data.ptr,
    ...
    /// ` _url: QUrl `
    ///
    pub fn redirection(self: KIO__SpecialJob, job: anytype, _url: anytype) void {
        comptime _ = @TypeOf(job)._is_KIO__Job;
        comptime _ = @TypeOf(_url)._is_QUrl;
    ...
    pub fn detailedErrorStrings(self: KIO__SpecialJob, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__SpecialJob.detailedErrorStrings: Memory allocation failed");
    ...
    /// ` _parentJob: KIO__Job `
    ///
    pub fn setParentJob(self: KIO__SpecialJob, _parentJob: anytype) void {
    ...
    ///
    pub fn setMetaData(self: KIO__SpecialJob, _metaData: anytype) void {
    ...
    pub fn detailedErrorStrings1(self: KIO__SpecialJob, allocator: std.mem.Allocator, reqUrl: anytype) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__SpecialJob.detailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn detailedErrorStrings2(self: KIO__SpecialJob, allocator: std.mem.Allocator, reqUrl: anytype, method: i32) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__SpecialJob.detailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` self: KIO__SpecialJob `
    ///
    pub fn suspend0(self: KIO__SpecialJob) bool {
    ...
    /// ` self: KIO__SpecialJob `
    ///
    pub fn resume0(self: KIO__SpecialJob) bool {
    ...
    /// ` self: KIO__SpecialJob `
    ///
    pub fn error0(self: KIO__SpecialJob) i32 {
    ...
    /// ` _speed: usize `
    ///
    pub fn speed(self: KIO__SpecialJob, job: anytype, _speed: usize) void {
        comptime _ = @TypeOf(job)._is_KJob;
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KIO__SpecialJob, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KIO__SpecialJob, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KIO__SpecialJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KIO__SpecialJob, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__SpecialJob.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KIO__SpecialJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ### DEPRECATED: Use `slotRedirection` instead
    ///
    pub const SlotRedirection = slotRedirection;
    ...
    /// ` _url: QUrl `
    ///
    pub fn slotRedirection(self: KIO__SpecialJob, _url: anytype) void {
        comptime _ = @TypeOf(_url)._is_QUrl;
        qtc.KIO__SpecialJob_SlotRedirection(@ptrCast(self.ptr), @ptrCast(_url.ptr));
    }

    /// ### DEPRECATED: Use `superSlotRedirection` instead
    ///
    pub const SuperSlotRedirection = superSlotRedirection;
    ...
    /// ` _url: QUrl `
    ///
    pub fn superSlotRedirection(self: KIO__SpecialJob, _url: anytype) void {
        comptime _ = @TypeOf(_url)._is_QUrl;
        qtc.KIO__SpecialJob_SuperSlotRedirection(@ptrCast(self.ptr), @ptrCast(_url.ptr));
    }

    /// ### DEPRECATED: Use `onSlotRedirection` instead
    ///
    pub const OnSlotRedirection = onSlotRedirection;
    ...
    /// ### DEPRECATED: Use `slotFinished` instead
    ///
    pub const SlotFinished = slotFinished;
    ...
    ///
    pub const SuperSlotFinished = superSlotFinished;
    ...
    /// ### DEPRECATED: Use `onSlotFinished` instead
    ///
    pub const OnSlotFinished = onSlotFinished;
    ...
    /// ### DEPRECATED: Use `slotData` instead
    ///
    pub const SlotData = slotData;
    ...
    /// ` _data: []u8 `
    ///
    pub fn slotData(self: KIO__SpecialJob, _data: []u8) void {
        const data_str = qtc.libqt_string{
            .len = _data.len,
            .data = _data.ptr,
        };
    ...
    ///
    pub const SuperSlotData = superSlotData;
    ...
    /// ` _data: []u8 `
    ///
    pub fn superSlotData(self: KIO__SpecialJob, _data: []u8) void {
        const data_str = qtc.libqt_string{
            .len = _data.len,
            .data = _data.ptr,
        };
    ...
    /// ### DEPRECATED: Use `onSlotData` instead
    ///
    pub const OnSlotData = onSlotData;
    ...
    /// ### DEPRECATED: Use `slotDataReq` instead
    ///
    pub const SlotDataReq = slotDataReq;
    ...
    ///
    pub const SuperSlotDataReq = superSlotDataReq;
    ...
    /// ### DEPRECATED: Use `onSlotDataReq` instead
    ///
    pub const OnSlotDataReq = onSlotDataReq;
    ...
    /// ### DEPRECATED: Use `slotMimetype` instead
    ///
    pub const SlotMimetype = slotMimetype;
    ...
    /// ` _mimetype: []const u8 `
    ///
    pub fn slotMimetype(self: KIO__SpecialJob, _mimetype: []const u8) void {
        const mimetype_str = qtc.libqt_string{
            .len = _mimetype.len,
            .data = _mimetype.ptr,
        };
    ...
    ///
    pub const SuperSlotMimetype = superSlotMimetype;
    ...
    /// ` _mimetype: []const u8 `
    ///
    pub fn superSlotMimetype(self: KIO__SpecialJob, _mimetype: []const u8) void {
        const mimetype_str = qtc.libqt_string{
            .len = _mimetype.len,
            .data = _mimetype.ptr,
        };
    ...
    /// ### DEPRECATED: Use `onSlotMimetype` instead
    ///
    pub const OnSlotMimetype = onSlotMimetype;
    ...
    ///
    pub const SuperPutOnHold = superPutOnHold;
    ...
    /// ### DEPRECATED: Use `onPutOnHold` instead
    ///
    pub const OnPutOnHold = onPutOnHold;
    ...
    /// ### DEPRECATED: Use `slotMetaData` instead
    ///
    pub const SlotMetaData = slotMetaData;
    ...
    ///
    pub const SuperSlotMetaData = superSlotMetaData;
    ...
    /// ### DEPRECATED: Use `onSlotMetaData` instead
    ///
    pub const OnSlotMetaData = onSlotMetaData;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KIO__SpecialJob, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KIO__SpecialJob_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: KIO__SpecialJob, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KIO__SpecialJob_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KIO__SpecialJob, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KIO__SpecialJob_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: KIO__SpecialJob, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KIO__SpecialJob_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: KIO__SpecialJob, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KIO__SpecialJob_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: KIO__SpecialJob, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KIO__SpecialJob_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: KIO__SpecialJob, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KIO__SpecialJob_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: KIO__SpecialJob, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KIO__SpecialJob_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: KIO__SpecialJob, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KIO__SpecialJob_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: KIO__SpecialJob, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KIO__SpecialJob_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    ///
    pub fn setCapabilities(self: KIO__SpecialJob, _capabilities: i32) void {
        qtc.KIO__SpecialJob_SetCapabilities(@ptrCast(self.ptr), @bitCast(_capabilities));
    }
    ...
    /// ` _capabilities: flag of kjob_enums.Capability `
    ///
    pub fn superSetCapabilities(self: KIO__SpecialJob, _capabilities: i32) void {
        qtc.KIO__SpecialJob_SuperSetCapabilities(@ptrCast(self.ptr), @bitCast(_capabilities));
    }
    ...
    /// ` _errorText: []const u8 `
    ///
    pub fn setErrorText(self: KIO__SpecialJob, _errorText: []const u8) void {
    ...
    /// ` _errorText: []const u8 `
    ///
    pub fn superSetErrorText(self: KIO__SpecialJob, _errorText: []const u8) void {
        const errorText_str = qtc.libqt_string{
            .len = _errorText.len,
            .data = _errorText.ptr,
        };
    ...
    /// ` _totalAmount: usize `
    ///
    pub fn emitPercent(self: KIO__SpecialJob, _processedAmount: usize, _totalAmount: usize) void {
        qtc.KIO__SpecialJob_EmitPercent(@ptrCast(self.ptr), @bitCast(_processedAmount), @bitCast(_totalAmount));
    }
    ...
    /// ` _totalAmount: usize `
    ///
    pub fn superEmitPercent(self: KIO__SpecialJob, _processedAmount: usize, _totalAmount: usize) void {
        qtc.KIO__SpecialJob_SuperEmitPercent(@ptrCast(self.ptr), @bitCast(_processedAmount), @bitCast(_totalAmount));
    }
    ...
    /// ` _speed: usize `
    ///
    pub fn emitSpeed(self: KIO__SpecialJob, _speed: usize) void {
        qtc.KIO__SpecialJob_EmitSpeed(@ptrCast(self.ptr), @bitCast(_speed));
    }
    ...
    /// ` _speed: usize `
    ///
    pub fn superEmitSpeed(self: KIO__SpecialJob, _speed: usize) void {
        qtc.KIO__SpecialJob_SuperEmitSpeed(@ptrCast(self.ptr), @bitCast(_speed));
    }
