...
class VirtualKUrlNavigator final : public KUrlNavigator {
  ...
  public:
    ...
    friend void KUrlNavigator_SuperUpdateMicroFocus(KUrlNavigator* self);
    friend void KUrlNavigator_Create(KUrlNavigator* self);
    friend void KUrlNavigator_SuperCreate(KUrlNavigator* self);
    friend void KUrlNavigator_Destroy(KUrlNavigator* self);
    friend void KUrlNavigator_SuperDestroy(KUrlNavigator* self);
    friend bool KUrlNavigator_FocusNextChild(KUrlNavigator* self);
    friend bool KUrlNavigator_SuperFocusNextChild(KUrlNavigator* self);
    friend bool KUrlNavigator_FocusPreviousChild(KUrlNavigator* self);
    friend bool KUrlNavigator_SuperFocusPreviousChild(KUrlNavigator* self);
    friend QObject* KUrlNavigator_Sender(const KUrlNavigator* self);
    friend QObject* KUrlNavigator_SuperSender(const KUrlNavigator* self);
    friend int KUrlNavigator_SenderSignalIndex(const KUrlNavigator* self);
    friend int KUrlNavigator_SuperSenderSignalIndex(const KUrlNavigator* self);
    friend int KUrlNavigator_Receivers(const KUrlNavigator* self, const char* signal);
    friend int KUrlNavigator_SuperReceivers(const KUrlNavigator* self, const char* signal);
    friend bool KUrlNavigator_IsSignalConnected(const KUrlNavigator* self, const QMetaMethod* signal);
    friend bool KUrlNavigator_SuperIsSignalConnected(const KUrlNavigator* self, const QMetaMethod* signal);
    friend double KUrlNavigator_GetDecodedMetricF(const KUrlNavigator* self, int metricA, int metricB);
    friend double KUrlNavigator_SuperGetDecodedMetricF(const KUrlNavigator* self, int metricA, int metricB);
};
