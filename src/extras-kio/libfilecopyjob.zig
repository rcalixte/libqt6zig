...
pub const kio__filecopyjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__FileCopyJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` size: usize `
    ///
    pub fn SetSourceSize(self: ?*anyopaque, size: usize) void {
        qtc.KIO__FileCopyJob_SetSourceSize(@ptrCast(self), @bitCast(size));
    }
    ...
    pub fn OnMimeTypeFound(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, [*:0]const u8) callconv(.c) void) void {
        qtc.KIO__FileCopyJob_Connect_MimeTypeFound(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__FileCopyJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__FileCopyJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__filecopyjob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__FileCopyJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__FileCopyJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__FileCopyJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__FileCopyJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__FileCopyJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn FileCopy(param1: ?*anyopaque, param2: ?*anyopaque, param3: i32, param4: i32) QtC.KIO__FileCopyJob {
        return qtc.KIO_FileCopy(@ptrCast(param1), @ptrCast(param2), @bitCast(param3), @bitCast(param4));
    }
    ...
    pub fn FileMove(param1: ?*anyopaque, param2: ?*anyopaque, param3: i32, param4: i32) QtC.KIO__FileCopyJob {
        return qtc.KIO_FileMove(@ptrCast(param1), @ptrCast(param2), @bitCast(param3), @bitCast(param4));
    }
};
