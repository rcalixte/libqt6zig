...
pub const kio__listjob = struct {
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KIO__Job, list: [*]QtC.KIO__UDSEntry) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KIO__ListJob, subJob: QtC.KIO__ListJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
