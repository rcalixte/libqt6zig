...
pub const kio__listjob = struct {
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, percent: u64) callconv(.c) void `
    ///
