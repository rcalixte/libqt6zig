...
pub const kio__listjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__ListJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KIO__Job, list: qtc.libqt_list ([]QtC.KIO__UDSEntry)) callconv(.c) void `
    ///
    pub fn OnEntries(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, qtc.libqt_list) callconv(.c) void) void {
        qtc.KIO__ListJob_Connect_Entries(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` job: QtC.KIO__ListJob `
    ///
    /// ` subJob: QtC.KIO__ListJob `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KIO__ListJob, subJob: QtC.KIO__ListJob) callconv(.c) void `
    ///
    pub fn OnSubError(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__ListJob_Connect_SubError(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void `
    ///
    pub fn OnRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__ListJob_Connect_Redirection(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void `
    ///
    pub fn OnPermanentRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__ListJob_Connect_PermanentRedirection(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__listjob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ListJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ListJob, objectName: [*:0]const u8) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn ListDir(param1: ?*anyopaque, param2: i32, param3: i32) QtC.KIO__ListJob {
        return qtc.KIO_ListDir(@ptrCast(param1), @bitCast(param2), @bitCast(param3));
    }
    ...
    pub fn ListRecursive(param1: ?*anyopaque, param2: i32, param3: i32) QtC.KIO__ListJob {
        return qtc.KIO_ListRecursive(@ptrCast(param1), @bitCast(param2), @bitCast(param3));
    }
};
