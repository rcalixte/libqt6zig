...
/// https://api.kde.org/kio-storedtransferjob.html
pub const kio__storedtransferjob = struct {
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob ```
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KIO__StoredTransferJob_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KIO__StoredTransferJob, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KIO__StoredTransferJob_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KIO__StoredTransferJob, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__StoredTransferJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__StoredTransferJob_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.Tr: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }

    /// [Qt documentation](https://api.kde.org/kio-storedtransferjob.html#setData)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, arr: []u8 ```
    pub fn SetData(self: ?*anyopaque, arr: []u8) void {
        const arr_str = qtc.libqt_string{
            .len = arr.len,
            .data = arr.ptr,
        };
        qtc.KIO__StoredTransferJob_SetData(@ptrCast(self), arr_str);
    }

    /// [Qt documentation](https://api.kde.org/kio-storedtransferjob.html#data)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, allocator: std.mem.Allocator ```
    pub fn Data(self: ?*anyopaque, allocator: std.mem.Allocator) []u8 {
        const _bytearray: qtc.libqt_string = qtc.KIO__StoredTransferJob_Data(@ptrCast(self));
        defer qtc.libqt_string_free(&_bytearray);
        const _ret = allocator.alloc(u8, _bytearray.len) catch @panic("kio::storedtransferjob.Data: Memory allocation failed");
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__StoredTransferJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KIO__StoredTransferJob_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, mtime: QtC.QDateTime ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, enabled: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, data: []u8 ```
    ...
    pub fn Mimetype(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.Mimetype: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, bytes: u64 ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, data: []u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-transferjob.html#dataReq)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, data: [*:0]u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, url: QtC.QUrl ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-transferjob.html#redirection)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-transferjob.html#permanentRedirection)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, mimeType: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-transferjob.html#mimeTypeFound)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, mimeType: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, offset: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-transferjob.html#canResume)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, offset: u64) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, handle: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, param1: i32, param2: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, extension: QtC.KIO__JobUiDelegateExtension ```
    ...
    pub fn ErrorString(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.ErrorString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn DetailedErrorStrings(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::storedtransferjob.DetailedErrorStrings: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::storedtransferjob.DetailedErrorStrings: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, parentJob: QtC.KIO__Job ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, metaData: QtC.KIO__MetaData ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, key: []const u8, value: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#addMetaData)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, values: map_constu8_constu8, allocator: std.mem.Allocator ```
    pub fn AddMetaData2(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::storedtransferjob.AddMetaData2: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::storedtransferjob.AddMetaData2: Memory allocation failed");
    ...
    pub fn MergeMetaData(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::storedtransferjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::storedtransferjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_values);
        var i: usize = 0;
        var values_it = values.iterator();
        while (values_it.next()) |entry| {
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, key: []const u8, allocator: std.mem.Allocator ```
    pub fn QueryMetaData(self: ?*anyopaque, key: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.QueryMetaData: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, reqUrl: QtC.QUrl, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings1(self: ?*anyopaque, reqUrl: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::storedtransferjob.DetailedErrorStrings1: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::storedtransferjob.DetailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, reqUrl: QtC.QUrl, method: i32, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings2(self: ?*anyopaque, reqUrl: ?*anyopaque, method: i32, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::storedtransferjob.DetailedErrorStrings2: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::storedtransferjob.DetailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, delegate: QtC.KJobUiDelegate ```
    ...
    pub fn ErrorText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.ErrorText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, unit: kjob_enums.Unit ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, autodelete: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KJob, message: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KJob, size: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, job: QtC.KJob, speed: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#kill)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, verbosity: kjob_enums.KillVerbosity ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#setFinishedNotificationHidden)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, hide: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::storedtransferjob.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, b: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio::storedtransferjob.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("kio::storedtransferjob.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::storedtransferjob.DynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__StoredTransferJob, callback: *const fn (self: QtC.KIO__StoredTransferJob, objectName: [*:0]const u8) callconv(.c) void ```
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.KIO__StoredTransferJob_Delete(@ptrCast(self));
    }
};
...
pub const kio = struct {
    ...
    pub fn StoredPut2(param1: []u8, param2: ?*anyopaque, param3: i32, param4: i32) QtC.KIO__StoredTransferJob {
        ...
        return qtc.KIO_StoredPut2(param1_str, @ptrCast(param2), @intCast(param3), @intCast(param4));
    }
    ...
    pub fn StoredHttpPost(param1: []u8, param2: ?*anyopaque, param3: i32) QtC.KIO__StoredTransferJob {
        ...
        return qtc.KIO_StoredHttpPost(param1_str, @ptrCast(param2), @intCast(param3));
    }
