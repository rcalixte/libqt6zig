...
pub const kio__storedtransferjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__StoredTransferJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Data(self: ?*anyopaque, allocator: std.mem.Allocator) []u8 {
        var _bytearray: qtc.libqt_string = qtc.KIO__StoredTransferJob_Data(@ptrCast(self));
    ...
    /// ` self: QtC.KIO__StoredTransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StoredTransferJob, job: QtC.KIO__Job, data: qtc.libqt_string) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__storedtransferjob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__StoredTransferJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StoredTransferJob) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn StoredGet(param1: ?*anyopaque, param2: i32, param3: i32) QtC.KIO__StoredTransferJob {
        return qtc.KIO_StoredGet(@ptrCast(param1), @bitCast(param2), @bitCast(param3));
    }
    ...
    pub fn StoredPut(param1: ?*anyopaque, param2: ?*anyopaque, param3: i32, param4: i32) QtC.KIO__StoredTransferJob {
        return qtc.KIO_StoredPut(@ptrCast(param1), @ptrCast(param2), @bitCast(param3), @bitCast(param4));
    }
    ...
    pub fn StoredPut2(param1: []u8, param2: ?*anyopaque, param3: i32, param4: i32) QtC.KIO__StoredTransferJob {
        ...
        return qtc.KIO_StoredPut2(param1_str, @ptrCast(param2), @bitCast(param3), @bitCast(param4));
    }
    ...
    pub fn StoredHttpPost(param1: []u8, param2: ?*anyopaque, param3: i32) QtC.KIO__StoredTransferJob {
        ...
        return qtc.KIO_StoredHttpPost(param1_str, @ptrCast(param2), @bitCast(param3));
    }
    ...
    pub fn StoredHttpPost2(param1: ?*anyopaque, param2: ?*anyopaque, param3: i64, param4: i32) QtC.KIO__StoredTransferJob {
        return qtc.KIO_StoredHttpPost2(@ptrCast(param1), @ptrCast(param2), @bitCast(param3), @bitCast(param4));
    }
};
