...
pub const kio__deleteortrashjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__DeleteOrTrashJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__DeleteOrTrashJob_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    pub fn QBaseErrorString(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KIO__DeleteOrTrashJob_QBaseErrorString(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::deleteortrashjob.ErrorString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DeleteOrTrashJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DeleteOrTrashJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
