...
pub const kio__job = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__Job_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio__job.Children: Memory allocation failed");
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__Job `
    ///
    /// ` callback: *const fn (self: QtC.KIO__Job, objectName: [*:0]const u8) callconv(.c) void `
    ///
