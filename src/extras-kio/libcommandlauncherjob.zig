...
pub const kio__commandlauncherjob = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__CommandLauncherJob_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseSetCapabilities(self: ?*anyopaque, capabilities: i32) void {
        qtc.KIO__CommandLauncherJob_QBaseSetCapabilities(@ptrCast(self), @bitCast(capabilities));
    }
    ...
    pub fn QBaseSetError(self: ?*anyopaque, errorCode: i32) void {
        qtc.KIO__CommandLauncherJob_QBaseSetError(@ptrCast(self), @bitCast(errorCode));
    }
    ...
    pub fn QBaseSetProcessedAmount(self: ?*anyopaque, unit: i32, amount: u64) void {
        qtc.KIO__CommandLauncherJob_QBaseSetProcessedAmount(@ptrCast(self), @bitCast(unit), @bitCast(amount));
    }
    ...
    pub fn QBaseSetTotalAmount(self: ?*anyopaque, unit: i32, amount: u64) void {
        qtc.KIO__CommandLauncherJob_QBaseSetTotalAmount(@ptrCast(self), @bitCast(unit), @bitCast(amount));
    }
    ...
    pub fn QBaseSetProgressUnit(self: ?*anyopaque, unit: i32) void {
        qtc.KIO__CommandLauncherJob_QBaseSetProgressUnit(@ptrCast(self), @bitCast(unit));
    }
    ...
    pub fn QBaseSetPercent(self: ?*anyopaque, percentage: u64) void {
        qtc.KIO__CommandLauncherJob_QBaseSetPercent(@ptrCast(self), @bitCast(percentage));
    }
    ...
    pub fn QBaseEmitPercent(self: ?*anyopaque, processedAmount: u64, totalAmount: u64) void {
        qtc.KIO__CommandLauncherJob_QBaseEmitPercent(@ptrCast(self), @bitCast(processedAmount), @bitCast(totalAmount));
    }
    ...
    pub fn QBaseEmitSpeed(self: ?*anyopaque, speed: u64) void {
        qtc.KIO__CommandLauncherJob_QBaseEmitSpeed(@ptrCast(self), @bitCast(speed));
    }
