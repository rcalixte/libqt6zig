...
pub const kio__commandlauncherjob = struct {
    ...
    /// ` self: QtC.KIO__CommandLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob`
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob`
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, percentage: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob`
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, processedAmount: usize, totalAmount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob`
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, speed: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__CommandLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__CommandLauncherJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
