...
pub const kio__davjob = struct {
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJob, job: QtC.KIO__Job, data: [*:0]u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJob, job: QtC.KIO__Job, offset: u64) callconv(.c) void `
    ///
    ...
    pub fn DetailedErrorStrings(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio__davjob.DetailedErrorStrings: Memory allocation failed");
    ...
    pub fn DetailedErrorStrings1(self: ?*anyopaque, reqUrl: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio__davjob.DetailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn DetailedErrorStrings2(self: ?*anyopaque, reqUrl: ?*anyopaque, method: i32, allocator: std.mem.Allocator) [][]const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio__davjob.DetailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJob, job: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJob, job: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio__davjob.DynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJob, job: QtC.KJob, percent: u64) callconv(.c) void `
    ///
