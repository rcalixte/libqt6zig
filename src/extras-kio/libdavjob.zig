...
pub const kio__davjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__DavJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KIO__Job, data: [*:0]u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KIO__Job, mimeType: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KIO__Job, offset: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__DavJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__DavJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
