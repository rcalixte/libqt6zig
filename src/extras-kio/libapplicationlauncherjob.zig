...
pub const kio__applicationlauncherjob = struct {
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__ApplicationLauncherJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__ApplicationLauncherJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
