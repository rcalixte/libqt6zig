...
pub const kio__statjob = struct {
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
