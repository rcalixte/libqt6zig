...
pub const KIO__StatJob = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KIO__StatJob_Tr(s_Cstring);
    ...
    /// ### DEPRECATED: Use `setSide` instead
    ///
    pub const SetSide = setSide;
    ...
    /// ### DEPRECATED: Use `statResult` instead
    ///
    pub const StatResult = statResult;
    ...
    /// ` _url: QUrl `
    ///
    pub fn redirection(self: KIO__StatJob, job: anytype, _url: anytype) void {
        comptime _ = @TypeOf(job)._is_KIO__Job;
        comptime _ = @TypeOf(_url)._is_QUrl;
        qtc.KIO__StatJob_Redirection(@ptrCast(self.ptr), @ptrCast(job.ptr), @ptrCast(_url.ptr));
    }
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KIO__StatJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KIO__StatJob_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn detailedErrorStrings(self: KIO__StatJob, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__StatJob.detailedErrorStrings: Memory allocation failed");
    ...
    /// ` _parentJob: KIO__Job `
    ///
    pub fn setParentJob(self: KIO__StatJob, _parentJob: anytype) void {
    ...
    ///
    pub fn setMetaData(self: KIO__StatJob, _metaData: anytype) void {
    ...
    pub fn detailedErrorStrings1(self: KIO__StatJob, allocator: std.mem.Allocator, reqUrl: anytype) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__StatJob.detailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn detailedErrorStrings2(self: KIO__StatJob, allocator: std.mem.Allocator, reqUrl: anytype, method: i32) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__StatJob.detailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` self: KIO__StatJob `
    ///
    pub fn suspend0(self: KIO__StatJob) bool {
    ...
    /// ` self: KIO__StatJob `
    ///
    pub fn resume0(self: KIO__StatJob) bool {
    ...
    /// ` self: KIO__StatJob `
    ///
    pub fn error0(self: KIO__StatJob) i32 {
    ...
    /// ` _speed: usize `
    ///
    pub fn speed(self: KIO__StatJob, job: anytype, _speed: usize) void {
        comptime _ = @TypeOf(job)._is_KJob;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KIO__StatJob, _event: anytype) bool {
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KIO__StatJob, watched: anytype, _event: anytype) bool {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KIO__StatJob, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KIO__StatJob, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KIO__StatJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KIO__StatJob, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__StatJob.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KIO__StatJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
...
pub const KIO = extern struct {
    ...
    ///
    pub fn stat(_url: anytype, flags: i32) KIO__StatJob {
        comptime _ = @TypeOf(_url)._is_QUrl;
        return .{ .ptr = qtc.KIO_Stat(@ptrCast(_url.ptr), @bitCast(flags)) };
    }

    /// ### DEPRECATED: Use `stat2` instead
    ///
    pub const Stat2 = stat2;
    ...
    /// ` flags: flag of job_base_enums.JobFlag `
    ///
    pub fn stat2(_url: anytype, side: i32, details: i32, flags: i32) KIO__StatJob {
        comptime _ = @TypeOf(_url)._is_QUrl;
        return .{ .ptr = qtc.KIO_Stat2(@ptrCast(_url.ptr), @bitCast(side), @bitCast(details), @bitCast(flags)) };
    }
    ...
    /// ` flags: flag of job_base_enums.JobFlag `
    ///
    pub fn mostLocalUrl(_url: anytype, flags: i32) KIO__StatJob {
        comptime _ = @TypeOf(_url)._is_QUrl;
        return .{ .ptr = qtc.KIO_MostLocalUrl(@ptrCast(_url.ptr), @bitCast(flags)) };
    }
};
