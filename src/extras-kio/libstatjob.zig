...
pub const kio__statjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KIO__StatJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn SetSide(self: ?*anyopaque, side: i32) void {
        qtc.KIO__StatJob_SetSide(@ptrCast(self), @bitCast(side));
    }
    ...
    pub fn SetDetails(self: ?*anyopaque, details: i32) void {
        qtc.KIO__StatJob_SetDetails(@ptrCast(self), @bitCast(details));
    }
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KIO__Job, url: QtC.QUrl) callconv(.c) void `
    ///
    pub fn OnRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__StatJob_Connect_Redirection(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KIO__Job, fromUrl: QtC.QUrl, toUrl: QtC.QUrl) callconv(.c) void `
    ///
    pub fn OnPermanentRedirection(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__StatJob_Connect_PermanentRedirection(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, size: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, speed: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, job: QtC.KJob, percent: usize) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__StatJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__StatJob, objectName: [*:0]const u8) callconv(.c) void `
    ///
...
pub const kio = struct {
    ...
    pub fn Stat(param1: ?*anyopaque, param2: i32) QtC.KIO__StatJob {
        return qtc.KIO_Stat(@ptrCast(param1), @bitCast(param2));
    }
    ...
    pub fn Stat2(param1: ?*anyopaque, param2: i32, param3: i32, param4: i32) QtC.KIO__StatJob {
        return qtc.KIO_Stat2(@ptrCast(param1), @bitCast(param2), @bitCast(param3), @bitCast(param4));
    }
    ...
    pub fn MostLocalUrl(param1: ?*anyopaque, param2: i32) QtC.KIO__StatJob {
        return qtc.KIO_MostLocalUrl(@ptrCast(param1), @bitCast(param2));
    }
};
