...
pub const KIO__DirectorySizeJob = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KIO__DirectorySizeJob_Tr(s_Cstring);
    ...
    /// ### DEPRECATED: Use `totalSubdirs` instead
    ///
    pub const TotalSubdirs = totalSubdirs;
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.KIO__DirectorySizeJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.KIO__DirectorySizeJob_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn detailedErrorStrings(self: KIO__DirectorySizeJob, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__DirectorySizeJob.detailedErrorStrings: Memory allocation failed");
    ...
    /// ` _parentJob: KIO__Job `
    ///
    pub fn setParentJob(self: KIO__DirectorySizeJob, _parentJob: anytype) void {
    ...
    ///
    pub fn setMetaData(self: KIO__DirectorySizeJob, _metaData: anytype) void {
    ...
    pub fn detailedErrorStrings1(self: KIO__DirectorySizeJob, allocator: std.mem.Allocator, reqUrl: anytype) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__DirectorySizeJob.detailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn detailedErrorStrings2(self: KIO__DirectorySizeJob, allocator: std.mem.Allocator, reqUrl: anytype, method: i32) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__DirectorySizeJob.detailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` self: KIO__DirectorySizeJob `
    ///
    pub fn suspend0(self: KIO__DirectorySizeJob) bool {
    ...
    /// ` self: KIO__DirectorySizeJob `
    ///
    pub fn resume0(self: KIO__DirectorySizeJob) bool {
    ...
    /// ` self: KIO__DirectorySizeJob `
    ///
    pub fn error0(self: KIO__DirectorySizeJob) i32 {
    ...
    /// ` _speed: usize `
    ///
    pub fn speed(self: KIO__DirectorySizeJob, job: anytype, _speed: usize) void {
        comptime _ = @TypeOf(job)._is_KJob;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KIO__DirectorySizeJob, _event: anytype) bool {
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KIO__DirectorySizeJob, watched: anytype, _event: anytype) bool {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KIO__DirectorySizeJob, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KIO__DirectorySizeJob, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KIO__DirectorySizeJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KIO__DirectorySizeJob, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KIO__DirectorySizeJob.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KIO__DirectorySizeJob, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
...
pub const KIO = extern struct {
    ...
    /// ### DEPRECATED: Use `directorySize` instead
    ///
    pub const DirectorySize = directorySize;
    ...
    /// ### DEPRECATED: Use `directorySize2` instead
    ///
    pub const DirectorySize2 = directorySize2;
