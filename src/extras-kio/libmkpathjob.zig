...
pub const kio__mkpathjob = struct {
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJoburl: QtC.QUrl) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KIO__Job) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KJob, message: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KJob, size: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KJob, speed: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobjob: QtC.KJob, percent: u64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KIO__MkpathJob `
    ///
    /// ` callback: *const fn (self: QtC.KIO__MkpathJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
