...
pub const kio__mkpathjob = struct {
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ``` self: QtC.KIO__MkpathJob ```
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KIO__MkpathJob_MetaObject(@ptrCast(self));
    }

    /// ``` self: QtC.KIO__MkpathJob, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KIO__MkpathJob_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KIO__MkpathJob, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KIO__MkpathJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__MkpathJob_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.Tr: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, url: QtC.QUrl ```
    pub fn DirectoryCreated(self: ?*anyopaque, url: ?*anyopaque) void {
        qtc.KIO__MkpathJob_DirectoryCreated(@ptrCast(self), @ptrCast(url));
    }

    /// [Qt documentation](https://api.kde.org/kio-mkpathjob.html#directoryCreated)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, url: QtC.QUrl) callconv(.c) void ```
    pub fn OnDirectoryCreated(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KIO__MkpathJob_Connect_DirectoryCreated(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KIO__MkpathJob_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KIO__MkpathJob_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, extension: QtC.KIO__JobUiDelegateExtension ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, allocator: std.mem.Allocator ```
    pub fn ErrorString(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KIO__Job_ErrorString(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.ErrorString: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn DetailedErrorStrings(self: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::mkpathjob.DetailedErrorStrings: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkpathjob.DetailedErrorStrings: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, parentJob: QtC.KIO__Job ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, metaData: QtC.KIO__MetaData ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, key: []const u8, value: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#addMetaData)
    ///
    /// ``` self: QtC.KIO__MkpathJob, values: map_constu8_constu8, allocator: std.mem.Allocator ```
    pub fn AddMetaData2(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::mkpathjob.AddMetaData2: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::mkpathjob.AddMetaData2: Memory allocation failed");
    ...
    pub fn MergeMetaData(self: ?*anyopaque, values: map_constu8_constu8, allocator: std.mem.Allocator) void {
        const values_keys = allocator.alloc(qtc.libqt_string, values.count()) catch @panic("kio::mkpathjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_keys);
        const values_values = allocator.alloc([]const u8, values.count()) catch @panic("kio::mkpathjob.MergeMetaData: Memory allocation failed");
        defer allocator.free(values_values);
        var i: usize = 0;
        var values_it = values.iterator();
        while (values_it.next()) |entry| {
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, key: []const u8, allocator: std.mem.Allocator ```
    pub fn QueryMetaData(self: ?*anyopaque, key: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.QueryMetaData: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KIO__Job ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#connected)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KIO__Job) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__MkpathJob, reqUrl: QtC.QUrl, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings1(self: ?*anyopaque, reqUrl: ?*anyopaque, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::mkpathjob.DetailedErrorStrings1: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkpathjob.DetailedErrorStrings1: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://api.kde.org/kio-job.html#detailedErrorStrings)
    ///
    /// ``` self: QtC.KIO__MkpathJob, reqUrl: QtC.QUrl, method: i32, allocator: std.mem.Allocator ```
    pub fn DetailedErrorStrings2(self: ?*anyopaque, reqUrl: ?*anyopaque, method: i32, allocator: std.mem.Allocator) [][]const u8 {
        ...
        const _ret = allocator.alloc([]const u8, _arr.len) catch @panic("kio::mkpathjob.DetailedErrorStrings2: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkpathjob.DetailedErrorStrings2: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, delegate: QtC.KJobUiDelegate ```
    ...
    pub fn ErrorText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.ErrorText: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, unit: kjob_enums.Unit ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, autodelete: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KJob, message: []const u8 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#infoMessage)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, message: [*:0]const u8) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KJob, size: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#totalSize)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, size: u64) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, job: QtC.KJob, speed: u64 ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#speed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, speed: u64) callconv(.c) void ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#kill)
    ///
    /// ``` self: QtC.KIO__MkpathJob, verbosity: kjob_enums.KillVerbosity ```
    ...
    /// [Qt documentation](https://api.kde.org/kjob.html#setFinishedNotificationHidden)
    ///
    /// ``` self: QtC.KIO__MkpathJob, hide: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, event: QtC.QEvent ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("kio::mkpathjob.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, b: bool ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KIO__MkpathJob, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("kio::mkpathjob.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__MkpathJob, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("kio::mkpathjob.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("kio::mkpathjob.DynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data.data[0.._data.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KIO__MkpathJob, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KIO__MkpathJob, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KIO__MkpathJob, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, param1: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, param1: QtC.QObject) callconv(.c) void ```
    ...
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, unit: kjob_enums.Unit, amount: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, job: QtC.KJob, percent: u64) callconv(.c) void ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.KIO__MkpathJob, callback: *const fn (self: QtC.KIO__MkpathJob, objectName: [*:0]const u8) callconv(.c) void ```
