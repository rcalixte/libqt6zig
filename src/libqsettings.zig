...
pub const qsettings = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QSettings_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QSettings `
    ///
    /// ` callback: *const fn (self: QtC.QSettingsparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSettings `
    ///
    /// ` callback: *const fn (self: QtC.QSettingsobjectName: [*:0]const u8) callconv(.c) void `
    ///
