...
pub const qabstractstate = struct {
    /// ### [Upstream resources](https://doc.qt.io/qt-6/qobject.html#metaObject)
    ///
    /// ## Parameter(s):
    ///
    /// ` self: QtC.QAbstractState `
    ///
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QAbstractState_MetaObject(@ptrCast(self));
    }
    ...
    pub fn Metacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        ...
        return qtc.QAbstractState_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QAbstractState_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QAbstractState `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractState, active: bool) callconv(.c) void `
    ///
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("qabstractstate.Children: Memory allocation failed");
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("qabstractstate.DynamicPropertyNames: Memory allocation failed");
    ...
    /// ` self: QtC.QAbstractState `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractState) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractState `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractState, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractState `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractState, objectName: [*:0]const u8) callconv(.c) void `
    ///
    ...
    pub fn QDelete(self: ?*anyopaque) void {
        qtc.QAbstractState_Delete(@ptrCast(self));
    }
};
