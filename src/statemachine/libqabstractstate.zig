...
pub const QAbstractState = extern struct {
    ...
    /// ` active: bool `
    ///
    pub fn ActiveChanged(self: QAbstractState, active: bool) void {
    ...
    /// ` event: QEvent `
    ///
    pub fn EventFilter(self: QAbstractState, watched: anytype, event: anytype) bool {
    ...
    /// ` thread: QThread `
    ///
    pub fn MoveToThread(self: QAbstractState, thread: anytype) bool {
    ...
    /// ` parent: QObject `
    ///
    pub fn SetParent(self: QAbstractState, parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn Connect3(self: QAbstractState, sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn Connect4(self: QAbstractState, sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
