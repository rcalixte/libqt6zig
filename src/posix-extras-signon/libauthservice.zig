...
pub const signon__authservice = struct {
    ...
    pub fn OnMetaObject(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QMetaObject) void {
        qtc.SignOn__AuthService_OnMetaObject(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.SignOn__AuthService_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn OnMetacast(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) ?*anyopaque) void {
        qtc.SignOn__AuthService_OnMetacast(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.SignOn__AuthService_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn MechanismsAvailable(self: ?*anyopaque, method: []const u8, mechanisms: [][]const u8, allocator: std.mem.Allocator) void {
        ...
        var mechanisms_arr = allocator.alloc(qtc.libqt_string, mechanisms.len) catch @panic("signon__authservice.MechanismsAvailable: Memory allocation failed");
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("signon__authservice.DynamicPropertyNames: Memory allocation failed");
