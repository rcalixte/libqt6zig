...
pub const qtextobject = struct {
    ...
    ///
    /// ``` self: QtC.QTextObject, callback: *const fn (self: QtC.QTextObject, objectName: [*:0]const u8) callconv(.c) void ```
...
pub const qtextblockgroup = struct {
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QTextBlockGroup, callback: *const fn (self: QtC.QTextBlockGroup, objectName: [*:0]const u8) callconv(.c) void ```
    pub fn OnObjectNameChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) void) void {
        qtc.QObject_Connect_ObjectNameChanged(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
};
...
pub const qtextframe = struct {
    ...
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque) callconv(.c) i32 ```
    ...
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, watched: QtC.QObject, event: QtC.QEvent) callconv(.c) bool ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, event: QtC.QTimerEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, event: QtC.QChildEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, event: QtC.QEvent) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, signal: QtC.QMetaMethod) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, format: QtC.QTextFormat) callconv(.c) void ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn () callconv(.c) QtC.QObject ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn () callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, signal: [*:0]const u8) callconv(.c) i32 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, signal: QtC.QMetaMethod) callconv(.c) bool ```
    ...
    /// Wrapper to allow calling private signal
    ///
    /// ``` self: QtC.QTextFrame, callback: *const fn (self: QtC.QTextFrame, objectName: [*:0]const u8) callconv(.c) void ```
    pub fn OnObjectNameChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) void) void {
        qtc.QObject_Connect_ObjectNameChanged(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
