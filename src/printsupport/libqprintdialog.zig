...
pub const QPrintDialog = extern struct {
    ...
    /// Allocate a new QPrintDialog object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    /// ` _parent: QWidget `
    ///
    pub fn new(_parent: anytype) QPrintDialog {
        comptime _ = @TypeOf(_parent)._is_QWidget;
        return .{ .ptr = qtc.QPrintDialog_new(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _printer: QPrinter `
    ///
    pub fn new2(_printer: anytype) QPrintDialog {
        comptime _ = @TypeOf(_printer)._is_QPrinter;
        return .{ .ptr = qtc.QPrintDialog_new2(@ptrCast(_printer.ptr)) };
    }
    ...
    /// ` _parent: QWidget `
    ///
    pub fn new4(_printer: anytype, _parent: anytype) QPrintDialog {
        comptime _ = @TypeOf(_printer)._is_QPrinter;
        comptime _ = @TypeOf(_parent)._is_QWidget;
        return .{ .ptr = qtc.QPrintDialog_new4(@ptrCast(_printer.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QPrintDialog_Tr(s_Cstring);
    ...
    /// ` _result: i32 `
    ///
    pub fn done(self: QPrintDialog, _result: i32) void {
        qtc.QPrintDialog_Done(@ptrCast(self.ptr), @bitCast(_result));
    }
    ...
    /// ` _result: i32 `
    ///
    pub fn superDone(self: QPrintDialog, _result: i32) void {
        qtc.QPrintDialog_SuperDone(@ptrCast(self.ptr), @bitCast(_result));
    }
    ...
    /// ` self: QPrintDialog `
    ///
    /// ` _options: flag of qabstractprintdialog_enums.PrintDialogOption `
    ///
    pub fn setOptions(self: QPrintDialog, _options: i32) void {
        qtc.QPrintDialog_SetOptions(@ptrCast(self.ptr), @bitCast(_options));
    }
    ...
    /// ` _printer: QPrinter `
    ///
    pub fn accepted(self: QPrintDialog, _printer: anytype) void {
        comptime _ = @TypeOf(_printer)._is_QPrinter;
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QPrintDialog_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QPrintDialog_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _toPage: i32 `
    ///
    pub fn setFromTo(self: QPrintDialog, _fromPage: i32, _toPage: i32) void {
    ...
    /// ` _result: i32 `
    ///
    pub fn finished(self: QPrintDialog, _result: i32) void {
    ...
    /// ` _style: QStyle `
    ///
    pub fn setStyle(self: QPrintDialog, _style: anytype) void {
    ...
    ///
    pub fn setWindowModality(self: QPrintDialog, _windowModality: i32) void {
    ...
    /// ` _minimumSize: QSize `
    ///
    pub fn setMinimumSize(self: QPrintDialog, _minimumSize: anytype) void {
    ...
    /// ` _maximumSize: QSize `
    ///
    pub fn setMaximumSize(self: QPrintDialog, _maximumSize: anytype) void {
    ...
    ///
    pub fn setSizeIncrement(self: QPrintDialog, _sizeIncrement: anytype) void {
    ...
    /// ` _baseSize: QSize `
    ///
    pub fn setBaseSize(self: QPrintDialog, _baseSize: anytype) void {
    ...
    /// ` _palette: QPalette `
    ///
    pub fn setPalette(self: QPrintDialog, _palette: anytype) void {
    ...
    ///
    pub fn setBackgroundRole(self: QPrintDialog, _backgroundRole: i32) void {
    ...
    ///
    pub fn setForegroundRole(self: QPrintDialog, _foregroundRole: i32) void {
    ...
    /// ` _font: QFont `
    ///
    pub fn setFont(self: QPrintDialog, _font: anytype) void {
    ...
    /// ` _cursor: QCursor `
    ///
    pub fn setCursor(self: QPrintDialog, _cursor: anytype) void {
    ...
    /// ` _mask: QBitmap `
    ///
    pub fn setMask(self: QPrintDialog, _mask: anytype) void {
    ...
    /// ` _mask: QRegion `
    ///
    pub fn setMask2(self: QPrintDialog, _mask: anytype) void {
    ...
    ///
    pub fn setWindowTitle(self: QPrintDialog, _windowTitle: []const u8) void {
    ...
    ///
    pub fn setStyleSheet(self: QPrintDialog, _styleSheet: []const u8) void {
    ...
    ///
    pub fn setWindowIconText(self: QPrintDialog, _windowIconText: []const u8) void {
    ...
    ///
    pub fn setWindowRole(self: QPrintDialog, _windowRole: []const u8) void {
    ...
    /// ` _toolTip: []const u8 `
    ///
    pub fn setToolTip(self: QPrintDialog, _toolTip: []const u8) void {
    ...
    /// ` _statusTip: []const u8 `
    ///
    pub fn setStatusTip(self: QPrintDialog, _statusTip: []const u8) void {
    ...
    /// ` _whatsThis: []const u8 `
    ///
    pub fn setWhatsThis(self: QPrintDialog, _whatsThis: []const u8) void {
    ...
    /// ` _locale: QLocale `
    ///
    pub fn setLocale(self: QPrintDialog, _locale: anytype) void {
    ...
    /// ` _focusProxy: QWidget `
    ///
    pub fn setFocusProxy(self: QPrintDialog, _focusProxy: anytype) void {
    ...
    /// ` h: i32 `
    ///
    pub fn update2(self: QPrintDialog, _x: i32, _y: i32, w: i32, h: i32) void {
    ...
    /// ` h: i32 `
    ///
    pub fn repaint2(self: QPrintDialog, _x: i32, _y: i32, w: i32, h: i32) void {
    ...
    /// ` _y: i32 `
    ///
    pub fn move(self: QPrintDialog, _x: i32, _y: i32) void {
    ...
    /// ` h: i32 `
    ///
    pub fn setGeometry(self: QPrintDialog, _x: i32, _y: i32, w: i32, h: i32) void {
    ...
    /// ` _geometry: QRect `
    ///
    pub fn setGeometry2(self: QPrintDialog, _geometry: anytype) void {
    ...
    /// ` _geometry: []u8 `
    ///
    pub fn restoreGeometry(self: QPrintDialog, _geometry: []u8) bool {
    ...
    ///
    pub fn setSizePolicy(self: QPrintDialog, _sizePolicy: anytype) void {
    ...
    /// ` _layout: QLayout `
    ///
    pub fn setLayout(self: QPrintDialog, _layout: anytype) void {
    ...
    /// ` _parent: QWidget `
    ///
    pub fn setParent(self: QPrintDialog, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QWidget;
    ...
    ///
    pub fn setParent2(self: QPrintDialog, _parent: anytype, f: i32) void {
        comptime _ = @TypeOf(_parent)._is_QWidget;
    ...
    /// ` _actions: []QAction `
    ///
    pub fn addActions(self: QPrintDialog, _actions: []QAction) void {
    ...
    /// ` _actions: []QAction `
    ///
    pub fn insertActions(self: QPrintDialog, before: anytype, _actions: []QAction) void {
    ...
    /// ` _y: i32 `
    ///
    pub fn childAt(self: QPrintDialog, _x: i32, _y: i32) QWidget {
    ...
    /// ` _screen: QScreen `
    ///
    pub fn setScreen(self: QPrintDialog, _screen: anytype) void {
    ...
    /// ` _pos: QPoint `
    ///
    pub fn customContextMenuRequested(self: QPrintDialog, _pos: anytype) void {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QPrintDialog, _thread: anytype) bool {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QPrintDialog, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QPrintDialog, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QPrintDialog.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QPrintDialog, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QPrintDialog, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QPrintDialog_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QPrintDialog, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QPrintDialog_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn mousePressEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_MousePressEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn superMousePressEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_SuperMousePressEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn mouseReleaseEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_MouseReleaseEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn superMouseReleaseEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_SuperMouseReleaseEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn mouseDoubleClickEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_MouseDoubleClickEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn superMouseDoubleClickEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_SuperMouseDoubleClickEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn mouseMoveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_MouseMoveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMouseEvent `
    ///
    pub fn superMouseMoveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMouseEvent;
        qtc.QPrintDialog_SuperMouseMoveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QWheelEvent `
    ///
    pub fn wheelEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QWheelEvent;
        qtc.QPrintDialog_WheelEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QWheelEvent `
    ///
    pub fn superWheelEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QWheelEvent;
        qtc.QPrintDialog_SuperWheelEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QKeyEvent `
    ///
    pub fn keyReleaseEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QKeyEvent;
        qtc.QPrintDialog_KeyReleaseEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QKeyEvent `
    ///
    pub fn superKeyReleaseEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QKeyEvent;
        qtc.QPrintDialog_SuperKeyReleaseEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QFocusEvent `
    ///
    pub fn focusInEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QFocusEvent;
        qtc.QPrintDialog_FocusInEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QFocusEvent `
    ///
    pub fn superFocusInEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QFocusEvent;
        qtc.QPrintDialog_SuperFocusInEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QFocusEvent `
    ///
    pub fn focusOutEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QFocusEvent;
        qtc.QPrintDialog_FocusOutEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QFocusEvent `
    ///
    pub fn superFocusOutEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QFocusEvent;
        qtc.QPrintDialog_SuperFocusOutEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEnterEvent `
    ///
    pub fn enterEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEnterEvent;
        qtc.QPrintDialog_EnterEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEnterEvent `
    ///
    pub fn superEnterEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEnterEvent;
        qtc.QPrintDialog_SuperEnterEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn leaveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QPrintDialog_LeaveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superLeaveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QPrintDialog_SuperLeaveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QPaintEvent `
    ///
    pub fn paintEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QPaintEvent;
        qtc.QPrintDialog_PaintEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QPaintEvent `
    ///
    pub fn superPaintEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QPaintEvent;
        qtc.QPrintDialog_SuperPaintEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMoveEvent `
    ///
    pub fn moveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMoveEvent;
        qtc.QPrintDialog_MoveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QMoveEvent `
    ///
    pub fn superMoveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QMoveEvent;
        qtc.QPrintDialog_SuperMoveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTabletEvent `
    ///
    pub fn tabletEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTabletEvent;
        qtc.QPrintDialog_TabletEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTabletEvent `
    ///
    pub fn superTabletEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTabletEvent;
        qtc.QPrintDialog_SuperTabletEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QActionEvent `
    ///
    pub fn actionEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QActionEvent;
        qtc.QPrintDialog_ActionEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QActionEvent `
    ///
    pub fn superActionEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QActionEvent;
        qtc.QPrintDialog_SuperActionEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    ///
    pub fn dragEnterEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDragEnterEvent;
        qtc.QPrintDialog_DragEnterEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QDragEnterEvent `
    ///
    pub fn superDragEnterEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDragEnterEvent;
        qtc.QPrintDialog_SuperDragEnterEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    ///
    pub fn dragMoveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDragMoveEvent;
        qtc.QPrintDialog_DragMoveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QDragMoveEvent `
    ///
    pub fn superDragMoveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDragMoveEvent;
        qtc.QPrintDialog_SuperDragMoveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    ///
    pub fn dragLeaveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDragLeaveEvent;
        qtc.QPrintDialog_DragLeaveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QDragLeaveEvent `
    ///
    pub fn superDragLeaveEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDragLeaveEvent;
        qtc.QPrintDialog_SuperDragLeaveEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QDropEvent `
    ///
    pub fn dropEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDropEvent;
        qtc.QPrintDialog_DropEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QDropEvent `
    ///
    pub fn superDropEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QDropEvent;
        qtc.QPrintDialog_SuperDropEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QHideEvent `
    ///
    pub fn hideEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QHideEvent;
        qtc.QPrintDialog_HideEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QHideEvent `
    ///
    pub fn superHideEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QHideEvent;
        qtc.QPrintDialog_SuperHideEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _result: *isize `
    ///
    pub fn nativeEvent(self: QPrintDialog, eventType: []u8, message: ?*anyopaque, _result: *isize) bool {
        const eventType_str = qtc.libqt_string{
            .len = eventType.len,
            .data = eventType.ptr,
        };
        return qtc.QPrintDialog_NativeEvent(@ptrCast(self.ptr), eventType_str, @ptrCast(message), @ptrCast(_result));
    }
    ...
    /// ` _result: *isize `
    ///
    pub fn superNativeEvent(self: QPrintDialog, eventType: []u8, message: ?*anyopaque, _result: *isize) bool {
        const eventType_str = qtc.libqt_string{
            .len = eventType.len,
            .data = eventType.ptr,
        };
        return qtc.QPrintDialog_SuperNativeEvent(@ptrCast(self.ptr), eventType_str, @ptrCast(message), @ptrCast(_result));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QPrintDialog_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QPrintDialog_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QPrintDialog_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QPrintDialog_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QPrintDialog_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QPrintDialog, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QPrintDialog_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
