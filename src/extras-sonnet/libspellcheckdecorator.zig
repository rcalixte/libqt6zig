...
pub const Sonnet__SpellCheckDecorator = extern struct {
    ...
    /// Allocate a new Sonnet::SpellCheckDecorator object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    /// ` textEdit: QTextEdit `
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.Sonnet__SpellCheckDecorator_Tr(s_Cstring);
    ...
    ///
    pub fn setHighlighter(self: Sonnet__SpellCheckDecorator, _highlighter: anytype) void {
        comptime _ = @TypeOf(_highlighter)._is_Sonnet__Highlighter;
        qtc.Sonnet__SpellCheckDecorator_SetHighlighter(@ptrCast(self.ptr), @ptrCast(_highlighter.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: Sonnet__SpellCheckDecorator, obj: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(obj)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.Sonnet__SpellCheckDecorator_EventFilter(@ptrCast(self.ptr), @ptrCast(obj.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: Sonnet__SpellCheckDecorator, obj: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(obj)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.Sonnet__SpellCheckDecorator_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(obj.ptr), @ptrCast(_event.ptr));
    }

    /// ### DEPRECATED: Use `isSpellCheckingEnabledForBlock` instead
    ///
    pub const IsSpellCheckingEnabledForBlock = isSpellCheckingEnabledForBlock;
    ...
    /// ### DEPRECATED: Use `onIsSpellCheckingEnabledForBlock` instead
    ///
    pub const OnIsSpellCheckingEnabledForBlock = onIsSpellCheckingEnabledForBlock;
    ...
    ///
    pub const SuperIsSpellCheckingEnabledForBlock = superIsSpellCheckingEnabledForBlock;
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.Sonnet__SpellCheckDecorator_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.Sonnet__SpellCheckDecorator_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: Sonnet__SpellCheckDecorator, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: Sonnet__SpellCheckDecorator, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: Sonnet__SpellCheckDecorator, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: Sonnet__SpellCheckDecorator, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("Sonnet__SpellCheckDecorator.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: Sonnet__SpellCheckDecorator, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: Sonnet__SpellCheckDecorator, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.Sonnet__SpellCheckDecorator_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.Sonnet__SpellCheckDecorator_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.Sonnet__SpellCheckDecorator_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.Sonnet__SpellCheckDecorator_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.Sonnet__SpellCheckDecorator_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.Sonnet__SpellCheckDecorator_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.Sonnet__SpellCheckDecorator_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: Sonnet__SpellCheckDecorator, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.Sonnet__SpellCheckDecorator_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
