...
pub const sonnet__spellcheckdecorator = struct {
    ...
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.Sonnet__SpellCheckDecorator_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.Sonnet__SpellCheckDecorator, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.Sonnet__SpellCheckDecorator_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.Sonnet__SpellCheckDecorator_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _ret = allocator.alloc(u8, _str.len) catch @panic("sonnet::spellcheckdecorator.Tr: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, textBlock: []const u8 ```
    pub fn QBaseIsSpellCheckingEnabledForBlock(self: ?*anyopaque, textBlock: []const u8) bool {
        const textBlock_str = qtc.libqt_string{
            .len = textBlock.len,
            .data = textBlock.ptr,
        };
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("sonnet::spellcheckdecorator.Tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        ...
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("sonnet::spellcheckdecorator.Tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, allocator: std.mem.Allocator ```
    pub fn ObjectName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.QObject_ObjectName(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("sonnet::spellcheckdecorator.ObjectName: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, b: bool ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, id: i32 ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, id: qnamespace_enums.TimerId ```
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("sonnet::spellcheckdecorator.Children: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, obj: QtC.QObject ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, name: []const u8, value: QtC.QVariant ```
    ...
    pub fn DynamicPropertyNames(self: ?*anyopaque, allocator: std.mem.Allocator) [][]u8 {
        ...
        const _ret = allocator.alloc([]u8, _arr.len) catch @panic("sonnet::spellcheckdecorator.DynamicPropertyNames: Memory allocation failed");
        for (0.._arr.len) |i| {
            const _data = _str[i];
            const _buf = allocator.alloc(u8, _data.len) catch @panic("sonnet::spellcheckdecorator.DynamicPropertyNames: Memory allocation failed");
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, classname: []const u8 ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Upstream resources](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, param1: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, event: QtC.QEvent ```
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.Sonnet__SpellCheckDecorator_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, event: QtC.QTimerEvent ```
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.Sonnet__SpellCheckDecorator_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, event: QtC.QChildEvent ```
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.Sonnet__SpellCheckDecorator_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.Sonnet__SpellCheckDecorator_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, signal: QtC.QMetaMethod ```
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.Sonnet__SpellCheckDecorator_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.Sonnet__SpellCheckDecorator_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.Sonnet__SpellCheckDecorator_QBaseSender(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.Sonnet__SpellCheckDecorator_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.Sonnet__SpellCheckDecorator, signal: []const u8 ```
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.Sonnet__SpellCheckDecorator_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.Sonnet__SpellCheckDecorator_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
