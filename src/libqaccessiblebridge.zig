...
pub const qaccessiblebridgeplugin = struct {
    ...
    /// ` self: QtC.QAccessibleBridgePlugin `
    ///
    /// ` callback: *const fn (self: QtC.QAccessibleBridgePluginparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAccessibleBridgePlugin `
    ///
    /// ` callback: *const fn (self: QtC.QAccessibleBridgePluginobjectName: [*:0]const u8) callconv(.c) void `
    ///
