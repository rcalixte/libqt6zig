...
pub const ksvg__framesvg = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KSvg__FrameSvg_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KSvg__FrameSvg_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Prefix(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KSvg__FrameSvg_Prefix(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn ActualPrefix(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KSvg__FrameSvg_ActualPrefix(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("ksvg__framesvg.Children: Memory allocation failed");
