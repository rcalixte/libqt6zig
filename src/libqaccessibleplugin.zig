...
pub const qaccessibleplugin = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.QAccessiblePlugin_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.QAccessiblePlugin_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QAccessiblePlugin `
    ///
    /// ` callback: *const fn (self: QtC.QAccessiblePluginparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAccessiblePlugin `
    ///
    /// ` callback: *const fn (self: QtC.QAccessiblePluginobjectName: [*:0]const u8) callconv(.c) void `
    ///
