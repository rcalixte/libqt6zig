...
pub const qgraphicssvgitem = struct {
    ...
    /// ` self: QtC.QGraphicsSvgItem `
    ///
    /// ` callback: *const fn (self: QtC.QGraphicsSvgItemparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QGraphicsSvgItem `
    ///
    /// ` callback: *const fn (self: QtC.QGraphicsSvgItemobjectName: [*:0]const u8) callconv(.c) void `
    ///
