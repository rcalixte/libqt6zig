...
libqt_string Solid__DeviceInterface_Tr(const char* s) {
    auto _ret = Solid::DeviceInterface::tr(s);
...
libqt_string Solid__DeviceInterface_TypeToString(int typeVal) {
    auto _ret = Solid::DeviceInterface::typeToString(static_cast<Solid::DeviceInterface::Type>(typeVal));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string Solid__DeviceInterface_TypeDescription(int typeVal) {
    auto _ret = Solid::DeviceInterface::typeDescription(static_cast<Solid::DeviceInterface::Type>(typeVal));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string Solid__DeviceInterface_Tr2(const char* s, const char* c) {
    auto _ret = Solid::DeviceInterface::tr(s, c);
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string Solid__DeviceInterface_Tr3(const char* s, const char* c, int n) {
    auto _ret = Solid::DeviceInterface::tr(s, c, static_cast<int>(n));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
