...
pub const Solid__GenericInterface = extern struct {
    ...
    /// ### DEPRECATED: Use `allProperties` instead
    ///
    pub const AllProperties = allProperties;
    ...
    pub fn allProperties(self: Solid__GenericInterface, allocator: std.mem.Allocator) ArrayMap_constu8_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, @intCast(_map.len)) catch @panic("Solid__GenericInterface.allProperties: Total capacity allocation failed");
        defer {
    ...
    ///
    pub const PropertyExists = propertyExists;
    ...
    /// ### DEPRECATED: Use `conditionRaised` instead
    ///
    pub const ConditionRaised = conditionRaised;
    ...
    /// ### DEPRECATED: Use `onConditionRaised` instead
    ///
    pub const OnConditionRaised = onConditionRaised;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: Solid__GenericInterface, _event: anytype) bool {
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: Solid__GenericInterface, watched: anytype, _event: anytype) bool {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: Solid__GenericInterface, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: Solid__GenericInterface, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: Solid__GenericInterface, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: Solid__GenericInterface, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("Solid__GenericInterface.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: Solid__GenericInterface, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
