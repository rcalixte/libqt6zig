...
pub const solid__genericinterface = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.Solid__GenericInterface_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn AllProperties(self: ?*anyopaque, allocator: std.mem.Allocator) map_constu8_qtcqvariant {
        ...
        while (i < _map.len) : (i += 1) {
            ...
            _ret.put(allocator, _entry_slice, @ptrCast(_value)) catch @panic("solid__genericinterface.AllProperties: Memory allocation failed");
        }
        return _ret;
    }
    ...
    pub fn OnConditionRaised(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8, [*:0]const u8) callconv(.c) void) void {
        qtc.Solid__GenericInterface_Connect_ConditionRaised(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("solid__genericinterface.Children: Memory allocation failed");
    ...
    /// ` self: QtC.Solid__GenericInterface `
    ///
    /// ` callback: *const fn (self: QtC.Solid__GenericInterface) callconv(.c) void `
    ///
