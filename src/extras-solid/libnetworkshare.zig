...
pub const solid__networkshare = struct {
    ...
    /// ``` self: QtC.Solid__NetworkShare, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.Solid__NetworkShare_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.Solid__NetworkShare, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    ...
    /// ``` self: QtC.Solid__NetworkShare ```
    ///
    /// Returns: ``` networkshare_enums.ShareType ```
    ...
    ///
    /// ``` self: QtC.Solid__NetworkShare, callback: *const fn (self: QtC.Solid__NetworkShare, objectName: [*:0]const u8) callconv(.c) void ```
