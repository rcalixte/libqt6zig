...
pub const solid__networkshare = struct {
    ...
    pub fn MetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.Solid__NetworkShare_MetaObject(@ptrCast(self));
    }
    ...
    pub fn Metacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        ...
        return qtc.Solid__NetworkShare_Metacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.Solid__NetworkShare_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("solid__networkshare.Children: Memory allocation failed");
    ...
    /// ` self: QtC.Solid__NetworkShare `
    ///
    /// ` callback: *const fn (self: QtC.Solid__NetworkShare) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__NetworkShare `
    ///
    /// ` callback: *const fn (self: QtC.Solid__NetworkShare, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.Solid__NetworkShare `
    ///
    /// ` callback: *const fn (self: QtC.Solid__NetworkShare, objectName: [*:0]const u8) callconv(.c) void `
    ///
    ...
    pub fn Delete(self: ?*anyopaque) void {
        qtc.Solid__NetworkShare_Delete(@ptrCast(self));
    }
};
