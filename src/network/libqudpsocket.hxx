#pragma once
#ifndef NETWORK_LIBQUDPSOCKET_HXX
#define NETWORK_LIBQUDPSOCKET_HXX
...
class VirtualQUdpSocket final : public QUdpSocket {
  ...
  public:
    ...
    using QUdpSocket_MetaObject_Callback = QMetaObject* (*)();
    using QUdpSocket_Metacast_Callback = void* (*)(QUdpSocket*, const char*);
    ...
    using QUdpSocket_ConnectToHost_Callback = void (*)(QUdpSocket*, const char*, uint16_t, int, int);
    ...
    using QUdpSocket_SetPeerName_Callback = void (*)(QUdpSocket*, const char*);
    using QUdpSocket_SetOpenMode_Callback = void (*)(QUdpSocket*, int);
    using QUdpSocket_SetErrorString_Callback = void (*)(QUdpSocket*, const char*);
  ...
  protected:
    ...
    QUdpSocket_MetaObject_Callback qudpsocket_metaobject_callback = nullptr;
    QUdpSocket_Metacast_Callback qudpsocket_metacast_callback = nullptr;
    ...
    // Instance base flags
    mutable bool qudpsocket_metaobject_isbase = false;
    mutable bool qudpsocket_metacast_isbase = false;
  ...
  public:
    ...
    // Callback setters
    inline void setQUdpSocket_MetaObject_Callback(QUdpSocket_MetaObject_Callback cb) { qudpsocket_metaobject_callback = cb; }
    inline void setQUdpSocket_Metacast_Callback(QUdpSocket_Metacast_Callback cb) { qudpsocket_metacast_callback = cb; }
    ...
    // Base flag setters
    inline void setQUdpSocket_MetaObject_IsBase(bool value) const { qudpsocket_metaobject_isbase = value; }
    inline void setQUdpSocket_Metacast_IsBase(bool value) const { qudpsocket_metacast_isbase = value; }
    ...
    virtual const QMetaObject* metaObject() const override {
        if (qudpsocket_metaobject_isbase) {
            qudpsocket_metaobject_isbase = false;
            return QUdpSocket::metaObject();
        }
        auto metaobject_cb = qudpsocket_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual void* qt_metacast(const char* param1) override {
        if (qudpsocket_metacast_isbase) {
            qudpsocket_metacast_isbase = false;
            return QUdpSocket::qt_metacast(param1);
        }
        auto metacast_cb = qudpsocket_metacast_callback;
        if (metacast_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qudpsocket_metacall_callback;
        if (metacall_cb) {
    ...
    virtual void resume() override {
        ...
        auto resume_cb = qudpsocket_resume_callback;
        if (resume_cb) {
            resume_cb();
            return;
        }
    ...
    virtual bool bind(const QHostAddress& address, quint16 port, QFlags<QAbstractSocket::BindFlag> mode) override {
        ...
        auto bind_cb = qudpsocket_bind_callback;
        if (bind_cb) {
    ...
    virtual void disconnectFromHost() override {
        ...
        auto disconnectfromhost_cb = qudpsocket_disconnectfromhost_callback;
    ...
    virtual qint64 bytesAvailable() const override {
        ...
        auto bytesavailable_cb = qudpsocket_bytesavailable_callback;
    ...
    virtual qint64 bytesToWrite() const override {
        ...
        auto bytestowrite_cb = qudpsocket_bytestowrite_callback;
        if (bytestowrite_cb) {
    ...
    virtual void setReadBufferSize(qint64 size) override {
        ...
        auto setreadbuffersize_cb = qudpsocket_setreadbuffersize_callback;
    ...
    virtual qintptr socketDescriptor() const override {
        ...
        auto socketdescriptor_cb = qudpsocket_socketdescriptor_callback;
    ...
    virtual bool setSocketDescriptor(qintptr socketDescriptor, QAbstractSocket::SocketState state, QFlags<QIODeviceBase::OpenModeFlag> openMode) override {
        ...
        auto setsocketdescriptor_cb = qudpsocket_setsocketdescriptor_callback;
    ...
    virtual void setSocketOption(QAbstractSocket::SocketOption option, const QVariant& value) override {
        ...
        auto setsocketoption_cb = qudpsocket_setsocketoption_callback;
    ...
    virtual QVariant socketOption(QAbstractSocket::SocketOption option) override {
        ...
        auto socketoption_cb = qudpsocket_socketoption_callback;
        if (socketoption_cb) {
            int cbval1 = static_cast<int>(option);
    ...
    virtual void close() override {
        ...
        auto close_cb = qudpsocket_close_callback;
        if (close_cb) {
            close_cb();
            return;
        }
    ...
    virtual bool isSequential() const override {
        ...
        auto issequential_cb = qudpsocket_issequential_callback;
        if (issequential_cb) {
    ...
    virtual bool waitForConnected(int msecs) override {
        ...
        auto waitforconnected_cb = qudpsocket_waitforconnected_callback;
    ...
    virtual bool waitForReadyRead(int msecs) override {
        ...
        auto waitforreadyread_cb = qudpsocket_waitforreadyread_callback;
    ...
    virtual bool waitForBytesWritten(int msecs) override {
        ...
        auto waitforbyteswritten_cb = qudpsocket_waitforbyteswritten_callback;
    ...
    virtual bool waitForDisconnected(int msecs) override {
        ...
        auto waitfordisconnected_cb = qudpsocket_waitfordisconnected_callback;
    ...
    virtual qint64 readData(char* data, qint64 maxlen) override {
        ...
        auto readdata_cb = qudpsocket_readdata_callback;
        if (readdata_cb) {
            char* cbval1 = data;
    ...
    virtual qint64 readLineData(char* data, qint64 maxlen) override {
        ...
        auto readlinedata_cb = qudpsocket_readlinedata_callback;
        if (readlinedata_cb) {
            char* cbval1 = data;
            long long cbval2 = static_cast<long long>(maxlen);
    ...
    virtual qint64 skipData(qint64 maxSize) override {
        ...
        auto skipdata_cb = qudpsocket_skipdata_callback;
        if (skipdata_cb) {
    ...
    virtual bool open(QIODeviceBase::OpenMode mode) override {
        ...
        auto open_cb = qudpsocket_open_callback;
        if (open_cb) {
    ...
    virtual qint64 pos() const override {
        ...
        auto pos_cb = qudpsocket_pos_callback;
        if (pos_cb) {
    ...
    virtual qint64 size() const override {
        ...
        auto size_cb = qudpsocket_size_callback;
        if (size_cb) {
    ...
    virtual bool seek(qint64 pos) override {
        ...
        auto seek_cb = qudpsocket_seek_callback;
        if (seek_cb) {
    ...
    virtual bool atEnd() const override {
        ...
        auto atend_cb = qudpsocket_atend_callback;
        if (atend_cb) {
    ...
    virtual bool reset() override {
        ...
        auto reset_cb = qudpsocket_reset_callback;
        if (reset_cb) {
    ...
    virtual bool canReadLine() const override {
        ...
        auto canreadline_cb = qudpsocket_canreadline_callback;
        if (canreadline_cb) {
    ...
    virtual bool event(QEvent* event) override {
        ...
        auto event_cb = qudpsocket_event_callback;
        if (event_cb) {
            QEvent* cbval1 = event;
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qudpsocket_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void timerEvent(QTimerEvent* event) override {
        ...
        auto timerevent_cb = qudpsocket_timerevent_callback;
        if (timerevent_cb) {
    ...
    virtual void childEvent(QChildEvent* event) override {
        ...
        auto childevent_cb = qudpsocket_childevent_callback;
        if (childevent_cb) {
    ...
    virtual void customEvent(QEvent* event) override {
        ...
        auto customevent_cb = qudpsocket_customevent_callback;
        if (customevent_cb) {
            QEvent* cbval1 = event;
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qudpsocket_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qudpsocket_disconnectnotify_callback;
    ...
    void setSocketState(QAbstractSocket::SocketState state) {
        ...
        auto setsocketstate_cb = qudpsocket_setsocketstate_callback;
    ...
    void setSocketError(QAbstractSocket::SocketError socketError) {
        ...
        auto setsocketerror_cb = qudpsocket_setsocketerror_callback;
    ...
    void setLocalPort(quint16 port) {
        ...
        auto setlocalport_cb = qudpsocket_setlocalport_callback;
        if (setlocalport_cb) {
    ...
    void setLocalAddress(const QHostAddress& address) {
        ...
        auto setlocaladdress_cb = qudpsocket_setlocaladdress_callback;
    ...
    void setPeerPort(quint16 port) {
        ...
        auto setpeerport_cb = qudpsocket_setpeerport_callback;
        if (setpeerport_cb) {
            uint16_t cbval1 = static_cast<uint16_t>(port);
    ...
    void setPeerAddress(const QHostAddress& address) {
        ...
        auto setpeeraddress_cb = qudpsocket_setpeeraddress_callback;
    ...
    void setOpenMode(QIODeviceBase::OpenMode openMode) {
        ...
        auto setopenmode_cb = qudpsocket_setopenmode_callback;
        if (setopenmode_cb) {
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qudpsocket_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qudpsocket_sendersignalindex_callback;
    ...
    int receivers(const char* signal) const {
        ...
        auto receivers_cb = qudpsocket_receivers_callback;
        if (receivers_cb) {
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qudpsocket_issignalconnected_callback;
    ...
    friend long long QUdpSocket_SuperReadData(QUdpSocket* self, char* data, long long maxlen);
    ...
    friend void QUdpSocket_SuperChildEvent(QUdpSocket* self, QChildEvent* event);
    friend void QUdpSocket_CustomEvent(QUdpSocket* self, QEvent* event);
    friend void QUdpSocket_SuperCustomEvent(QUdpSocket* self, QEvent* event);
    friend void QUdpSocket_ConnectNotify(QUdpSocket* self, const QMetaMethod* signal);
    friend void QUdpSocket_SuperConnectNotify(QUdpSocket* self, const QMetaMethod* signal);
    friend void QUdpSocket_DisconnectNotify(QUdpSocket* self, const QMetaMethod* signal);
    friend void QUdpSocket_SuperDisconnectNotify(QUdpSocket* self, const QMetaMethod* signal);
    friend void QUdpSocket_SetSocketState(QUdpSocket* self, int state);
    friend void QUdpSocket_SuperSetSocketState(QUdpSocket* self, int state);
    friend void QUdpSocket_SetSocketError(QUdpSocket* self, int socketError);
    friend void QUdpSocket_SuperSetSocketError(QUdpSocket* self, int socketError);
    friend void QUdpSocket_SetLocalPort(QUdpSocket* self, uint16_t port);
    friend void QUdpSocket_SuperSetLocalPort(QUdpSocket* self, uint16_t port);
    friend void QUdpSocket_SetLocalAddress(QUdpSocket* self, const QHostAddress* address);
    friend void QUdpSocket_SuperSetLocalAddress(QUdpSocket* self, const QHostAddress* address);
    friend void QUdpSocket_SetPeerPort(QUdpSocket* self, uint16_t port);
    friend void QUdpSocket_SuperSetPeerPort(QUdpSocket* self, uint16_t port);
    friend void QUdpSocket_SetPeerAddress(QUdpSocket* self, const QHostAddress* address);
    friend void QUdpSocket_SuperSetPeerAddress(QUdpSocket* self, const QHostAddress* address);
    friend void QUdpSocket_SetPeerName(QUdpSocket* self, const libqt_string name);
    friend void QUdpSocket_SuperSetPeerName(QUdpSocket* self, const libqt_string name);
    friend void QUdpSocket_SetOpenMode(QUdpSocket* self, int openMode);
    friend void QUdpSocket_SuperSetOpenMode(QUdpSocket* self, int openMode);
    friend void QUdpSocket_SetErrorString(QUdpSocket* self, const libqt_string errorString);
    friend void QUdpSocket_SuperSetErrorString(QUdpSocket* self, const libqt_string errorString);
    friend QObject* QUdpSocket_Sender(const QUdpSocket* self);
    friend QObject* QUdpSocket_SuperSender(const QUdpSocket* self);
    friend int QUdpSocket_SenderSignalIndex(const QUdpSocket* self);
    friend int QUdpSocket_SuperSenderSignalIndex(const QUdpSocket* self);
    friend int QUdpSocket_Receivers(const QUdpSocket* self, const char* signal);
    friend int QUdpSocket_SuperReceivers(const QUdpSocket* self, const char* signal);
    friend bool QUdpSocket_IsSignalConnected(const QUdpSocket* self, const QMetaMethod* signal);
    friend bool QUdpSocket_SuperIsSignalConnected(const QUdpSocket* self, const QMetaMethod* signal);
};
