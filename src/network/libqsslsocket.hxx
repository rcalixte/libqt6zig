...
class VirtualQSslSocket final : public QSslSocket {
  ...
  public:
    ...
    friend void QSslSocket_SuperSetSocketState(QSslSocket* self, int state);
    friend void QSslSocket_SetSocketError(QSslSocket* self, int socketError);
    friend void QSslSocket_SuperSetSocketError(QSslSocket* self, int socketError);
    friend void QSslSocket_SetLocalPort(QSslSocket* self, uint16_t port);
    friend void QSslSocket_SuperSetLocalPort(QSslSocket* self, uint16_t port);
    friend void QSslSocket_SetLocalAddress(QSslSocket* self, const QHostAddress* address);
    friend void QSslSocket_SuperSetLocalAddress(QSslSocket* self, const QHostAddress* address);
    friend void QSslSocket_SetPeerPort(QSslSocket* self, uint16_t port);
    friend void QSslSocket_SuperSetPeerPort(QSslSocket* self, uint16_t port);
    friend void QSslSocket_SetPeerAddress(QSslSocket* self, const QHostAddress* address);
    friend void QSslSocket_SuperSetPeerAddress(QSslSocket* self, const QHostAddress* address);
    friend void QSslSocket_SetPeerName(QSslSocket* self, const libqt_string name);
    friend void QSslSocket_SuperSetPeerName(QSslSocket* self, const libqt_string name);
    friend void QSslSocket_SetOpenMode(QSslSocket* self, int openMode);
    friend void QSslSocket_SuperSetOpenMode(QSslSocket* self, int openMode);
    friend void QSslSocket_SetErrorString(QSslSocket* self, const libqt_string errorString);
    friend void QSslSocket_SuperSetErrorString(QSslSocket* self, const libqt_string errorString);
    friend QObject* QSslSocket_Sender(const QSslSocket* self);
    friend QObject* QSslSocket_SuperSender(const QSslSocket* self);
    friend int QSslSocket_SenderSignalIndex(const QSslSocket* self);
    friend int QSslSocket_SuperSenderSignalIndex(const QSslSocket* self);
    friend int QSslSocket_Receivers(const QSslSocket* self, const char* signal);
    friend int QSslSocket_SuperReceivers(const QSslSocket* self, const char* signal);
    friend bool QSslSocket_IsSignalConnected(const QSslSocket* self, const QMetaMethod* signal);
    friend bool QSslSocket_SuperIsSignalConnected(const QSslSocket* self, const QMetaMethod* signal);
};
