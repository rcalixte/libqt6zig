...
pub const qabstractproxymodel = struct {
    ...
    /// ` self: QtC.QAbstractProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractProxyModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.QAbstractProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractProxyModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractProxyModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QAbstractProxyModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAbstractProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.QAbstractProxyModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.QAbstractProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.QAbstractProxyModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
