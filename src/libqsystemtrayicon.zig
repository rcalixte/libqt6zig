...
pub const QSystemTrayIcon = extern struct {
    ...
    /// Allocate a new QSystemTrayIcon object in C++ memory
    ///
    ...
    /// ` _icon: QIcon `
    ///
    pub fn new2(_icon: anytype) QSystemTrayIcon {
        comptime _ = @TypeOf(_icon)._is_QIcon;
        return .{ .ptr = qtc.QSystemTrayIcon_new2(@ptrCast(_icon.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new3(_parent: anytype) QSystemTrayIcon {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QSystemTrayIcon_new3(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new4(_icon: anytype, _parent: anytype) QSystemTrayIcon {
        comptime _ = @TypeOf(_icon)._is_QIcon;
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QSystemTrayIcon_new4(@ptrCast(_icon.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QSystemTrayIcon_Tr(s_Cstring);
    ...
    /// ` _icon: QIcon `
    ///
    pub fn setIcon(self: QSystemTrayIcon, _icon: anytype) void {
        comptime _ = @TypeOf(_icon)._is_QIcon;
        qtc.QSystemTrayIcon_SetIcon(@ptrCast(self.ptr), @ptrCast(_icon.ptr));
    }
    ...
    /// ### DEPRECATED: Use `isSystemTrayAvailable` instead
    ///
    pub const IsSystemTrayAvailable = isSystemTrayAvailable;
    ...
    /// ### DEPRECATED: Use `supportsMessages` instead
    ///
    pub const SupportsMessages = supportsMessages;
    ...
    /// ` _icon: QIcon `
    ///
    pub fn showMessage(self: QSystemTrayIcon, title: []const u8, msg: []const u8, _icon: anytype) void {
        ...
        comptime _ = @TypeOf(_icon)._is_QIcon;
        qtc.QSystemTrayIcon_ShowMessage(@ptrCast(self.ptr), title_str, msg_str, @ptrCast(_icon.ptr));
    }
    ...
    /// ### DEPRECATED: Use `messageClicked` instead
    ///
    pub const MessageClicked = messageClicked;
    ...
    /// ### DEPRECATED: Use `onMessageClicked` instead
    ///
    pub const OnMessageClicked = onMessageClicked;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QSystemTrayIcon, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QSystemTrayIcon_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QSystemTrayIcon, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QSystemTrayIcon_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QSystemTrayIcon_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QSystemTrayIcon_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` msecs: i32 `
    ///
    pub fn showMessage4(self: QSystemTrayIcon, title: []const u8, msg: []const u8, _icon: anytype, msecs: i32) void {
        const title_str = qtc.libqt_string{
            .len = title.len,
            .data = title.ptr,
        };
        ...
        comptime _ = @TypeOf(_icon)._is_QIcon;
        qtc.QSystemTrayIcon_ShowMessage4(@ptrCast(self.ptr), title_str, msg_str, @ptrCast(_icon.ptr), @bitCast(msecs));
    }
    ...
    /// ` msg: []const u8 `
    ///
    /// ` _icon: qsystemtrayicon_enums.MessageIcon `
    ///
    pub fn showMessage3(self: QSystemTrayIcon, title: []const u8, msg: []const u8, _icon: i32) void {
        const title_str = qtc.libqt_string{
            .len = title.len,
            .data = title.ptr,
        };
        ...
        qtc.QSystemTrayIcon_ShowMessage3(@ptrCast(self.ptr), title_str, msg_str, @bitCast(_icon));
    }

    /// ### DEPRECATED: Use `showMessage42` instead
    ///
    pub const ShowMessage42 = showMessage42;
    ...
    /// ` msecs: i32 `
    ///
    pub fn showMessage42(self: QSystemTrayIcon, title: []const u8, msg: []const u8, _icon: i32, msecs: i32) void {
        const title_str = qtc.libqt_string{
            .len = title.len,
            .data = title.ptr,
        };
        ...
        qtc.QSystemTrayIcon_ShowMessage42(@ptrCast(self.ptr), title_str, msg_str, @bitCast(_icon), @bitCast(msecs));
    }
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QSystemTrayIcon, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QSystemTrayIcon, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QSystemTrayIcon, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QSystemTrayIcon, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QSystemTrayIcon.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QSystemTrayIcon, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QSystemTrayIcon, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QSystemTrayIcon_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QSystemTrayIcon, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QSystemTrayIcon_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QSystemTrayIcon, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QSystemTrayIcon_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QSystemTrayIcon, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QSystemTrayIcon_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QSystemTrayIcon, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QSystemTrayIcon_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QSystemTrayIcon, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QSystemTrayIcon_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QSystemTrayIcon, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QSystemTrayIcon_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QSystemTrayIcon, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QSystemTrayIcon_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
