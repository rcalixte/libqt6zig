...
pub const qpdfsearchmodel = struct {
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QPdfSearchModel `
    ///
    /// ` callback: *const fn (self: QtC.QPdfSearchModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
