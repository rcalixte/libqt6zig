...
pub const qtabwidget = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QTabWidget_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QTabWidget_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn TabText(self: ?*anyopaque, index: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QTabWidget_TabText(@ptrCast(self), @intCast(index));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn TabToolTip(self: ?*anyopaque, index: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QTabWidget_TabToolTip(@ptrCast(self), @intCast(index));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn TabWhatsThis(self: ?*anyopaque, index: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QTabWidget_TabWhatsThis(@ptrCast(self), @intCast(index));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgetindex: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgettitle: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgeticon: QtC.QIcon) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgeticonText: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgetpos: QtC.QPoint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgetparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QTabWidget`
    ///
    /// ` callback: *const fn (self: QtC.QTabWidget, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
    ...
    /// ` self: QtC.QTabWidget `
    ///
    /// ` callback: *const fn (self: QtC.QTabWidgetobjectName: [*:0]const u8) callconv(.c) void `
    ///
