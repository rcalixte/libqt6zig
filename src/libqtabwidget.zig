...
pub const qtabwidget = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QTabWidget_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseHeightForWidth(self: ?*anyopaque, width: i32) i32 {
        return qtc.QTabWidget_QBaseHeightForWidth(@ptrCast(self), @bitCast(width));
    }
    ...
    pub fn QBaseTabInserted(self: ?*anyopaque, index: i32) void {
        qtc.QTabWidget_QBaseTabInserted(@ptrCast(self), @bitCast(index));
    }
    ...
    pub fn QBaseTabRemoved(self: ?*anyopaque, index: i32) void {
        qtc.QTabWidget_QBaseTabRemoved(@ptrCast(self), @bitCast(index));
    }
    ...
    pub fn QBaseMetric(self: ?*anyopaque, param1: i32) i32 {
        return qtc.QTabWidget_QBaseMetric(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseInputMethodQuery(self: ?*anyopaque, param1: i32) QtC.QVariant {
        return qtc.QTabWidget_QBaseInputMethodQuery(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseGetDecodedMetricF(self: ?*anyopaque, metricA: i32, metricB: i32) f64 {
        return qtc.QTabWidget_QBaseGetDecodedMetricF(@ptrCast(self), @bitCast(metricA), @bitCast(metricB));
    }
