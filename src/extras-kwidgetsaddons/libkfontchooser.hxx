...
class VirtualKFontChooser final : public KFontChooser {
  ...
  public:
    ...
    friend void KFontChooser_SuperUpdateMicroFocus(KFontChooser* self);
    friend void KFontChooser_Create(KFontChooser* self);
    friend void KFontChooser_SuperCreate(KFontChooser* self);
    friend void KFontChooser_Destroy(KFontChooser* self);
    friend void KFontChooser_SuperDestroy(KFontChooser* self);
    friend bool KFontChooser_FocusNextChild(KFontChooser* self);
    friend bool KFontChooser_SuperFocusNextChild(KFontChooser* self);
    friend bool KFontChooser_FocusPreviousChild(KFontChooser* self);
    friend bool KFontChooser_SuperFocusPreviousChild(KFontChooser* self);
    friend QObject* KFontChooser_Sender(const KFontChooser* self);
    friend QObject* KFontChooser_SuperSender(const KFontChooser* self);
    friend int KFontChooser_SenderSignalIndex(const KFontChooser* self);
    friend int KFontChooser_SuperSenderSignalIndex(const KFontChooser* self);
    friend int KFontChooser_Receivers(const KFontChooser* self, const char* signal);
    friend int KFontChooser_SuperReceivers(const KFontChooser* self, const char* signal);
    friend bool KFontChooser_IsSignalConnected(const KFontChooser* self, const QMetaMethod* signal);
    friend bool KFontChooser_SuperIsSignalConnected(const KFontChooser* self, const QMetaMethod* signal);
    friend double KFontChooser_GetDecodedMetricF(const KFontChooser* self, int metricA, int metricB);
    friend double KFontChooser_SuperGetDecodedMetricF(const KFontChooser* self, int metricA, int metricB);
};
