...
pub const KColumnResizer = extern struct {
    ...
    /// Allocate a new KColumnResizer object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_parent: anytype) KColumnResizer {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.KColumnResizer_new2(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ### DEPRECATED: Use `addWidgetsFromLayout` instead
    ///
    pub const AddWidgetsFromLayout = addWidgetsFromLayout;
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: KColumnResizer, param1: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(param1)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KColumnResizer_EventFilter(@ptrCast(self.ptr), @ptrCast(param1.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: KColumnResizer, param1: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(param1)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KColumnResizer_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(param1.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ### DEPRECATED: Use `addWidgetsFromLayout2` instead
    ///
    pub const AddWidgetsFromLayout2 = addWidgetsFromLayout2;
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: KColumnResizer, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: KColumnResizer, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: KColumnResizer, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: KColumnResizer, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("KColumnResizer.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: KColumnResizer, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: KColumnResizer, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KColumnResizer_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: KColumnResizer, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.KColumnResizer_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: KColumnResizer, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KColumnResizer_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: KColumnResizer, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.KColumnResizer_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: KColumnResizer, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KColumnResizer_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: KColumnResizer, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.KColumnResizer_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: KColumnResizer, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KColumnResizer_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: KColumnResizer, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.KColumnResizer_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
