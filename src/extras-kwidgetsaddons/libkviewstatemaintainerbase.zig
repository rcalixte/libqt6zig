...
pub const KViewStateMaintainerBase = extern struct {
    ...
    /// ` parent: QObject `
    ///
    pub fn New2(parent: anytype) KViewStateMaintainerBase {
        comptime _ = @TypeOf(parent)._is_QObject;
        return .{ .ptr = qtc.KViewStateMaintainerBase_new2(@ptrCast(parent.ptr)) };
    }
    ...
    ///
    pub fn SetSelectionModel(self: KViewStateMaintainerBase, selectionModel: anytype) void {
        comptime _ = @TypeOf(selectionModel)._is_QItemSelectionModel;
        qtc.KViewStateMaintainerBase_SetSelectionModel(@ptrCast(self.ptr), @ptrCast(selectionModel.ptr));
    }
    ...
    ///
    pub fn SetView(self: KViewStateMaintainerBase, view: anytype) void {
        comptime _ = @TypeOf(view)._is_QAbstractItemView;
        qtc.KViewStateMaintainerBase_SetView(@ptrCast(self.ptr), @ptrCast(view.ptr));
    }
    ...
    /// ` thread: QThread `
    ///
    pub fn MoveToThread(self: KViewStateMaintainerBase, thread: anytype) bool {
    ...
    /// ` parent: QObject `
    ///
    pub fn SetParent(self: KViewStateMaintainerBase, parent: anytype) void {
        comptime _ = @TypeOf(parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn Connect3(self: KViewStateMaintainerBase, sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn Connect4(self: KViewStateMaintainerBase, sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` event: QEvent `
    ///
    pub fn Event(self: KViewStateMaintainerBase, event: anytype) bool {
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.KViewStateMaintainerBase_Event(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperEvent(self: KViewStateMaintainerBase, event: anytype) bool {
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.KViewStateMaintainerBase_SuperEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn EventFilter(self: KViewStateMaintainerBase, watched: anytype, event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.KViewStateMaintainerBase_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperEventFilter(self: KViewStateMaintainerBase, watched: anytype, event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(event)._is_QEvent;
        return qtc.KViewStateMaintainerBase_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QTimerEvent `
    ///
    pub fn TimerEvent(self: KViewStateMaintainerBase, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QTimerEvent;
        qtc.KViewStateMaintainerBase_TimerEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QTimerEvent `
    ///
    pub fn SuperTimerEvent(self: KViewStateMaintainerBase, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QTimerEvent;
        qtc.KViewStateMaintainerBase_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QChildEvent `
    ///
    pub fn ChildEvent(self: KViewStateMaintainerBase, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QChildEvent;
        qtc.KViewStateMaintainerBase_ChildEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QChildEvent `
    ///
    pub fn SuperChildEvent(self: KViewStateMaintainerBase, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QChildEvent;
        qtc.KViewStateMaintainerBase_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn CustomEvent(self: KViewStateMaintainerBase, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QEvent;
        qtc.KViewStateMaintainerBase_CustomEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
    ...
    /// ` event: QEvent `
    ///
    pub fn SuperCustomEvent(self: KViewStateMaintainerBase, event: anytype) void {
        comptime _ = @TypeOf(event)._is_QEvent;
        qtc.KViewStateMaintainerBase_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(event.ptr));
    }
