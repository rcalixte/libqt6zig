...
pub const kselector = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KSelector_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KSelector_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    /// ` self: QtC.KSelector`
    ///
    /// ` callback: *const fn (self: QtC.KSelector, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
...
pub const kgradientselector = struct {
    ...
    ///
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.KGradientSelector_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KGradientSelector_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    /// ` self: QtC.KGradientSelector`
    ///
    /// ` callback: *const fn (self: QtC.KGradientSelector, eventType: [*:0]u8, message: ?*anyopaque, result: *isize) callconv(.c) bool `
    ///
    pub fn OnNativeEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]u8, ?*anyopaque, *isize) callconv(.c) bool) void {
