...
pub const kdatepickerpopup = struct {
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopupdate: QtC.QDate) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopupaction: QtC.QAction) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopuptitle: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopupicon: QtC.QIcon) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopupiconText: [*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopuppos: QtC.QPoint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopupparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDatePickerPopup `
    ///
    /// ` callback: *const fn (self: QtC.KDatePickerPopupobjectName: [*:0]const u8) callconv(.c) void `
    ///
