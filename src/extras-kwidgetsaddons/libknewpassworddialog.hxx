...
class VirtualKNewPasswordDialog final : public KNewPasswordDialog {
  ...
  public:
    ...
    using KNewPasswordDialog_MetaObject_Callback = QMetaObject* (*)();
  ...
  protected:
    ...
    // Instance base flags
    mutable bool knewpassworddialog_metaobject_isbase = false;
    mutable bool knewpassworddialog_metacast_isbase = false;
  ...
  public:
    ...
    // Base flag setters
    inline void setKNewPasswordDialog_MetaObject_IsBase(bool value) const { knewpassworddialog_metaobject_isbase = value; }
    inline void setKNewPasswordDialog_Metacast_IsBase(bool value) const { knewpassworddialog_metacast_isbase = value; }
    ...
    friend void KNewPasswordDialog_SuperAdjustPosition(KNewPasswordDialog* self, QWidget* param1);
    friend void KNewPasswordDialog_UpdateMicroFocus(KNewPasswordDialog* self);
    friend void KNewPasswordDialog_SuperUpdateMicroFocus(KNewPasswordDialog* self);
    friend void KNewPasswordDialog_Create(KNewPasswordDialog* self);
    friend void KNewPasswordDialog_SuperCreate(KNewPasswordDialog* self);
    friend void KNewPasswordDialog_Destroy(KNewPasswordDialog* self);
    friend void KNewPasswordDialog_SuperDestroy(KNewPasswordDialog* self);
    friend bool KNewPasswordDialog_FocusNextChild(KNewPasswordDialog* self);
    friend bool KNewPasswordDialog_SuperFocusNextChild(KNewPasswordDialog* self);
    friend bool KNewPasswordDialog_FocusPreviousChild(KNewPasswordDialog* self);
    friend bool KNewPasswordDialog_SuperFocusPreviousChild(KNewPasswordDialog* self);
    friend QObject* KNewPasswordDialog_Sender(const KNewPasswordDialog* self);
    friend QObject* KNewPasswordDialog_SuperSender(const KNewPasswordDialog* self);
    friend int KNewPasswordDialog_SenderSignalIndex(const KNewPasswordDialog* self);
    friend int KNewPasswordDialog_SuperSenderSignalIndex(const KNewPasswordDialog* self);
    friend int KNewPasswordDialog_Receivers(const KNewPasswordDialog* self, const char* signal);
    friend int KNewPasswordDialog_SuperReceivers(const KNewPasswordDialog* self, const char* signal);
    friend bool KNewPasswordDialog_IsSignalConnected(const KNewPasswordDialog* self, const QMetaMethod* signal);
    friend bool KNewPasswordDialog_SuperIsSignalConnected(const KNewPasswordDialog* self, const QMetaMethod* signal);
    friend double KNewPasswordDialog_GetDecodedMetricF(const KNewPasswordDialog* self, int metricA, int metricB);
    friend double KNewPasswordDialog_SuperGetDecodedMetricF(const KNewPasswordDialog* self, int metricA, int metricB);
};
