...
pub const attica__deletejob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.Attica__DeleteJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Children(self: ?*anyopaque, allocator: std.mem.Allocator) []QtC.QObject {
        ...
        const _ret = allocator.alloc(QtC.QObject, _arr.len) catch @panic("attica__deletejob.Children: Memory allocation failed");
    ...
    /// ` self: QtC.Attica__DeleteJob `
    ///
    /// ` callback: *const fn (self: QtC.Attica__DeleteJob) callconv(.c) void `
    ///
