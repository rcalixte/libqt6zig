...
pub const kdialogjobuidelegate = struct {
    ...
    pub fn New2(flags: i32, window: ?*anyopaque) QtC.KDialogJobUiDelegate {
        return qtc.KDialogJobUiDelegate_new2(@bitCast(flags), @ptrCast(window));
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KDialogJobUiDelegate_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.KDialogJobUiDelegate `
    ///
    /// ` callback: *const fn (self: QtC.KDialogJobUiDelegate) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDialogJobUiDelegate `
    ///
    /// ` callback: *const fn (self: QtC.KDialogJobUiDelegate, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KDialogJobUiDelegate `
    ///
    /// ` callback: *const fn (self: QtC.KDialogJobUiDelegate, objectName: [*:0]const u8) callconv(.c) void `
    ///
