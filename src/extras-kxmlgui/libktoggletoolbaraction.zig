...
pub const ktoggletoolbaraction = struct {
    ...
    /// ` self: QtC.KToggleToolBarAction `
    ///
    /// ` callback: *const fn (self: QtC.KToggleToolBarActionenabled: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KToggleToolBarAction `
    ///
    /// ` callback: *const fn (self: QtC.KToggleToolBarActioncheckable: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KToggleToolBarAction `
    ///
    /// ` callback: *const fn (self: QtC.KToggleToolBarActionparam1: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KToggleToolBarAction `
    ///
    /// ` callback: *const fn (self: QtC.KToggleToolBarActionchecked: bool) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KToggleToolBarAction `
    ///
    /// ` callback: *const fn (self: QtC.KToggleToolBarActionparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KToggleToolBarAction `
    ///
    /// ` callback: *const fn (self: QtC.KToggleToolBarActionobjectName: [*:0]const u8) callconv(.c) void `
    ///
