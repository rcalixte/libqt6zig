...
pub const qinputdialog = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QInputDialog_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseDone(self: ?*anyopaque, result: i32) void {
        qtc.QInputDialog_QBaseDone(@ptrCast(self), @bitCast(result));
    }
    ...
    pub fn QBaseHeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return qtc.QInputDialog_QBaseHeightForWidth(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseMetric(self: ?*anyopaque, param1: i32) i32 {
        return qtc.QInputDialog_QBaseMetric(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseInputMethodQuery(self: ?*anyopaque, param1: i32) QtC.QVariant {
        return qtc.QInputDialog_QBaseInputMethodQuery(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseGetDecodedMetricF(self: ?*anyopaque, metricA: i32, metricB: i32) f64 {
        return qtc.QInputDialog_QBaseGetDecodedMetricF(@ptrCast(self), @bitCast(metricA), @bitCast(metricB));
    }
