...
pub const QStringListModel = extern struct {
    ...
    /// Allocate a new QStringListModel object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new3(_parent: anytype) QStringListModel {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QStringListModel_new3(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new4(allocator: std.mem.Allocator, strings: []const []const u8, _parent: anytype) QStringListModel {
        ...
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QStringListModel_new4(strings_list, @ptrCast(_parent.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QStringListModel_Tr(s_Cstring);
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn rowCount(self: QStringListModel, _parent: anytype) i32 {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_RowCount(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superRowCount(self: QStringListModel, _parent: anytype) i32 {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperRowCount(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` role: i32 `
    ///
    pub fn data(self: QStringListModel, _index: anytype, role: i32) QVariant {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_Data(@ptrCast(self.ptr), @ptrCast(_index.ptr), @bitCast(role)) };
    }
    ...
    /// ` role: i32 `
    ///
    pub fn superData(self: QStringListModel, _index: anytype, role: i32) QVariant {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_SuperData(@ptrCast(self.ptr), @ptrCast(_index.ptr), @bitCast(role)) };
    }
    ...
    /// ` role: i32 `
    ///
    pub fn setData(self: QStringListModel, _index: anytype, value: anytype, role: i32) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        comptime _ = @TypeOf(value)._is_QVariant;
        return qtc.QStringListModel_SetData(@ptrCast(self.ptr), @ptrCast(_index.ptr), @ptrCast(value.ptr), @bitCast(role));
    }
    ...
    /// ` role: i32 `
    ///
    pub fn superSetData(self: QStringListModel, _index: anytype, value: anytype, role: i32) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        comptime _ = @TypeOf(value)._is_QVariant;
        return qtc.QStringListModel_SuperSetData(@ptrCast(self.ptr), @ptrCast(_index.ptr), @ptrCast(value.ptr), @bitCast(role));
    }
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn clearItemData(self: QStringListModel, _index: anytype) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return qtc.QStringListModel_ClearItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr));
    }
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn superClearItemData(self: QStringListModel, _index: anytype) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return qtc.QStringListModel_SuperClearItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr));
    }
    ...
    ///
    pub fn flags(self: QStringListModel, _index: anytype) i32 {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return qtc.QStringListModel_Flags(@ptrCast(self.ptr), @ptrCast(_index.ptr));
    }
    ...
    /// ` flag of qnamespace_enums.ItemFlag `
    ///
    pub fn superFlags(self: QStringListModel, _index: anytype) i32 {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return qtc.QStringListModel_SuperFlags(@ptrCast(self.ptr), @ptrCast(_index.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertRows(self: QStringListModel, row: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_InsertRows(@ptrCast(self.ptr), @bitCast(row), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superInsertRows(self: QStringListModel, row: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperInsertRows(@ptrCast(self.ptr), @bitCast(row), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeRows(self: QStringListModel, row: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_RemoveRows(@ptrCast(self.ptr), @bitCast(row), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superRemoveRows(self: QStringListModel, row: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperRemoveRows(@ptrCast(self.ptr), @bitCast(row), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn itemData(self: QStringListModel, allocator: std.mem.Allocator, _index: anytype) ArrayMap_i32_QVariant {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        const _map: qtc.libqt_map = qtc.QStringListModel_ItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr));
        var _ret: ArrayMap_i32_QVariant = .empty;
        _ret.ensureTotalCapacity(allocator, @intCast(_map.len)) catch @panic("QStringListModel.itemData: Total capacity allocation failed");
        defer {
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn superItemData(self: QStringListModel, allocator: std.mem.Allocator, _index: anytype) ArrayMap_i32_QVariant {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        const _map: qtc.libqt_map = qtc.QStringListModel_SuperItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr));
        var _ret: ArrayMap_i32_QVariant = .empty;
        _ret.ensureTotalCapacity(allocator, @intCast(_map.len)) catch @panic("QStringListModel.itemData: Total capacity allocation failed");
        defer {
            qtc.libqt_free(_map.keys);
    ...
    ///
    pub fn setItemData(self: QStringListModel, allocator: std.mem.Allocator, _index: anytype, roles: ArrayMap_i32_QVariant) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        ...
        return qtc.QStringListModel_SetItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr), roles_map);
    }
    ...
    /// ` roles: ArrayMap_i32_QVariant `
    ///
    pub fn superSetItemData(self: QStringListModel, allocator: std.mem.Allocator, _index: anytype, roles: ArrayMap_i32_QVariant) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        const roles_count = roles.count();
        const roles_keys = allocator.alloc(i32, roles_count) catch @panic("QStringListModel.setItemData: Memory allocation failed");
        defer allocator.free(roles_keys);
        ...
        return qtc.QStringListModel_SuperSetItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr), roles_map);
    }
    ...
    /// ### DEPRECATED: Use `stringList` instead
    ///
    pub const StringList = stringList;
    ...
    pub fn stringList(self: QStringListModel, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QStringListModel.stringList: Memory allocation failed");
    ...
    /// ### DEPRECATED: Use `setStringList` instead
    ///
    pub const SetStringList = setStringList;
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QStringListModel_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QStringListModel_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn columnCount(self: QStringListModel, _parent: anytype) i32 {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn hasChildren(self: QStringListModel, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superHasChildren(self: QStringListModel, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn checkIndex(self: QStringListModel, _index: anytype) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn hasIndex3(self: QStringListModel, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertRow2(self: QStringListModel, row: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertColumn2(self: QStringListModel, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeRow2(self: QStringListModel, row: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeColumn2(self: QStringListModel, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    ///
    pub fn checkIndex2(self: QStringListModel, _index: anytype, options: i32) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QStringListModel, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QStringListModel, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QStringListModel, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QStringListModel, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QStringListModel.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QStringListModel, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn index(self: QStringListModel, row: i32, column: i32, _parent: anytype) QModelIndex {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_Index(@ptrCast(self.ptr), @bitCast(row), @bitCast(column), @ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superIndex(self: QStringListModel, row: i32, column: i32, _parent: anytype) QModelIndex {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_SuperIndex(@ptrCast(self.ptr), @bitCast(row), @bitCast(column), @ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn dropMimeData(self: QStringListModel, _data: anytype, action: i32, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_data)._is_QMimeData;
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_DropMimeData(@ptrCast(self.ptr), @ptrCast(_data.ptr), @bitCast(action), @bitCast(row), @bitCast(column), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superDropMimeData(self: QStringListModel, _data: anytype, action: i32, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_data)._is_QMimeData;
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperDropMimeData(@ptrCast(self.ptr), @ptrCast(_data.ptr), @bitCast(action), @bitCast(row), @bitCast(column), @ptrCast(_parent.ptr));
    }
    ...
    pub fn mimeTypes(self: QStringListModel, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QStringListModel.mimeTypes: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn canDropMimeData(self: QStringListModel, _data: anytype, action: i32, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_data)._is_QMimeData;
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_CanDropMimeData(@ptrCast(self.ptr), @ptrCast(_data.ptr), @bitCast(action), @bitCast(row), @bitCast(column), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superCanDropMimeData(self: QStringListModel, _data: anytype, action: i32, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_data)._is_QMimeData;
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperCanDropMimeData(@ptrCast(self.ptr), @ptrCast(_data.ptr), @bitCast(action), @bitCast(row), @bitCast(column), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertColumns(self: QStringListModel, column: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_InsertColumns(@ptrCast(self.ptr), @bitCast(column), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superInsertColumns(self: QStringListModel, column: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperInsertColumns(@ptrCast(self.ptr), @bitCast(column), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeColumns(self: QStringListModel, column: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_RemoveColumns(@ptrCast(self.ptr), @bitCast(column), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superRemoveColumns(self: QStringListModel, column: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperRemoveColumns(@ptrCast(self.ptr), @bitCast(column), @bitCast(count), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn fetchMore(self: QStringListModel, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        qtc.QStringListModel_FetchMore(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superFetchMore(self: QStringListModel, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        qtc.QStringListModel_SuperFetchMore(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn canFetchMore(self: QStringListModel, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_CanFetchMore(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn superCanFetchMore(self: QStringListModel, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QStringListModel_SuperCanFetchMore(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn buddy(self: QStringListModel, _index: anytype) QModelIndex {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_Buddy(@ptrCast(self.ptr), @ptrCast(_index.ptr)) };
    }
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn superBuddy(self: QStringListModel, _index: anytype) QModelIndex {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_SuperBuddy(@ptrCast(self.ptr), @ptrCast(_index.ptr)) };
    }
    ...
    ///
    pub fn match(self: QStringListModel, allocator: std.mem.Allocator, start: anytype, role: i32, value: anytype, hits: i32, _flags: i32) []QModelIndex {
        comptime _ = @TypeOf(start)._is_QModelIndex;
        comptime _ = @TypeOf(value)._is_QVariant;
        const _arr: qtc.libqt_list = qtc.QStringListModel_Match(@ptrCast(self.ptr), @ptrCast(start.ptr), @bitCast(role), @ptrCast(value.ptr), @bitCast(hits), @bitCast(_flags));
        defer qtc.libqt_free(_arr.data);
    ...
    /// ` _flags: flag of qnamespace_enums.MatchFlag `
    ///
    pub fn superMatch(self: QStringListModel, allocator: std.mem.Allocator, start: anytype, role: i32, value: anytype, hits: i32, _flags: i32) []QModelIndex {
        comptime _ = @TypeOf(start)._is_QModelIndex;
        comptime _ = @TypeOf(value)._is_QVariant;
        const _arr: qtc.libqt_list = qtc.QStringListModel_SuperMatch(@ptrCast(self.ptr), @ptrCast(start.ptr), @bitCast(role), @ptrCast(value.ptr), @bitCast(hits), @bitCast(_flags));
        defer qtc.libqt_free(_arr.data);
        const _ret = allocator.alloc(QModelIndex, _arr.len) catch @panic("QStringListModel.match: Memory allocation failed");
        const _data_val: [*]QtC.QModelIndex = @ptrCast(@alignCast(_arr.data));
        for (0.._arr.len) |j|
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn span(self: QStringListModel, _index: anytype) QSize {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_Span(@ptrCast(self.ptr), @ptrCast(_index.ptr)) };
    }
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn superSpan(self: QStringListModel, _index: anytype) QSize {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QStringListModel_SuperSpan(@ptrCast(self.ptr), @ptrCast(_index.ptr)) };
    }
    ...
    pub fn roleNames(self: QStringListModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, @intCast(_map.len)) catch @panic("QStringListModel.roleNames: Total capacity allocation failed");
        defer {
    ...
    ///
    pub fn multiData(self: QStringListModel, _index: anytype, roleDataSpan: anytype) void {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        comptime _ = @TypeOf(roleDataSpan)._is_QModelRoleDataSpan;
        qtc.QStringListModel_MultiData(@ptrCast(self.ptr), @ptrCast(_index.ptr), @ptrCast(roleDataSpan.ptr));
    }
    ...
    /// ` roleDataSpan: QModelRoleDataSpan `
    ///
    pub fn superMultiData(self: QStringListModel, _index: anytype, roleDataSpan: anytype) void {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        comptime _ = @TypeOf(roleDataSpan)._is_QModelRoleDataSpan;
        qtc.QStringListModel_SuperMultiData(@ptrCast(self.ptr), @ptrCast(_index.ptr), @ptrCast(roleDataSpan.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QStringListModel, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QStringListModel_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QStringListModel, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QStringListModel_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QStringListModel, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QStringListModel_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QStringListModel, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QStringListModel_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QStringListModel, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QStringListModel_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QStringListModel, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QStringListModel_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QStringListModel, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QStringListModel_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QStringListModel, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QStringListModel_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QStringListModel, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QStringListModel_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QStringListModel, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QStringListModel_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` stream: QDataStream `
    ///
    pub fn decodeData(self: QStringListModel, row: i32, column: i32, _parent: anytype, stream: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        comptime _ = @TypeOf(stream)._is_QDataStream;
    ...
    /// ` last: i32 `
    ///
    pub fn beginInsertRows(self: QStringListModel, _parent: anytype, first: i32, last: i32) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` last: i32 `
    ///
    pub fn beginRemoveRows(self: QStringListModel, _parent: anytype, first: i32, last: i32) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` last: i32 `
    ///
    pub fn beginInsertColumns(self: QStringListModel, _parent: anytype, first: i32, last: i32) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` last: i32 `
    ///
    pub fn beginRemoveColumns(self: QStringListModel, _parent: anytype, first: i32, last: i32) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
