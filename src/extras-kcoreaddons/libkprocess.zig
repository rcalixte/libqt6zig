...
pub const kprocess = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KProcess_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcessexitCode: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcesserrorVal: qprocess_enums.ProcessError) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcessexitCode: i32, exitStatus: qprocess_enums.ExitStatus) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcesschannel: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcessbytes: i64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcesschannel: i32, bytes: i64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcessparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcessstate: qprocess_enums.ProcessState) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KProcess `
    ///
    /// ` callback: *const fn (self: QtC.KProcessobjectName: [*:0]const u8) callconv(.c) void `
    ///
