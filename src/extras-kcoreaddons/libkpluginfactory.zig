...
pub const kpluginfactory = struct {
    ...
    /// ` self: QtC.KPluginFactory `
    ///
    /// ` callback: *const fn (self: QtC.KPluginFactoryparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KPluginFactory `
    ///
    /// ` callback: *const fn (self: QtC.KPluginFactoryobjectName: [*:0]const u8) callconv(.c) void `
    ///
