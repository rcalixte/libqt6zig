...
pub const QFileSystemWatcher = extern struct {
    ...
    /// Allocate a new QFileSystemWatcher object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new3(_parent: anytype) QFileSystemWatcher {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QFileSystemWatcher_new3(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new4(allocator: std.mem.Allocator, paths: []const []const u8, _parent: anytype) QFileSystemWatcher {
        ...
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QFileSystemWatcher_new4(paths_list, @ptrCast(_parent.ptr)) };
    }
    ...
    /// ### DEPRECATED: Use `addPaths` instead
    ///
    pub const AddPaths = addPaths;
    ...
    ///
    pub fn addPaths(self: QFileSystemWatcher, allocator: std.mem.Allocator, _files: []const []const u8) []const []const u8 {
        const files_arr = allocator.alloc(qtc.libqt_string, _files.len) catch @panic("QFileSystemWatcher.addPaths: Memory allocation failed");
        defer allocator.free(files_arr);
        for (_files, 0.._files.len) |str_item, i|
            files_arr[i] = .{
                .len = str_item.len,
                .data = str_item.ptr,
            };
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QFileSystemWatcher.addPaths: Memory allocation failed");
    ...
    /// ### DEPRECATED: Use `removePath` instead
    ///
    pub const RemovePath = removePath;
    ...
    /// ### DEPRECATED: Use `removePaths` instead
    ///
    pub const RemovePaths = removePaths;
    ...
    /// ` _files: []const []const u8 `
    ///
    pub fn removePaths(self: QFileSystemWatcher, allocator: std.mem.Allocator, _files: []const []const u8) []const []const u8 {
        const files_arr = allocator.alloc(qtc.libqt_string, _files.len) catch @panic("QFileSystemWatcher.removePaths: Memory allocation failed");
        defer allocator.free(files_arr);
        for (_files, 0.._files.len) |str_item, i|
            files_arr[i] = .{
                .len = str_item.len,
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QFileSystemWatcher.removePaths: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn files(self: QFileSystemWatcher, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QFileSystemWatcher.files: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn directories(self: QFileSystemWatcher, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QFileSystemWatcher.directories: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QFileSystemWatcher_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QFileSystemWatcher, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QFileSystemWatcher, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QFileSystemWatcher, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QFileSystemWatcher, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QFileSystemWatcher.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QFileSystemWatcher, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QFileSystemWatcher, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QFileSystemWatcher_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QFileSystemWatcher, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QFileSystemWatcher_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QFileSystemWatcher, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QFileSystemWatcher_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QFileSystemWatcher, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QFileSystemWatcher_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QFileSystemWatcher, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QFileSystemWatcher_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QFileSystemWatcher, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QFileSystemWatcher_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QFileSystemWatcher, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QFileSystemWatcher_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QFileSystemWatcher, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QFileSystemWatcher_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QFileSystemWatcher, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QFileSystemWatcher_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QFileSystemWatcher, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QFileSystemWatcher_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    ///
    pub const OnFileChanged = onFileChanged;
    ...
    /// ### DEPRECATED: Use `onDirectoryChanged` instead
    ///
    pub const OnDirectoryChanged = onDirectoryChanged;
