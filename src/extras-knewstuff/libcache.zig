...
pub const knscore__cache = struct {
    ...
    /// ` self: QtC.KNSCore__Cache `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__Cacheparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KNSCore__Cache `
    ///
    /// ` callback: *const fn (self: QtC.KNSCore__CacheobjectName: [*:0]const u8) callconv(.c) void `
    ///
