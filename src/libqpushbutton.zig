...
pub const qpushbutton = struct {
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QPushButton_QBaseMetacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseHeightForWidth(self: ?*anyopaque, param1: i32) i32 {
        return qtc.QPushButton_QBaseHeightForWidth(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseMetric(self: ?*anyopaque, param1: i32) i32 {
        return qtc.QPushButton_QBaseMetric(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseInputMethodQuery(self: ?*anyopaque, param1: i32) QtC.QVariant {
        return qtc.QPushButton_QBaseInputMethodQuery(@ptrCast(self), @bitCast(param1));
    }
    ...
    pub fn QBaseGetDecodedMetricF(self: ?*anyopaque, metricA: i32, metricB: i32) f64 {
        return qtc.QPushButton_QBaseGetDecodedMetricF(@ptrCast(self), @bitCast(metricA), @bitCast(metricB));
    }
