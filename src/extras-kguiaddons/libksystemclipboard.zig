...
pub const ksystemclipboard = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.KSystemClipboard_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Text(self: ?*anyopaque, mode: i32, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KSystemClipboard_Text(@ptrCast(self), @intCast(mode));
        defer qtc.libqt_string_free(&_str);
