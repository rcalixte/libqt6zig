...
pub const kcheckableproxymodel = struct {
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelorientation: qnamespace_enums.Orientation, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModeltopLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelparents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelparents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelparent: QtC.QModelIndex, first: i32, last: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationRow: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelsourceParent: QtC.QModelIndex, sourceStart: i32, sourceEnd: i32, destinationParent: QtC.QModelIndex, destinationColumn: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCheckableProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.KCheckableProxyModelobjectName: [*:0]const u8) callconv(.c) void `
    ///
