...
pub const KSelectionProxyModel = extern struct {
    ...
    pub fn ItemData(self: KSelectionProxyModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kselectionproxymodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: KSelectionProxyModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kselectionproxymodel.RoleNames: Total capacity allocation failed");
        defer {
