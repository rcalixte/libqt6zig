...
pub const qttranslation_h = extern struct {
    ...
    pub fn qtTrId(allocator: std.mem.Allocator, id: [:0]const u8, n: i32) []const u8 {
        ...
        var _str = qtc.qttranslation_h_QtTrId(id_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("qttranslation_h.qtTrId: Memory allocation failed");
