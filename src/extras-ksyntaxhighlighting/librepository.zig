...
pub const ksyntaxhighlighting__repository = struct {
    ...
    /// ` self: QtC.KSyntaxHighlighting__Repository `
    ///
    /// ` callback: *const fn (self: QtC.KSyntaxHighlighting__Repositoryparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KSyntaxHighlighting__Repository `
    ///
    /// ` callback: *const fn (self: QtC.KSyntaxHighlighting__RepositoryobjectName: [*:0]const u8) callconv(.c) void `
    ///
