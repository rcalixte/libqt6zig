...
pub const TextGrammarCheck__GrammalecteManager = extern struct {
    ...
    /// Allocate a new TextGrammarCheck::GrammalecteManager object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_parent: anytype) TextGrammarCheck__GrammalecteManager {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.TextGrammarCheck__GrammalecteManager_new2(@ptrCast(_parent.ptr)) };
    }
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.TextGrammarCheck__GrammalecteManager_Tr(s_Cstring);
    ...
    /// ### [Upstream resources](https://api.kde.org/legacy/ktextaddons/html/classTextGrammarCheck_1_1GrammalecteManager.html)
    ///
    pub fn self0() TextGrammarCheck__GrammalecteManager {
    ...
    /// ### DEPRECATED: Use `grammalectePath` instead
    ///
    pub const GrammalectePath = grammalectePath;
    ...
    ///
    pub fn setPythonPath(self: TextGrammarCheck__GrammalecteManager, _pythonPath: []const u8) void {
    ...
    /// ### DEPRECATED: Use `setGrammalectePath` instead
    ///
    pub const SetGrammalectePath = setGrammalectePath;
    ...
    /// ` self: TextGrammarCheck__GrammalecteManager `
    ///
    /// ` _grammalectePath: []const u8 `
    ///
    pub fn setGrammalectePath(self: TextGrammarCheck__GrammalecteManager, _grammalectePath: []const u8) void {
        const grammalectePath_str = qtc.libqt_string{
            .len = _grammalectePath.len,
            .data = _grammalectePath.ptr,
        };
    ...
    pub fn options(self: TextGrammarCheck__GrammalecteManager, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("TextGrammarCheck__GrammalecteManager.options: Memory allocation failed");
    ...
    pub fn setOptions(self: TextGrammarCheck__GrammalecteManager, allocator: std.mem.Allocator, saveOptions: []const []const u8) void {
        ...
        for (saveOptions, 0..saveOptions.len) |str_item, i|
            saveOptions_arr[i] = .{
                .len = str_item.len,
                .data = str_item.ptr,
            };
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.TextGrammarCheck__GrammalecteManager_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.TextGrammarCheck__GrammalecteManager_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: TextGrammarCheck__GrammalecteManager, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: TextGrammarCheck__GrammalecteManager, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: TextGrammarCheck__GrammalecteManager, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: TextGrammarCheck__GrammalecteManager, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("TextGrammarCheck__GrammalecteManager.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: TextGrammarCheck__GrammalecteManager, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: TextGrammarCheck__GrammalecteManager, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteManager_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteManager_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: TextGrammarCheck__GrammalecteManager, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteManager_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: TextGrammarCheck__GrammalecteManager, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.TextGrammarCheck__GrammalecteManager_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.TextGrammarCheck__GrammalecteManager_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.TextGrammarCheck__GrammalecteManager_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.TextGrammarCheck__GrammalecteManager_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.TextGrammarCheck__GrammalecteManager_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.TextGrammarCheck__GrammalecteManager_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: TextGrammarCheck__GrammalecteManager, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.TextGrammarCheck__GrammalecteManager_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
