...
pub const qopenglfunctions_3_1 = struct {
    ...
    pub fn GlGetUniformLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_3_1_GlGetUniformLocation(@ptrCast(self), @intCast(program), name.ptr);
    }
    ...
    pub fn GlGetShaderSource(self: ?*anyopaque, shader: u32, bufSize: i32, length: []i32, source: []u8) void {
        qtc.QOpenGLFunctions_3_1_GlGetShaderSource(@ptrCast(self), @intCast(shader), @intCast(bufSize), length.ptr, source.ptr);
    }
    ...
    pub fn GlGetShaderInfoLog(self: ?*anyopaque, shader: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_3_1_GlGetShaderInfoLog(@ptrCast(self), @intCast(shader), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlGetProgramInfoLog(self: ?*anyopaque, program: u32, bufSize: i32, length: []i32, infoLog: []u8) void {
        qtc.QOpenGLFunctions_3_1_GlGetProgramInfoLog(@ptrCast(self), @intCast(program), @intCast(bufSize), length.ptr, infoLog.ptr);
    }
    ...
    pub fn GlGetAttribLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_3_1_GlGetAttribLocation(@ptrCast(self), @intCast(program), name.ptr);
    }
    ...
    pub fn GlBindAttribLocation(self: ?*anyopaque, program: u32, index: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_3_1_GlBindAttribLocation(@ptrCast(self), @intCast(program), @intCast(index), name.ptr);
    }
    ...
    pub fn GlGetFragDataLocation(self: ?*anyopaque, program: u32, name: []const u8) i32 {
        return qtc.QOpenGLFunctions_3_1_GlGetFragDataLocation(@ptrCast(self), @intCast(program), name.ptr);
    }
    ...
    pub fn GlBindFragDataLocation(self: ?*anyopaque, program: u32, color: u32, name: []const u8) void {
        qtc.QOpenGLFunctions_3_1_GlBindFragDataLocation(@ptrCast(self), @intCast(program), @intCast(color), name.ptr);
    }
    ...
    pub fn GlGetActiveUniformBlockName(self: ?*anyopaque, program: u32, uniformBlockIndex: u32, bufSize: i32, length: []i32, uniformBlockName: []u8) void {
        qtc.QOpenGLFunctions_3_1_GlGetActiveUniformBlockName(@ptrCast(self), @intCast(program), @intCast(uniformBlockIndex), @intCast(bufSize), length.ptr, uniformBlockName.ptr);
    }
    ...
    pub fn GlGetUniformBlockIndex(self: ?*anyopaque, program: u32, uniformBlockName: []const u8) u32 {
        return qtc.QOpenGLFunctions_3_1_GlGetUniformBlockIndex(@ptrCast(self), @intCast(program), uniformBlockName.ptr);
    }
    ...
    pub fn GlGetActiveUniformName(self: ?*anyopaque, program: u32, uniformIndex: u32, bufSize: i32, length: []i32, uniformName: []u8) void {
        qtc.QOpenGLFunctions_3_1_GlGetActiveUniformName(@ptrCast(self), @intCast(program), @intCast(uniformIndex), @intCast(bufSize), length.ptr, uniformName.ptr);
    }
