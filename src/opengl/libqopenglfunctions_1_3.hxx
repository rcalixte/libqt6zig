...
class VirtualQOpenGLFunctions_1_3 final : public QOpenGLFunctions_1_3 {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_1_3_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_1_3_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_1_3_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_1_3_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_1_3_SuperIsInitialized(const QOpenGLFunctions_1_3* self);
    friend void QOpenGLFunctions_1_3_SetOwningContext(QOpenGLFunctions_1_3* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_1_3_SuperSetOwningContext(QOpenGLFunctions_1_3* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_1_3_OwningContext(const QOpenGLFunctions_1_3* self);
    friend QOpenGLContext* QOpenGLFunctions_1_3_SuperOwningContext(const QOpenGLFunctions_1_3* self);
};
