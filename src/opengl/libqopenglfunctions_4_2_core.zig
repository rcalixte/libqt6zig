...
pub const qopenglfunctions_4_2_core = struct {
    ...
    pub fn SuperInitializeOpenGLFunctions(self: ?*anyopaque) bool {
        return qtc.QOpenGLFunctions_4_2_Core_SuperInitializeOpenGLFunctions(@ptrCast(self));
    }
    ...
    pub fn SuperIsInitialized(self: ?*anyopaque) bool {
        return qtc.QOpenGLFunctions_4_2_Core_SuperIsInitialized(@ptrCast(self));
    }
    ...
    pub fn SuperSetOwningContext(self: ?*anyopaque, context: ?*anyopaque) void {
        qtc.QOpenGLFunctions_4_2_Core_SuperSetOwningContext(@ptrCast(self), @ptrCast(context));
    }
    ...
    pub fn SuperOwningContext(self: ?*anyopaque) QtC.QOpenGLContext {
        return qtc.QOpenGLFunctions_4_2_Core_SuperOwningContext(@ptrCast(self));
    }
