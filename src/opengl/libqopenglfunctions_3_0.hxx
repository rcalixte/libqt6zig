...
class VirtualQOpenGLFunctions_3_0 final : public QOpenGLFunctions_3_0 {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_3_0_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_3_0_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_3_0_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_3_0_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_3_0_SuperIsInitialized(const QOpenGLFunctions_3_0* self);
    friend void QOpenGLFunctions_3_0_SetOwningContext(QOpenGLFunctions_3_0* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_3_0_SuperSetOwningContext(QOpenGLFunctions_3_0* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_3_0_OwningContext(const QOpenGLFunctions_3_0* self);
    friend QOpenGLContext* QOpenGLFunctions_3_0_SuperOwningContext(const QOpenGLFunctions_3_0* self);
};
