...
pub const qopenglfunctions_3_0 = struct {
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_3_0, program: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_3_0, shader: u32, bufSize: i32, length: []i32, source: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_3_0, shader: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_3_0, program: u32, bufSize: i32, length: []i32, infoLog: []u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_3_0, program: u32, index: u32, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.QOpenGLFunctions_3_0, program: u32, color: u32, name: []const u8 ```
