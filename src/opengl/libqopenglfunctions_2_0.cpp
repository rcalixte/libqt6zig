...
void QOpenGLFunctions_2_0_GlGetBufferSubData(QOpenGLFunctions_2_0* self, uint32_t target, intptr_t offset, intptr_t size, void* data) {
    self->glGetBufferSubData(static_cast<GLenum>(target), static_cast<GLintptr>(offset), static_cast<GLsizeiptr>(size), data);
}

void QOpenGLFunctions_2_0_GlBufferSubData(QOpenGLFunctions_2_0* self, uint32_t target, intptr_t offset, intptr_t size, const void* data) {
    self->glBufferSubData(static_cast<GLenum>(target), static_cast<GLintptr>(offset), static_cast<GLsizeiptr>(size), data);
}

void QOpenGLFunctions_2_0_GlBufferData(QOpenGLFunctions_2_0* self, uint32_t target, intptr_t size, const void* data, uint32_t usage) {
...
void QOpenGLFunctions_2_0_GlShaderSource(QOpenGLFunctions_2_0* self, uint32_t shader, int32_t count, const GLchar** string, const int32_t* length) {
...
void QOpenGLFunctions_2_0_GlGetPixelMapusv(QOpenGLFunctions_2_0* self, uint32_t map, uint16_t* values) {
    self->glGetPixelMapusv(static_cast<GLenum>(map), static_cast<GLushort*>(values));
}

void QOpenGLFunctions_2_0_GlGetPixelMapuiv(QOpenGLFunctions_2_0* self, uint32_t map, uint32_t* values) {
    self->glGetPixelMapuiv(static_cast<GLenum>(map), static_cast<GLuint*>(values));
}

void QOpenGLFunctions_2_0_GlGetPixelMapfv(QOpenGLFunctions_2_0* self, uint32_t map, float* values) {
...
void QOpenGLFunctions_2_0_GlPixelMapusv(QOpenGLFunctions_2_0* self, uint32_t map, int32_t mapsize, const uint16_t* values) {
    self->glPixelMapusv(static_cast<GLenum>(map), static_cast<GLint>(mapsize), static_cast<const GLushort*>(values));
}

void QOpenGLFunctions_2_0_GlPixelMapuiv(QOpenGLFunctions_2_0* self, uint32_t map, int32_t mapsize, const uint32_t* values) {
    self->glPixelMapuiv(static_cast<GLenum>(map), static_cast<GLint>(mapsize), static_cast<const GLuint*>(values));
}

void QOpenGLFunctions_2_0_GlPixelMapfv(QOpenGLFunctions_2_0* self, uint32_t map, int32_t mapsize, const float* values) {
