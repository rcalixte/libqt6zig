...
class VirtualQOpenGLFunctions_1_1 final : public QOpenGLFunctions_1_1 {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_1_1_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_1_1_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_1_1_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_1_1_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_1_1_SuperIsInitialized(const QOpenGLFunctions_1_1* self);
    friend void QOpenGLFunctions_1_1_SetOwningContext(QOpenGLFunctions_1_1* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_1_1_SuperSetOwningContext(QOpenGLFunctions_1_1* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_1_1_OwningContext(const QOpenGLFunctions_1_1* self);
    friend QOpenGLContext* QOpenGLFunctions_1_1_SuperOwningContext(const QOpenGLFunctions_1_1* self);
};
