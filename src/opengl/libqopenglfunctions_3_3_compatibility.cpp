...
void QOpenGLFunctions_3_3_Compatibility_GlShaderSource(QOpenGLFunctions_3_3_Compatibility* self, uint32_t shader, int32_t count, const GLchar** string, const int32_t* length) {
