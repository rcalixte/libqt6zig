...
void QOpenGLFunctions_3_3_Core_GlGetBufferSubData(QOpenGLFunctions_3_3_Core* self, uint32_t target, intptr_t offset, intptr_t size, void* data);
void QOpenGLFunctions_3_3_Core_GlBufferSubData(QOpenGLFunctions_3_3_Core* self, uint32_t target, intptr_t offset, intptr_t size, const void* data);
void QOpenGLFunctions_3_3_Core_GlBufferData(QOpenGLFunctions_3_3_Core* self, uint32_t target, intptr_t size, const void* data, uint32_t usage);
...
void QOpenGLFunctions_3_3_Core_GlShaderSource(QOpenGLFunctions_3_3_Core* self, uint32_t shader, int32_t count, const GLchar** string, const int32_t* length);
...
void QOpenGLFunctions_3_3_Core_GlFlushMappedBufferRange(QOpenGLFunctions_3_3_Core* self, uint32_t target, intptr_t offset, intptr_t length);
void* QOpenGLFunctions_3_3_Core_GlMapBufferRange(QOpenGLFunctions_3_3_Core* self, uint32_t target, intptr_t offset, intptr_t length, uint32_t access);
...
void QOpenGLFunctions_3_3_Core_GlBindBufferRange(QOpenGLFunctions_3_3_Core* self, uint32_t target, uint32_t index, uint32_t buffer, intptr_t offset, intptr_t size);
...
void QOpenGLFunctions_3_3_Core_GlCopyBufferSubData(QOpenGLFunctions_3_3_Core* self, uint32_t readTarget, uint32_t writeTarget, intptr_t readOffset, intptr_t writeOffset, intptr_t size);
