...
class VirtualQOpenGLFunctions_3_1 final : public QOpenGLFunctions_3_1 {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_3_1_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_3_1_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_3_1_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_3_1_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_3_1_SuperIsInitialized(const QOpenGLFunctions_3_1* self);
    friend void QOpenGLFunctions_3_1_SetOwningContext(QOpenGLFunctions_3_1* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_3_1_SuperSetOwningContext(QOpenGLFunctions_3_1* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_3_1_OwningContext(const QOpenGLFunctions_3_1* self);
    friend QOpenGLContext* QOpenGLFunctions_3_1_SuperOwningContext(const QOpenGLFunctions_3_1* self);
};
