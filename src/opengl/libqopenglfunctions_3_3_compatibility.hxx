#pragma once
#ifndef OPENGL_LIBQOPENGLFUNCTIONS_3_3_COMPATIBILITY_HXX
#define OPENGL_LIBQOPENGLFUNCTIONS_3_3_COMPATIBILITY_HXX
...
class VirtualQOpenGLFunctions_3_3_Compatibility final : public QOpenGLFunctions_3_3_Compatibility {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_3_3_compatibility_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_3_3_compatibility_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_3_3_compatibility_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_3_3_compatibility_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_3_3_Compatibility_SuperIsInitialized(const QOpenGLFunctions_3_3_Compatibility* self);
    ...
    friend void QOpenGLFunctions_3_3_Compatibility_SuperSetOwningContext(QOpenGLFunctions_3_3_Compatibility* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_3_3_Compatibility_OwningContext(const QOpenGLFunctions_3_3_Compatibility* self);
    friend QOpenGLContext* QOpenGLFunctions_3_3_Compatibility_SuperOwningContext(const QOpenGLFunctions_3_3_Compatibility* self);
};
