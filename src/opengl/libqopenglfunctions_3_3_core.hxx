#pragma once
#ifndef OPENGL_LIBQOPENGLFUNCTIONS_3_3_CORE_HXX
#define OPENGL_LIBQOPENGLFUNCTIONS_3_3_CORE_HXX
...
class VirtualQOpenGLFunctions_3_3_Core final : public QOpenGLFunctions_3_3_Core {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_3_3_core_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_3_3_core_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_3_3_core_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_3_3_core_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_3_3_Core_SuperIsInitialized(const QOpenGLFunctions_3_3_Core* self);
    friend void QOpenGLFunctions_3_3_Core_SetOwningContext(QOpenGLFunctions_3_3_Core* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_3_3_Core_SuperSetOwningContext(QOpenGLFunctions_3_3_Core* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_3_3_Core_OwningContext(const QOpenGLFunctions_3_3_Core* self);
    friend QOpenGLContext* QOpenGLFunctions_3_3_Core_SuperOwningContext(const QOpenGLFunctions_3_3_Core* self);
};
