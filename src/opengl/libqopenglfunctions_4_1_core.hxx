...
class VirtualQOpenGLFunctions_4_1_Core final : public QOpenGLFunctions_4_1_Core {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_4_1_core_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_4_1_core_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_4_1_core_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_4_1_core_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_4_1_Core_SuperIsInitialized(const QOpenGLFunctions_4_1_Core* self);
    friend void QOpenGLFunctions_4_1_Core_SetOwningContext(QOpenGLFunctions_4_1_Core* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_4_1_Core_SuperSetOwningContext(QOpenGLFunctions_4_1_Core* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_4_1_Core_OwningContext(const QOpenGLFunctions_4_1_Core* self);
    friend QOpenGLContext* QOpenGLFunctions_4_1_Core_SuperOwningContext(const QOpenGLFunctions_4_1_Core* self);
};
