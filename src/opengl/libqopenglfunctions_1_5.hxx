...
class VirtualQOpenGLFunctions_1_5 final : public QOpenGLFunctions_1_5 {
  ...
  public:
    ...
    virtual bool initializeOpenGLFunctions() override {
        ...
        auto initializeopenglfunctions_cb = qopenglfunctions_1_5_initializeopenglfunctions_callback;
    ...
    bool isInitialized() const {
        ...
        auto isinitialized_cb = qopenglfunctions_1_5_isinitialized_callback;
        if (isinitialized_cb) {
    ...
    void setOwningContext(const QOpenGLContext* context) {
        ...
        auto setowningcontext_cb = qopenglfunctions_1_5_setowningcontext_callback;
    ...
    QOpenGLContext* owningContext() const {
        ...
        auto owningcontext_cb = qopenglfunctions_1_5_owningcontext_callback;
        if (owningcontext_cb) {
    ...
    friend bool QOpenGLFunctions_1_5_SuperIsInitialized(const QOpenGLFunctions_1_5* self);
    friend void QOpenGLFunctions_1_5_SetOwningContext(QOpenGLFunctions_1_5* self, const QOpenGLContext* context);
    friend void QOpenGLFunctions_1_5_SuperSetOwningContext(QOpenGLFunctions_1_5* self, const QOpenGLContext* context);
    friend QOpenGLContext* QOpenGLFunctions_1_5_OwningContext(const QOpenGLFunctions_1_5* self);
    friend QOpenGLContext* QOpenGLFunctions_1_5_SuperOwningContext(const QOpenGLFunctions_1_5* self);
};
