...
pub const qdatawidgetmapper = struct {
    ...
    pub fn QBaseMetaObject(self: ?*anyopaque) QtC.QMetaObject {
        return qtc.QDataWidgetMapper_QBaseMetaObject(@ptrCast(self));
    }
    ...
    pub fn QBaseMetacast(self: ?*anyopaque, param1: [:0]const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.QDataWidgetMapper_QBaseMetacast(@ptrCast(self), param1_Cstring);
    }
    ...
    pub fn MappedPropertyName(self: ?*anyopaque, widget: ?*anyopaque, allocator: std.mem.Allocator) []u8 {
        var _bytearray: qtc.libqt_string = qtc.QDataWidgetMapper_MappedPropertyName(@ptrCast(self), @ptrCast(widget));
