...
pub const qwebenginewebauthuxrequest = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineWebAuthUxRequest_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn RelyingPartyId(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.QWebEngineWebAuthUxRequest_RelyingPartyId(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn StateChanged(self: ?*anyopaque, state: i32) void {
        qtc.QWebEngineWebAuthUxRequest_StateChanged(@ptrCast(self), @bitCast(state));
    }
    ...
    /// ` self: QtC.QWebEngineWebAuthUxRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineWebAuthUxRequest, state: qwebenginewebauthuxrequest_enums.WebAuthUxState) callconv(.c) void `
    ///
    pub fn OnStateChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32) callconv(.c) void) void {
        qtc.QWebEngineWebAuthUxRequest_Connect_StateChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.QWebEngineWebAuthUxRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineWebAuthUxRequest, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineWebAuthUxRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineWebAuthUxRequest, objectName: [*:0]const u8) callconv(.c) void `
    ///
...
pub const qwebenginewebauthpinrequest = struct {
    ...
    pub fn SetReason(self: ?*anyopaque, reason: i32) void {
        qtc.QWebEngineWebAuthPinRequest_SetReason(@ptrCast(self), @bitCast(reason));
    }
    ...
    pub fn SetError(self: ?*anyopaque, _error: i32) void {
        qtc.QWebEngineWebAuthPinRequest_SetError(@ptrCast(self), @bitCast(_error));
    }
    ...
    pub fn SetMinPinLength(self: ?*anyopaque, minPinLength: i32) void {
        qtc.QWebEngineWebAuthPinRequest_SetMinPinLength(@ptrCast(self), @bitCast(minPinLength));
    }
