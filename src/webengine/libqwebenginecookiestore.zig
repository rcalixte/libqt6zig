...
pub const qwebenginecookiestore = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineCookieStore_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn OnCookieAdded(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineCookieStore_Connect_CookieAdded(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnCookieRemoved(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineCookieStore_Connect_CookieRemoved(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    /// ` self: QtC.QWebEngineCookieStore `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineCookieStore) callconv(.c) void `
    ///
...
pub const qwebenginecookiestore__filterrequest = struct {
    ...
    pub fn SetReservedType(self: ?*anyopaque, _reservedType: u16) void {
        qtc.QWebEngineCookieStore__FilterRequest_SetReservedType(@ptrCast(self), @bitCast(_reservedType));
    }
