...
pub const qwebenginenavigationrequest = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineNavigationRequest_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QWebEngineNavigationRequest `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineNavigationRequest) callconv(.c) void `
    ///
    pub fn OnActionChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineNavigationRequest_Connect_ActionChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
