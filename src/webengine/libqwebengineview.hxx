...
class VirtualQWebEngineView final : public QWebEngineView {
  ...
  public:
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        auto metaobject_cb = qwebengineview_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qwebengineview_metacall_callback;
        if (metacall_cb) {
    ...
    virtual int devType() const override {
        ...
        auto devtype_cb = qwebengineview_devtype_callback;
        if (devtype_cb) {
    ...
    virtual bool hasHeightForWidth() const override {
        ...
        auto hasheightforwidth_cb = qwebengineview_hasheightforwidth_callback;
    ...
    virtual QPaintEngine* paintEngine() const override {
        ...
        auto paintengine_cb = qwebengineview_paintengine_callback;
        if (paintengine_cb) {
    ...
    virtual bool nativeEvent(const QByteArray& eventType, void* message, qintptr* result) override {
        ...
        auto nativeevent_cb = qwebengineview_nativeevent_callback;
        if (nativeevent_cb) {
    ...
    virtual QPainter* sharedPainter() const override {
        ...
        auto sharedpainter_cb = qwebengineview_sharedpainter_callback;
        if (sharedpainter_cb) {
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qwebengineview_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qwebengineview_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qwebengineview_disconnectnotify_callback;
    ...
    void updateMicroFocus() {
        ...
        auto updatemicrofocus_cb = qwebengineview_updatemicrofocus_callback;
    ...
    void create() {
        ...
        auto create_cb = qwebengineview_create_callback;
        if (create_cb) {
            create_cb();
            return;
        }
    ...
    void destroy() {
        ...
        auto destroy_cb = qwebengineview_destroy_callback;
        if (destroy_cb) {
            destroy_cb();
            return;
        }
    ...
    bool focusNextChild() {
        ...
        auto focusnextchild_cb = qwebengineview_focusnextchild_callback;
    ...
    bool focusPreviousChild() {
        ...
        auto focuspreviouschild_cb = qwebengineview_focuspreviouschild_callback;
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qwebengineview_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qwebengineview_sendersignalindex_callback;
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qwebengineview_issignalconnected_callback;
    ...
    double getDecodedMetricF(QPaintDevice::PaintDeviceMetric metricA, QPaintDevice::PaintDeviceMetric metricB) const {
        ...
        auto getdecodedmetricf_cb = qwebengineview_getdecodedmetricf_callback;
    ...
    friend void QWebEngineView_SuperUpdateMicroFocus(QWebEngineView* self);
    friend void QWebEngineView_Create(QWebEngineView* self);
    friend void QWebEngineView_SuperCreate(QWebEngineView* self);
    friend void QWebEngineView_Destroy(QWebEngineView* self);
    friend void QWebEngineView_SuperDestroy(QWebEngineView* self);
    friend bool QWebEngineView_FocusNextChild(QWebEngineView* self);
    friend bool QWebEngineView_SuperFocusNextChild(QWebEngineView* self);
    friend bool QWebEngineView_FocusPreviousChild(QWebEngineView* self);
    friend bool QWebEngineView_SuperFocusPreviousChild(QWebEngineView* self);
    friend QObject* QWebEngineView_Sender(const QWebEngineView* self);
    friend QObject* QWebEngineView_SuperSender(const QWebEngineView* self);
    friend int QWebEngineView_SenderSignalIndex(const QWebEngineView* self);
    friend int QWebEngineView_SuperSenderSignalIndex(const QWebEngineView* self);
    friend int QWebEngineView_Receivers(const QWebEngineView* self, const char* signal);
    friend int QWebEngineView_SuperReceivers(const QWebEngineView* self, const char* signal);
    friend bool QWebEngineView_IsSignalConnected(const QWebEngineView* self, const QMetaMethod* signal);
    friend bool QWebEngineView_SuperIsSignalConnected(const QWebEngineView* self, const QMetaMethod* signal);
    friend double QWebEngineView_GetDecodedMetricF(const QWebEngineView* self, int metricA, int metricB);
    friend double QWebEngineView_SuperGetDecodedMetricF(const QWebEngineView* self, int metricA, int metricB);
};
