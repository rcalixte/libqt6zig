...
pub const qwebengineurlrequestjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineUrlRequestJob_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn RequestMethod(self: ?*anyopaque, allocator: std.mem.Allocator) []u8 {
        var _bytearray: qtc.libqt_string = qtc.QWebEngineUrlRequestJob_RequestMethod(@ptrCast(self));
    ...
    pub fn SetAdditionalResponseHeaders(self: ?*anyopaque, additionalResponseHeaders: map_u8_sliceu8, allocator: std.mem.Allocator) void {
        ...
        qtc.QWebEngineUrlRequestJob_SetAdditionalResponseHeaders(@ptrCast(self), additionalResponseHeaders_map);
    }
    ...
    /// ` self: QtC.QWebEngineUrlRequestJob `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineUrlRequestJob) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineUrlRequestJob `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineUrlRequestJob, param1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineUrlRequestJob `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineUrlRequestJob, objectName: [*:0]const u8) callconv(.c) void `
    ///
