...
pub const qwebengineurlrequestjob = struct {
    ...
    /// ` self: QtC.QWebEngineUrlRequestJob `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineUrlRequestJobparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QWebEngineUrlRequestJob `
    ///
    /// ` callback: *const fn (self: QtC.QWebEngineUrlRequestJobobjectName: [*:0]const u8) callconv(.c) void `
    ///
