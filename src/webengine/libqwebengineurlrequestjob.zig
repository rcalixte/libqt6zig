...
pub const qwebengineurlrequestjob = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineUrlRequestJob_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn Fail(self: ?*anyopaque, errorVal: i32) void {
        qtc.QWebEngineUrlRequestJob_Fail(@ptrCast(self), @bitCast(errorVal));
    }
