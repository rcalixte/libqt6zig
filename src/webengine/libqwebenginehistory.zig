...
pub const QWebEngineHistoryItem = extern struct {
    ...
    /// Allocate a new QWebEngineHistoryItem object in C++ memory
    ///
    /// ## Parameter(s):
    ///
    ...
    ///
    pub const OriginalUrl = originalUrl;
    ...
    /// ### DEPRECATED: Use `lastVisited` instead
    ///
    pub const LastVisited = lastVisited;
...
pub const QWebEngineHistoryModel = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QWebEngineHistoryModel_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("QWebEngineHistoryModel.tr: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn rowCount(self: QWebEngineHistoryModel, _parent: anytype) i32 {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
        return qtc.QWebEngineHistoryModel_RowCount(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` role: i32 `
    ///
    pub fn data(self: QWebEngineHistoryModel, _index: anytype, role: i32) QVariant {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        return .{ .ptr = qtc.QWebEngineHistoryModel_Data(@ptrCast(self.ptr), @ptrCast(_index.ptr), @bitCast(role)) };
    }
    ...
    pub fn roleNames(self: QWebEngineHistoryModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, @intCast(_map.len)) catch @panic("QWebEngineHistoryModel.roleNames: Total capacity allocation failed");
        defer {
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        ...
        var _str = qtc.QWebEngineHistoryModel_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("QWebEngineHistoryModel.tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QWebEngineHistoryModel_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("QWebEngineHistoryModel.tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn index(self: QWebEngineHistoryModel, row: i32, column: i32, _parent: anytype) QModelIndex {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn dropMimeData(self: QWebEngineHistoryModel, _data: anytype, action: i32, row: i32, column: i32, _parent: anytype) bool {
    ...
    ///
    pub fn flags(self: QWebEngineHistoryModel, _index: anytype) i32 {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn columnCount(self: QWebEngineHistoryModel, _parent: anytype) i32 {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn hasChildren(self: QWebEngineHistoryModel, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` role: i32 `
    ///
    pub fn setData(self: QWebEngineHistoryModel, _index: anytype, value: anytype, role: i32) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn itemData(self: QWebEngineHistoryModel, allocator: std.mem.Allocator, _index: anytype) ArrayMap_i32_QVariant {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        const _map: qtc.libqt_map = qtc.QAbstractItemModel_ItemData(@ptrCast(self.ptr), @ptrCast(_index.ptr));
        var _ret: ArrayMap_i32_QVariant = .empty;
        _ret.ensureTotalCapacity(allocator, @intCast(_map.len)) catch @panic("QWebEngineHistoryModel.itemData: Total capacity allocation failed");
        defer {
            qtc.libqt_free(_map.keys);
            qtc.libqt_free(_map.values);
        }
    ...
    ///
    pub fn setItemData(self: QWebEngineHistoryModel, allocator: std.mem.Allocator, _index: anytype, roles: ArrayMap_i32_QVariant) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
        ...
        const roles_values = allocator.alloc(QtC.QVariant, roles_count) catch @panic("QWebEngineHistoryModel.setItemData: Memory allocation failed");
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn clearItemData(self: QWebEngineHistoryModel, _index: anytype) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    pub fn mimeTypes(self: QWebEngineHistoryModel, allocator: std.mem.Allocator) []const []const u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QWebEngineHistoryModel.mimeTypes: Memory allocation failed");
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn canDropMimeData(self: QWebEngineHistoryModel, _data: anytype, action: i32, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_data)._is_QMimeData;
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertRows(self: QWebEngineHistoryModel, row: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertColumns(self: QWebEngineHistoryModel, column: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeRows(self: QWebEngineHistoryModel, row: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeColumns(self: QWebEngineHistoryModel, column: i32, count: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn fetchMore(self: QWebEngineHistoryModel, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn canFetchMore(self: QWebEngineHistoryModel, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn buddy(self: QWebEngineHistoryModel, _index: anytype) QModelIndex {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    ///
    pub fn match(self: QWebEngineHistoryModel, allocator: std.mem.Allocator, start: anytype, role: i32, value: anytype, hits: i32, _flags: i32) []QModelIndex {
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn span(self: QWebEngineHistoryModel, _index: anytype) QSize {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _index: QModelIndex `
    ///
    pub fn checkIndex(self: QWebEngineHistoryModel, _index: anytype) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    ///
    pub fn multiData(self: QWebEngineHistoryModel, _index: anytype, roleDataSpan: anytype) void {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn hasIndex3(self: QWebEngineHistoryModel, row: i32, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertRow2(self: QWebEngineHistoryModel, row: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn insertColumn2(self: QWebEngineHistoryModel, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeRow2(self: QWebEngineHistoryModel, row: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    /// ` _parent: QModelIndex `
    ///
    pub fn removeColumn2(self: QWebEngineHistoryModel, column: i32, _parent: anytype) bool {
        comptime _ = @TypeOf(_parent)._is_QModelIndex;
    ...
    ///
    pub fn checkIndex2(self: QWebEngineHistoryModel, _index: anytype, options: i32) bool {
        comptime _ = @TypeOf(_index)._is_QModelIndex;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QWebEngineHistoryModel, _event: anytype) bool {
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QWebEngineHistoryModel, watched: anytype, _event: anytype) bool {
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QWebEngineHistoryModel, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QWebEngineHistoryModel, _parent: anytype) void {
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QWebEngineHistoryModel, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QWebEngineHistoryModel, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QWebEngineHistoryModel.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QWebEngineHistoryModel, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
...
pub const QWebEngineHistory = extern struct {
    ...
    pub fn tr(allocator: std.mem.Allocator, s: [:0]const u8) []const u8 {
        const s_Cstring = s.ptr;
        var _str = qtc.QWebEngineHistory_Tr(s_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("QWebEngineHistory.tr: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn items(self: QWebEngineHistory, allocator: std.mem.Allocator) []QWebEngineHistoryItem {
        ...
        const _data_val: [*]QtC.QWebEngineHistoryItem = @ptrCast(@alignCast(_arr.data));
        for (0.._arr.len) |j|
            _ret[j] = .{ .ptr = _data_val[j] };
        return _ret;
    }

    /// ### DEPRECATED: Use `backItems` instead
    ///
    pub const BackItems = backItems;
    ...
    /// ### DEPRECATED: Use `forwardItems` instead
    ///
    pub const ForwardItems = forwardItems;
    ...
    /// ### DEPRECATED: Use `canGoBack` instead
    ///
    pub const CanGoBack = canGoBack;
    ...
    /// ### DEPRECATED: Use `canGoForward` instead
    ///
    pub const CanGoForward = canGoForward;
    ...
    /// ### DEPRECATED: Use `goToItem` instead
    ///
    pub const GoToItem = goToItem;
    ...
    /// ### DEPRECATED: Use `backItem` instead
    ///
    pub const BackItem = backItem;
    ...
    /// ### DEPRECATED: Use `forwardItem` instead
    ///
    pub const ForwardItem = forwardItem;
    ...
    /// ### DEPRECATED: Use `currentItemIndex` instead
    ///
    pub const CurrentItemIndex = currentItemIndex;
    ...
    /// ### DEPRECATED: Use `itemsModel` instead
    ///
    pub const ItemsModel = itemsModel;
    ...
    /// ### DEPRECATED: Use `backItemsModel` instead
    ///
    pub const BackItemsModel = backItemsModel;
    ...
    /// ### DEPRECATED: Use `forwardItemsModel` instead
    ///
    pub const ForwardItemsModel = forwardItemsModel;
    ...
    pub fn tr2(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QWebEngineHistory_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("QWebEngineHistory.tr2: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QWebEngineHistory_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
        const _ret = allocator.alloc(u8, _str.len) catch @panic("QWebEngineHistory.tr3: Memory allocation failed");
        @memcpy(_ret, _str.data[0.._str.len]);
        return _ret;
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QWebEngineHistory, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QObject_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QWebEngineHistory, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QObject_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QWebEngineHistory, _thread: anytype) bool {
        comptime _ = @TypeOf(_thread)._is_QThread;
        return qtc.QObject_MoveToThread(@ptrCast(self.ptr), @ptrCast(_thread.ptr));
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QWebEngineHistory, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
        qtc.QObject_SetParent(@ptrCast(self.ptr), @ptrCast(_parent.ptr));
    }
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QWebEngineHistory, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
        return .{ .ptr = qtc.QObject_Connect3(@ptrCast(self.ptr), @ptrCast(_sender.ptr), signal_Cstring, member_Cstring) };
    ...
    pub fn dynamicPropertyNames(self: QWebEngineHistory, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            const _data_val = _str[i];
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QWebEngineHistory.dynamicPropertyNames: Memory allocation failed");
            @memcpy(_buf, _data_val.data[0.._data_val.len]);
            _ret[i] = _buf;
        }
        return _ret;
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QWebEngineHistory, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
        return .{ .ptr = qtc.QObject_Connect4(@ptrCast(self.ptr), @ptrCast(_sender.ptr), signal_Cstring, member_Cstring, @bitCast(typeVal)) };
