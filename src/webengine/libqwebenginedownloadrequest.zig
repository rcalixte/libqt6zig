...
pub const qwebenginedownloadrequest = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QWebEngineDownloadRequest_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    pub fn SetSavePageFormat(self: ?*anyopaque, format: i32) void {
        qtc.QWebEngineDownloadRequest_SetSavePageFormat(@ptrCast(self), @bitCast(format));
    }
    ...
    pub fn StateChanged(self: ?*anyopaque, state: i32) void {
        qtc.QWebEngineDownloadRequest_StateChanged(@ptrCast(self), @bitCast(state));
    }
    ...
    pub fn OnStateChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque, i32) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_StateChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnSavePageFormatChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_SavePageFormatChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnReceivedBytesChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_ReceivedBytesChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnTotalBytesChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_TotalBytesChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnInterruptReasonChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_InterruptReasonChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnIsFinishedChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_IsFinishedChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnIsPausedChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_IsPausedChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnDownloadDirectoryChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_DownloadDirectoryChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnDownloadFileNameChanged(self: ?*anyopaque, callback: *const fn (?*anyopaque) callconv(.c) void) void {
        qtc.QWebEngineDownloadRequest_Connect_DownloadFileNameChanged(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
