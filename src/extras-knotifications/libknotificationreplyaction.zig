...
pub const knotificationreplyaction = struct {
    ...
    /// ``` self: QtC.KNotificationReplyAction, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KNotificationReplyAction_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KNotificationReplyAction, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KNotificationReplyAction_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Label(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KNotificationReplyAction_Label(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn PlaceholderText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KNotificationReplyAction_PlaceholderText(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn SubmitButtonText(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KNotificationReplyAction_SubmitButtonText(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn SubmitButtonIconName(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        const _str = qtc.KNotificationReplyAction_SubmitButtonIconName(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ``` self: QtC.KNotificationReplyAction ```
    ///
    /// Returns: ``` knotificationreplyaction_enums.FallbackBehavior ```
    ...
    ///
    /// ``` self: QtC.KNotificationReplyAction, event: QtC.QEvent ```
    ...
    pub fn QBaseEvent(self: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KNotificationReplyAction_QBaseEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KNotificationReplyAction, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    pub fn QBaseEventFilter(self: ?*anyopaque, watched: ?*anyopaque, event: ?*anyopaque) bool {
        return qtc.KNotificationReplyAction_QBaseEventFilter(@ptrCast(self), @ptrCast(watched), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KNotificationReplyAction, event: QtC.QTimerEvent ```
    ...
    pub fn QBaseTimerEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KNotificationReplyAction_QBaseTimerEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KNotificationReplyAction, event: QtC.QChildEvent ```
    ...
    pub fn QBaseChildEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KNotificationReplyAction_QBaseChildEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    pub fn QBaseCustomEvent(self: ?*anyopaque, event: ?*anyopaque) void {
        qtc.KNotificationReplyAction_QBaseCustomEvent(@ptrCast(self), @ptrCast(event));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KNotificationReplyAction, signal: QtC.QMetaMethod ```
    ...
    pub fn QBaseConnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KNotificationReplyAction_QBaseConnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseDisconnectNotify(self: ?*anyopaque, signal: ?*anyopaque) void {
        qtc.KNotificationReplyAction_QBaseDisconnectNotify(@ptrCast(self), @ptrCast(signal));
    }
    ...
    pub fn QBaseSender(self: ?*anyopaque) QtC.QObject {
        return qtc.KNotificationReplyAction_QBaseSender(@ptrCast(self));
    }
    ...
    pub fn QBaseSenderSignalIndex(self: ?*anyopaque) i32 {
        return qtc.KNotificationReplyAction_QBaseSenderSignalIndex(@ptrCast(self));
    }
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KNotificationReplyAction, signal: []const u8 ```
    ...
    pub fn QBaseReceivers(self: ?*anyopaque, signal: []const u8) i32 {
        const signal_Cstring = signal.ptr;
        return qtc.KNotificationReplyAction_QBaseReceivers(@ptrCast(self), signal_Cstring);
    }
    ...
    pub fn QBaseIsSignalConnected(self: ?*anyopaque, signal: ?*anyopaque) bool {
        return qtc.KNotificationReplyAction_QBaseIsSignalConnected(@ptrCast(self), @ptrCast(signal));
    }
