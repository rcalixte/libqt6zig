...
pub const QSortFilterProxyModel = extern struct {
    ...
    pub fn ItemData(self: QSortFilterProxyModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qsortfilterproxymodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: QSortFilterProxyModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qsortfilterproxymodel.RoleNames: Total capacity allocation failed");
        defer {
