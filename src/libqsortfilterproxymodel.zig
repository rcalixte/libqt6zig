...
pub const qsortfilterproxymodel = struct {
    ...
    /// ` self: QtC.QSortFilterProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, indexes: [*]QtC.QModelIndex) callconv(.c) QtC.QMimeData `
    ///
    ...
    /// ` self: QtC.QSortFilterProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, start: QtC.QModelIndex, role: i32, value: QtC.QVariant, hits: i32, flags: flag of qnamespace_enums.MatchFlag) callconv(.c) [*:null]QtC.QModelIndex `
    ///
    ...
    /// ` self: QtC.QSortFilterProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, topLeft: QtC.QModelIndex, bottomRight: QtC.QModelIndex, roles: [*:-1]i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSortFilterProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, parents: [*]QtC.QPersistentModelIndex) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSortFilterProxyModel `
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, parents: [*]QtC.QPersistentModelIndex, hint: qabstractitemmodel_enums.LayoutChangeHint) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QSortFilterProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, indexes: [*]QtC.QModelIndex, stream: QtC.QDataStream) callconv(.c) void `
    ///
