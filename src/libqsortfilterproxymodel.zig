...
pub const qsortfilterproxymodel = struct {
    ...
    pub fn OnMetaObject(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QMetaObject) void {
        qtc.QSortFilterProxyModel_OnMetaObject(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnMetacast(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) ?*anyopaque) void {
        qtc.QSortFilterProxyModel_OnMetacast(@ptrCast(self), @intCast(@intFromPtr(callback)));
    }
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QSortFilterProxyModel_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.QSortFilterProxyModel_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QSortFilterProxyModel`
    ///
    /// ` callback: *const fn (self: QtC.QSortFilterProxyModel, index: QtC.QModelIndex, roles: qtc.libqt_map (map_i32_qtcqvariant)) callconv(.c) bool `
    ///
    ...
    pub fn CreateSourceIndex(self: ?*anyopaque, row: i32, col: i32, internalPtr: ?*anyopaque) QtC.QModelIndex {
        return qtc.QSortFilterProxyModel_CreateSourceIndex(@ptrCast(self), @intCast(row), @intCast(col), @ptrCast(internalPtr));
    }
    ...
    pub fn QBaseCreateSourceIndex(self: ?*anyopaque, row: i32, col: i32, internalPtr: ?*anyopaque) QtC.QModelIndex {
        return qtc.QSortFilterProxyModel_QBaseCreateSourceIndex(@ptrCast(self), @intCast(row), @intCast(col), @ptrCast(internalPtr));
    }
