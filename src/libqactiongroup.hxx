...
class VirtualQActionGroup final : public QActionGroup {
  ...
  public:
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        auto metaobject_cb = qactiongroup_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        auto metacast_cb = qactiongroup_metacast_callback;
        if (metacast_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qactiongroup_metacall_callback;
        if (metacall_cb) {
    ...
    virtual bool event(QEvent* event) override {
        ...
        auto event_cb = qactiongroup_event_callback;
        if (event_cb) {
            QEvent* cbval1 = event;
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qactiongroup_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void timerEvent(QTimerEvent* event) override {
        ...
        auto timerevent_cb = qactiongroup_timerevent_callback;
        if (timerevent_cb) {
    ...
    virtual void childEvent(QChildEvent* event) override {
        ...
        auto childevent_cb = qactiongroup_childevent_callback;
        if (childevent_cb) {
    ...
    virtual void customEvent(QEvent* event) override {
        ...
        auto customevent_cb = qactiongroup_customevent_callback;
        if (customevent_cb) {
            QEvent* cbval1 = event;
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qactiongroup_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qactiongroup_disconnectnotify_callback;
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qactiongroup_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qactiongroup_sendersignalindex_callback;
    ...
    int receivers(const char* signal) const {
        ...
        auto receivers_cb = qactiongroup_receivers_callback;
        if (receivers_cb) {
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qactiongroup_issignalconnected_callback;
    ...
    friend QObject* QActionGroup_SuperSender(const QActionGroup* self);
    friend int QActionGroup_SenderSignalIndex(const QActionGroup* self);
    friend int QActionGroup_SuperSenderSignalIndex(const QActionGroup* self);
    friend int QActionGroup_Receivers(const QActionGroup* self, const char* signal);
    friend int QActionGroup_SuperReceivers(const QActionGroup* self, const char* signal);
    friend bool QActionGroup_IsSignalConnected(const QActionGroup* self, const QMetaMethod* signal);
    friend bool QActionGroup_SuperIsSignalConnected(const QActionGroup* self, const QMetaMethod* signal);
};
