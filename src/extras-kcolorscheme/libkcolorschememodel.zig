...
pub const KColorSchemeModel = extern struct {
    ...
    pub fn ItemData(self: KColorSchemeModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kcolorschememodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: KColorSchemeModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("kcolorschememodel.RoleNames: Total capacity allocation failed");
        defer {
