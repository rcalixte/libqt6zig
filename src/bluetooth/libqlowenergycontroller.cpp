...
libqt_string QLowEnergyController_Tr(const char* s) {
    auto _ret = QLowEnergyController::tr(s);
...
libqt_string QLowEnergyController_Tr2(const char* s, const char* c) {
    auto _ret = QLowEnergyController::tr(s, c);
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
...
libqt_string QLowEnergyController_Tr3(const char* s, const char* c, int n) {
    auto _ret = QLowEnergyController::tr(s, c, static_cast<int>(n));
    // Convert QString from UTF-16 in C++ RAII memory to UTF-8 in manually-managed C memory
    QByteArray _b = _ret.toUtf8();
    libqt_string _str;
    _str.len = _b.length();
