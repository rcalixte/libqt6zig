...
pub const QTreeWidget = extern struct {
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QTreeWidget_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: QTreeWidget `
    ///
    pub fn asQPaintDevice(self: QTreeWidget) QPaintDevice {
    ...
    ///
    pub fn fromQPaintDevice(_qpaintdevice: anytype) QTreeWidget {
