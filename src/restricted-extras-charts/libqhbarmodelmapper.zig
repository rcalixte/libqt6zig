...
pub const qhbarmodelmapper = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QHBarModelMapper_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QHBarModelMapper_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QHBarModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QHBarModelMapperparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QHBarModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QHBarModelMapperobjectName: [*:0]const u8) callconv(.c) void `
    ///
