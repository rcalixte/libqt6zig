...
class VirtualQChartView final : public QChartView {
  ...
  public:
    ...
    friend void QChartView_SuperSetViewportMargins(QChartView* self, int left, int top, int right, int bottom);
    friend QMargins* QChartView_ViewportMargins(const QChartView* self);
    friend QMargins* QChartView_SuperViewportMargins(const QChartView* self);
    friend void QChartView_DrawFrame(QChartView* self, QPainter* param1);
    friend void QChartView_SuperDrawFrame(QChartView* self, QPainter* param1);
    friend void QChartView_UpdateMicroFocus(QChartView* self);
    friend void QChartView_SuperUpdateMicroFocus(QChartView* self);
    friend void QChartView_Create(QChartView* self);
    friend void QChartView_SuperCreate(QChartView* self);
    friend void QChartView_Destroy(QChartView* self);
    friend void QChartView_SuperDestroy(QChartView* self);
    friend bool QChartView_FocusNextChild(QChartView* self);
    friend bool QChartView_SuperFocusNextChild(QChartView* self);
    friend bool QChartView_FocusPreviousChild(QChartView* self);
    friend bool QChartView_SuperFocusPreviousChild(QChartView* self);
    friend QObject* QChartView_Sender(const QChartView* self);
    friend QObject* QChartView_SuperSender(const QChartView* self);
    friend int QChartView_SenderSignalIndex(const QChartView* self);
    friend int QChartView_SuperSenderSignalIndex(const QChartView* self);
    friend int QChartView_Receivers(const QChartView* self, const char* signal);
    friend int QChartView_SuperReceivers(const QChartView* self, const char* signal);
    friend bool QChartView_IsSignalConnected(const QChartView* self, const QMetaMethod* signal);
    friend bool QChartView_SuperIsSignalConnected(const QChartView* self, const QMetaMethod* signal);
    friend double QChartView_GetDecodedMetricF(const QChartView* self, int metricA, int metricB);
    friend double QChartView_SuperGetDecodedMetricF(const QChartView* self, int metricA, int metricB);
};
