...
class VirtualQColorAxis final : public QColorAxis {
  ...
  public:
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        auto metaobject_cb = qcoloraxis_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual void* qt_metacast(const char* param1) override {
        ...
        auto metacast_cb = qcoloraxis_metacast_callback;
        if (metacast_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qcoloraxis_metacall_callback;
        if (metacall_cb) {
    ...
    virtual QAbstractAxis::AxisType type() const override {
        ...
        auto type_cb = qcoloraxis_type_callback;
        if (type_cb) {
    ...
    virtual bool event(QEvent* event) override {
        ...
        auto event_cb = qcoloraxis_event_callback;
        if (event_cb) {
            QEvent* cbval1 = event;
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qcoloraxis_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void timerEvent(QTimerEvent* event) override {
        ...
        auto timerevent_cb = qcoloraxis_timerevent_callback;
        if (timerevent_cb) {
    ...
    virtual void childEvent(QChildEvent* event) override {
        ...
        auto childevent_cb = qcoloraxis_childevent_callback;
        if (childevent_cb) {
    ...
    virtual void customEvent(QEvent* event) override {
        ...
        auto customevent_cb = qcoloraxis_customevent_callback;
        if (customevent_cb) {
            QEvent* cbval1 = event;
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qcoloraxis_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qcoloraxis_disconnectnotify_callback;
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qcoloraxis_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qcoloraxis_sendersignalindex_callback;
    ...
    int receivers(const char* signal) const {
        ...
        auto receivers_cb = qcoloraxis_receivers_callback;
        if (receivers_cb) {
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qcoloraxis_issignalconnected_callback;
    ...
    friend QObject* QColorAxis_SuperSender(const QColorAxis* self);
    friend int QColorAxis_SenderSignalIndex(const QColorAxis* self);
    friend int QColorAxis_SuperSenderSignalIndex(const QColorAxis* self);
    friend int QColorAxis_Receivers(const QColorAxis* self, const char* signal);
    friend int QColorAxis_SuperReceivers(const QColorAxis* self, const char* signal);
    friend bool QColorAxis_IsSignalConnected(const QColorAxis* self, const QMetaMethod* signal);
    friend bool QColorAxis_SuperIsSignalConnected(const QColorAxis* self, const QMetaMethod* signal);
};
