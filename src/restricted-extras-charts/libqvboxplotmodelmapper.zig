...
pub const qvboxplotmodelmapper = struct {
    ...
    /// ` self: QtC.QVBoxPlotModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QVBoxPlotModelMapperparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QVBoxPlotModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QVBoxPlotModelMapperobjectName: [*:0]const u8) callconv(.c) void `
    ///
