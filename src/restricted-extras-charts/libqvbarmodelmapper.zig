...
pub const qvbarmodelmapper = struct {
    ...
    /// ` self: QtC.QVBarModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QVBarModelMapperparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QVBarModelMapper `
    ///
    /// ` callback: *const fn (self: QtC.QVBarModelMapperobjectName: [*:0]const u8) callconv(.c) void `
    ///
