...
class VirtualQVPieModelMapper final : public QVPieModelMapper {
  ...
  public:
    ...
    virtual const QMetaObject* metaObject() const override {
        ...
        auto metaobject_cb = qvpiemodelmapper_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qvpiemodelmapper_metacall_callback;
        if (metacall_cb) {
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qvpiemodelmapper_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qvpiemodelmapper_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qvpiemodelmapper_disconnectnotify_callback;
    ...
    int first() const {
        ...
        auto first_cb = qvpiemodelmapper_first_callback;
        if (first_cb) {
    ...
    int count() const {
        ...
        auto count_cb = qvpiemodelmapper_count_callback;
        if (count_cb) {
    ...
    int valuesSection() const {
        ...
        auto valuessection_cb = qvpiemodelmapper_valuessection_callback;
        if (valuessection_cb) {
    ...
    int labelsSection() const {
        ...
        auto labelssection_cb = qvpiemodelmapper_labelssection_callback;
        if (labelssection_cb) {
    ...
    Qt::Orientation orientation() const {
        ...
        auto orientation_cb = qvpiemodelmapper_orientation_callback;
        if (orientation_cb) {
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qvpiemodelmapper_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qvpiemodelmapper_sendersignalindex_callback;
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qvpiemodelmapper_issignalconnected_callback;
    ...
    friend int QVPieModelMapper_SuperFirst(const QVPieModelMapper* self);
    friend void QVPieModelMapper_SetFirst(QVPieModelMapper* self, int first);
    friend void QVPieModelMapper_SuperSetFirst(QVPieModelMapper* self, int first);
    friend int QVPieModelMapper_Count(const QVPieModelMapper* self);
    friend int QVPieModelMapper_SuperCount(const QVPieModelMapper* self);
    friend void QVPieModelMapper_SetCount(QVPieModelMapper* self, int count);
    friend void QVPieModelMapper_SuperSetCount(QVPieModelMapper* self, int count);
    friend int QVPieModelMapper_ValuesSection(const QVPieModelMapper* self);
    friend int QVPieModelMapper_SuperValuesSection(const QVPieModelMapper* self);
    friend void QVPieModelMapper_SetValuesSection(QVPieModelMapper* self, int valuesSection);
    friend void QVPieModelMapper_SuperSetValuesSection(QVPieModelMapper* self, int valuesSection);
    friend int QVPieModelMapper_LabelsSection(const QVPieModelMapper* self);
    friend int QVPieModelMapper_SuperLabelsSection(const QVPieModelMapper* self);
    friend void QVPieModelMapper_SetLabelsSection(QVPieModelMapper* self, int labelsSection);
    friend void QVPieModelMapper_SuperSetLabelsSection(QVPieModelMapper* self, int labelsSection);
    friend int QVPieModelMapper_Orientation(const QVPieModelMapper* self);
    friend int QVPieModelMapper_SuperOrientation(const QVPieModelMapper* self);
    friend void QVPieModelMapper_SetOrientation(QVPieModelMapper* self, int orientation);
    friend void QVPieModelMapper_SuperSetOrientation(QVPieModelMapper* self, int orientation);
    friend QObject* QVPieModelMapper_Sender(const QVPieModelMapper* self);
    friend QObject* QVPieModelMapper_SuperSender(const QVPieModelMapper* self);
    friend int QVPieModelMapper_SenderSignalIndex(const QVPieModelMapper* self);
    friend int QVPieModelMapper_SuperSenderSignalIndex(const QVPieModelMapper* self);
    friend int QVPieModelMapper_Receivers(const QVPieModelMapper* self, const char* signal);
    friend int QVPieModelMapper_SuperReceivers(const QVPieModelMapper* self, const char* signal);
    friend bool QVPieModelMapper_IsSignalConnected(const QVPieModelMapper* self, const QMetaMethod* signal);
    friend bool QVPieModelMapper_SuperIsSignalConnected(const QVPieModelMapper* self, const QMetaMethod* signal);
};
