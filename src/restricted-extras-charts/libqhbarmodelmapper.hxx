...
class VirtualQHBarModelMapper final : public QHBarModelMapper {
  ...
  public:
    ...
    using QHBarModelMapper_MetaObject_Callback = QMetaObject* (*)();
  ...
  protected:
    ...
    // Instance base flags
    mutable bool qhbarmodelmapper_metaobject_isbase = false;
    mutable bool qhbarmodelmapper_metacast_isbase = false;
  ...
  public:
    ...
    // Callback setters
    inline void setQHBarModelMapper_MetaObject_Callback(QHBarModelMapper_MetaObject_Callback cb) { qhbarmodelmapper_metaobject_callback = cb; }
    inline void setQHBarModelMapper_Metacast_Callback(QHBarModelMapper_Metacast_Callback cb) { qhbarmodelmapper_metacast_callback = cb; }
    ...
    // Base flag setters
    inline void setQHBarModelMapper_MetaObject_IsBase(bool value) const { qhbarmodelmapper_metaobject_isbase = value; }
    inline void setQHBarModelMapper_Metacast_IsBase(bool value) const { qhbarmodelmapper_metacast_isbase = value; }
    ...
    virtual const QMetaObject* metaObject() const override {
        if (qhbarmodelmapper_metaobject_isbase) {
            qhbarmodelmapper_metaobject_isbase = false;
            return QHBarModelMapper::metaObject();
        }
        auto metaobject_cb = qhbarmodelmapper_metaobject_callback;
        if (metaobject_cb) {
    ...
    virtual void* qt_metacast(const char* param1) override {
        if (qhbarmodelmapper_metacast_isbase) {
            qhbarmodelmapper_metacast_isbase = false;
            return QHBarModelMapper::qt_metacast(param1);
        }
        auto metacast_cb = qhbarmodelmapper_metacast_callback;
        if (metacast_cb) {
    ...
    virtual int qt_metacall(QMetaObject::Call param1, int param2, void** param3) override {
        ...
        auto metacall_cb = qhbarmodelmapper_metacall_callback;
        if (metacall_cb) {
    ...
    virtual bool event(QEvent* event) override {
        ...
        auto event_cb = qhbarmodelmapper_event_callback;
        if (event_cb) {
            QEvent* cbval1 = event;
    ...
    virtual bool eventFilter(QObject* watched, QEvent* event) override {
        ...
        auto eventfilter_cb = qhbarmodelmapper_eventfilter_callback;
        if (eventfilter_cb) {
    ...
    virtual void timerEvent(QTimerEvent* event) override {
        ...
        auto timerevent_cb = qhbarmodelmapper_timerevent_callback;
        if (timerevent_cb) {
    ...
    virtual void childEvent(QChildEvent* event) override {
        ...
        auto childevent_cb = qhbarmodelmapper_childevent_callback;
        if (childevent_cb) {
    ...
    virtual void customEvent(QEvent* event) override {
        ...
        auto customevent_cb = qhbarmodelmapper_customevent_callback;
        if (customevent_cb) {
            QEvent* cbval1 = event;
    ...
    virtual void connectNotify(const QMetaMethod& signal) override {
        ...
        auto connectnotify_cb = qhbarmodelmapper_connectnotify_callback;
        if (connectnotify_cb) {
    ...
    virtual void disconnectNotify(const QMetaMethod& signal) override {
        ...
        auto disconnectnotify_cb = qhbarmodelmapper_disconnectnotify_callback;
    ...
    int first() const {
        ...
        auto first_cb = qhbarmodelmapper_first_callback;
        if (first_cb) {
    ...
    void setFirst(int first) {
        ...
        auto setfirst_cb = qhbarmodelmapper_setfirst_callback;
        if (setfirst_cb) {
            int cbval1 = first;
    ...
    int count() const {
        ...
        auto count_cb = qhbarmodelmapper_count_callback;
        if (count_cb) {
    ...
    void setCount(int count) {
        ...
        auto setcount_cb = qhbarmodelmapper_setcount_callback;
        if (setcount_cb) {
            int cbval1 = count;
    ...
    int firstBarSetSection() const {
        ...
        auto firstbarsetsection_cb = qhbarmodelmapper_firstbarsetsection_callback;
    ...
    void setFirstBarSetSection(int firstBarSetSection) {
        ...
        auto setfirstbarsetsection_cb = qhbarmodelmapper_setfirstbarsetsection_callback;
    ...
    int lastBarSetSection() const {
        ...
        auto lastbarsetsection_cb = qhbarmodelmapper_lastbarsetsection_callback;
    ...
    void setLastBarSetSection(int lastBarSetSection) {
        ...
        auto setlastbarsetsection_cb = qhbarmodelmapper_setlastbarsetsection_callback;
    ...
    Qt::Orientation orientation() const {
        ...
        auto orientation_cb = qhbarmodelmapper_orientation_callback;
        if (orientation_cb) {
    ...
    void setOrientation(Qt::Orientation orientation) {
        ...
        auto setorientation_cb = qhbarmodelmapper_setorientation_callback;
    ...
    QObject* sender() const {
        ...
        auto sender_cb = qhbarmodelmapper_sender_callback;
        if (sender_cb) {
    ...
    int senderSignalIndex() const {
        ...
        auto sendersignalindex_cb = qhbarmodelmapper_sendersignalindex_callback;
    ...
    int receivers(const char* signal) const {
        ...
        auto receivers_cb = qhbarmodelmapper_receivers_callback;
        if (receivers_cb) {
    ...
    bool isSignalConnected(const QMetaMethod& signal) const {
        ...
        auto issignalconnected_cb = qhbarmodelmapper_issignalconnected_callback;
    ...
    friend int QHBarModelMapper_SuperFirst(const QHBarModelMapper* self);
    friend void QHBarModelMapper_SetFirst(QHBarModelMapper* self, int first);
    friend void QHBarModelMapper_SuperSetFirst(QHBarModelMapper* self, int first);
    friend int QHBarModelMapper_Count(const QHBarModelMapper* self);
    friend int QHBarModelMapper_SuperCount(const QHBarModelMapper* self);
    friend void QHBarModelMapper_SetCount(QHBarModelMapper* self, int count);
    friend void QHBarModelMapper_SuperSetCount(QHBarModelMapper* self, int count);
    friend int QHBarModelMapper_FirstBarSetSection(const QHBarModelMapper* self);
    friend int QHBarModelMapper_SuperFirstBarSetSection(const QHBarModelMapper* self);
    friend void QHBarModelMapper_SetFirstBarSetSection(QHBarModelMapper* self, int firstBarSetSection);
    friend void QHBarModelMapper_SuperSetFirstBarSetSection(QHBarModelMapper* self, int firstBarSetSection);
    friend int QHBarModelMapper_LastBarSetSection(const QHBarModelMapper* self);
    friend int QHBarModelMapper_SuperLastBarSetSection(const QHBarModelMapper* self);
    friend void QHBarModelMapper_SetLastBarSetSection(QHBarModelMapper* self, int lastBarSetSection);
    friend void QHBarModelMapper_SuperSetLastBarSetSection(QHBarModelMapper* self, int lastBarSetSection);
    friend int QHBarModelMapper_Orientation(const QHBarModelMapper* self);
    friend int QHBarModelMapper_SuperOrientation(const QHBarModelMapper* self);
    friend void QHBarModelMapper_SetOrientation(QHBarModelMapper* self, int orientation);
    friend void QHBarModelMapper_SuperSetOrientation(QHBarModelMapper* self, int orientation);
    friend QObject* QHBarModelMapper_Sender(const QHBarModelMapper* self);
    friend QObject* QHBarModelMapper_SuperSender(const QHBarModelMapper* self);
    friend int QHBarModelMapper_SenderSignalIndex(const QHBarModelMapper* self);
    friend int QHBarModelMapper_SuperSenderSignalIndex(const QHBarModelMapper* self);
    friend int QHBarModelMapper_Receivers(const QHBarModelMapper* self, const char* signal);
    friend int QHBarModelMapper_SuperReceivers(const QHBarModelMapper* self, const char* signal);
    friend bool QHBarModelMapper_IsSignalConnected(const QHBarModelMapper* self, const QMetaMethod* signal);
    friend bool QHBarModelMapper_SuperIsSignalConnected(const QHBarModelMapper* self, const QMetaMethod* signal);
};
