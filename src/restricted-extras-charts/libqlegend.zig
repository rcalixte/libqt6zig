...
pub const QLegend = extern struct {
    ...
    /// ` self: QLegend `
    ///
    pub fn asQGraphicsLayoutItem(self: QLegend) QGraphicsLayoutItem {
    ...
    ///
    pub fn fromQGraphicsLayoutItem(_qgraphicslayoutitem: anytype) QLegend {
    ...
    /// ` self: QLegend `
    ///
    pub fn asQGraphicsItem(self: QLegend) QGraphicsItem {
    ...
    ///
    pub fn fromQGraphicsItem(_qgraphicsitem: anytype) QLegend {
    ...
    pub fn advance(self: QLegend, phase: i32) void {
        qtc.QGraphicsItem_Advance(@ptrCast(self.asQGraphicsItem().ptr), @bitCast(phase));
    }
    ...
    pub fn contains(self: QLegend, point: anytype) bool {
        ...
        return qtc.QGraphicsItem_Contains(@ptrCast(self.asQGraphicsItem().ptr), @ptrCast(point.ptr));
    }
    ...
    pub fn collidesWithPath(self: QLegend, path: anytype, mode: i32) bool {
        ...
        return qtc.QGraphicsItem_CollidesWithPath(@ptrCast(self.asQGraphicsItem().ptr), @ptrCast(path.ptr), @bitCast(mode));
    }
    ...
    pub fn opaqueArea(self: QLegend) QPainterPath {
        return .{ .ptr = qtc.QGraphicsItem_OpaqueArea(@ptrCast(self.asQGraphicsItem().ptr)) };
    }
    ...
    pub fn isEmpty(self: QLegend) bool {
        return qtc.QGraphicsLayoutItem_IsEmpty(@ptrCast(self.asQGraphicsLayoutItem().ptr));
    }
