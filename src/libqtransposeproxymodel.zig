...
pub const QTransposeProxyModel = extern struct {
    ...
    pub fn ItemData(self: QTransposeProxyModel, allocator: std.mem.Allocator, index: anytype) ArrayMap_i32_QVariant {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qtransposeproxymodel.ItemData: Total capacity allocation failed");
        defer {
    ...
    pub fn RoleNames(self: QTransposeProxyModel, allocator: std.mem.Allocator) Map_i32_u8 {
        ...
        _ret.ensureTotalCapacity(allocator, _map.len) catch @panic("qtransposeproxymodel.RoleNames: Total capacity allocation failed");
        defer {
