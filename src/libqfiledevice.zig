...
pub const qfiledevice = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?**anyopaque) i32 {
        return qtc.QFileDevice_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(param3));
    }
    ...
    /// ` self: QtC.QFileDevice `
    ///
    /// ` callback: *const fn (self: QtC.QFileDevicechannel: i32) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileDevice `
    ///
    /// ` callback: *const fn (self: QtC.QFileDevicebytes: i64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileDevice `
    ///
    /// ` callback: *const fn (self: QtC.QFileDevicechannel: i32, bytes: i64) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileDevice `
    ///
    /// ` callback: *const fn (self: QtC.QFileDeviceparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QFileDevice `
    ///
    /// ` callback: *const fn (self: QtC.QFileDeviceobjectName: [*:0]const u8) callconv(.c) void `
    ///
