...
pub const qaudiodecoder = struct {
    ...
    /// ` self: QtC.QAudioDecoder `
    ///
    /// ` callback: *const fn (self: QtC.QAudioDecoderparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QAudioDecoder `
    ///
    /// ` callback: *const fn (self: QtC.QAudioDecoderobjectName: [*:0]const u8) callconv(.c) void `
    ///
