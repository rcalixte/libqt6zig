...
pub const QVideoFrameInput = extern struct {
    ...
    /// Allocate a new QVideoFrameInput object in C++ memory
    ///
    ...
    /// ## Parameter(s):
    ///
    /// ` _format: QVideoFrameFormat `
    ///
    pub fn new2(_format: anytype) QVideoFrameInput {
        comptime _ = @TypeOf(_format)._is_QVideoFrameFormat;
        return .{ .ptr = qtc.QVideoFrameInput_new2(@ptrCast(_format.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new3(_parent: anytype) QVideoFrameInput {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QVideoFrameInput_new3(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new4(_format: anytype, _parent: anytype) QVideoFrameInput {
        comptime _ = @TypeOf(_format)._is_QVideoFrameFormat;
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QVideoFrameInput_new4(@ptrCast(_format.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    ///
    pub const SendVideoFrame = sendVideoFrame;
    ...
    /// ### DEPRECATED: Use `readyToSendVideoFrame` instead
    ///
    pub const ReadyToSendVideoFrame = readyToSendVideoFrame;
    ...
    /// ### DEPRECATED: Use `onReadyToSendVideoFrame` instead
    ///
    pub const OnReadyToSendVideoFrame = onReadyToSendVideoFrame;
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QVideoFrameInput_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QVideoFrameInput, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QVideoFrameInput, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QVideoFrameInput, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QVideoFrameInput, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QVideoFrameInput.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QVideoFrameInput, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QVideoFrameInput, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoFrameInput_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QVideoFrameInput, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoFrameInput_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QVideoFrameInput, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoFrameInput_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QVideoFrameInput, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoFrameInput_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QVideoFrameInput, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QVideoFrameInput_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QVideoFrameInput, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QVideoFrameInput_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QVideoFrameInput, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QVideoFrameInput_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QVideoFrameInput, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QVideoFrameInput_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QVideoFrameInput, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QVideoFrameInput_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QVideoFrameInput, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QVideoFrameInput_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
