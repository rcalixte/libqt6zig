...
pub const qwavedecoder = struct {
    ...
    ///
    /// ``` self: QtC.QWaveDecoder, data: []u8, maxlen: i64 ```
    ...
    /// Wrapper to allow overriding base class virtual or protected method
    ///
    /// ``` self: QtC.QWaveDecoder, callback: *const fn (self: QtC.QWaveDecoder, data: [*:0]u8, maxlen: i64) callconv(.c) i64 ```
