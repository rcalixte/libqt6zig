...
pub const QVideoSink = extern struct {
    ...
    /// Allocate a new QVideoSink object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_parent: anytype) QVideoSink {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QVideoSink_new2(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ### DEPRECATED: Use `videoSize` instead
    ///
    pub const VideoSize = videoSize;
    ...
    /// ### DEPRECATED: Use `setVideoFrame` instead
    ///
    pub const SetVideoFrame = setVideoFrame;
    ...
    ///
    pub const VideoFrame = videoFrame;
    ...
    /// ### DEPRECATED: Use `videoFrameChanged` instead
    ///
    pub const VideoFrameChanged = videoFrameChanged;
    ...
    /// ### DEPRECATED: Use `onVideoFrameChanged` instead
    ///
    pub const OnVideoFrameChanged = onVideoFrameChanged;
    ...
    /// ### DEPRECATED: Use `subtitleTextChanged` instead
    ///
    pub const SubtitleTextChanged = subtitleTextChanged;
    ...
    /// ` self: QVideoSink `
    ///
    /// ` _subtitleText: []const u8 `
    ///
    pub fn subtitleTextChanged(self: QVideoSink, _subtitleText: []const u8) void {
        const subtitleText_str = qtc.libqt_string{
            .len = _subtitleText.len,
            .data = _subtitleText.ptr,
        };
        qtc.QVideoSink_SubtitleTextChanged(@ptrCast(self.ptr), subtitleText_str);
    }

    /// ### DEPRECATED: Use `onSubtitleTextChanged` instead
    ///
    pub const OnSubtitleTextChanged = onSubtitleTextChanged;
    ...
    /// ### DEPRECATED: Use `videoSizeChanged` instead
    ///
    pub const VideoSizeChanged = videoSizeChanged;
    ...
    /// ### DEPRECATED: Use `onVideoSizeChanged` instead
    ///
    pub const OnVideoSizeChanged = onVideoSizeChanged;
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QVideoSink, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QVideoSink, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QVideoSink, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QVideoSink, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QVideoSink.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QVideoSink, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QVideoSink, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoSink_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QVideoSink, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoSink_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QVideoSink, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoSink_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QVideoSink, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QVideoSink_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QVideoSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QVideoSink_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QVideoSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QVideoSink_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QVideoSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QVideoSink_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QVideoSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QVideoSink_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QVideoSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QVideoSink_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QVideoSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QVideoSink_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
