...
pub const QMediaDevices = extern struct {
    ...
    /// Allocate a new QMediaDevices object in C++ memory
    ///
    ...
    /// ` _parent: QObject `
    ///
    pub fn new2(_parent: anytype) QMediaDevices {
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QMediaDevices_new2(@ptrCast(_parent.ptr)) };
    }
    ...
    /// ### DEPRECATED: Use `audioInputs` instead
    ///
    pub const AudioInputs = audioInputs;
    ...
    pub fn audioInputs(allocator: std.mem.Allocator) []QAudioDevice {
        ...
        const _data_val: [*]QtC.QAudioDevice = @ptrCast(@alignCast(_arr.data));
        for (0.._arr.len) |j|
            _ret[j] = .{ .ptr = _data_val[j] };
        return _ret;
    }

    /// ### DEPRECATED: Use `audioOutputs` instead
    ///
    pub const AudioOutputs = audioOutputs;
    ...
    /// ### DEPRECATED: Use `videoInputs` instead
    ///
    pub const VideoInputs = videoInputs;
    ...
    pub fn videoInputs(allocator: std.mem.Allocator) []QCameraDevice {
        ...
        const _data_val: [*]QtC.QCameraDevice = @ptrCast(@alignCast(_arr.data));
        for (0.._arr.len) |j|
            _ret[j] = .{ .ptr = _data_val[j] };
        return _ret;
    }

    /// ### DEPRECATED: Use `defaultAudioInput` instead
    ///
    pub const DefaultAudioInput = defaultAudioInput;
    ...
    /// ### DEPRECATED: Use `defaultAudioOutput` instead
    ///
    pub const DefaultAudioOutput = defaultAudioOutput;
    ...
    /// ### DEPRECATED: Use `defaultVideoInput` instead
    ///
    pub const DefaultVideoInput = defaultVideoInput;
    ...
    /// ### DEPRECATED: Use `audioInputsChanged` instead
    ///
    pub const AudioInputsChanged = audioInputsChanged;
    ...
    /// ### DEPRECATED: Use `onAudioInputsChanged` instead
    ///
    pub const OnAudioInputsChanged = onAudioInputsChanged;
    ...
    /// ### DEPRECATED: Use `audioOutputsChanged` instead
    ///
    pub const AudioOutputsChanged = audioOutputsChanged;
    ...
    /// ### DEPRECATED: Use `onAudioOutputsChanged` instead
    ///
    pub const OnAudioOutputsChanged = onAudioOutputsChanged;
    ...
    /// ### DEPRECATED: Use `videoInputsChanged` instead
    ///
    pub const VideoInputsChanged = videoInputsChanged;
    ...
    /// ### DEPRECATED: Use `onVideoInputsChanged` instead
    ///
    pub const OnVideoInputsChanged = onVideoInputsChanged;
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QMediaDevices_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QMediaDevices, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QMediaDevices, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QMediaDevices, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QMediaDevices, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QMediaDevices.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QMediaDevices, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QMediaDevices, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QMediaDevices_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QMediaDevices, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QMediaDevices_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QMediaDevices, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QMediaDevices_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QMediaDevices, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QMediaDevices_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QMediaDevices, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QMediaDevices_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QMediaDevices, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QMediaDevices_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QMediaDevices, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QMediaDevices_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QMediaDevices, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QMediaDevices_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QMediaDevices, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QMediaDevices_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QMediaDevices, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QMediaDevices_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
