...
pub const QGraphicsVideoItem = extern struct {
    ...
    /// ` rect: QRectF `
    ///
    pub fn mapToItem2(self: QGraphicsVideoItem, item: anytype, rect: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` rect: QRectF `
    ///
    pub fn mapToParent2(self: QGraphicsVideoItem, rect: anytype) QPolygonF {
        comptime _ = @TypeOf(rect)._is_QRectF;
    ...
    /// ` rect: QRectF `
    ///
    pub fn mapToScene2(self: QGraphicsVideoItem, rect: anytype) QPolygonF {
        comptime _ = @TypeOf(rect)._is_QRectF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapToItem3(self: QGraphicsVideoItem, item: anytype, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapToParent3(self: QGraphicsVideoItem, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapToScene3(self: QGraphicsVideoItem, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` rect: QRectF `
    ///
    pub fn mapFromItem2(self: QGraphicsVideoItem, item: anytype, rect: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        comptime _ = @TypeOf(rect)._is_QRectF;
    ...
    /// ` rect: QRectF `
    ///
    pub fn mapFromParent2(self: QGraphicsVideoItem, rect: anytype) QPolygonF {
        comptime _ = @TypeOf(rect)._is_QRectF;
    ...
    /// ` rect: QRectF `
    ///
    pub fn mapFromScene2(self: QGraphicsVideoItem, rect: anytype) QPolygonF {
        comptime _ = @TypeOf(rect)._is_QRectF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapFromItem3(self: QGraphicsVideoItem, item: anytype, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapFromParent3(self: QGraphicsVideoItem, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` polygon: QPolygonF `
    ///
    pub fn mapFromScene3(self: QGraphicsVideoItem, polygon: anytype) QPolygonF {
        comptime _ = @TypeOf(polygon)._is_QPolygonF;
    ...
    /// ` h: f64 `
    ///
    pub fn mapToItem6(self: QGraphicsVideoItem, item: anytype, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` h: f64 `
    ///
    pub fn mapToParent6(self: QGraphicsVideoItem, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
    ...
    /// ` h: f64 `
    ///
    pub fn mapToScene6(self: QGraphicsVideoItem, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
    ...
    /// ` h: f64 `
    ///
    pub fn mapFromItem6(self: QGraphicsVideoItem, item: anytype, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
        comptime _ = @TypeOf(item)._is_QGraphicsItem;
        const item_ = if (@hasDecl(@TypeOf(item), "asQGraphicsItem")) item.asQGraphicsItem() else item;
    ...
    /// ` h: f64 `
    ///
    pub fn mapFromParent6(self: QGraphicsVideoItem, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
    ...
    /// ` h: f64 `
    ///
    pub fn mapFromScene6(self: QGraphicsVideoItem, _x: f64, _y: f64, w: f64, h: f64) QPolygonF {
