...
pub const QAudioSink = extern struct {
    ...
    /// Allocate a new QAudioSink object in C++ memory
    ///
    ...
    ///
    pub fn new3(_format: anytype) QAudioSink {
        comptime _ = @TypeOf(_format)._is_QAudioFormat;
        return .{ .ptr = qtc.QAudioSink_new3(@ptrCast(_format.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new4(_format: anytype, _parent: anytype) QAudioSink {
        comptime _ = @TypeOf(_format)._is_QAudioFormat;
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QAudioSink_new4(@ptrCast(_format.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    /// ` _format: QAudioFormat `
    ///
    pub fn new5(audioDeviceInfo: anytype, _format: anytype) QAudioSink {
        comptime _ = @TypeOf(audioDeviceInfo)._is_QAudioDevice;
        comptime _ = @TypeOf(_format)._is_QAudioFormat;
        return .{ .ptr = qtc.QAudioSink_new5(@ptrCast(audioDeviceInfo.ptr), @ptrCast(_format.ptr)) };
    }
    ...
    /// ` _parent: QObject `
    ///
    pub fn new6(audioDeviceInfo: anytype, _format: anytype, _parent: anytype) QAudioSink {
        comptime _ = @TypeOf(audioDeviceInfo)._is_QAudioDevice;
        comptime _ = @TypeOf(_format)._is_QAudioFormat;
        comptime _ = @TypeOf(_parent)._is_QObject;
        return .{ .ptr = qtc.QAudioSink_new6(@ptrCast(audioDeviceInfo.ptr), @ptrCast(_format.ptr), @ptrCast(_parent.ptr)) };
    }
    ...
    /// ` self: QAudioSink `
    ///
    pub fn suspend0(self: QAudioSink) void {
    ...
    /// ` self: QAudioSink `
    ///
    pub fn resume0(self: QAudioSink) void {
    ...
    /// ` qaudio_enums.Error `
    ///
    pub fn error0(self: QAudioSink) i32 {
    ...
    /// ` _volume: f64 `
    ///
    pub fn setVolume(self: QAudioSink, _volume: f64) void {
        qtc.QAudioSink_SetVolume(@ptrCast(self.ptr), @bitCast(_volume));
    }
    ...
    ///
    pub fn stateChanged(self: QAudioSink, _state: i32) void {
        qtc.QAudioSink_StateChanged(@ptrCast(self.ptr), @bitCast(_state));
    }
    ...
    pub fn tr3(allocator: std.mem.Allocator, s: [:0]const u8, c: [:0]const u8, n: i32) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        var _str = qtc.QAudioSink_Tr3(s_Cstring, c_Cstring, @bitCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` _thread: QThread `
    ///
    pub fn moveToThread(self: QAudioSink, _thread: anytype) bool {
    ...
    /// ` _parent: QObject `
    ///
    pub fn setParent(self: QAudioSink, _parent: anytype) void {
        comptime _ = @TypeOf(_parent)._is_QObject;
    ...
    /// ` member: [:0]const u8 `
    ///
    pub fn connect3(self: QAudioSink, _sender: anytype, signal: [:0]const u8, member: [:0]const u8) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    pub fn dynamicPropertyNames(self: QAudioSink, allocator: std.mem.Allocator) [][]u8 {
        ...
        for (0.._arr.len) |i| {
            ...
            const _buf = allocator.alloc(u8, _data_val.len) catch @panic("QAudioSink.dynamicPropertyNames: Memory allocation failed");
    ...
    /// ` typeVal: qnamespace_enums.ConnectionType `
    ///
    pub fn connect4(self: QAudioSink, _sender: anytype, signal: [:0]const u8, member: [:0]const u8, typeVal: i32) QMetaObject__Connection {
        comptime _ = @TypeOf(_sender)._is_QObject;
        const signal_Cstring = signal.ptr;
        const member_Cstring = member.ptr;
    ...
    /// ` _event: QEvent `
    ///
    pub fn event(self: QAudioSink, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QAudioSink_Event(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEvent(self: QAudioSink, _event: anytype) bool {
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QAudioSink_SuperEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn eventFilter(self: QAudioSink, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QAudioSink_EventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superEventFilter(self: QAudioSink, watched: anytype, _event: anytype) bool {
        comptime _ = @TypeOf(watched)._is_QObject;
        comptime _ = @TypeOf(_event)._is_QEvent;
        return qtc.QAudioSink_SuperEventFilter(@ptrCast(self.ptr), @ptrCast(watched.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn timerEvent(self: QAudioSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QAudioSink_TimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QTimerEvent `
    ///
    pub fn superTimerEvent(self: QAudioSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QTimerEvent;
        qtc.QAudioSink_SuperTimerEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn childEvent(self: QAudioSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QAudioSink_ChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QChildEvent `
    ///
    pub fn superChildEvent(self: QAudioSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QChildEvent;
        qtc.QAudioSink_SuperChildEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn customEvent(self: QAudioSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QAudioSink_CustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
    ...
    /// ` _event: QEvent `
    ///
    pub fn superCustomEvent(self: QAudioSink, _event: anytype) void {
        comptime _ = @TypeOf(_event)._is_QEvent;
        qtc.QAudioSink_SuperCustomEvent(@ptrCast(self.ptr), @ptrCast(_event.ptr));
    }
