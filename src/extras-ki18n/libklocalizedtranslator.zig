...
pub const klocalizedtranslator = struct {
    ...
    /// ` self: QtC.KLocalizedTranslator `
    ///
    /// ` callback: *const fn (self: QtC.KLocalizedTranslatorparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KLocalizedTranslator `
    ///
    /// ` callback: *const fn (self: QtC.KLocalizedTranslatorobjectName: [*:0]const u8) callconv(.c) void `
    ///
