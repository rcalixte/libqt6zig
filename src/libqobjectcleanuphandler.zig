...
pub const qobjectcleanuphandler = struct {
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QObjectCleanupHandler_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.QObjectCleanupHandler_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    /// ` self: QtC.QObjectCleanupHandler `
    ///
    /// ` callback: *const fn (self: QtC.QObjectCleanupHandlerparam1: QtC.QObject) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.QObjectCleanupHandler `
    ///
    /// ` callback: *const fn (self: QtC.QObjectCleanupHandlerobjectName: [*:0]const u8) callconv(.c) void `
    ///
