...
pub const kcompletion = struct {
    ...
    /// ` self: QtC.KCompletion `
    ///
    /// ` callback: *const fn (self: QtC.KCompletion, param1: [*:0]const u8) callconv(.c) ?*anyopaque `
    ///
    ...
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: *?*anyopaque) i32 {
        return qtc.KCompletion_Metacall(@ptrCast(self), @bitCast(param1), @bitCast(param2), @ptrCast(param3));
    }
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn SubstringCompletion(self: ?*anyopaque, stringVal: []const u8, allocator: std.mem.Allocator) []const []const u8 {
    ...
    pub fn LastMatch(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KCompletion_LastMatch(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn SetCompletionMode(self: ?*anyopaque, mode: i32) void {
        qtc.KCompletion_SetCompletionMode(@ptrCast(self), @bitCast(mode));
    }
    ...
    pub fn SetOrder(self: ?*anyopaque, order: i32) void {
        qtc.KCompletion_SetOrder(@ptrCast(self), @bitCast(order));
    }
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn AllMatches(self: ?*anyopaque, allocator: std.mem.Allocator) []const []const u8 {
    ...
    /// ` allocator: std.mem.Allocator `
    ///
    pub fn AllMatches2(self: ?*anyopaque, stringVal: []const u8, allocator: std.mem.Allocator) []const []const u8 {
        const stringVal_str = qtc.libqt_string{
            .len = stringVal.len,
            .data = stringVal.ptr,
        };
    ...
    pub fn MakeCompletion(self: ?*anyopaque, stringVal: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        var _str = qtc.KCompletion_MakeCompletion(@ptrCast(self), stringVal_str);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn PreviousMatch(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KCompletion_PreviousMatch(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn NextMatch(self: ?*anyopaque, allocator: std.mem.Allocator) []const u8 {
        var _str = qtc.KCompletion_NextMatch(@ptrCast(self));
        defer qtc.libqt_string_free(&_str);
    ...
    /// ` self: QtC.KCompletion `
    ///
    /// ` callback: *const fn (self: QtC.KCompletion, itemList: ?[*:null]?[*:0]const u8) callconv(.c) void `
    ///
    ...
    /// ` self: QtC.KCompletion `
    ///
    /// ` callback: *const fn (self: QtC.KCompletion, matchlist: ?[*:null]?[*:0]const u8) callconv(.c) void `
    ///
    ...
    pub fn OnEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KCompletion_OnEvent(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnEventFilter(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KCompletion_OnEventFilter(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnTimerEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KCompletion_OnTimerEvent(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnChildEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KCompletion_OnChildEvent(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnCustomEvent(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KCompletion_OnCustomEvent(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnConnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KCompletion_OnConnectNotify(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnDisconnectNotify(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) void) void {
        qtc.KCompletion_OnDisconnectNotify(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnSender(self: ?*anyopaque, callback: *const fn () callconv(.c) QtC.QObject) void {
        qtc.KCompletion_OnSender(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnSenderSignalIndex(self: ?*anyopaque, callback: *const fn () callconv(.c) i32) void {
        qtc.KCompletion_OnSenderSignalIndex(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnReceivers(self: ?*anyopaque, callback: *const fn (?*anyopaque, [*:0]const u8) callconv(.c) i32) void {
        qtc.KCompletion_OnReceivers(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
    ...
    pub fn OnIsSignalConnected(self: ?*anyopaque, callback: *const fn (?*anyopaque, ?*anyopaque) callconv(.c) bool) void {
        qtc.KCompletion_OnIsSignalConnected(@ptrCast(self), @bitCast(@intFromPtr(callback)));
    }
