...
pub const kemailvalidator = struct {
    ...
    /// ``` self: QtC.KEmailValidator, param1: []const u8 ```
    pub fn Metacast(self: ?*anyopaque, param1: []const u8) ?*anyopaque {
        const param1_Cstring = param1.ptr;
        return qtc.KEmailValidator_Metacast(@ptrCast(self), param1_Cstring);
    }

    /// ``` self: QtC.KEmailValidator, param1: qobjectdefs_enums.Call, param2: i32, param3: ?*anyopaque ```
    pub fn Metacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KEmailValidator_Metacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn QBaseMetacall(self: ?*anyopaque, param1: i32, param2: i32, param3: ?*anyopaque) i32 {
        return qtc.KEmailValidator_QBaseMetacall(@ptrCast(self), @intCast(param1), @intCast(param2), @ptrCast(@alignCast(param3)));
    }
    ...
    pub fn Tr(s: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KEmailValidator_Tr(s_Cstring);
    ...
    pub fn Tr2(s: []const u8, c: []const u8, allocator: std.mem.Allocator) []const u8 {
        ...
        const _str = qtc.KEmailValidator_Tr2(s_Cstring, c_Cstring);
        defer qtc.libqt_string_free(&_str);
    ...
    pub fn Tr3(s: []const u8, c: []const u8, n: i32, allocator: std.mem.Allocator) []const u8 {
        const s_Cstring = s.ptr;
        const c_Cstring = c.ptr;
        const _str = qtc.KEmailValidator_Tr3(s_Cstring, c_Cstring, @intCast(n));
        defer qtc.libqt_string_free(&_str);
    ...
    ///
    /// ``` self: QtC.KEmailValidator, locale: QtC.QLocale ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, allocator: std.mem.Allocator ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, name: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, b: bool ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, thread: QtC.QThread ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, interval: i32 ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, id: i32 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#killTimer)
    ///
    /// ``` self: QtC.KEmailValidator, id: qnamespace_enums.TimerId ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, parent: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, filterObj: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, obj: QtC.QObject ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KEmailValidator, sender: QtC.QObject, signal: []const u8, member: []const u8 ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, name: []const u8, value: QtC.QVariant ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, classname: []const u8 ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#moveToThread)
    ///
    /// ``` self: QtC.KEmailValidator, thread: QtC.QThread, param2: QtC.Disambiguated_t ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#startTimer)
    ///
    /// ``` self: QtC.KEmailValidator, interval: i32, timerType: qnamespace_enums.TimerType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#connect)
    ///
    /// ``` self: QtC.KEmailValidator, sender: QtC.QObject, signal: []const u8, member: []const u8, typeVal: qnamespace_enums.ConnectionType ```
    ...
    /// [Qt documentation](https://doc.qt.io/qt-6/qobject.html#destroyed)
    ///
    /// ``` self: QtC.KEmailValidator, param1: QtC.QObject ```
    ...
    ///
    /// ``` self: QtC.KEmailValidator, event: QtC.QEvent ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KEmailValidator, watched: QtC.QObject, event: QtC.QEvent ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KEmailValidator, event: QtC.QTimerEvent ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KEmailValidator, event: QtC.QChildEvent ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KEmailValidator, signal: QtC.QMetaMethod ```
    ...
    /// Wrapper to allow calling virtual or protected method
    ///
    /// ``` self: QtC.KEmailValidator, signal: []const u8 ```
